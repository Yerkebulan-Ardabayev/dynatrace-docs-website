# -*- coding: utf-8 -*-
"""L4-IF.62 g5b QA: setup-on-k8s/guides/deployment-and-configuration (2 files).
...
# Full lines that legitimately stay EN (identifiers / mode badges / footnote markers).
ALLOW_EN_LINE = {
    "1",
    "2",

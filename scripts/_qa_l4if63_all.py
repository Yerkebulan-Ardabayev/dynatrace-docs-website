# -*- coding: utf-8 -*-
"""L4-IF.63 UNIFIED QA: 18 setup-on-k8s files (deployment 16 + extend-observability-k8s 2).
...
FILES = [
    ...
    "ingest-from/setup-on-k8s/deployment/troubleshooting.md",
    "ingest-from/setup-on-k8s/deployment/k8s-obs-managed.md",
    "ingest-from/setup-on-k8s/deployment/other/oneagent-daemonset.md",
    "ingest-from/setup-on-k8s/deployment/app-obs-managed.md",
    "ingest-from/setup-on-k8s/deployment/other/host-monitoring.md",
    "ingest-from/setup-on-k8s/deployment/other/ag-in-vm.md",
    "ingest-from/setup-on-k8s/deployment/other/pod-runtime.md",
    "ingest-from/setup-on-k8s/deployment/other/classic-full-stack.md",
    "ingest-from/setup-on-k8s/deployment/other/ag-statefulset.md",

# -*- coding: utf-8 -*-
"""L4-IF.60e QA: setup-on-k8s/guides/migration/classic-to-app-monitoring (1 file).
...
# (rel_dir, filename)
FILES = [
    (SUB, "classic-to-app-monitoring.md"),
]
...
# Bare lines / tab labels that legitimately stay as-is (latin product names).
ALLOW_EN_LINE = {
    "Helm",
    "Manifest",
    "**Kubernetes**",

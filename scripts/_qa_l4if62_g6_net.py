# -*- coding: utf-8 -*-
"""L4-IF.62 G6 QA: setup-on-k8s/guides/networking-security-compliance
...
# (rel_dir, filename)
FILES = [
    (SUB, "network-configurations.md"),
    (SUB + "/network-configurations", "network-zones.md"),
]
...
# Full lines that legitimately stay EN (identifiers, component names, EN product
# concept "network zone(s)" kept per batch instruction).
ALLOW_EN_LINE = {
    "Network zones",
    "Kubernetes",
    "OpenShift",

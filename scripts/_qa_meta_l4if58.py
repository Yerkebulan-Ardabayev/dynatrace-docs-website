# -*- coding: utf-8 -*-
"""L4-IF.58 QA: setup-on-k8s/guides/metadata-automation batch (3 files).
...
Framework copied from _qa_cr_l4if57.py.
"""
...
# (rel_dir, filename)
FILES = [
    (SUB, "custom-properties-file.md"),
    (SUB, "build-label-propagation.md"),
    (SUB, "metadata-enrichment.md"),
]
...
# Bare filenames (escaped underscore) that legitimately stay as-is.
ALLOW_EN_LINE = {

# -*- coding: utf-8 -*-
"""L4-IF.61 QA: api-version-migration-guides batch (8 files).
...
Framework from _qa_meta_l4if58.py.
"""
...
# Intentional EN lines: paired tab labels (correspond to YAML field identifiers).
ALLOW_EN_LINE = {
    "Host monitoring",
    "Classic fullstack",

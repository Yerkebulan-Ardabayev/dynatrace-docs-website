# -*- coding: utf-8 -*-
"""L4-IF.67 QA: opentelemetry/collector/use-cases/kafka subtree (4 files).
...
Framework copied from _qa_meta_l4if58.py (strip-aware FENCE_RE; no guillemets used
in this batch so the » mojibake entry is kept).
"""
...
HUB = "ingest-from/opentelemetry/collector/use-cases"
KAFKA = "ingest-from/opentelemetry/collector/use-cases/kafka"

FILES = [
    (HUB, "kafka.md"),
    (KAFKA, "exporter.md"),
    (KAFKA, "receiver.md"),
    (KAFKA, "kafkametrics.md"),
]
...
# Component-block headers / card title kept EN by canon.
ALLOW_EN_LINE = {
    "### Receivers",
    "### Processors",
    "### Exporters",

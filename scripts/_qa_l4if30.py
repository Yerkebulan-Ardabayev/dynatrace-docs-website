...
- application-software/dotnet.md (114)
- application-software/nodejs.md (130)
- application-software/python.md (153)
"""
...
FILES = [
    "ingest-from/technology-support/application-software/dotnet.md",
    "ingest-from/technology-support/application-software/nodejs.md",
    "ingest-from/technology-support/application-software/python.md",
]

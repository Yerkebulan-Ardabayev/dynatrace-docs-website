# -*- coding: utf-8 -*-
"""L4-IF.60a QA: setup-on-k8s/guides/migration/dynakube.md (single file).
...
FIX vs template: FENCE_RE = r"^\s*```" so list-INDENTED code fences are detected
(otherwise indented code commands false-positive as EN-leftover).
"""
...
# Bare technical lines that legitimately stay as-is.
ALLOW_EN_LINE = {
    "1",
}

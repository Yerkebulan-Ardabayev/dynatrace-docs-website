# -*- coding: utf-8 -*-
"""L4-IF.60d QA: setup-on-k8s/guides/migration/classic-to-cloud-native (1 file).
...
# (rel_dir, filename)
FILES = [
    (SUB, "classic-to-cloud-native.md"),
]
...
# Tab labels / kept-as-is identifiers that legitimately stay as-is.
ALLOW_EN_LINE = {
    "Helm",
    "Manifest",
    "**Kubernetes**",

# -*- coding: utf-8 -*-
"""L4-IF.68 QA: opentelemetry/collector/use-cases hub + 8 recipe leaves.
...
Strict: no guillemets used in this batch, so `»` stays in MOJI.
"""
...
# Component-block headers / EN-kept card product titles.
ALLOW_EN_LINE = {
    "### Receivers",
    "### Processors",
    "### Exporters",

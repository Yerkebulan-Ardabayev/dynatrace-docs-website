#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Critical review + code-fence sync for Batch L4I (configuration-api/reports-api, parent + 7 endpoints).
ACTIVE config-api (no deprecated banner, L89/L90). No env-api twin -> L103 case (b):
anchor = azure/aws-credentials RU (k8s/credentials family) for shared objects
...
Domain term "report"->"отчёт", "dashboard"->"дашборд" (corpus-dominant). L101 periods by source."""
...
PAIRS = [
    (f"{EN}/reports-api.md", f"{RU}/reports-api.md"),
    (f"{EN}/reports-api/del-report.md", f"{RU}/reports-api/del-report.md"),
    (f"{EN}/reports-api/get-all.md", f"{RU}/reports-api/get-all.md"),
    (f"{EN}/reports-api/get-report.md", f"{RU}/reports-api/get-report.md"),
    (f"{EN}/reports-api/post-report.md", f"{RU}/reports-api/post-report.md"),
    (f"{EN}/reports-api/put-report.md", f"{RU}/reports-api/put-report.md"),
    (f"{EN}/reports-api/subscribe-report.md", f"{RU}/reports-api/subscribe-report.md"),
    (
        f"{EN}/reports-api/unsubscribe-report.md",
        f"{RU}/reports-api/unsubscribe-report.md",
    ),
]

# -*- coding: utf-8 -*-
"""L4-IF.60c QA: setup-on-k8s/guides/migration/cloud-native-to-app-monitoring (1 file).
...
# (rel_dir, filename)
FILES = [
    (SUB, "cloud-native-to-app-monitoring.md"),
]
...
# Lines that legitimately stay as-is (tab labels / bare tokens).
ALLOW_EN_LINE = {

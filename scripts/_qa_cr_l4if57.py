# -*- coding: utf-8 -*-
"""L4-IF.57 QA: setup-on-k8s/guides/container-registries batch (5 files).
...
Framework copied from _qa_l4if56.py; adds per-file REL dir + ALLOW_EN_LINE for
product-name headings/tool tabs that legitimately stay English.
"""
...
# (rel_dir, filename)
FILES = [
    (GUIDES, "container-registries.md"),
    (SUB, "use-public-registry.md"),
    (SUB, "use-private-registry.md"),
    (SUB, "verify-image-signature.md"),
    (SUB, "prepare-private-registry.md"),
]
...
# Product-name headings and tool-tab labels that stay English by design.
ALLOW_EN_LINE = {
    "### Dynatrace Operator",
    ...
    "Manifest",
    "Docker CLI",
    # image-ref table rows (hyphens become spaces in bare-scan -> false positive)

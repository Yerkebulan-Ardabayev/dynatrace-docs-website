...
FILES = [
    "ingest-from/setup-on-k8s/reference/network.md",
    "ingest-from/setup-on-k8s/reference/dynakube-feature-flags.md",
    "ingest-from/setup-on-k8s/reference/storage.md",
    "ingest-from/setup-on-k8s/reference/workload-mutation.md",
    "ingest-from/setup-on-k8s/reference/security.md",
]

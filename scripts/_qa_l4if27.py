"""QA script for L4-IF.27 technology-support batch.

3 files:
- nginx/manual-runtime-instrumentation.md (51)
- java/top-java-memory-problems.md (195)
- java/support-for-jvms.md (209)
"""
...
FILES = [
    "ingest-from/technology-support/application-software/nginx/manual-runtime-instrumentation.md",
    "ingest-from/technology-support/application-software/java/top-java-memory-problems.md",
    "ingest-from/technology-support/application-software/java/support-for-jvms.md",
]

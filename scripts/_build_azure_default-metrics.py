# -*- coding: utf-8 -*-
"""L4-IF.73 — ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide/default-azure-metrics.md"""
...
TT_MIGRATION = "Миграция классических сервисов Azure на их новые версии."
TT_MONITORING = "Настройка и конфигурирование мониторинга Azure в Dynatrace."
TT_CLOUD_SVCS = "Мониторинг сервисов Azure с Dynatrace и просмотр доступных метрик."

TRANS = {
    "title: Classic (formerly 'built-in') Azure metrics": "title: Классические (ранее «встроенные») метрики Azure",
    "# Classic (formerly 'built-in') Azure metrics": "# Классические (ранее «встроенные») метрики Azure",
    "* Reference": "* Справочник",
    "* 1-min read": "* Чтение: 1 мин",
    "* Updated on Jan 29, 2024": "* Обновлено 29 января 2024 г.",
    "For information about differences between classic services and other services, see [Migrate from Azure classic (formerly 'built-in') services to cloud services](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide/azure-migration-guide \"Migrate Azure classic services to their new versions.\").": f'Информацию о различиях между классическими и другими сервисами см. в разделе [Миграция с классических (ранее «встроенных») сервисов Azure на облачные сервисы](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide/azure-migration-guide "{TT_MIGRATION}").',
    'The table below lists all Azure metrics that Dynatrace collects by default when you enable [Microsoft Azure](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide "Set up and configure Azure monitoring in Dynatrace.") monitoring.': f'В таблице ниже перечислены все метрики Azure, которые Dynatrace собирает по умолчанию при включении мониторинга [Microsoft Azure](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide "{TT_MONITORING}").',
    'For all other metrics collected by Dynatrace per configurable Azure service, see [cloud services](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-cloud-services-metrics "Monitor Azure services with Dynatrace and view available metrics.") pages.': f'Все остальные метрики, собираемые Dynatrace для каждого настраиваемого сервиса Azure, см. на страницах [облачных сервисов](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-cloud-services-metrics "{TT_CLOUD_SVCS}").',
    "| Metric key | Name | Unit | Aggregations |": "| Ключ метрики | Название | Единица измерения | Агрегации |",
    "| --- | --- | --- | --- |": "| --- | --- | --- | --- |",
}
...
if __name__ == "__main__":
    build_one(REL, "default-azure-metrics.md", TRANS, PASS)
    qa_one(REL, "default-azure-metrics.md")

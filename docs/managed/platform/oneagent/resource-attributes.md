...
| `aws.availability_zone` | A specific availability zone in given AWS Region. For example, `usâeastâ1a`. |
| `aws.region` | A specific geographical AWS Cloud location. For example, `usâeastâ1`. |

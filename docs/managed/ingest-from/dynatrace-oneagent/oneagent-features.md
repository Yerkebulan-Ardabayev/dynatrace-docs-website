...
* You can use the Dynatrace [Settings API](/managed/dynatrace-api/environment-api/settings "Find out what the Dynatrace Settings API offers.") to make the same settings via API calls.
...
Using the [Settings API](/managed/dynatrace-api/environment-api/settings "Find out what the Dynatrace Settings API offers."), you can:
...
1. To learn the JSON format required to post your configuration, use the [Get a schema](/managed/dynatrace-api/environment-api/settings/schemas/get-schema "View a settings schema via the Dynatrace API.") endpoint. The schema ID is `builtin:oneagent.features`.
   ...
   ```
2. To send your configuration, use the [Post an object](/managed/dynatrace-api/environment-api/settings/objects/post-object "Create or validate a settings object via the Dynatrace API.") endpoint.
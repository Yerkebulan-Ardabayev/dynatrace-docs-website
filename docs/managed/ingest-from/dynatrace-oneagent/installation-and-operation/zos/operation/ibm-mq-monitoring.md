...
* [Create queue manager configuration](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing#qm-api-create "Configure Dynatrace for IBM MQ tracing.")
* [Update queue manager configuration](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing#qm-api-update "Configure Dynatrace for IBM MQ tracing.")
* [Create queue sharing group configuration](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing#qsg-api-create "Configure Dynatrace for IBM MQ tracing.")
* [Update queue sharing group configuration](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing#qsg-api-update "Configure Dynatrace for IBM MQ tracing.")
* [Create IMS bridge configuration](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing#ims-bridge-api-create "Configure Dynatrace for IBM MQ tracing.")
* [Update IMS bridge configuration](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing#ims-bridge-api-update "Configure Dynatrace for IBM MQ tracing.")

## Related topics

* [IBM MQ tracing](/managed/observe/infrastructure-observability/queues/configuration/ibm-mq-tracing "Configure Dynatrace for IBM MQ tracing.")
...
| --- | --- | --- | --- |
| -healthcheck.heartbeat.timeout | Seconds | 900 | The connection timeout between the zRemote service and your Dynatrace environment |
| -healthcheck.memory.limit\_absolute | MiB | 500 | Absolute input for the memory calculation limit of the child process |
| -healthcheck.memory.limit\_percentage | % | 20 | Percentage input for the memory calculation limit of the child process |

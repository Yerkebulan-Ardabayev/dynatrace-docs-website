...
OneAgent downloads AIX system logs for the purpose of diagnosing issues that may be caused by conditions in your environment. For details, see [System logs downloaded by OneAgent](/managed/ingest-from/dynatrace-oneagent/installation-and-operation/aix/installation/oneagent-security-aix#system-logs-downloaded-by-oneagent "Learn about Dynatrace OneAgent security and modifications to your AIX-based system.").
...
Note that this is a self-diagnostics setting that is not related to [Log Monitoring](/managed/analyze-explore-automate/log-monitoring "Learn how to enable Log Monitoring, the insights that Log Monitoring can provide, and more.").
...
For information about the OneAgent auto-update mechanism, see [Update Dynatrace OneAgent on AIX](/managed/ingest-from/dynatrace-oneagent/installation-and-operation/aix/operation/update-oneagent-on-aix "Learn how you can update Dynatrace OneAgent on AIX.").
...
For supported platforms, see [Technology support](/managed/ingest-from/technology-support#aix "Find technical details related to Dynatrace support for specific platforms and development frameworks.").
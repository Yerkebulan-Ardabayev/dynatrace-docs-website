...
For limits applying to your extension, see [Extensions limits](/managed/ingest-from/extensions/extension-limits "Learn about extensions limits.") and the following Prometheus-specific limits:

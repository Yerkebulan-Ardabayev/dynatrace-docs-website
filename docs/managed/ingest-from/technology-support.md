...
| [Alpine Linux (musl libc) for containers](/managed/ingest-from/technology-support/oneagent-platform-and-capability-support-matrix "Learn which capabilities are supported by OneAgent on different operating systems and platforms.") | 3.10 - 3.23[1](#fn-supported-os-1-def) | x86-64 |
| [Amazon Linux](/managed/ingest-from/dynatrace-oneagent/installation-and-operation/linux "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 2023 | ARM64 (AArch64), x86-64 |
...
| [Fedora](/managed/ingest-from/dynatrace-oneagent/installation-and-operation/linux "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 41, 42, 43 | x86-64 |
...
If the `mmpmonSocket` command on Linux fails, a fallback mode is available, which works when the CAP\_SETUID capability is enabled. For details, see [OneAgent configuration via command-line interface](/managed/ingest-from/dynatrace-oneagent/oneagent-configuration-via-command-line-interface#capsetuid-osagent "Learn how to perform some OneAgent configuration tasks without the need to reinstall OneAgent.").
...
Please see [known limitations of Docker container monitoring](/managed/observe/infrastructure-observability/container-platform-monitoring/container-groups#limitations "Overview on container groups monitoring").

2

Supported for OneAgent 1.267+ installed on the Podman node using [crunï»¿](https://github.com/containers/crun) container runtime, versions 0.17 - 1.15 Podman using the `runc` runtime isn't supported.
...
For details, see [Supported technologies](/managed/secure/application-security#tech "Access the Dynatrace Application Security functionalities.").
...
| --- | --- | --- |
| Amazon Corretto | 8 LTS, 11 LTS, 17 LTS, 21 LTS, 22, 23, 24, 25 LTS, 26[5](#fn-virtual-machines-5-def) | Linux (x86-64, ARM64 (AArch64)) |
| Azul Platform Core (Zulu) | 7, 8 LTS, 11 LTS, 17 LTS, 21 LTS, 22, 23, 24, 25 LTS, 26[9](#fn-virtual-machines-9-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64, ARM64 (AArch64)), Windows (x86-64) |
| Azul Platform Prime (Zing) | 6[9](#fn-virtual-machines-9-def), 7[9](#fn-virtual-machines-9-def), 8 LTS[9](#fn-virtual-machines-9-def), 11 LTS[9](#fn-virtual-machines-9-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64), Windows (x86-64) |
| Bellsoft Liberica | 8 LTS, 11 LTS, 17 LTS, 21 LTS[10](#fn-virtual-machines-10-def), 22, 23, 24, 25 LTS, 26[10](#fn-virtual-machines-10-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64, ARM64 (AArch64), PPCLE), Solaris (SPARC, x86-64), Windows (x86-64) |
| Eclipse Temurin (a.k.a. 'Adoptium') | 8 LTS, 11 LTS, 17 LTS, 21 LTS, 22, 23, 24, 25 LTS, 26[10](#fn-virtual-machines-10-def) | AIX (POWER8, POWER9, POWER10), Linux (x86-64, ARM64 (AArch64), PPCLE, s390), Windows (x86-64) |
| Fujitsu | 5, 6, 8 | Linux (x86-64), Windows (x86-64) |
| GraalVM | 19[6](#fn-virtual-machines-6-def), 20[6](#fn-virtual-machines-6-def), 21[7](#fn-virtual-machines-7-def), 22[8](#fn-virtual-machines-8-def) | Linux (x86-64), Windows (x86-64) |
...
| OpenJ9 | 0.8[2](#fn-virtual-machines-2-def), 0.9[3](#fn-virtual-machines-3-def), 0.10[4](#fn-virtual-machines-4-def), 0.11[5](#fn-virtual-machines-5-def) | Linux (x86-64) |
| OpenJDK | 6, 7, 8 LTS, 11 LTS, 17 LTS, 21 LTS, 22, 23, 24, 25 LTS, 26[1](#fn-virtual-machines-1-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64, s390), Windows (x86-64) |
| Oracle HotSpot VM | 6, 7, 8 LTS, 11 LTS, 17 LTS, 21 LTS, 22, 23, 24, 25 LTS, 26[1](#fn-virtual-machines-1-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64, ARM64 (AArch64)), Solaris (SPARC, x86-64), Windows (x86-64) |
| Oracle JRockit | 6 | Alpine Linux 64-bit (x86-64), Linux (x86-64), Solaris (SPARC), Windows (x86-64) |
| SapMachine | 7, 8 LTS, 11 LTS, 17 LTS, 21 LTS, 23, 24, 25 LTS, 26[1](#fn-virtual-machines-1-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64), Windows (x86-64) |
...
Powered by Oracle JVM 8 or 11. For Native Images, see [Java Native Images](/managed/ingest-from/technology-support#java-native-image "Find technical details related to Dynatrace support for specific platforms and development frameworks.")

7

Powered by Oracle JVM 8, 11 or 17. For Native Images, see [Java Native Images](/managed/ingest-from/technology-support#java-native-image "Find technical details related to Dynatrace support for specific platforms and development frameworks.").

8

Powered by Oracle JVM 11, 17 or 19. For Native Images, see [Java Native Images](/managed/ingest-from/technology-support#java-native-image "Find technical details related to Dynatrace support for specific platforms and development frameworks.")
...
| [Lettuceï»¿](https://lettuce.io/) | 5.1 - 5.3[1](#fn-database-frameworks-1-def), 6.0.3 - 6.1.6[1](#fn-database-frameworks-1-def), 6.1.8 - 6.8[1](#fn-database-frameworks-1-def), 7.0 - 7.5[1](#fn-database-frameworks-1-def) |
...
| [Kafkaï»¿](https://kafka.apache.org/documentation/) | 1.0 - 1.1[1](#fn-messaging-clients-1-def), 2.0 - 2.3[1](#fn-messaging-clients-1-def), 2.4 - 2.7[1](#fn-messaging-clients-1-def), 2.8[1](#fn-messaging-clients-1-def), 3.0 - 3.6[1](#fn-messaging-clients-1-def), 3.7 - 3.9[1](#fn-messaging-clients-1-def), 4.0 - 4.2[1](#fn-messaging-clients-1-def) |
...
| [gRPCï»¿](https://grpc.github.io/grpc-java/javadoc/index.html) | 1.18 - 1.80[4](#fn-remoting-frameworks-4-def) |
...
| --- | --- |
| [OpenTelemetryï»¿](https://github.com/open-telemetry/opentelemetry-java/) | 1.0 - 1.3[1](#fn-monitoring-frameworks-1-def), 1.4 - 1.54[1](#fn-monitoring-frameworks-1-def), 1.55 - 1.60 |
...
| [StackExchange.Redisï»¿](https://github.com/StackExchange/StackExchange.Redis) | 2.0.0+[1](#fn-database-framework-1-def) |
...
| --- | --- | --- |
| [Golang toolchain with FIPS (openssl-fips) modificationsï»¿](https://dt-url.net/golang-fips) | 1.23.6, 1.23.9, 1.24.4, 1.24.6, 1.25.3, 1.25.5, 1.25.7 | Alpine Linux 64-bit (x86-64), Linux (x86-64) |
| [Official Golang toolchainï»¿](https://dt-url.net/go) | 1.23, 1.24, 1.25, 1.26 | Alpine Linux 64-bit (x86-64), Linux (x86-64, ARM64 (AArch64)), Windows (x86-64) |

| Web framework | Versions |
| --- | --- |
| net/http | All versions supported[1](#fn-web-framework-1-def) |
...
| Database frameworks | Versions |
| --- | --- |
| [Cassandra client (gocql/gocql)ï»¿](https://github.com/gocql/gocql) | 1.0 - 1.7[1](#fn-database-frameworks-1-def) |
| [Microsoft SQL Server (denisenkom/go-mssqldb)ï»¿](https://github.com/denisenkom/go-mssqldb) | 0.11 - 0.12 |
| [Microsoft SQL Server (microsoft/go-mssqldb)ï»¿](https://github.com/microsoft/go-mssqldb) | 0.11 - 0.21[1](#fn-database-frameworks-1-def), 1.0 - 1.9[1](#fn-database-frameworks-1-def) |
| [MongoDB Go driver (mongo-go-driver)ï»¿](https://github.com/mongodb/mongo-go-driver) | 1.3 - 1.17[1](#fn-database-frameworks-1-def), 2.+[1](#fn-database-frameworks-1-def) |
| [MySQLï»¿](https://github.com/go-sql-driver/mysql/) | 1.4.1[1](#fn-database-frameworks-1-def), 1.5.0[1](#fn-database-frameworks-1-def), 1.6.0[1](#fn-database-frameworks-1-def), 1.7[1](#fn-database-frameworks-1-def), 1.8 - 1.9[1](#fn-database-frameworks-1-def) |
| [PostgreSQL (jackc/pgx)ï»¿](https://github.com/jackc/pgx) | 4.7 - 4.18[1](#fn-database-frameworks-1-def), 5.0 - 5.8[1](#fn-database-frameworks-1-def) |
| [PostgreSQL (lib/pq)ï»¿](https://github.com/lib/pq/) | 1.2.0[1](#fn-database-frameworks-1-def), 1.3.0[1](#fn-database-frameworks-1-def), 1.4.0 - 1.10.9[1](#fn-database-frameworks-1-def) |
| [go-redisï»¿](https://github.com/redis/go-redis) | 7[1](#fn-database-frameworks-1-def), 8.8.0 - 8.11.5[1](#fn-database-frameworks-1-def), 9[1](#fn-database-frameworks-1-def) |
...
| [Kafka (IBM/sarama)ï»¿](https://github.com/IBM/sarama) | 1.40+[1](#fn-messaging-clients-1-def) |
| [Kafka (Shopify/sarama)ï»¿](https://github.com/Shopify/sarama) | 1.18 - 1.39[1](#fn-messaging-clients-1-def) |
| [Kafka (confluentinc/confluent-kafka-go)ï»¿](https://github.com/confluentinc/confluent-kafka-go) | 1.9 - 2.8[1](#fn-messaging-clients-1-def), 2.10[1](#fn-messaging-clients-1-def), 2.11[1](#fn-messaging-clients-1-def), 2.12[1](#fn-messaging-clients-1-def), 2.13.0[1](#fn-messaging-clients-1-def) |
...
| Remoting frameworks | Versions |
| --- | --- |
| [Amazon AWS Lambda SDKï»¿](https://github.com/aws/aws-lambda-go) | 1.18.0-1.54.0[1](#fn-remoting-frameworks-1-def) |
| [Amazon AWS SDKï»¿](https://github.com/aws/aws-sdk-go-v2) | 1.13.0 - 1.39.0[2](#fn-remoting-frameworks-2-def), 1.39.1 - 1.41.1[2](#fn-remoting-frameworks-2-def) |
| [gRPCï»¿](https://godoc.org/google.golang.org/grpc) | 1.17 - 1.28[3](#fn-remoting-frameworks-3-def), 1.29[3](#fn-remoting-frameworks-3-def), 1.30 - 1.39[3](#fn-remoting-frameworks-3-def), 1.40 - 1.59[3](#fn-remoting-frameworks-3-def), 1.60 - 1.68[3](#fn-remoting-frameworks-3-def), 1.69 - 1.76[3](#fn-remoting-frameworks-3-def), 1.78 - 1.80[3](#fn-remoting-frameworks-3-def) |
...
| Monitoring frameworks | Versions |
| --- | --- |
| [OpenTelemetryï»¿](https://github.com/open-telemetry/opentelemetry-go/) | 1.0 - 1.7[1](#fn-monitoring-frameworks-1-def), 1.8 - 1.11.0[1](#fn-monitoring-frameworks-1-def), 1.11.1 - 1.27[1](#fn-monitoring-frameworks-1-def), 1.28 - 1.43[1](#fn-monitoring-frameworks-1-def) |
...
| [Zapï»¿](https://github.com/uber-go/zap) | 1.10 - 1.28[2](#fn-logging-frameworks-2-def) |
| log/slog | All versions supported[2](#fn-logging-frameworks-2-def) |

1

Versions 1.7.0 and earlier are not supported due to [a race condition problemï»¿](https://github.com/sirupsen/logrus/issues/1046) in the Logrus framework. Supported in [AWS Lambda](/managed/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration "AWS Lambda capabilities and integration options").
...
| --- | --- | --- |
| [Node.js](/managed/ingest-from/technology-support/application-software/nodejs "Read about Dynatrace support for Node.js applications.") | 20, 22, 24, 25 | Alpine Linux 64-bit (x86-64), Linux (ARM64 (AArch64), PPCLE, s390, x86-64), Windows (x86-64) |
...
Supported in [AWS Lambda](/managed/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration "AWS Lambda capabilities and integration options"). Requires Dynatrace Cluster version 1.334+. Service failure detection is not supported.
...
| [Confluent Kafka Python client libraryï»¿](https://github.com/confluentinc/confluent-kafka-python) | 2.0.2+[1](#fn-messaging-libraries-1-def) |
| [Kombuï»¿](https://github.com/celery/kombu) | 4.6.7+ |
| [kafka-python client libraryï»¿](https://github.com/dpkp/kafka-python) | 1.4+[1](#fn-messaging-libraries-1-def) |
| [pikaï»¿](https://github.com/pika/pika) | 1.0.0+ |
...
| --- | --- |
| [Amazon Bedrock Runtimeï»¿](https://github.com/boto/boto3) | 1.14+ |
| [LangChainï»¿](https://github.com/langchain-ai/langchain) | 1.0+ |
| [OpenAIï»¿](https://github.com/openai/openai-python) | 1.54.0+ |
...
| Servers | Versions | Platforms |
| --- | --- | --- |
| [Envoyï»¿](https://www.envoyproxy.io/) | 1.30+[1](#fn-servers-1-def) | Linux (x86-64) |
...
| [Jetpack Compose](/managed/observe/digital-experience/mobile-applications/instrument-android-app/instrumentation-via-plugin/monitoring-capabilities#compose-instrumentation "Configure the Dynatrace Android Gradle plugin to adjust the monitoring capabilities of OneAgent.") | 1.4 - 1.10 |

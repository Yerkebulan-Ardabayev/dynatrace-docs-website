...
* [Set up Container Insights on Amazon EKS or Kubernetes﻿](https://dt-url.net/bc03sar).
...
Container Insights needs to be set up on a cluster to have metrics reported. For details, see the [AWS documentation﻿](https://dt-url.net/aw030yi).

...
[Amazon API Gateway Version 2 API (WebSocket and HTTP APIs)﻿](https://dt-url.net/dt03xj6) isn't currently supported for Amazon API Gateway. Only [Amazon API Gateway Version 1 API (REST APIs)﻿](https://dt-url.net/l523xes) is supported.

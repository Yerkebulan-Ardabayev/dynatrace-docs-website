...
For a list of supported services and their metrics for version 1.0 of the GCP integration, see [Google Cloud service metrics (new)](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-supported-service-metrics-new "Monitor Google Cloud services with Dynatrace and view available metrics.").
...
After deploying the Dynatrace integration, you can view these preset dashboards in **Dashboards**.

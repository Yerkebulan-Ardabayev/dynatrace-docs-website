...
* [Create an API token](/managed/manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens#create-api-token "Learn the concept of an access token and its scopes.") and [enable the following permission](/managed/dynatrace-api/basics/dynatrace-api-authentication#token-permissions "Find out how to get authenticated to use the Dynatrace API."): **Ingest logs** (API v2).
...
**Download the Helm deployment package in Google Cloud Shell**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/set-up-gcp-integration-logs-only#dwld "Set up log monitoring for Google Cloud services in a Kubernetes container (GKE).")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Configure parameter values**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/set-up-gcp-integration-logs-only#param "Set up log monitoring for Google Cloud services in a Kubernetes container (GKE).")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Connect your Kubernetes cluster**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/set-up-gcp-integration-logs-only#connect "Set up log monitoring for Google Cloud services in a Kubernetes container (GKE).")[![Step 4](https://dt-cdn.net/images/step-4-3f89d67d41.svg "Step 4")

**Run the deployment script**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/set-up-gcp-integration-logs-only#script "Set up log monitoring for Google Cloud services in a Kubernetes container (GKE).")
...
| `deploymentType` | Required Set to `logs`. | `all` |
...
3. Check if dashboards are imported.
   ...
   In Dynatrace, go to **Dashboards** and filter by **Tag** for `Google Cloud`. A number of dashboards for Google Cloud Services should be available.
...
After deploying the integration, you can view and analyze Google Cloud logs in Dynatrace if you go to **Logs** and filter by `cloud.provider: gcp`.

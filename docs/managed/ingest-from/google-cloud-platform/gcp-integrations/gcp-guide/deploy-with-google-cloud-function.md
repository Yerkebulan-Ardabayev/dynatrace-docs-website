...
See [Migrate from Google Cloud Functions 1.0 to Google Cloud k8s 1.0](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/migrate-gcp-function-1-to-k8s-1 "Migrate from Google Cloud Functions v1.0 to Google Cloud k8s v1.0.").
...
**Download the deployment package**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/deploy-with-google-cloud-function#dwld "Set up monitoring for Google Cloud services in Google Cloud Functions.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Configure deployment**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/deploy-with-google-cloud-function#configure-deployment "Set up monitoring for Google Cloud services in Google Cloud Functions.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Run the deployment script**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/deploy-with-google-cloud-function#script "Set up monitoring for Google Cloud services in Google Cloud Functions.")
...
For a complete list of the Google Cloud supported services, see [Google Cloud supported services](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-supported-service-metrics-new#services "Monitor Google Cloud services with Dynatrace and view available metrics.").

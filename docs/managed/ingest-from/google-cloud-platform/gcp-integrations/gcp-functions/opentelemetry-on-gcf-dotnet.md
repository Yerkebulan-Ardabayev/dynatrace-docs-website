...
**Initialize tracing**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-functions/opentelemetry-on-gcf-dotnet#initialize "Monitor Google Cloud Functions with OpenTelemetry for .NET and Dynatrace.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Instrument a handler function**](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-functions/opentelemetry-on-gcf-dotnet#instrument "Monitor Google Cloud Functions with OpenTelemetry for .NET and Dynatrace.")

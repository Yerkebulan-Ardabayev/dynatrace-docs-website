...
* One of the following Collector distributions with the [attributes processorï»¿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.151.0/processor/attributesprocessor) and the [Syslog receiverï»¿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.151.0/receiver/syslogreceiver):
...
The Syslog receiver supports a number of [configuration parametersï»¿](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.151.0/receiver/syslogreceiver/README.md), which enable you to customize its behavior. For our example, we use the following:

* `tcp`âSpecifies a TCP listener for the receiver and configures ports 54526 and 54527
* `protocol`âSpecifies the RFC 5424 implementation for our receiver (alternatively, RFC 3164 is also supported)
* `operators`âConfigures the operators we apply to each log entry. For our example, we use the [addï»¿](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.151.0/pkg/stanza/docs/operators/add.md) operator to add additional information.

  + `field`âSpecifies the name of value we are adding
  + `value`âSpecifies the content of the value we are adding

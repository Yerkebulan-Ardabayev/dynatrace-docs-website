...
* The [`kafkareceiver`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/kafkareceiver) component.
...
Under `receivers`, we specify [`kafka`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/kafkareceiver) as the active receiver component for our deployment.
This is required to receive data from Kafka server.

### Exporters

Under `exporters`, we specify the [`otlp_http` exporter﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.157.0/exporter/otlphttpexporter) to forward data into Dynatrace.

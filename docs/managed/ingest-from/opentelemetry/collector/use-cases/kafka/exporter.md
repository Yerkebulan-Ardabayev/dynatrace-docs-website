...
* The [`kafkaexporter`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/exporter/kafkaexporter) component.
...
Under `receivers`, we specify [`otlp`﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.157.0/receiver/otlpreceiver) as the active receiver component for our deployment.
...
* [`memory_limiter` processor﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.157.0/processor/memorylimiterprocessor).
* [`batch` processor﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.157.0/processor/batchprocessor) as per [recommendation for the kafka exporter﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/exporter/kafkaexporter#readme).

### Exporters

Under `exporters`, we specify the [`kafka` exporter﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/exporter/kafkaexporter) to forward data to the Kafka server.

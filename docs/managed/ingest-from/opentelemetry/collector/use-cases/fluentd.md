...
* One of the following Collector distributions with the [Fluent Forward receiver﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.158.0/receiver/fluentforwardreceiver):

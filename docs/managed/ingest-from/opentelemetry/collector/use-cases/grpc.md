...
Under `receivers`, we specify the gRPC [`otlp` receiver﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.157.0/receiver/otlpreceiver) as active receiver component for our Collector instance.

...
* One of the following Collector distributions with the [Zipkin receiver﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/zipkinreceiver):
...
The Zipkin receiver can be customized with [a few more attributes﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/zipkinreceiver), which we leave with their default values in our example.

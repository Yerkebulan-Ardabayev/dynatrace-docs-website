...
* One of the following Collector distributions for the gateway tier, with the [`metric_start_time`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/processor/metricstarttimeprocessor), [`cumulative_to_delta`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/processor/cumulativetodeltaprocessor), [`k8sattributes`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/processor/k8sattributesprocessor), and [`transform`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/processor/transformprocessor) processors and the [`otlphttp` exporter﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.160.0/exporter/otlphttpexporter):

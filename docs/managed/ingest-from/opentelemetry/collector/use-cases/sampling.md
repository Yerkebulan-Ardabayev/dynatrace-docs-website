...
* [`tail_sampling`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/tailsamplingprocessor) to sample distributed traces based on properties of the trace.

### Connectors

Under `connectors`, we specify the [`spanmetrics` connector﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/connector/spanmetricsconnector) to compute service metrics from spans.

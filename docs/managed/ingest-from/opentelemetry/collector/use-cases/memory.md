...
* One of the following Collector distributions with the [memory limiter processor﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.160.0/processor/memorylimiterprocessor):
...
Under `processors`, we specify the [`memory_limiter` processor﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.160.0/processor/memorylimiterprocessor) with the following parameters:

...
* One of the following Collector distributions with the [`hostmetrics`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/hostmetricsreceiver) and [`journald`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/journaldreceiver) receivers, and the [`resource_detection`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/resourcedetectionprocessor), [`filter`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/filterprocessor), and [`transform`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/transformprocessor) processors.
...
* [`hostmetrics`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/hostmetricsreceiver)
* [`journald`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/journaldreceiver)

#### hostmetrics

The [`hostmetrics` receiver﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/hostmetricsreceiver) collects host-level metrics.
...
The [`journald` receiver﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/receiver/journaldreceiver) collects systemd journal logs from the host and ingests them into the logs pipeline alongside your metrics.
...
* [`resource_detection` processor﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/resourcedetectionprocessor), which can be used to detect resource information from the host, in a format that conforms to the OpenTelemetry resource semantic conventions, and append or override the resource value in telemetry data with this information.
* [`filter`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/filterprocessor) is used twice: once to clean up unnecessary metrics dimensions, and secondly to (optionally) filter out unneeded process metrics.
* [`transform`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.157.0/processor/transformprocessor).

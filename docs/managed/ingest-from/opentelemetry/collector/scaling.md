...
* `otelcol_processor_refused_spans`: If you have the [Memory Limiter
  Processor﻿](https://github.com/open-telemetry/opentelemetry-collector/blob/v0.160.0/processor/memorylimiterprocessor)
...
* `k8s.resource_quota.used`: If you are monitoring your Kubernetes cluster with
  ...
  Receiver﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/receiver/k8sclusterreceiver),
...
* `container.cpu.usage` and `container.memory.usage`: If you are monitoring your
  ...
  Receiver﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/receiver/kubeletstatsreceiver),
...
Exporter﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.160.0/exporter/loadbalancingexporter).
...
stability
level﻿](https://github.com/open-telemetry/opentelemetry-collector/blob/v0.160.0/docs/component-stability.md).
...
* The [Cumulative to Delta
  Processor﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/processor/cumulativetodeltaprocessor):
...
* The [Tail Sampling
  Processor﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/processor/tailsamplingprocessor):
  ...
  accomplish this.
* The [Span Metrics
  Connector﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/connector/spanmetricsconnector):
...
[upstream
docs﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.160.0/exporter/loadbalancingexporter#resilience-and-scaling-considerations)
...
Under `receivers`, we configure the [`otlp` receiver﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.160.0/receiver/otlpreceiver) to receive data over gRPC and HTTP.

### Exporters

In the `exporters` section, we configure three [`load_balancing exporters`﻿](https://github.com/open-telemetry/opentelemetry-collector-contrib/blob/v0.160.0/exporter/loadbalancingexporter),

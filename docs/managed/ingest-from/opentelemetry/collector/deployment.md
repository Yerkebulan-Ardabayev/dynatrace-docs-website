...
```
docker pull ghcr.io/dynatrace/dynatrace-otel-collector/dynatrace-otel-collector:0.53.1
```
...
```
docker run -v $(pwd)/otel-collector-config.yaml:/etc/otelcol/otel-collector-config.yaml ghcr.io/dynatrace/dynatrace-otel-collector/dynatrace-otel-collector:0.53.1 --config=/etc/otelcol/otel-collector-config.yaml
```
...
1. Download the [dynatrace-otel-collector﻿](https://github.com/Dynatrace/dynatrace-otel-collector/releases/v0.53.1) for your operating system from GitHub.
...
To deploy the Dynatrace OTel Collector using an installer package, download the [dynatrace-otel-collector﻿](https://github.com/Dynatrace/dynatrace-otel-collector/releases/v0.53.1) for your operating system from GitHub, and install it using root privileges and the following commands.
...
* [Amazon Elastic Container Registry (Amazon ECR)﻿](https://gallery.ecr.aws/dynatrace/dynatrace-otel-collector)
  ...
  + `public.ecr.aws/dynatrace/dynatrace-otel-collector:0.53.1`
* [Docker Hub Container Registry﻿](https://hub.docker.com/r/dynatrace/dynatrace-otel-collector)

  + `dynatrace/dynatrace-otel-collector:0.53.1`
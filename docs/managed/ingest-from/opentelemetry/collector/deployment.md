...
The Kubernetes CRD of the Operator can be found on [GitHub﻿](https://github.com/open-telemetry/opentelemetry-operator/blob/v0.158.0/docs/api/opentelemetrycollectors.md).
...
```
docker pull ghcr.io/dynatrace/dynatrace-otel-collector/dynatrace-otel-collector:0.56.0
```
...
```
docker run -v $(pwd)/otel-collector-config.yaml:/etc/otelcol/otel-collector-config.yaml ghcr.io/dynatrace/dynatrace-otel-collector/dynatrace-otel-collector:0.56.0 --config=/etc/otelcol/otel-collector-config.yaml
```
...
1. Download the [dynatrace-otel-collector﻿](https://github.com/Dynatrace/dynatrace-otel-collector/releases/v0.56.0) for your operating system from GitHub.
...
To deploy the Dynatrace OTel Collector using an installer package, download the [dynatrace-otel-collector﻿](https://github.com/Dynatrace/dynatrace-otel-collector/releases/v0.56.0) for your operating system from GitHub, and install it using root privileges and the following commands.

...
If you use the OpenTelemetry Collector, we highly recommend that you use [batching﻿](https://github.com/open-telemetry/opentelemetry-collector/blob/v0.160.0/exporter/exporterhelper#sending-queue-batch-settings) in the `otlp_http` exporter.
...
See this [GitHub readme﻿](https://github.com/open-telemetry/opentelemetry-collector/blob/v0.160.0/processor/batchprocessor/README.md) for more information.
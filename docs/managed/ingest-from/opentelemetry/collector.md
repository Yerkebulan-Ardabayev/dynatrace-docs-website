...
In addition to the two distributions, OpenTelemetry also offers the [OpenTelemetry Collector Builder (OCB)﻿](https://github.com/open-telemetry/opentelemetry-collector/tree/v0.160.0/cmd/builder), a command line tool that allows you to build your own customized version of the Collector.

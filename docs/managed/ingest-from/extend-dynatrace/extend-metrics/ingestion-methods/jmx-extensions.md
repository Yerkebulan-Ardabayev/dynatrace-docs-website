...
JMX and PMI extensions are also available in [Infrastructure Monitoring mode](/managed/platform/oneagent/monitoring-modes/monitoring-modes "Find out more about the available monitoring modes when using OneAgent.") You can use them to monitor any infrastructure component and backing service written in Java and have all the collected metrics reported by Dynatrace.
...
The Dynatrace JMX extensions are highly customizable beyond the capabilities of the editor. You can download your extension and edit its JSON file that describes your JMX metrics and how you want to display them. For reference and examples, see [Customizing JMX Plugins](/managed/ingest-from/extend-dynatrace/extend-metrics/ingestion-methods/jmx-extensions/customize-jmx-extensions "Learn how to further customize your JMX extensions.").

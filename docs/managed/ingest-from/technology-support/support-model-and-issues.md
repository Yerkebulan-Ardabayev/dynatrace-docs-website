...
A new Go version used in Dynatrace Operator is incompatible with the CRI-O version of OpenShift 4.8 and Kubernetes 1.21.
...
All Dynatrace Operator 1.7 versions are not supported.

For Dynatrace Operator versions 1.8+ and versions 1.6 and earlier, additional configuration may be required:

* If your OneAgent version is earlier than 1.333, configure the `remountOperatorEnrichment` debug flag.
* If your OneAgent version is 1.333+, this OneAgent debug flag is not required.

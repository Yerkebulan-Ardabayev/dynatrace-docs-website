...
* [Kubernetes platform monitoringï»¿](https://docs.dynatrace.com/docs/shortlink/installation-k8s-platform-only)
* [Classic Full-Stack monitoringï»¿](https://docs.dynatrace.com/docs/shortlink/installation-k8s-classic-fs)
* [Application observabilityï»¿](https://docs.dynatrace.com/docs/shortlink/installation-k8s-automated-app-monitoring) without CSI driver
* [Full-Stack observabilityï»¿](https://docs.dynatrace.com/docs/shortlink/node-image-pull) without CSI driver

Deployment options that **can't** be installed from OperatorHub (they require Helm or manifest installation approaches):

* [Full-Stack observabilityï»¿](https://docs.dynatrace.com/docs/shortlink/installation-k8s-cloud-native-fs) with CSI driver
* [Application observabilityï»¿](https://docs.dynatrace.com/docs/shortlink/installation-k8s-automated-app-monitoring) with CSI driver
* [Host monitoringï»¿](https://docs.dynatrace.com/docs/shortlink/k8s-host-monitoring)
...
10. Make the following changes:
    ...
    * Replace `apiURL` value according to your deployment:
      ...
      Replace `ENVIRONMENTID` with your [environment ID](/managed/discover-dynatrace/get-started/monitoring-environment "Understand and learn how to work with monitoring environments.").
      ...
      Replace `YourDynatraceServerURL` with the address of your Dynatrace Managed Cluster and `ENVIRONMENTID` with your [environment ID](/managed/discover-dynatrace/get-started/monitoring-environment "Understand and learn how to work with monitoring environments.").

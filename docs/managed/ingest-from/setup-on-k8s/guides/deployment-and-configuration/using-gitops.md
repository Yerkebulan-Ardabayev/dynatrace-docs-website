...
For details on DynaKube CR configuration, see the [deployment modes](/managed/ingest-from/setup-on-k8s/deployment "Deploy Dynatrace Operator on Kubernetes") documentation.
...
For configuring automatic updates for Dynatrace Operator, see [Auto-update of Dynatrace Operator](/managed/ingest-from/setup-on-k8s/guides/deployment-and-configuration/updates-and-maintenance/dto-auto-update "Enable automatic updates of Dynatrace Operator following a GitOps approach."), which explains integrating GitOps with dependency automation tools.

## Related topics

* [Auto-update for Dynatrace Operator](/managed/ingest-from/setup-on-k8s/guides/deployment-and-configuration/updates-and-maintenance/dto-auto-update "Enable automatic updates of Dynatrace Operator following a GitOps approach.")
...
For more details, see [Enrich ingested data with Dynatrace-specific dimensions](/managed/ingest-from/extend-dynatrace/extend-data#operator-enrichment-directory "Learn how to automatically enrich your telemetry data with Dynatrace-specific fields.").

## Learn more

* [Dynatrace documentation: metadata enrichment files](/managed/ingest-from/extend-dynatrace/extend-data#operator-enrichment-directory "Learn how to automatically enrich your telemetry data with Dynatrace-specific fields.")

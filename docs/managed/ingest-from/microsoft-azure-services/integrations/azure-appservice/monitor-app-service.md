...
source: https://docs.dynatrace.com/managed/ingest-from/microsoft-azure-services/integrations/azure-appservice/monitor-app-service
---
...
| HttpQueueLength | HTTP queue length | Instance | Count | Applicable |

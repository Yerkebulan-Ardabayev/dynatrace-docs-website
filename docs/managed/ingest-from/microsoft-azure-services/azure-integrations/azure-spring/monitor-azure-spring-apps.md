...
For an end-to-end view into your Spring Apps workloads, you can [set up OneAgent integration with Azure Spring Apps](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-spring "Learn how to configure OneAgent for monitoring Azure Spring Apps.").

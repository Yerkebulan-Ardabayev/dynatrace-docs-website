...
The table below lists all Azure metrics that Dynatrace collects by default when you enable [Microsoft Azure](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide "Set up and configure Azure monitoring in Dynatrace.") monitoring.

For all other metrics collected by Dynatrace per configurable Azure service, see [cloud services](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-cloud-services-metrics "Monitor Azure services with Dynatrace and view available metrics.") pages.

---
title: Monitor Azure App Service (built-in)
...
# Monitor Azure App Service (built-in)
...
Full OneAgent service integration and linking:
...
to `Service` entities, is supported only for [Azure Functions](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-functions "Monitor Azure Functions").
...
To access the classic Smartscape environment-topology view, go to Smartscape.
...
| Smartscape symbol 3 | Services of unrecognized technologies are depicted using a generic service symbol. These are typically [opaque services](/managed/observe/application-observability/services/service-detection/service-detection-v1/service-types/opaque-services "Understand what opaque services are."). |
...
Note that you might observe a difference in the number of services presented in **Services** tab of the Smartscape page versus the **Services** page. This is because Smartscape takes a broader scope of service categories into account.

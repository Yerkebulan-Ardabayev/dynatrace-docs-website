...
Dynatrace [automatically detects attributes](/managed/upgrade/unavailable-in-managed "Your selection is unavailable in Dynatrace Managed.") of ingested log data. **Available attributes** quickly filter the result table data for a specific log data attribute.
...
2. Create a custom attribute.
   ...
   Creating a custom log attribute.
3. View the attribute in log viewer. (See [Log viewer (Logs Classic)](/managed/analyze-explore-automate/log-monitoring/analyze-log-data/log-viewer "Learn how to use Dynatrace log viewer to analyze log data.") for details.)
   ...
   * Check **Available attributes**
     ...
     Available attributes-based filter in a log viewer.
   * Check table options

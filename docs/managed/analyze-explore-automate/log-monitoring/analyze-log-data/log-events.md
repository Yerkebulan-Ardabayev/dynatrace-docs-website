...
3. Enter the **Matcher**.  
   Enter the Log Monitoring query to filter the log data for your log event. For details, see [Log viewer](/managed/analyze-explore-automate/log-monitoring/analyze-log-data/log-viewer#query-syntax "Learn how to use Dynatrace log viewer to analyze log data.").
...
1. Go to **Hosts** and select the host name.

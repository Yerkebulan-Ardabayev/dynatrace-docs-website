...
Alternatively, you can navigate to **Logs**, where filtering can be done in either simple or advanced mode.
...
* [Stream logs to Dynatrace with Fluent Bit (Logs Classic)](/managed/analyze-explore-automate/log-monitoring/acquire-log-data/stream-logs-with-fluent-bit "Integrate Fluent Bit to stream logs to Dynatrace.")
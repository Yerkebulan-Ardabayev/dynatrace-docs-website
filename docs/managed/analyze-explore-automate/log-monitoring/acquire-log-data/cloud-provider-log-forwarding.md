...
For detailed instructions on how to set up AWS log forwarding, see [Log monitoring with AWS log forwarder](/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-logs-ingest/aws-log-forwarder#prereq "Use AWS log forwarding to ingest AWS logs.").
...
* [On a new GKE Autopilot cluster created automatically](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/deploy-k8 "Set up log and metric monitoring for GCP services on a new GKE Autopilot cluster."). Recommended
* [On an existing GKE standard or GKE Autopilot cluster](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/set-up-gcp-integration-on-existing-cluster "Deploy log and metric monitoring for Google Cloud services on an existing standard GKE or GKE Autopilot cluster").
...
For all log ingestion options, see [Log ingestion](/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-guide/deploy-k8#ingestion "Set up log and metric monitoring for GCP services on a new GKE Autopilot cluster.").

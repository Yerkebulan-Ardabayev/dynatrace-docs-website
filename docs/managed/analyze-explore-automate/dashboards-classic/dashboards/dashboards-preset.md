...
1. [Create a dashboard](/managed/analyze-explore-automate/dashboards-classic/dashboards/create-dashboards "Learn how to create and edit Dynatrace dashboards.") or display an existing dashboard for which you have editing rights.
2. Select **Edit**.

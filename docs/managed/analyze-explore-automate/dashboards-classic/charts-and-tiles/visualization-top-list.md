...
To visualize your query results as a top list, select  `Top list` from the list above the query definition, in the upper-left corner of the page.

This visualization does not display multiple metrics. If your query has multiple metrics configured, only the metric selected in the query editor is executed. (By default, the first metric is selected.)

To choose one metric from a multi-metric query, select the letter next to the metric or select the eye icon .
...
![Data Explorer: Top list](https://dt-cdn.net/images/visualization-example-top-list-1596-f2a02801a3.png)

Data Explorer: Top list

#### Example pinned to a dashboard as a tile

![Example top list](https://dt-cdn.net/images/example-tile-top-list-263-57605443d4.png)

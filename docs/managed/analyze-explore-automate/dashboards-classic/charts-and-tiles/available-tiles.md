...
* From the tile menu, select **View details** to open your [Smartscape](/managed/analyze-explore-automate/smartscape-classic#services "Learn how Smartscape visualizes all the entities and dependencies in your environment.") topology view to the Services layer.

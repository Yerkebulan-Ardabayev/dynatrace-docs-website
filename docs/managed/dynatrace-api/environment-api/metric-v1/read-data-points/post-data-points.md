...
| considerMaintenanceWindowsForAvailability | boolean | Exclude (`true`) or include (`false`) data points from any [maintenance window﻿](https://dt-url.net/b2123rg0?dt=m), defined in your environment. | Optional |

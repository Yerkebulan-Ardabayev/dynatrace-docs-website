---
title: Deployment API - Download the signature of an orchestration tarball
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/deployment/orchestration/get-version-signature
scraped: 2026-05-12T11:58:14.069065
---
...
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v1/deployment/orchestration/agent/{orchestrationType}/version/{version}/signature` |
...
| version | string | The requested version of the OneAgent deployment orchestration tarball in `0.1.0.20200925-120822` format. | path | Required |

...
**Note:** To use an Environment ActiveGate as beacon endpoint, beacon forwarding must be enabled in the ActiveGate config first. Learn more about how to configure an [Environment ActiveGateï»¿](https://dt-url.net/90r039v) or how to use [OneAgent as a beacon endpointï»¿](https://dt-url.net/hr4e0ijr).

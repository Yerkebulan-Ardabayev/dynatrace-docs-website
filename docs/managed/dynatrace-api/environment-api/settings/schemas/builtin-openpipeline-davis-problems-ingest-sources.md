---
title: Settings API - Ingest sources configuration (davis.problems) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-davis-problems-ingest-sources
scraped: 2026-05-12T11:42:13.384789
---

# Settings API - Ingest sources configuration (davis.problems) schema table

# Settings API - Ingest sources configuration (davis.problems) schema table

* Published Aug 25, 2025

### Ingest sources configuration (davis.problems) (`builtin:openpipeline.davis.problems.ingest-sources)`

Contains configuration of ingest sources

| Schema ID | Schema groups | Scope |
| --- | --- | --- |
| `builtin:openpipeline.davis.problems.ingest-sources` | * `group:openpipeline.all.ingest-sources` | `environment` |

Retrieve schema via Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.davis.problems.ingest-sources` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.davis.problems.ingest-sources` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.davis.problems.ingest-sources` |

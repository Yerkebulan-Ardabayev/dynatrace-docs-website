...
### Assign synthetic monitor to applications (`builtin:synthetic.http.assigned-applications)`

Assigned applications will gain availability information and be considered in the root cause analysis of problems that impact this monitor.

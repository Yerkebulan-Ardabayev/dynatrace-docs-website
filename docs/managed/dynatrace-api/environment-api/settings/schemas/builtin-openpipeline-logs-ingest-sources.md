---
title: Settings API - Ingest sources configuration (logs) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-logs-ingest-sources
scraped: 2026-05-12T11:47:46.129118
---

# Settings API - Ingest sources configuration (logs) schema table

# Settings API - Ingest sources configuration (logs) schema table

* Published Aug 25, 2025

### Ingest sources configuration (logs) (`builtin:openpipeline.logs.ingest-sources)`

Contains configuration of ingest sources

| Schema ID | Schema groups | Scope |
| --- | --- | --- |
| `builtin:openpipeline.logs.ingest-sources` | * `group:openpipeline.all.ingest-sources` | `environment` |

Retrieve schema via Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.logs.ingest-sources` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.logs.ingest-sources` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.logs.ingest-sources` |

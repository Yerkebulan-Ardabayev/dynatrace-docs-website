...
Select how frequently this monitor should run at each enabled location. For more information, see [how do I create a browser monitor?﻿](https://dt-url.net/qj1p0p2b)

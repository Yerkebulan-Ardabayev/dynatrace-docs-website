...
### Ingest pipelines configuration (security.events) (`builtin:openpipeline.security.events.pipelines)`

Contains configuration of pipelines
...
| --- | --- | --- | --- |
| Pipeline metadata list `metadataList` | [MetadataEntry](#MetadataEntry)[] | - | Required |
| Custom pipeline id `customId` | text | - | Required |
...
| Property | Type | Description | Required |
| --- | --- | --- | --- |
| Metadata entry key `entryKey` | text | - | Required |
| Metadata entry value `entryValue` | text | - | Optional |

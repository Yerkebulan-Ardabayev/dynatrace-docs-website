...
| Server name `serverName` | [serviceIdContributor](#serviceIdContributor) | - | Required |
| Web service name `webServiceName` | [serviceIdContributor](#serviceIdContributor) | - | Required |
| Web service namespace `webServiceNamespace` | [serviceIdContributor](#serviceIdContributor) | - | Required |

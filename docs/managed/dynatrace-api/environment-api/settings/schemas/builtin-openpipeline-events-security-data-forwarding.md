...
### Data forwarding configuration (events.security) (`builtin:openpipeline.events.security.data-forwarding)`
...
| Compression type `compressionType` | enum | The element has these enums * `gzip` * `zstd` | Optional |

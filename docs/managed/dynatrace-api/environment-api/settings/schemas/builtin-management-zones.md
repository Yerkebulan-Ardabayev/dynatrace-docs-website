...
| --- | --- | --- | --- |
| Management zone name `name` | text | **Be careful when renaming** - if there are policies that are referencing this Management zone, they will need to be adapted to the new name! | Required |
...
| Apply to custom devices in a custom device group `customDeviceGroupToCustomDevicePropagation` | boolean | - | Required |
...
| Property | Type | Description | Required |
| --- | --- | --- | --- |
| Type `appliesTo` | enum | The element has these enums * `ANY` * `LOG` * `METRIC` | Required |
| Conditions `conditions` | Set<[DimensionCondition](#DimensionCondition)> | - | Required |
...
| Property | Type | Description | Required |
| --- | --- | --- | --- |
| Type `conditionType` | enum | The element has these enums * `DIMENSION` * `LOG_FILE_NAME` * `METRIC_KEY` | Required |
| Key `key` | text | - | Required |
| Operator `ruleMatcher` | enum | The element has these enums * `BEGINS_WITH` * `EQUALS` | Required |

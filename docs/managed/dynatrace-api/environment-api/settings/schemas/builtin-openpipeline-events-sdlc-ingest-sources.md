---
title: Settings API - Ingest sources configuration (events.sdlc) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-events-sdlc-ingest-sources
scraped: 2026-05-12T11:39:56.021636
---

# Settings API - Ingest sources configuration (events.sdlc) schema table

# Settings API - Ingest sources configuration (events.sdlc) schema table

* Published Aug 25, 2025

### Ingest sources configuration (events.sdlc) (`builtin:openpipeline.events.sdlc.ingest-sources)`

Contains configuration of ingest sources

| Schema ID | Schema groups | Scope |
| --- | --- | --- |
| `builtin:openpipeline.events.sdlc.ingest-sources` | * `group:openpipeline.all.ingest-sources` | `environment` |

Retrieve schema via Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.events.sdlc.ingest-sources` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.events.sdlc.ingest-sources` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.events.sdlc.ingest-sources` |

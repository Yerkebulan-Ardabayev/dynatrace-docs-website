...
Enable SDv2 endpoint detection rules (`<your-dynatrace-url>/builtin:endpoint-detection-rules`) instead of the hard-coded ones. See [Service Detection v2 documentation﻿](https://dt-url.net/lu030qq) and [community post﻿](https://dt-url.net/r2230n9) for details.

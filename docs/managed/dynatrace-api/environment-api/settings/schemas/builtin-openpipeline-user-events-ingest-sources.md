---
title: Settings API - Ingest sources configuration (user.events) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-user-events-ingest-sources
scraped: 2026-05-12T11:49:31.815142
---

# Settings API - Ingest sources configuration (user.events) schema table

# Settings API - Ingest sources configuration (user.events) schema table

* Published Aug 25, 2025

### Ingest sources configuration (user.events) (`builtin:openpipeline.user.events.ingest-sources)`

Contains configuration of ingest sources

| Schema ID | Schema groups | Scope |
| --- | --- | --- |
| `builtin:openpipeline.user.events.ingest-sources` | * `group:openpipeline.all.ingest-sources` | `environment` |
...
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.user.events.ingest-sources` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.user.events.ingest-sources` |

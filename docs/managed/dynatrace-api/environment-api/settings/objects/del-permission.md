...
Removes permissions for the specified accessor on the specified settings object. Deletion cannot be undone! The accessor ID must be a user or group UUID; use the User management API or Group management API to look up these identifiers.

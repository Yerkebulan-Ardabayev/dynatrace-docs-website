---
title: Synthetic monitor executions API v2 - GET basic info of an execution
...
| GET | Environment and Cluster ActiveGate (default port 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/synthetic/executions/{executionId}` |
...
| --- | --- | --- |
| **200** | [SyntheticOnDemandExecution](#openapi-definition-SyntheticOnDemandExecution) | Success. The response contains basic information about the on-demand execution. |

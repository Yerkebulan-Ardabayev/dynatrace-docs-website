---
title: OneAgent remote configuration management API - GET current job
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/remote-configuration/oneagent/get-current-job
---

# OneAgent remote configuration management API - GET current job
...
Gets parameters of a currently running configuration job for OneAgents.

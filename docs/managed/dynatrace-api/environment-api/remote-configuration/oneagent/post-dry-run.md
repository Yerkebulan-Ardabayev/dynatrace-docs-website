---
title: OneAgent remote configuration management API - POST a target check
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/remote-configuration/oneagent/post-dry-run
---

# OneAgent remote configuration management API - POST a target check
...
Required scope: `fleet-management:oneagents:write`

...
This API call retrieves the current configuration status for cluster nodes.
...
In this example we inspect all historical node reconfiguration operation statuses. For example, when we have disabled Web UI traffic. or enabled OneAgent traffic.

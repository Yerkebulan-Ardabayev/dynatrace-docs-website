...
| customAlerting | boolean | Include (`true`) or exclude (`false`) the error in Davis AI [problem detection and analysis﻿](https://dt-url.net/a963kd2?dt=m). | Required |
...
| considerForAi | boolean | Include (`true`) or exclude (`false`) the error in Davis AI [problem detection and analysis﻿](https://dt-url.net/a963kd2?dt=m). | Required |

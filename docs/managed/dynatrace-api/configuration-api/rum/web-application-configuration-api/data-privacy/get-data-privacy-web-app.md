...
| --- | --- | --- | --- | --- |
| id | string | The ID of the web application where you want to check data privacy settings. | path | Required |
...
| --- | --- | --- |
| **200** | [ApplicationDataPrivacy](#openapi-definition-ApplicationDataPrivacy) | Success |

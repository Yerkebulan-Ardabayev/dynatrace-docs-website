...
| --- | --- | --- | --- | --- |
| id | string | The ID of the Kubernetes credentials configuration to be updated. | path | Required |
| body | [KubernetesCredentials](#openapi-definition-KubernetesCredentials) | The JSON body of the request. Contains updated parameters of the Kubernetes credentials configuration. | body | Optional |

...
| --- | --- | --- | --- | --- |
| body | [AutoTag](#openapi-definition-AutoTag) | The JSON body of the request. Contains parameters of the new auto-tag. | body | Optional |
...
| --- | --- | --- |
| **201** | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | Success. The auto-tag has been created. The response body contains the ID of the new auto-tag. |

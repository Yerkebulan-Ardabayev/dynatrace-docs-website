...
| --- | --- | --- | --- | --- |
| id | string | The ID of the maintenance window to be updated. | path | Required |
| body | [MaintenanceWindow](#openapi-definition-MaintenanceWindow) | The JSON body of the request. Contains updated parameters of the maintenance window. | body | Optional |
...
In this example, the request updates the **infrastructure maintenance** maintenance window from the [GET request example](/managed/dynatrace-api/configuration-api/maintenance-windows-api/get-mw#example "View a maintenance window via the Dynatrace API.")

...
| --- | --- | --- | --- | --- |
| body | [RequestAttribute](#openapi-definition-RequestAttribute) | The body must not provide an ID as IDs are automatically assigned. | body | Required |
...
| operator | string | Operator comparing the extracted value to the comparison value. The element can hold these values * `BEGINS_WITH` * `BEGINS_WITH_ANY_OF` * `CONTAINS` * `ENDS_WITH` * `ENDS_WITH_ANY_OF` * `EQUALS` * `EQUALS_ANY_OF` | Required |
...
| --- | --- | --- |
| **201** | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | Success. Request attribute has been created. The ID of the new configuration is returned. |

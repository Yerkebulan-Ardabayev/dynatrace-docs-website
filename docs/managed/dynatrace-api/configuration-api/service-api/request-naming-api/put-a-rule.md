...
| body | [RequestNaming](#openapi-definition-RequestNaming) | The JSON body of the request containing updated parameters of the request naming. | body | Optional |
...
| --- | --- | --- |
| **201** | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | Success. Request naming rule has been created. Response contains the new request naming rule's ID and name. |

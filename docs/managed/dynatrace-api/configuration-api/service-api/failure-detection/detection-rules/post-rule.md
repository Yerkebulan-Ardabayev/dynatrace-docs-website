...
| --- | --- | --- | --- | --- |
| body | [FailureDetectionRule](#openapi-definition-FailureDetectionRule) | The JSON body of the request. Contains the configuration of the new failure detection rule.  Dynatrace will generate a random UUID for you, if you don't specify an ID. | body | Optional |

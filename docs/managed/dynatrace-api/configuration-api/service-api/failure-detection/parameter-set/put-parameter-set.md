...
| body | [FailureDetectionParameterSet](#openapi-definition-FailureDetectionParameterSet) | The JSON body of the request. Contains the updated failure detection parameter set.  You can't update the ID with this request. Use the change ID request instead. | body | Optional |

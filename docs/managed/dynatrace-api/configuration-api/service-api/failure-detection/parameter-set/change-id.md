...
| PUT | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/config/v1/service/failureDetection/parameterSelection/parameterSets/{id}/changeId` |
...
| body | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | The JSON body of the request. Contains the new ID of the set. All other fields are ignored. | body | Required |

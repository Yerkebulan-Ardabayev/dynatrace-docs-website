...
| body | [FullWebRequestRule](#openapi-definition-FullWebRequestRule) | The JSON body of the request. Contains updated parameters of the service detection rule.  The **order** field is ignored in this request. To enforce a particular order, use the `PUT /service/detectionRules/FULL_WEB_REQUEST/reorder` request. | body | Optional |
...
| --- | --- | --- |
| **201** | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | Success. The new service detection rule has been created. The response body contains the ID of the rule. |

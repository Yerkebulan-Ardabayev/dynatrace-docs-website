...
| body | [FullWebServiceRule](#openapi-definition-FullWebServiceRule) | The JSON body of the request containing updated parameters of the service detection rule.  The **order** field is ignored in this request. To enforce a particular order use the `PUT /service/detectionRules/FULL_WEB_SERVICE/reorder` request. | body | Optional |

...
| body | [Dashboard](#openapi-definition-Dashboard) | The JSON body of the request. Contains updated parameters of the dashboard. | body | Optional |
...
In this example, the request adds the **Service health** tile to the **Sample dashboard** in the [GET request](/managed/dynatrace-api/configuration-api/dashboards-api/get-dashboard#example "View a dashboard via the Dynatrace Classic API.") example.

...
Updates the specified conditional naming rule. If the rule with the specified ID doesn't existâcreates a new rule with this ID.
...
| body | [ConditionalNamingRule](#openapi-definition-ConditionalNamingRule) | The JSON body of the request. Contains updated parameters of the naming rule.  The value of the **type** field must match the **type** path parameter. | body | Optional |
...
| rules | [EntityRuleEngineCondition[]](#openapi-definition-EntityRuleEngineCondition) | A list of matching conditions of the rule.  The rule applies only if **all** conditions are fulfilled. | Required |
| type | string | The type of Dynatrace entities to which the rule applies. The element can hold these values * `HOST` * `PROCESS_GROUP` * `SERVICE` | Required |
...
| --- | --- | --- |
| **201** | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | Success. The naming rule has been created. The response contains the ID of the new rule. |

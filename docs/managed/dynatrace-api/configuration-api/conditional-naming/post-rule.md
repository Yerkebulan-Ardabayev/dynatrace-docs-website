...
scraped: 2026-05-12T11:17:17.217697
---
...
| body | [ConditionalNamingRule](#openapi-definition-ConditionalNamingRule) | The JSON body of the request. Contains parameters of the new naming rule.  Do not specify the **id** of the rule.  The value of the **type** field must match the **type** path parameter. | body | Optional |

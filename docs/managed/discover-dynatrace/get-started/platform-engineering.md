...
Try it yourself: [Always-on app profiling](/managed/observe/application-observability/services/always-on-app-profiling "Optimize your code and find performance problems").
...
[OpenTelemetry](/managed/ingest-from/opentelemetry "Learn how to integrate and ingest OpenTelemetry data (traces, metrics, and logs) into Dynatrace.") (also referred to as OTel) is an open-source observability framework made up of a collection of tools, APIs, and SDKs.

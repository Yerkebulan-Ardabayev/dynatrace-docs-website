...
2. Download the latest release of the [LoadRunner Request Tagging tool for Dynatraceï»¿](https://github.com/Dynatrace/Dynatrace-LoadRunner-Request-Tagging/releases)
...
| VU | **V**irtual **U**ser ID of the unique user who sent the request. | Example: 1, 2, 3, â¦ |

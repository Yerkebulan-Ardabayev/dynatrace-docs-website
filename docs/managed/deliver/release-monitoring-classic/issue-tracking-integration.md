...
For other operators, consult the [ServiceNow API documentation﻿](https://dt-url.net/0w03qc9).
...
The following is a solution to a problem some people had with [Automated release monitoring issue-tracking integration: no query results matching the filter﻿](https://dt-url.net/5o038bi).
...
As a result, releases defined via OpenTelemetry resource attributes won't appear in the [release inventory](/managed/deliver/release-monitoring/monitor-releases-with-dynatrace#release-inventory "Analyze data related to each release version of your software.").

...
| [Azure Functions](/managed/ingest-from/microsoft-azure-services/integrations/azure-functions "Monitor Azure Functions") | Azure serverless functions: monitored using OpenTelemetry SDKs |

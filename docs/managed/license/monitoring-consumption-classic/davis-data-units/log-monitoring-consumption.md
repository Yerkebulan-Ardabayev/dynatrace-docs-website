...
The DDU cost is `9` log lines/records Ã `0.0005` log weight = `0.0045` DDUs.
...
The DDU cost is `3` log lines/records Ã `0.0005` log weight = `0.0015` DDUs
...
The DDU cost is `14` log records Ã `0.0005` log weight = `0.007` DDUs.
...
The DDU cost is `2` log records Ã `0.0005` log weight = `0.001` DDUs.

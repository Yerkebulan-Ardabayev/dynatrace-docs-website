...
* Access tokens and personal access tokens grant access to:
  ...
  + [Dynatrace API](/managed/dynatrace-api "Find out what you need to use the Dynatrace API.")
  + Download of OneAgent and ActiveGate installers
* [Personal access tokens](/managed/manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens/personal-access-token "Learn the concept of a personal access token and its scopes.") grant access to some endpoints of Dynatrace API
* [Tenant tokens](/managed/manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens/rotate-tenant-token "Learn what a tenant token is and how to change it.") allow OneAgent to report data to Dynatrace
...
1. In the CMC web UI, go to **Settings > API tokens**.

...
Build your Managed Cluster with additional capacity and possible node failure in mind. A Managed Cluster that operates at 100 percent of its processing capacity has no capacity to compensate for a lost node and can drop data during a node failure. Plan for a processing capacity one-third higher than typical utilization.

---
title: Dynatrace API changelog version 1.330
source: https://docs.dynatrace.com/managed/whats-new/dynatrace-api/sprint-330
---

# Dynatrace API changelog version 1.330
...
This is a non-breaking change hiding the `tagKey` from the schema. The POST request with `tagKey` is still valid, but, as before, it has no effect.
...
Added new endpoints for Early Accesss:
...
Added a new endpoint for Early Access:

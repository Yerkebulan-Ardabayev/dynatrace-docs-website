---
title: Work with key performance metrics
...
Dynatrace offers an expanded selection of [key performance metrics](/managed/observe/digital-experience/rum-concepts/user-action-metrics#kpm "Learn what metrics Dynatrace calculates for user actions and find out what each metric indicates.") on which you can base your Real User Monitoring.
...
6. On the key user action details page, select **More** (**â¦**) > **Edit**.

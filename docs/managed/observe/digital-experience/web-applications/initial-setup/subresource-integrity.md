---
title: Use Subresource Integrity (SRI) for Real User Monitoring code
...
[Configure the Real User Monitoring code source](/managed/observe/digital-experience/web-applications/additional-configuration/configure-monitoring-code-source#request-rum-monitoring-code-from-cdn "Configure the Real User Monitoring code source for your specific requirements."). This will allow you to select the necessary snippet format.

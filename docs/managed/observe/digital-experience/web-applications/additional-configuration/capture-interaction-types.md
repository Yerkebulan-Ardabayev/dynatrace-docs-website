...
For [XHR actions](/managed/observe/digital-experience/rum-concepts/user-actions#xhr-action "Learn what user actions are and how they help you understand what users do with your application."), Real User Monitoring detects the following interaction types:

---
title: Check user experience metrics for mobile applications
...
# Check user experience metrics for mobile applications
...
For web request errors, you can also [configure error exclusion rules](/managed/observe/digital-experience/mobile-applications/additional-configuration/web-request-errors-mobile "Stop treating certain response HTTP codes as errors for your mobile applications.") if you don't want Dynatrace to flag a particular HTTP status code as erroneous. Select **Edit error exclusion rules** to go to the corresponding settings page.

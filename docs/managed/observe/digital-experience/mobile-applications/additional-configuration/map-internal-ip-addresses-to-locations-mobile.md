---
title: Map internal IP addresses to locations for mobile applications
...
Dynatrace Real User Monitoring groups [user sessions and user actions per location](/managed/observe/digital-experience/rum-concepts/detection-of-ip-addresses-locations-and-user-agents "Dynatrace detects IP addresses and geolocations like a city, region, and country as well as browsers, devices, and operating systems.") and shows them on the [world map](/managed/observe/digital-experience/mobile-applications/analyze-and-use/check-usage-metrics-mobile#geo-regions "Learn how to use Dynatrace to check the user experience metrics of your mobile application.").

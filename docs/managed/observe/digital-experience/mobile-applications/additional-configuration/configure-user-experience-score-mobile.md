---
title: Change user experience score thresholds for mobile applications
...
# Change user experience score thresholds for mobile applications
...
3. Optional Turn on **Consider rage clicks / rage taps in score calculation** to include [rage events](/managed/observe/digital-experience/rum-concepts/user-and-error-events#rage-event "Learn about user and error events and the types of user and error events captured by Dynatrace.") when determining the user experience score.
...
* [User experience score](/managed/observe/digital-experience/rum-concepts/scores-and-ratings/user-experience-score "User experience score is a metric used to categorize user sessions as Frustrating, Tolerable, or Satisfying.")
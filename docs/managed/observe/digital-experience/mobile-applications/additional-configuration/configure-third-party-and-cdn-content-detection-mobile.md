---
title: Configure first-party, third-party, and CDN resource detection for mobile applications
...
You can view your application's top providers and access the detailed information on each provider from your application overview page. For details, see [Analyze web requests > Top providers](/managed/observe/digital-experience/mobile-applications/analyze-and-use/analyze-web-requests-mobile#top-providers "Leverage Dynatrace to monitor web requests for your mobile applications.").

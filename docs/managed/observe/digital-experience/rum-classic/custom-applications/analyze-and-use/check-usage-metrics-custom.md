---
title: Check user experience metrics for custom applications in RUM Classic
...
# Check user experience metrics for custom applications in RUM Classic
...
For web request errors, you can also [configure error exclusion rules](/managed/observe/digital-experience/rum-classic/custom-applications/additional-configuration/web-request-errors-custom "Stop treating certain HTTP response codes as errors for your custom applications.") if you don't want Dynatrace to flag a particular HTTP status code as erroneous. Select **Edit error exclusion rules** to go to the corresponding settings page.

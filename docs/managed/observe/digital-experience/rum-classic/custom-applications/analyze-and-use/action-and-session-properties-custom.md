---
title: Leverage user action and user session properties for custom applications in RUM Classic
...
# Leverage user action and user session properties for custom applications in RUM Classic

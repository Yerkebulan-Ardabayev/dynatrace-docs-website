---
title: Analyze web requests for custom applications in RUM Classic
...
# Analyze web requests for custom applications in RUM Classic
...
This chart compares the web request rate—the number of web requests per minute—to the [error](/managed/observe/digital-experience/rum-classic/rum-concepts/user-and-error-events#error "Learn about user and error events and the types of user and error events captured by Dynatrace.") rate for the selected timeframe.
...
* Go to the **Errors** tab to view the list of web request errors for this provider. Select the error that you want to analyze to open the [web request error details page](/managed/observe/digital-experience/rum-classic/session-segmentation/user-sessions#error-details-page "Learn about user session segmentation and filtering attributes.").

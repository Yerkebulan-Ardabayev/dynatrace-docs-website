---
title: Manually instrument your application using OneAgent SDK for Android in RUM Classic
...
# Manually instrument your application using OneAgent SDK for Android in RUM Classic
...
When you can't use the [Dynatrace Android Gradle plugin](/managed/observe/digital-experience/rum-classic/mobile-applications/instrument-android-app/instrumentation-via-plugin "Learn how the Dynatrace Android Gradle plugin can auto-instrument your Android application project.") due to certain technical limitations, opt for standalone manual instrumentation with OneAgent SDK for Android.

Follow the steps below to manually instrument your application using OneAgent SDK for Android.

[![Step 1](https://dt-cdn.net/images/step-1-086e22066c.svg "Step 1")

**Ensure that the Maven Central repository is declared.**](/managed/observe/digital-experience/rum-classic/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk/manual-instrumentation#step-declare-maven-central "Use OneAgent SDK for Android to manually instrument your Android application.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Include the OneAgent library as a dependency to your project.**](/managed/observe/digital-experience/rum-classic/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk/manual-instrumentation#step-include-OneAgent-library "Use OneAgent SDK for Android to manually instrument your Android application.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Start OneAgent manually.**](/managed/observe/digital-experience/rum-classic/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk/manual-instrumentation#step-start-one-agent "Use OneAgent SDK for Android to manually instrument your Android application.")[![Step 4](https://dt-cdn.net/images/step-4-3f89d67d41.svg "Step 4")

**Capture additional data via OneAgent SDK for Android.**](/managed/observe/digital-experience/rum-classic/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk/manual-instrumentation#step-capture-additional-data "Use OneAgent SDK for Android to manually instrument your Android application.")
...
1. Ensure that the Maven Central repository is declared.
   ...
   OneAgent for Android is hosted on [Maven Central﻿](https://central.sonatype.com/artifact/com.dynatrace.agent/agent-android). In the Gradle settings file, verify that `mavenCentral()` is added to the `repositories` blocks under `dependencyResolutionManagement`. Check the [official Android documentation﻿](https://dt-url.net/gradle-settings-file) to see what the Gradle settings file should look like.
...
4. Capture additional data via [OneAgent SDK for Android](/managed/observe/digital-experience/rum-classic/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk/oneagent-sdk-for-android "Learn how to enrich mobile user experience monitoring in Android using OneAgent SDK.").

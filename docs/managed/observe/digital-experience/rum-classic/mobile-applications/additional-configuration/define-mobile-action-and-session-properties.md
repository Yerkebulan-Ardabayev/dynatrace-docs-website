---
title: Define user action and user session properties for mobile applications in RUM Classic
...
# Define user action and user session properties for mobile applications in RUM Classic

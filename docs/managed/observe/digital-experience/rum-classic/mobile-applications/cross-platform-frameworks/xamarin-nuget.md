---
title: Instrument mobile apps with Dynatrace Xamarin NuGet package in RUM Classic
...
# Instrument mobile apps with Dynatrace Xamarin NuGet package in RUM Classic
...
On May 1, 2024, [Microsoft will end support for all Xamarin SDKs﻿](https://dotnet.microsoft.com/en-us/platform/support/policy/xamarin#microsoft-support). For this reason, we're deprecating the Dynatrace Xamarin NuGet package in May 2024. We will let you know in which upcoming package version we will be only fixing bugs and addressing important security issues.

Also, in accordance with the [Dynatrace Support Policy﻿](https://www.dynatrace.com/company/trust-center/support-policy/), we will end support for the Dynatrace Xamarin NuGet package in May 2025.

We recommend that you [upgrade your Xamarin projects to .NET﻿](https://learn.microsoft.com/en-gb/dotnet/maui/migration) and use the [Dynatrace .NET MAUI NuGet package](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/maui "Monitor .NET MAUI applications with Dynatrace OneAgent.") instead of the deprecated Xamarin NuGet package.
...
**Install the Dynatrace Xamarin NuGet package**](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/xamarin-nuget#install-package "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Create an application and get the config file**](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/xamarin-nuget#installation-dynatrace "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Add the config file to your project**](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/xamarin-nuget#configure-app "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 4](https://dt-cdn.net/images/step-4-3f89d67d41.svg "Step 4")

**Add the OneAgent start method**](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/xamarin-nuget#start-method "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 5](https://dt-cdn.net/images/step-5-2de312b50f.svg "Step 5")

Xamarin.Forms only

**Set up Xamarin.Forms DependencyService**](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/xamarin-nuget#usage-forms "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 6 optional](https://dt-cdn.net/images/dotted-step-6-fbd29ea893.svg "Step 6 optional")

**Enable automatic web request instrumentation**](/managed/observe/digital-experience/rum-classic/mobile-applications/cross-platform-frameworks/xamarin-nuget#http-client "Monitor Xamarin apps with Dynatrace OneAgent.")
...
2. Find [**Dynatrace.OneAgent.Xamarin** from nuget.org﻿](https://www.nuget.org/packages/Dynatrace.OneAgent.Xamarin) and select **Add Package**.
...
If you can't resolve a problem, check [Mobile applications: Issues with Dynatrace Xamarin NuGet package﻿](https://dt-url.net/xn638zc) in the Dynatrace Community.

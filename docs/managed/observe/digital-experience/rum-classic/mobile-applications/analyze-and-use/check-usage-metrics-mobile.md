---
title: Check user experience metrics for mobile applications in RUM Classic
...
# Check user experience metrics for mobile applications in RUM Classic
...
The **Apdex rating** chart shows your application's average [Apdex rating](/managed/observe/digital-experience/rum-classic/rum-concepts/scores-and-ratings/apdex-ratings "Learn how Dynatrace uses Apdex to measure user satisfaction with application performance.") trends for the selected timeframe.
...
From the multidimensional **User action analysis** page, you can also examine the list of web request errors or reported [errors](/managed/observe/digital-experience/rum-classic/rum-concepts/user-and-error-events#error "Learn about user and error events and the types of user and error events captured by Dynatrace."): Select **Web request errors over time** or **Reported errors over time** from the **Analyze by** text field. The list of errors shows up under the chart. Expand the error you're interested in and then select **Analyze error** to view the error details page.
...
For web request errors, you can also [configure error exclusion rules](/managed/observe/digital-experience/rum-classic/mobile-applications/additional-configuration/web-request-errors-mobile "Stop treating certain response HTTP codes as errors for your mobile applications.") if you don't want Dynatrace to flag a particular HTTP status code as erroneous. Select **Edit error exclusion rules** to go to the corresponding settings page.

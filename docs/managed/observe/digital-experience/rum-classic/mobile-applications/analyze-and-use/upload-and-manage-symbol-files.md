---
title: Upload and manage symbol files for mobile applications in RUM Classic
...
# Upload and manage symbol files for mobile applications in RUM Classic
...
To learn more about mapping files and where to find them, check the [official Android documentation﻿](https://developer.android.com/studio/build/shrink-code#decode-stack-trace).
...
For more information and detailed instructions, check the [plugin documentation﻿](https://github.com/Dynatrace/fastlane-plugin-dynatrace) on GitHub.
...
4. Provide the **Package name**—the application package name, such as `com.yourcompany.app`.
5. Enter the **Version code** and **Version name**—you can find these in the `build.gradle` file.
...
7. Enter the **Version code** and **Version name**—you can find these in the `build.gradle` file.
...
3. Select your application from the dropdown list.
4. Provide the **Bundle identifier**—this is the application `bundleId` that can be found in **App's target** > **General** > **Bundle Identifier**.

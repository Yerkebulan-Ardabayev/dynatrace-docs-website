---
title: Control the RUM JavaScript version in RUM Classic
...
# Control the RUM JavaScript version in RUM Classic
...
* We ended support for Internet Explorer 7–10 starting with RUM JavaScript version 1.265.
...
* **Environments created before Dynatrace version 1.266**: You can choose a version of the RUM JavaScript that is compatible with Internet Explorer 7–10. Select the **Latest IE7-10 supported** option in step 5 of the instructions in [Configure the RUM JavaScript version for an application](#configure-js-version).

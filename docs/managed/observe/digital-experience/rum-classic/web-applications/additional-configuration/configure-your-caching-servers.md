---
title: Configure your caching servers in RUM Classic
...
# Configure your caching servers in RUM Classic
...
Using a caching server with Dynatrace Real User Monitoring Classic can sometimes lead to unexpected results. A cache hit rate close to zero is the most obvious symptom of cache-related problems. This is most likely to happen when you rely on default caching-server configuration settings.

---
title: Check application detection rules in RUM Classic
...
# Check application detection rules in RUM Classic
...
You can now check if the defined detection rules are detecting traffic from the correct URLs and accurately reflecting the applications that they’re designed to detect. By checking the URL of any auto-injected RUM application, you can:

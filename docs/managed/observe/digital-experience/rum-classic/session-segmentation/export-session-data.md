...
[OAuth 2.0﻿](https://auth0.com/intro-to-iam/what-is-oauth-2/) offers various grant types, but Dynatrace supports only the client credentials grant type. For information on this grant type, see the following resources:
...
* **Elasticsearch version 8**
  ...
  + Specifying types is no longer supported. Starting with this version, omit the document type. For more information, see [Removal of mapping types﻿](https://www.elastic.co/guide/en/elasticsearch/reference/current/removal-of-types.html).

...
* You can also [create private Synthetic locations](/managed/observe/digital-experience/synthetic-monitoring/private-synthetic-locations/create-a-private-synthetic-location "Learn how to create a private location for synthetic monitoring.") within your own network infrastructure. All public and private Synthetic locations can run [browser as well as HTTP monitors](/managed/observe/digital-experience/synthetic-monitoring/general-information/types-of-synthetic-monitors "Learn about Dynatrace synthetic monitor types.").
* A Cluster ActiveGate with a public IP address must be configured to run synthetic monitors from any of the public Synthetic locations.

## Location release stages

Locations are released in one of these progressive stages: **Coming soon**, **Early Access**, or **GA**. Locations can also be **Deprecated**. Learn about the relationship between the stages:
...
| **Early Access** | Location is production ready and fully supported. Its future availability depends on the interest the location receives and on vendor-dependent factors. |
...
* Use the [Synthetic locations API - GET all locations](/managed/dynatrace-api/environment-api/synthetic/synthetic-locations/get-all-locations "List all synthetic locations via the Synthetic v1 API.") API call, which returns all the locations available for your Environment along with their IP addresses.
...
You can also use the [Synthetic Monitors API](/managed/dynatrace-api/environment-api/synthetic/synthetic-monitors "Manage synthetic monitors via the Synthetic v1 API.") for configuration at scale.

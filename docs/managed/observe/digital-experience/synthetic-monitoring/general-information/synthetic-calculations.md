...
Performance thresholds for [HTTP monitors](/managed/observe/digital-experience/synthetic-monitoring/general-information/types-of-synthetic-monitors#http-monitor "Learn about Dynatrace synthetic monitor types.") are defined as the **Response time** of the monitor or of individual requests.

---
title: Analyze database services (classic)
...
# Analyze database services (classic)
...
* To switch to the [new database overview page](/managed/observe/infrastructure-observability/database-services-classic/analyze-database-services-new "Analyze your database services with Dynatrace (new page)."), just turn on **Try it out** at the top of the database overview page. You can switch back to the classic design if you decide that you prefer it.

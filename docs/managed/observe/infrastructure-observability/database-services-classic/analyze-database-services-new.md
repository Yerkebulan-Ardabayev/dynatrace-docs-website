---
title: Analyze database services (new)
...
* If you want to revert to the classic database page, on the database overview page select **More** (**…**) > **Return to classic page** and then refer to the [documentation for the classic database page](/managed/observe/infrastructure-observability/database-services-classic/analyze-database-services "Analyze your database services with Dynatrace (classic page).").

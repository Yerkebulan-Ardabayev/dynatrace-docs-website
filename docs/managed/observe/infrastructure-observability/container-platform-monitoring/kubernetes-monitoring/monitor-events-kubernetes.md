...
* [Enable the latest version of Dynatrace log monitoring](/managed/analyze-explore-automate/log-monitoring "Learn how to enable Log Monitoring, the insights that Log Monitoring can provide, and more.")
...
You can also view events on the **Log viewer** page (in Dynatrace, go to **Logs**), which allows for advanced search and filtering.
...
You can define the event field selectors via [Dynatrace API](/managed/dynatrace-api/configuration-api/k8s-credentials-api-api "Manage Kubernetes credentials via the Dynatrace configuration API.").

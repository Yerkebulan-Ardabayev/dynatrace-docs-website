...
This feature is available only if your Kubernetes cluster is [connected to a local Kubernetes API endpoint](/managed/ingest-from/setup-on-k8s/guides/deployment-and-configuration/monitoring-and-instrumentation/k8s-api-monitoring "Monitor the Kubernetes API using Dynatrace").

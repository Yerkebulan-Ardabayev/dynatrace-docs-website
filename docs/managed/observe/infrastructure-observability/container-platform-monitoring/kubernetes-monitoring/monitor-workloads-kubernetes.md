...
To display the Kubernetes workloads, go to **Kubernetes Workloads**.
...
To display the namespace unified analysis page, in Dynatrace, go to **Kubernetes Workloads** and select a namespace.
...
1. Go to **Kubernetes Workloads** and select a workload.
2. Select **Pods**.

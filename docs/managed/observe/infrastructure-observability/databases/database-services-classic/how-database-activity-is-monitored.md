...
Attributes used for detection are marked with an asterisk ✱ on the [database](/managed/observe/infrastructure-observability/databases/database-services-classic/analyze-database-services-new "Analyze your database services with Dynatrace (new page).") overview page, under **Properties and tags**.

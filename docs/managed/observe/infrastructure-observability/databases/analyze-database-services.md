...
source: https://docs.dynatrace.com/managed/observe/infrastructure-observability/databases/analyze-database-services
---
...
* To switch to the new database overview page, turn on **Try it out** at the top of the database overview page. You can switch back to the classic design if you decide that you prefer it.

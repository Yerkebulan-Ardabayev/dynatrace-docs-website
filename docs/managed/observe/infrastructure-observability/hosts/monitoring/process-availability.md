...
You can analyze the latest activity of the processes defined for process availability in the [Process instance snapshots](/managed/observe/infrastructure-observability/hosts/monitoring/host-monitoring#snapshots "Monitor hosts with Dynatrace.") section on the host overview page.

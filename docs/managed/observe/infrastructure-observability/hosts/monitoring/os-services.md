...
The [Host overview](/managed/observe/infrastructure-observability/hosts/monitoring/host-monitoring "Monitor hosts with Dynatrace.") page contains the **OS services analysis** section listing the OS services for which any policy (with active alerting or monitoring) is fulfilled.
...
For more information, see [OS services analysis](/managed/observe/infrastructure-observability/hosts/monitoring/host-monitoring#os-services "Monitor hosts with Dynatrace.").

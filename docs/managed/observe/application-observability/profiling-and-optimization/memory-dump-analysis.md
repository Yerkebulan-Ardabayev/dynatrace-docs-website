...
Yes. OneAgent stores memory dumps locally and ensures that dumps do not leave your local network. You can [customize the location of the memory dumps](/managed/ingest-from/dynatrace-oneagent/installation-and-operation/linux/installation/customize-oneagent-installation-on-linux#data-storage "Learn how to use the Linux installer with command line parameters.").
...
* You can enable remote access to the ActiveGate by changing the public endpoints.  
  ...
  + [Enable the memory dump module](/managed/ingest-from/dynatrace-activegate/configuration/configure-activegate#mem_dump_mod "Learn which ActiveGate properties you can configure based on your needs and requirements.")
  + [Configure ActiveGate for memory dump storage](/managed/observe/application-observability/profiling-and-optimization/memory-dump-analysis/configure-an-activegate-for-memory-dump-storage "Learn how to enable storage of memory dumps on an ActiveGate.")

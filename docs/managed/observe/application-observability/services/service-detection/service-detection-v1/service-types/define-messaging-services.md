...
2. Select whether your messaging service is based on **Java**, **.NET**, or **Node.js**, and then select **Define messaging service**.
...
12. .NET Node.js Restart your consumer application so that the custom messaging service can be detected.
...
* [AWS SDKv1 SQSï»¿](https://dt-url.net/4942e9a) `com.amazonaws.services.sqs.model.Message`
* [AWS SDKv2 SQSï»¿](https://dt-url.net/pd62ee9) `software.amazon.awssdk.services.sqs.model.Message`
...
Select a method that has a [Kafkaï»¿](https://dt-url.net/ka03s3d) `org.apache.kafka.clients.consumer.ConsumerRecord` as an argument. The full package path is required.
...
2. Turn on the **Node.js KafkaJs Consumer Automatic Detectionn** toggle.
...
* If you use the `@SqsListener` annotation or the [MessageListenerï»¿](https://dt-url.net/7p02e18) interface, no further configuration is needed.
* If you use the [SqsTemplateï»¿](https://dt-url.net/kq02erd), a custom messaging service for Spring Cloud AWS SQS incoming must define a method in your code that is responsible for processing a single SQS message. This method can be used as an entry point for Spring Cloud AWS SQS messaging services. The defined method must have exactly one `Message` parameter (and any number of other parameters).

Select a method that has exactly one [Spring Cloud AWS SQSï»¿](https://dt-url.net/fq02e9l) `org.springframework.messaging.Message` parameter, no [AWS SDKv1 SQSï»¿](https://dt-url.net/4942e9a) `com.amazonaws.services.sqs.model.Message` and [AWS SDKv2 SQSï»¿](https://dt-url.net/pd62ee9) `software.amazon.awssdk.services.sqs.model.Message` parameters and any amount of other parameters. The full package path is required.

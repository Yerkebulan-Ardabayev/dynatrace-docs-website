...
1. Go to **Multidimensional Analysis** or **Database Services**.
...
Details of an individual database statement
...
Backtrace for top database statements
...
Response time distribution of requests of a service
...
From service flow to database statement

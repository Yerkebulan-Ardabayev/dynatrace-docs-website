...
Log analysis distributed trace - 6

### Steps

We begin our analysis with the affected Go service and check its [dynamic requests](/managed/discover-dynatrace/get-started/glossary#request "Get acquainted with Dynatrace terminology.").

![Log analysis distributed trace - 7](https://dt-cdn.net/images/pp-log-analysis-11-1505-1fd6fd3e99.png)

Log analysis distributed trace - 7
...
Log analysis distributed trace - 8
...
Log analysis distributed trace - 9
...
Log analysis distributed trace - 2
...
Log analysis distributed trace - 3
...
Log analysis distributed trace - 4
...
Log analysis distributed trace - 5
...
Let's go back and check logs for more errors. Because we have attended to the shipping holiday problem, we can filter out those logs with [**advanced query** mode](/managed/analyze-explore-automate/log-monitoring/analyze-log-data/log-viewer#search "Learn how to use Dynatrace log viewer to analyze log data.").

![Log analysis distributed trace - 10](https://dt-cdn.net/images/pp-log-analysis-14-1890-6ccd1ed6f9.png)

Log analysis distributed trace - 10
...
Log analysis distributed trace - 11
...
Dashboard - Logs in root cause analysis
...
Overview of problems - Logs in root cause analysis
...
Problem details - Logs in root cause analysis
...
Failure analysis - Logs in root cause analysis
...
Workload analysis - Logs for Kubernetes
...
Distributed traces - Logs for Kubernetes
...
Summary tab of frontend revers proxy

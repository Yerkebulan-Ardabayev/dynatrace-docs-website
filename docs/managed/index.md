...
Learn about Dynatrace Managed and explore resources to enhance your observability and security.
...
[![Dashboards Classic](https://dt-cdn.net/images/dashboards-classic-512-15764940e8.png "Dashboards Classic")Dashboards Classic](/managed/analyze-explore-automate/dashboards-classic) [![Data Explorer](https://dt-cdn.net/images/data-explorer-512-743267b1fc.png "Data Explorer")Data Explorer](/managed/analyze-explore-automate/explorer) [![Metrics](https://dt-cdn.net/images/matrics-512-bb60358a0d.png "Metrics")Metrics](/managed/analyze-explore-automate/metrics-classic) [![Notifications](https://dt-cdn.net/images/notification-512-a99560c5a3.png "Notifications")Notifications and alerting](/managed/analyze-explore-automate/notifications-and-alerting) [![Logs and Events](https://dt-cdn.net/images/logs-and-events-512-4b43bbadbe.png "Logs and Events")Logs](/managed/analyze-explore-automate/log-monitoring) [![Distributed Traces Classic](https://dt-cdn.net/images/distributed-traces-classic-7197cdacfb.svg "Distributed Traces Classic")Distributed traces](/managed/observe/application-observability/distributed-traces) 

## Extend Dynatrace

---

[![Extend metrics](https://dt-cdn.net/images/matrics-512-bb60358a0d.png "Metrics")Extend metrics](/managed/ingest-from/extend-dynatrace/extend-metrics) [![Extend logs](https://dt-cdn.net/hub/console/drafts/85/logo/logs-app-icon.png "Logs")Extend logs](/managed/ingest-from/extend-dynatrace/extend-logs) [![Extend traces](https://dt-cdn.net/images/distributed-traces-classic-7197cdacfb.svg "Distributed Traces Classic")Extend traces](/managed/ingest-from/extend-dynatrace/extend-tracing) [![Dynatrace OpenKit](https://dt-cdn.net/images/user-profile-512-ca0affeacb.png "User profile")Extend UX and behavior data](/managed/ingest-from/extend-dynatrace/openkit) [![Extend UI](https://dt-cdn.net/images/frontend-512-e5705a0aec.png "Frontend")Extend Dynatrace UI](/managed/ingest-from/extend-dynatrace/extend-ui) [![Extend topology](https://dt-cdn.net/images/smartscape-topology-512-dca23011f9.png "Smartscape")Extend topology](/managed/ingest-from/extend-dynatrace/extend-topology) [![Extensions](https://dt-cdn.net/images/extensions-512-1b8ed0c785.png "Extensions Classic")Extensions](/managed/ingest-from/extensions) [![OpenTelemetry](https://dt-cdn.net/images/techn-icon-opentelemetry-345d0f8b0e.svg "OpenTelemetry")OpenTelemetry](/managed/ingest-from/opentelemetry) 
...
[Environment API](/managed/dynatrace-api/environment-api) [Configuration API](/managed/dynatrace-api/configuration-api) [Account Management API](/managed/dynatrace-api/account-management-api) [Cluster API](/managed/dynatrace-api/cluster-api/cluster-api-v2) [Tokens and authentication](/managed/dynatrace-api/basics/dynatrace-api-authentication) [Response codes](/managed/dynatrace-api/basics/dynatrace-api-response-codes) [Access limit](/managed/dynatrace-api/basics/access-limit)
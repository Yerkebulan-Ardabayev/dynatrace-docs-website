...
Установите Environment ActiveGate в вашем центре обработки данных перед подключением Dynatrace к платформе VMware.
...
3. Проверьте настройки сети/прокси.
   ...
   По желанию вы также можете обойти прокси для подключения к vCenter или ESXi при настройке интеграции VMware. Измените конфигурацию ActiveGate, чтобы исключить определенный хост из прокси.
...
1. Чтобы узнать схему, используйте GET схемы с `builtin:virtualization.vmware` в качестве schemaId.
2. На основе схемы `builtin:virtualization.vmware` создайте ваш объект конфигурации.
3. Для создания конфигурации используйте POST объекта.

...
Новый возможный эндпоинт:

* `DELETE /metrics`

### /rum

Зрелость API следующих эндпоинтов изменена с **EARLY\_ADOPTER** на **GENERAL\_AVAILABILITY**

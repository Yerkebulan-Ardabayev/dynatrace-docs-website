...
* `POST /credentials`
  ...
  + Request:
    ...
    - Changed **Credentials** schema ![Warning](https://dt-cdn.net/images/warning-16-56c09ccf83.png "Warning") Несовместимое изменение
...
* [Заметки о выпуске SaaS 1.303](https://docs.dynatrace.com/docs/shortlink/release-notes-saas-sprint-303)
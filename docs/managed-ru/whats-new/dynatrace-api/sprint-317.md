---
title: Журнал изменений Dynatrace API версии 1.317
source: https://docs.dynatrace.com/managed/whats-new/dynatrace-api/sprint-317
scraped: 2026-05-12T11:36:11.629947
---

# Журнал изменений Dynatrace API версии 1.317
...
* `GET /extensions/{extensionName}/monitoringConfigurations/{configurationId}/audit` Новый раздел!

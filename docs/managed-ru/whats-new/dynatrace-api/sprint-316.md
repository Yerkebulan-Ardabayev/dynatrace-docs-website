---
title: Журнал изменений Dynatrace API версии 1.316
source: https://docs.dynatrace.com/managed/whats-new/dynatrace-api/sprint-316
scraped: 2026-05-12T11:19:03.594437
---

# Журнал изменений Dynatrace API версии 1.316
...
### Объявлено устаревшим для SaaS и Managed

* `DELETE /entities/securityContext`
* `POST /entities/securityContext`

### Объявлено устаревшим для Managed

...
Узнайте о возможностях мониторинга, предоставляемых OneAgent.](/managed/platform/oneagent/supported-monitoring-types "Read an overview of all monitoring capabilities offered by OneAgent.")[### Принципы работы

Узнайте, как работает OneAgent.](/managed/platform/oneagent/how-one-agent-works "Understand how OneAgent works.")

[### Режимы мониторинга OneAgent

Узнайте о доступных режимах мониторинга при использовании OneAgent.](/managed/platform/oneagent/monitoring-modes/monitoring-modes "Find out more about the available monitoring modes when using OneAgent.")[### Включение режимов мониторинга

Узнайте, как включить режимы мониторинга при использовании OneAgent.](/managed/platform/oneagent/monitoring-modes/enable-monitoring-modes "Learn how to enable monitoring modes when using OneAgent.")

---
title: Семантические атрибуты (Logs Classic)
...
# Семантические атрибуты (Logs Classic)
...
Семантические атрибуты — это пары ключ-значение, предоставляющие дополнительный контекст о событиях журнала. Они помогают эффективно категоризировать, фильтровать и анализировать журналы. Семантические атрибуты индексируются в Log Monitoring Classic для улучшения поиска и анализа журналов.

Поддерживаемые ключи семантических атрибутов в Log Monitoring Classic:

...
Вы можете создать дашборд Dynatrace для быстрого и целенаправленного доступа к данным самомониторинга. Создайте плитки, выбрав метрики самомониторинга в Data Explorer, настроив визуализацию для каждой из них и закрепив их на ваших дашбордах. Подробнее см. в разделе Dashboards Classic.
...
В этом примере мы используем метрики самомониторинга для получения информации о работе Log Monitoring Classic с течением времени.

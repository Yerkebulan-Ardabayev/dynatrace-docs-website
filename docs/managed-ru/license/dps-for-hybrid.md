...
Подробнее о DPS см. Лицензирование Dynatrace — модели лицензирования для всех возможностей Dynatrace.").
...
Подробнее см. Настройка оповещений о расходах.
...
Общую информацию о бюджетах см. в Настройка оповещений о бюджете.
...
После настройки DPS для Hybrid вы можете увидеть всю информацию на уровне лицензии и аккаунта в управлении аккаунтами, см. Обзор подписки (DPS для Hybrid).
Это предоставляет аналитику и информацию, аналогичную обзору подписки для стандартных лицензий DPS.

Как настроить панель?

Пожалуйста, ознакомьтесь с Изучение подписки DPS для Hybrid с помощью панелей для получения информации о настройке.

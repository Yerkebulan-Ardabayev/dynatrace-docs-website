...
Приём пользовательских метрик потребляет Davis Data Units (DDU). Подробнее об управлении потреблением DDU см. в разделе [лицензирования](/managed/manage/licensing "Узнайте об управлении лицензией Dynatrace.").

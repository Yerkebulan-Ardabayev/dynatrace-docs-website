...
# Мониторинг Google Cloud Network Topology
...
Для Google Cloud Network Topology доступны следующие наборы функций.

| Набор функций | Имя | Единица измерения | Идентификатор метрики GCP |
| --- | --- | --- | --- |
| gce\_zone\_network\_health/default\_metrics | Number of probes | Количество | networking.googleapis.com/cloud\_netslo/active\_probing/probe\_count |

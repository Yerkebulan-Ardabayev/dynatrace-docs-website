---
title: Мониторинг Google Cloud Firestore in Datastore mode
...
# Мониторинг Google Cloud Firestore in Datastore mode
...
Для Google Cloud Firestore in Datastore mode доступны следующие наборы функций.

| Набор функций | Имя | Единица измерения | Идентификатор метрики GCP |
| --- | --- | --- | --- |
| datastore\_request/default\_metrics | Requests | Количество | datastore.googleapis.com/api/request\_count |
| datastore\_request/default\_metrics | Sizes of read entities | Байт | datastore.googleapis.com/entity/read\_sizes |
| datastore\_request/default\_metrics | Sizes of written entities | Байт | datastore.googleapis.com/entity/write\_sizes |
| datastore\_request/default\_metrics | Index writes | Количество | datastore.googleapis.com/index/write\_count |
| datastore\_request/default\_metrics | Requests | Количество | firestore.googleapis.com/api/request\_count |

...
source: https://docs.dynatrace.com/managed/ingest-from/google-cloud-platform/gcp-integrations/gcp-supported-service-metrics-new/gcp-storage-transfer-service-monitoring
scraped: 2026-05-12T11:50:29.201138
---
...
| --- | --- | --- | --- |
| transfer\_service\_agent/default\_metrics | Agent connected status | Не указано | storagetransfer.googleapis.com/agent/connected |
| transfer\_service\_agent/default\_metrics | Agent transfer delta | Байт | storagetransfer.googleapis.com/agent/transferred\_bytes\_count |

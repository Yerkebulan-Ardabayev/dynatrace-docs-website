...
* Создайте [токен PaaS](../../../../manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens.md#paas-token "Узнайте о концепции токена доступа и его областях действия.").
* Ознакомьтесь со списком [поддерживаемых приложений и версий](../../../../ingest-from/technology-support.md "Технические подробности о поддержке конкретных платформ и фреймворков в Dynatrace.").
...
* [Настройка Dynatrace в Google Cloud](../../../../ingest-from/google-cloud-platform.md "Мониторинг Google Cloud с помощью Dynatrace.")
* [Матрица поддержки платформ и возможностей OneAgent](../../../../ingest-from/technology-support/oneagent-platform-and-capability-support-matrix.md "Узнайте, какие возможности поддерживаются OneAgent на различных операционных системах и платформах.")

...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-transfer-family
scraped: 2026-05-12T11:31:04.007595
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Transfer Family. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `ServerId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| BytesIn | Общее количество байт, переданных на сервер | Байт | Sum | ServerId | Применимо |
| BytesOut | Общее количество байт, переданных с сервера | Байт | Sum | ServerId | Применимо |
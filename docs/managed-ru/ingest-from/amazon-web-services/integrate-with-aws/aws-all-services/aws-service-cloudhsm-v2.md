---
title: Мониторинг AWS CloudHSM (V2)
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-cloudhsm-v2
scraped: 2026-05-12T11:30:02.136076
---

# Мониторинг AWS CloudHSM (V2)
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS CloudHSM (V2). Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| HsmUnhealthy | Экземпляр HSM работает некорректно | None | Multi | ClusterId, HsmId | Применимо |
| HsmUnhealthy |  | None | Multi | ClusterId | Применимо |
| HsmUnhealthy |  | None | Multi | Region | Применимо |
| HsmTemperature | Температура перехода аппаратного процессора | None | Multi | ClusterId, HsmId | Применимо |
| HsmTemperature |  | None | Multi | ClusterId | Применимо |
| HsmTemperature |  | None | Multi | Region |  |
| HsmKeysSessionOccupied | Количество сеансовых ключей, используемых экземпляром HSM | Количество | Multi | ClusterId, HsmId | Применимо |
| HsmKeysSessionOccupied |  | Количество | Multi | ClusterId | Применимо |
| HsmKeysSessionOccupied |  | Количество | Multi | Region | Применимо |
| HsmKeysTokenOccupied | Количество ключей токенов, используемых экземпляром HSM и кластером | Количество | Multi | ClusterId, HsmId | Применимо |
| HsmKeysTokenOccupied |  | Количество | Multi | ClusterId | Применимо |
| HsmKeysTokenOccupied |  | Количество | Multi | Region | Применимо |
| HsmSslCtxsOccupied | Количество каналов со сквозным шифрованием, установленных в настоящее время для экземпляра HSM | Количество | Multi | ClusterId, HsmId | Применимо |
| HsmSslCtxsOccupied |  | Количество | Multi | ClusterId | Применимо |
| HsmSslCtxsOccupied |  | Количество | Multi | Region |  |
| HsmSessionCount | Количество открытых подключений к экземпляру HSM | Количество | Multi | ClusterId, HsmId | Применимо |
| HsmSessionCount |  | Количество | Multi | ClusterId | Применимо |
| HsmSessionCount |  | Количество | Multi | Region |  |
| HsmUsersAvailable | Количество дополнительных пользователей, которых можно создать | Количество | Multi | ClusterId, HsmId | Применимо |
| HsmUsersAvailable |  | Количество | Multi | ClusterId | Применимо |
| HsmUsersAvailable |  | Количество | Multi | Region |  |
| HsmUsersMax | Максимальное количество пользователей, которых можно создать на экземпляре HSM | Количество | Maximum | ClusterId, HsmId | Применимо |
| HsmUsersMax |  | Количество | Maximum | ClusterId | Применимо |
| HsmUsersMax |  | Количество | Maximum | Region |  |
| InterfaceEth2DroppedInput | Количество отброшенных пакетов на входе | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2DroppedInput |  | Количество | Average | ClusterId |  |
| InterfaceEth2DroppedInput |  | Количество | Average | Region |  |
| InterfaceEth2ErrorsInput | Количество пакетов с ошибками на входе | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2ErrorsInput |  | Количество | Average | ClusterId |  |
| InterfaceEth2ErrorsInput |  | Количество | Average | Region |  |
| InterfaceEth2OctetsInput | Накопительная сумма трафика к HSM на текущий момент | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2OctetsInput |  | Количество | Average | ClusterId |  |
| InterfaceEth2OctetsInput |  | Количество | Average | Region |  |
| InterfaceEth2PacketsInput | Общее количество пакетов на входе | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2PacketsInput |  | Количество | Average | ClusterId |  |
| InterfaceEth2PacketsInput |  | Количество | Average | Region |  |
| InterfaceEth2DroppedOutput | Количество отброшенных пакетов на выходе | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2DroppedOutput |  | Количество | Average | ClusterId |  |
| InterfaceEth2DroppedOutput |  | Количество | Average | Region |  |
| InterfaceEth2ErrorsOutput | Количество пакетов с ошибками на выходе | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2ErrorsOutput |  | Количество | Average | ClusterId |  |
| InterfaceEth2ErrorsOutput |  | Количество | Average | Region |  |
| InterfaceEth2OctetsOutput | Накопительная сумма трафика от HSM на текущий момент | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2OctetsOutput |  | Количество | Average | ClusterId |  |
| InterfaceEth2OctetsOutput |  | Количество | Average | Region |  |
| InterfaceEth2PacketsOutput | Общее количество пакетов на выходе | Количество | Average | ClusterId, HsmId |  |
| InterfaceEth2PacketsOutput |  | Количество | Average | ClusterId |  |
| InterfaceEth2PacketsOutput |  | Количество | Average | Region |  |

## Ограничения

CloudHSM Classic не поддерживается.
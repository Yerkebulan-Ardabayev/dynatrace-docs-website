---
title: Мониторинг Amazon EBS (Elastic Block Store) (built-in)
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-elastic-block-store-ebs-builtin
scraped: 2026-05-12T11:28:41.657279
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Elastic Block Store. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- |
| builtin:cloud.aws.ebs.latency.read | EBS volume read latency | Секунда | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.latency.write | EBS volume write latency | Секунда | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.ops.consumed | EBS volume consumed OPS | В секунду | autovalue | DDUs |
| builtin:cloud.aws.ebs.ops.read | EBS volume read OPS | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.ops.write | EBS volume write OPS | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.throughput.percent | EBS volume throughput % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.throughput.read | EBS volume read throughput | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.throughput.write | EBS volume write throughput | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.idleTime | EBS volume idle time % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ebs.queue | EBS volume queue length | Количество | autoavgmaxmin | DDUs |
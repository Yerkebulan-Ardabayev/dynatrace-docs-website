...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-transit-gateway
scraped: 2026-05-12T11:30:07.645644
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Transit Gateway. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
TransitGateway является межаккаунтным сервисом: один экземпляр TransitGateway могут отслеживать несколько аккаунтов. Dynatrace хранит метрики раздельно для каждого отслеживаемого аккаунта, который отслеживает один и тот же экземпляр TransitGateway.
...
Основное измерение: `TransitGateway`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| BytesDropCountBlackhole | Количество байт, отброшенных из-за соответствия маршруту чёрной дыры | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| BytesDropCountBlackhole |  | Количество | Sum | TransitGateway | Применимо |
| BytesDropCountNoRoute | Количество байт, отброшенных из-за несоответствия ни одному маршруту | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| BytesDropCountNoRoute |  | Количество | Sum | TransitGateway | Применимо |
| BytesIn | Количество байт, полученных транзитным шлюзом | Байт | Sum | TransitGateway, TransitGatewayAttachment |  |
| BytesIn |  | Байт | Sum | TransitGateway | Применимо |
| BytesOut | Количество пакетов, отправленных транзитным шлюзом | Байт | Sum | TransitGateway, TransitGatewayAttachment |  |
| BytesOut |  | Байт | Sum | TransitGateway | Применимо |
| IGMPJoins | Количество сообщений `IGMP Join`, полученных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| IGMPQueries | Количество сообщений `IGMP Query`, полученных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| IGMPReceives | Количество сообщений `IGMP Leave`, полученных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| MulticastBytesIn | Количество многоадресных байт, полученных транзитным шлюзом | Байт | Sum | TransitGateway, TransitGatewayAttachment |  |
| MulticastBytesOut | Количество многоадресных байт, отправленных транзитным шлюзом | Байт | Sum | TransitGateway, TransitGatewayAttachment |  |
| MulticastPacketDropCount | Количество отброшенных многоадресных пакетов | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| MulticastPacketsIn | Количество многоадресных пакетов, полученных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| MulticastPacketsOut | Количество многоадресных пакетов, отправленных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| NumberofMulticastDomains | Количество многоадресных доменов, настроенных на транзитном шлюзе | Количество | Sum | TransitGateway |  |
| NumberofMulticastGroupMembers | Количество членов многоадресных групп, настроенных на транзитном шлюзе | Количество | Sum | TransitGateway |  |
| PacketDropCountBlackhole | Количество пакетов, отброшенных из-за соответствия маршруту чёрной дыры | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| PacketDropCountBlackhole |  | Количество | Sum | TransitGateway | Применимо |
| PacketDropCountNoRoute | Количество пакетов, отброшенных из-за несоответствия ни одному маршруту | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| PacketDropCountNoRoute |  | Количество | Sum | TransitGateway | Применимо |
| PacketsIn | Количество пакетов, полученных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| PacketsIn |  | Количество | Sum | TransitGateway | Применимо |
| PacketsOut | Количество пакетов, отправленных транзитным шлюзом | Количество | Sum | TransitGateway, TransitGatewayAttachment |  |
| PacketsOut |  | Количество | Sum | TransitGateway | Применимо |
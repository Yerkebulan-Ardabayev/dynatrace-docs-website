...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-service-catalog
scraped: 2026-05-12T11:28:22.122495
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Service Catalog. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| ProvisionedProductLaunch | Количество подготовленных продуктов, запущенных для заданного продукта и артефакта подготовки за указанный период времени | Количество | Sum | Region | Применимо |
| ProvisionedProductLaunch |  | Количество | Sum | Region, ProductId | Применимо |
| ProvisionedProductLaunch |  | Количество | Sum | Region, State | Применимо |
| ProvisionedProductLaunch |  | Количество | Sum | Region, ProvisioningArtifactId | Применимо |
...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-cloudsearch
scraped: 2026-05-12T11:28:52.055007
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon CloudSearch. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| IndexUtilization | Процент использованной ёмкости индекса экземпляра поиска | Процент | Multi | DomainName, ClientId | Применимо |
| Partitions | Количество партиций, по которым распределён индекс | Количество | Multi | DomainName, ClientId | Применимо |
| SearchableDocuments | Количество документов с возможностью поиска в поисковом индексе домена | Количество | Maximum | DomainName, ClientId | Применимо |
| SuccessfulRequests | Количество поисковых запросов, успешно обработанных экземпляром поиска | Количество | Sum | DomainName, ClientId | Применимо |
| SuccessfulRequests |  | Количество | Maximum | DomainName, ClientId | Применимо |
---
title: Мониторинг AWS Chatbot
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-chatbot
scraped: 2026-05-12T11:28:57.940884
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Chatbot. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| EventsProcessed | Количество уведомлений о событиях, полученных AWS Chatbot | Количество | Sum | ConfigurationName | Применимо |
| EventsProcessed |  | Количество | Sum | Region | Применимо |
| EventsThrottled | Количество уведомлений, подвергнутых регулированию | Количество | Sum | Region | Применимо |
| MessageDeliveryFailure | Количество сообщений, которые не удалось доставить чат-клиенту | Количество | Sum | ConfigurationName | Применимо |
| MessageDeliveryFailure |  | Количество | Sum | Region | Применимо |
| MessageDeliverySuccess | Количество сообщений, успешно доставленных чат-клиенту | Количество | Sum | ConfigurationName |  |
| MessageDeliverySuccess |  | Количество | Sum | Region |  |
| UnsupportedEvents | Количество попыток обработки неподдерживаемых событий или сообщений | Количество | Sum | ConfigurationName | Применимо |
| UnsupportedEvents |  | Количество | Sum | Region | Применимо |

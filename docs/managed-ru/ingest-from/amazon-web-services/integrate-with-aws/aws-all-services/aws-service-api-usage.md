---
title: Мониторинг AWS API Usage
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-api-usage
scraped: 2026-05-12T11:29:50.603674
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS API Usage. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `Service`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| CallCount | Количество указанных операций, выполненных в вашем аккаунте | Количество | Sum | Service, Class, Resource, Type | Применимо |
| ResourceCount | Количество указанных ресурсов, работающих в вашем аккаунте | Количество | Average | Service, Class, Resource, Type | Применимо |

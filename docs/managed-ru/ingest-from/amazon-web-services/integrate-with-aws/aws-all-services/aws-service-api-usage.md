---
title: Мониторинг использования AWS API
...
scraped: 2026-03-04T21:36:35.168241
---
...
`Service` является основным измерением.

| Название | Описание | Единица | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| CallCount | Количество указанных операций, выполненных в вашей учётной записи | Count | Sum | Service, Class, Resource, Type | Да |
| ResourceCount | Количество указанных ресурсов, работающих в вашей учётной записи | Count | Average | Service, Class, Resource, Type | Да |

...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-cognito
scraped: 2026-05-12T11:29:41.356413
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Cognito. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
* Для сбора метрик необходимо включить режим аудита для вашего экземпляра Amazon Cognito. В режиме аудита расширенные функции безопасности публикуют метрики в Amazon CloudWatch.
...
| --- | --- | --- | --- | --- | --- |
| AccountTakeOverRisk | Запросы, в которых Amazon Cognito обнаружил риск захвата аккаунта | Количество | Sum | Region, RiskLevel | Применимо |
| CompromisedCredentialsRisk | Запросы, в которых Amazon Cognito обнаружил скомпрометированные учётные данные | Количество | Sum | Region, Operation, UserPoolId, RiskLevel | Применимо |
| NoRisk | Запросы, в которых Amazon Cognito не выявил никаких рисков | Количество | Sum | Region, Operation, UserPoolId | Применимо |
| OverrideBlock | Запросы, заблокированные Amazon Cognito из-за конфигурации, заданной разработчиком | Количество | Sum | Region, RiskLevel | Применимо |
| Risk | Запросы, помеченные Amazon Cognito как рискованные | Количество | Sum | Region, Operation, UserPoolId | Применимо |
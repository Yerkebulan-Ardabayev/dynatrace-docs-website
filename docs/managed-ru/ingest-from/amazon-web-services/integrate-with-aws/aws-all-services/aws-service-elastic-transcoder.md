---
title: Мониторинг Amazon Elastic Transcoder
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-elastic-transcoder
scraped: 2026-05-12T11:30:50.907097
---

# Мониторинг Amazon Elastic Transcoder
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Elastic Transcoder. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `PipelineId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| BilledAudioOutput | Количество тарифицируемых секунд аудио на выходе конвейера | Секунда | Multi | PipelineId |  |
| BilledAudioOutput | Количество тарифицируемых секунд видео HD на выходе конвейера | Секунда | Sum | PipelineId | Применимо |
| BilledHDOutput | Количество тарифицируемых секунд видео SD на выходе конвейера | Секунда | Multi | PipelineId |  |
| BilledHDOutput |  | Секунда | Sum | PipelineId | Применимо |
| BilledSDOutput | Количество тарифицируемых секунд видео SD на выходе конвейера. | Секунда | Multi | PipelineId |  |
| BilledSDOutput |  | Секунда | Sum | PipelineId | Применимо |
...
| JobsCompleted | Количество заданий, выполненных этим конвейером | Количество | Sum | PipelineId | Применимо |
| JobsErrored | Количество заданий, завершившихся сбоем из-за недопустимых входных данных, например запроса на перекодирование файла, отсутствующего в заданной входной корзине | Количество | Sum | PipelineId | Применимо |
| OutputsPerJob | Количество выходных файлов, созданных Elastic Transcoder для задания | Количество | Sum | PipelineId | Применимо |
| StandbyTime | Количество секунд до того, как Elastic Transcoder начал перекодирование задания | Секунда | Multi | PipelineId | Применимо |
| Throttles | Количество случаев, когда Elastic Transcoder автоматически подвергал операцию регулированию | Количество | Sum | Region, Operation | Применимо |

## Ограничения

Amazon Elastic Transcoder не поддерживает тегирование.
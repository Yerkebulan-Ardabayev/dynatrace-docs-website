...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Elemental MediaTailor. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| AdDecisionServer.Ads | Количество рекламных объявлений, включённых в ответы сервера решений по рекламе (ADS) за указанный вами период времени | Количество | Sum | ConfigurationName |  |
| AdDecisionServer.Duration | Общая продолжительность в миллисекундах всех рекламных объявлений, полученных MediaTailor от ADS за указанный вами период времени | Миллисекунда | Average | ConfigurationName |  |
| AdDecisionServer.Errors | Количество ответов с кодом состояния, отличным от HTTP 200, пустых ответов и ответов с истёкшим временем ожидания, полученных MediaTailor от ADS за указанный вами период времени | Количество | Sum | ConfigurationName |  |
| AdDecisionServer.FillRate | Простое среднее значение долей, на которые ответы от ADS заполняли соответствующие отдельные рекламные блоки за указанный вами период времени | Количество | Average | ConfigurationName |  |
| AdDecisionServer.Timeouts | Количество запросов к ADS с истёкшим временем ожидания за указанный вами период времени | Количество | Sum | ConfigurationName |  |
| AdNotReady | Количество случаев, когда ADS указывал на рекламное объявление, ещё не перекодированное внутренним сервисом перекодирования, за указанный вами период времени | Количество | Sum | ConfigurationName |  |
| Avail.Duration | Общая продолжительность в миллисекундах всех рекламных блоков, обнаруженных MediaTailor за указанный вами период времени | Миллисекунда | Average | ConfigurationName |  |
| Avail.FillRate | Простое среднее значение долей, на которые MediaTailor заполнял отдельные рекламные блоки за указанный вами период времени | Количество | Average | ConfigurationName | Применимо |
| Avail.FilledDuration | Общая продолжительность в миллисекундах времени рекламных блоков, которое MediaTailor заполнил рекламой за указанный вами период времени | Миллисекунда | Average | ConfigurationName | Применимо |
| GetManifest.Errors | Количество ошибок, полученных во время генерации манифестов MediaTailor за указанный вами период времени | Количество | Sum | ConfigurationName |  |
| Origin.Errors | Количество ответов с кодом состояния, отличным от HTTP 200, и ответов с истёкшим временем ожидания, полученных MediaTailor от сервера-источника за указанный вами период времени | Количество | Sum | ConfigurationName |  |
| Origin.Timeouts | Количество запросов к серверу-источнику с истёкшим временем ожидания за указанный вами период времени | Количество | Sum | ConfigurationName |  |

## Ограничения

`AdDecisionServer.FillRate` и `Avail.FillRate` должны выражаться в процентах, однако AWS сообщает их как значение от `0` до `1`. Пока они определены как **значения Count**.
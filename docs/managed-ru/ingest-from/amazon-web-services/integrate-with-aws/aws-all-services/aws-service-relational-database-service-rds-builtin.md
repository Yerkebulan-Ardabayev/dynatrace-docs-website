---
title: Мониторинг Amazon RDS (Relational Database Service) (built-in)
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Relational Database Service (Amazon RDS). Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- |
| builtin:cloud.aws.rds.cpu.usage | RDS CPU usage % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.latency.read | RDS read latency | Секунда | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.latency.write | RDS write latency | Секунда | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.memory.freeable | RDS freeable memory | Байт | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.memory.swap | RDS swap usage | Байт | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.net.rx | RDS network received throughput | Байт в секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.net.tx | RDS network transmitted throughput | Байт в секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.ops.read | RDS read IOPS | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.ops.write | RDS write IOPS | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.throughput.read | RDS read throughput | Байт в секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.throughput.write | RDS write throughput | Байт в секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.connections | RDS connections | Количество | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.free | RDS free storage space % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.rds.restarts | RDS restarts | Количество | autovalue | DDUs |
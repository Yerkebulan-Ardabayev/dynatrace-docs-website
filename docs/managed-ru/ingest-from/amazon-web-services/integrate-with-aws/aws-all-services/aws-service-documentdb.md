---
title: Мониторинг Amazon DocumentDB (with MongoDB compatibility)
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-documentdb
scraped: 2026-05-12T11:28:54.118913
---

# Мониторинг Amazon DocumentDB (with MongoDB compatibility)
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon DocumentDB. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Поддерживаются только метрики из пространства имён `AWS/DocDB`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| BackupRetentionPeriodStorageUsed | Общий объём хранилища резервных копий в ГиБ, используемого для поддержки функции восстановления на момент времени в пределах окна хранения Amazon DocumentDB | Байт | Multi | DBClusterIdentifier | Применимо |
| BackupRetentionPeriodStorageUsed |  | Байт | Multi | Region, EngineName |  |
| BufferCacheHitRatio | Процент запросов, обслуженных буферным кэшем | Процент | Multi | Region, DBInstanceIdentifier |  |
| BufferCacheHitRatio |  | Процент | Multi | DBClusterIdentifier, Role |  |
| BufferCacheHitRatio |  | Процент | Multi | DBClusterIdentifier | Применимо |
| CPUUtilization | Процент CPU, используемого экземпляром | Процент | Multi | Region, DBInstanceIdentifier |  |
| CPUUtilization |  | Процент | Multi | DBClusterIdentifier, Role |  |
| CPUUtilization |  | Процент | Multi | DBClusterIdentifier | Применимо |
| ChangeStreamLogSize | Объём хранилища, используемого вашим кластером для хранения журнала потока изменений, в мегабайтах | Мегабайт | Multi | Region, DBInstanceIdentifier |  |
| ChangeStreamLogSize |  | Мегабайт | Multi | DBClusterIdentifier, Role |  |
| ChangeStreamLogSize |  | Мегабайт | Multi | DBClusterIdentifier |  |
| DBClusterReplicaLagMaximum | Максимальная величина отставания в миллисекундах между первичным экземпляром и каждым экземпляром Amazon DocumentDB в кластере | Миллисекунда | Multi | Region, DBInstanceIdentifier |  |
| DBClusterReplicaLagMaximum |  | Миллисекунда | Multi | DBClusterIdentifier |  |
| DBClusterReplicaLagMaximum |  | Миллисекунда | Multi | DBClusterIdentifier, Role |  |
| DBClusterReplicaLagMinimum | Минимальная величина отставания в миллисекундах между первичным экземпляром и каждым экземпляром реплики в кластере | Миллисекунда | Multi | Region, DBInstanceIdentifier |  |
| DBClusterReplicaLagMinimum |  | Миллисекунда | Multi | DBClusterIdentifier |  |
| DBClusterReplicaLagMinimum |  | Миллисекунда | Multi | DBClusterIdentifier, Role |  |
| DBInstanceReplicaLag | Величина отставания в миллисекундах при репликации обновлений с первичного экземпляра на экземпляр реплики | Миллисекунда | Multi | Region, DBInstanceIdentifier |  |
| DBInstanceReplicaLag |  | Миллисекунда | Multi | DBClusterIdentifier |  |
| DBInstanceReplicaLag |  | Миллисекунда | Multi | DBClusterIdentifier, Role |  |
| DatabaseConnections | Количество подключений, открытых на экземпляре, измеряемое с частотой раз в минуту | Количество | Multi | Region, DBInstanceIdentifier |  |
| DatabaseConnections |  | Количество | Multi | DBClusterIdentifier, Role |  |
| DatabaseConnections |  | Количество | Multi | DBClusterIdentifier | Применимо |
| DiskQueueDepth | Количество незавершённых запросов чтения/записи, ожидающих доступа к диску | Количество | Average | Region, DBInstanceIdentifier |  |
| DiskQueueDepth |  | Количество | Average | DBClusterIdentifier,Role |  |
| DiskQueueDepth |  | Количество | Average | DBClusterIdentifier |  |
| EngineUptime | Время работы экземпляра в секундах | Секунда | Multi | DBClusterIdentifier, Role |  |
| EngineUptime |  | Секунда | Multi | DBClusterIdentifier |  |
| EngineUptime |  | Секунда | Multi | Region, DBInstanceIdentifier |  |
| FreeLocalStorage | Объём хранилища, доступного каждому экземпляру для временных таблиц и журналов | Байт | Multi | Region, DBInstanceIdentifier |  |
| FreeLocalStorage |  | Байт | Multi | DBClusterIdentifier, Role |  |
| FreeLocalStorage |  | Байт | Multi | DBClusterIdentifier |  |
| FreeableMemory | Объём доступной оперативной памяти в байтах | Байт | Multi | Region, DBInstanceIdentifier |  |
| FreeableMemory |  | Байт | Multi | DBClusterIdentifier, Role |  |
| FreeableMemory |  | Байт | Multi | DBClusterIdentifier |  |
| NetworkReceiveThroughput | Объём сетевой пропускной способности в байтах в секунду, полученной от клиентов каждым экземпляром в кластере | Байт в секунду | Multi | Region, DBInstanceIdentifier |  |
| NetworkReceiveThroughput |  | Байт в секунду | Multi | DBClusterIdentifier, Role |  |
| NetworkReceiveThroughput |  | Байт в секунду | Multi | DBClusterIdentifier | Применимо |
| NetworkThroughput | Объём сетевой пропускной способности в байтах в секунду, как полученной от клиентов, так и переданной им каждым экземпляром в кластере Amazon DocumentDB | Байт в секунду | Multi | Region, DBInstanceIdentifier |  |
| NetworkThroughput |  | Байт в секунду | Multi | DBClusterIdentifier, Role |  |
| NetworkThroughput |  | Байт в секунду | Multi | DBClusterIdentifier | Применимо |
| NetworkTransmitThroughput | Объём сетевой пропускной способности в байтах в секунду, отправленной клиентам каждым экземпляром в кластере | Байт в секунду | Multi | Region, DBInstanceIdentifier |  |
| NetworkTransmitThroughput |  | Байт в секунду | Multi | DBClusterIdentifier, Role |  |
| NetworkTransmitThroughput |  | Байт в секунду | Multi | DBClusterIdentifier | Применимо |
| ReadIOPS | Среднее количество операций ввода-вывода чтения с диска в секунду | Количество в секунду | Multi | Region, DBInstanceIdentifier |  |
| ReadIOPS |  | Количество в секунду | Multi | DBClusterIdentifier, Role |  |
| ReadIOPS |  | Количество в секунду | Multi | DBClusterIdentifier | Применимо |
| ReadLatency | Среднее время, затрачиваемое на одну дисковую операцию ввода-вывода | Секунда | Multi | Region, DBInstanceIdentifier | Применимо |
| ReadLatency |  | Секунда | Multi | DBClusterIdentifier, Role |  |
| ReadLatency |  | Секунда | Multi | DBClusterIdentifier | Применимо |
| ReadThroughput | Среднее количество байт, считываемых с диска в секунду | Байт в секунду | Multi | Region, DBInstanceIdentifier |  |
| ReadThroughput |  | Байт в секунду | Multi | DBClusterIdentifier, Role |  |
| ReadThroughput |  | Байт в секунду | Multi | DBClusterIdentifier | Применимо |
| SnapshotStorageUsed | Общий объём хранилища резервных копий в ГиБ, занятого всеми снимками для данного кластера Amazon DocumentDB за пределами окна хранения резервных копий | Байт | Multi | Region, EngineName |  |
| SnapshotStorageUsed |  | Байт | Multi | DBClusterIdentifier | Применимо |
| SwapUsage | Объём пространства подкачки, используемого на экземпляре | Байт | Multi | Region, DBInstanceIdentifier |  |
| SwapUsage |  | Байт | Multi | DBClusterIdentifier, Role |  |
| SwapUsage |  | Байт | Multi | DBClusterIdentifier |  |
| TotalBackupStorageBilled | Общий объём хранилища резервных копий в ГиБ, за который начисляется плата для данного кластера Amazon DocumentDB | Байт | Multi | Region, EngineName |  |
| TotalBackupStorageBilled |  | Байт | Multi | DBClusterIdentifier | Применимо |
| VolumeBytesUsed | Объём хранилища, используемого вашим кластером, в байтах | Байт | Average | DBClusterIdentifier | Применимо |
| VolumeReadIOPs | Среднее количество оплачиваемых операций ввода-вывода чтения из тома кластера; регистрируется с интервалом в 5 минут | Количество | Average | DBClusterIdentifier | Применимо |
| VolumeWriteIOPs | Среднее количество оплачиваемых операций ввода-вывода записи из тома кластера; регистрируется с интервалом в 5 минут | Количество | Average | DBClusterIdentifier | Применимо |
| WriteIOPS | Среднее количество операций ввода-вывода записи на диск в секунду | Количество в секунду | Multi | Region, DBInstanceIdentifier |  |
| WriteIOPS |  | Количество в секунду | Multi | DBClusterIdentifier, Role |  |
| WriteIOPS |  | Количество в секунду | Multi | DBClusterIdentifier | Применимо |
| WriteLatency | Среднее время в миллисекундах, затрачиваемое на одну дисковую операцию ввода-вывода | Секунда | Multi | Region, DBInstanceIdentifier |  |
| WriteLatency |  | Секунда | Multi | DBClusterIdentifier, Role |  |
| WriteLatency |  | Секунда | Multi | DBClusterIdentifier | Применимо |
| WriteThroughput | Среднее количество байт, записываемых на диск в секунду | Байт в секунду | Multi | Region, DBInstanceIdentifier |  |
| WriteThroughput |  | Байт в секунду | Multi | DBClusterIdentifier, Role |  |
| WriteThroughput |  | Байт в секунду | Multi | DBClusterIdentifier | Применимо |
...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-systems-manager-run-command
scraped: 2026-05-12T11:31:08.737821
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Systems Manager Run Command. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| CommandsDeliveryTimedOut | Количество команд с конечным статусом `Delivery Timed Out` | Количество | Sum | Region | Применимо |
| CommandsFailed | Количество команд с конечным статусом `Failed` | Количество | Sum | Region | Применимо |
| CommandsSucceeded | Количество команд с конечным статусом `Success` | Количество | Sum | Region | Применимо |
---
title: Мониторинг Amazon Rekognition
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-rekognition
scraped: 2026-05-12T11:28:11.802414
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Rekognition. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| DetectedFaceCount | Количество лиц, обнаруженных с помощью операции `IndexFaces` или `DetectFaces` | Количество | Sum | Region, Operation | Применимо |
| DetectedFaceCount |  | Количество | Sum | Region | Применимо |
| DetectedLabelCount | Количество меток, обнаруженных с помощью операции `DetectLabels` | Количество | Sum | Region, Operation | Применимо |
| DetectedLabelCount |  | Количество | Sum | Region |  |
| ResponseTime | Время в миллисекундах, за которое Rekognition вычисляет ответ | Миллисекунда | Multi | Region, Operation | Применимо |
| ResponseTime |  | Миллисекунда | Multi | Region | Применимо |
| ServerErrorCount | Количество серверных ошибок. Диапазон кодов ответа для серверной ошибки: 500-599. | Количество | Sum | Region, Operation | Применимо |
| ServerErrorCount |  | Количество | Sum | Region | Применимо |
| SuccessfulRequestCount | Количество успешных запросов. Диапазон кодов ответа для успешного запроса: 200-299. | Количество | Sum | Region, Operation | Применимо |
| SuccessfulRequestCount |  | Количество | Sum | Region | Применимо |
| ThrottledCount | Количество запросов, подвергнутых регулированию | Количество | Sum | Region, Operation | Применимо |
| ThrottledCount |  | Количество | Sum | Region | Применимо |
| UserErrorCount | Количество пользовательских ошибок (например, неверные параметры, неверное изображение или отсутствие прав). Диапазон кодов ответа для пользовательской ошибки: 400-499. | Количество | Sum | Region, Operation | Применимо |
| UserErrorCount |  | Количество | Sum | Region | Применимо |
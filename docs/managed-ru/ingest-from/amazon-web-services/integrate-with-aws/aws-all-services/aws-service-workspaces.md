...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-workspaces
scraped: 2026-05-12T11:30:54.320250
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon WorkSpaces. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `WorkspaceId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| Available | Количество WorkSpaces, вернувших исправный статус | Количество | Sum | WorkspaceId | Применимо |
| Available |  | Количество | Sum | Region, DirectoryId | Применимо |
| ConnectionAttempt | Количество попыток подключения | Количество | Sum | WorkspaceId | Применимо |
| ConnectionAttempt |  | Количество | Sum | Region, DirectoryId | Применимо |
| ConnectionFailure | Количество неудачных подключений | Количество | Sum | WorkspaceId | Применимо |
| ConnectionFailure |  | Количество | Sum | Region, DirectoryId | Применимо |
| ConnectionSuccess | Количество успешных подключений | Количество | Sum | WorkspaceId | Применимо |
| ConnectionSuccess |  | Количество | Sum | Region, DirectoryId | Применимо |
| InSessionLatency | Время кругового пути (RTT) между клиентом WorkSpaces и WorkSpace | Миллисекунда | Multi | WorkspaceId | Применимо |
| InSessionLatency |  | Миллисекунда | Multi | Region, DirectoryId | Применимо |
| Maintenance | Количество WorkSpaces, находящихся на обслуживании | Количество | Sum | WorkspaceId | Применимо |
| Maintenance |  | Количество | Sum | Region, DirectoryId | Применимо |
| SessionDisconnect | Количество закрытых подключений, включая подключения, закрытые пользователем, и неудачные подключения | Количество | Sum | WorkspaceId | Применимо |
| SessionDisconnect |  | Количество | Sum | Region, DirectoryId | Применимо |
| SessionLaunchTime | Время, необходимое для инициации сессии WorkSpaces | Секунда | Multi | WorkspaceId | Применимо |
| SessionLaunchTime |  | Секунда | Multi | Region, DirectoryId | Применимо |
| Stopped | Количество остановленных WorkSpaces | Количество | Sum | WorkspaceId | Применимо |
| Stopped |  | Количество | Sum | Region, DirectoryId | Применимо |
| Unhealthy | Количество WorkSpaces, вернувших неисправный статус | Количество | Sum | WorkspaceId | Применимо |
| Unhealthy |  | Количество | Sum | Region, DirectoryId | Применимо |
| UserConnected | Количество WorkSpaces с подключённым пользователем | Количество | Sum | WorkspaceId |  |
| UserConnected |  | Количество | Sum | Region, DirectoryId | Применимо |
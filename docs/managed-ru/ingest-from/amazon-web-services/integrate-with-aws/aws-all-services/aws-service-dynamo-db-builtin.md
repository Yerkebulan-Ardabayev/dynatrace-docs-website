---
title: Мониторинг Amazon DynamoDB (built-in)
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-dynamo-db-builtin
scraped: 2026-05-12T11:28:37.543656
---
...
DynamoDB **не** поддерживает зоны управления.
...
| --- | --- | --- | --- | --- |
| builtin:cloud.aws.dynamo.capacityUnits.consumed.read | DynamoDB read capacity units | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.capacityUnits.consumed.write | DynamoDB write capacity units | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.capacityUnits.provisioned.read | DynamoDB provisioned read capacity units | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.capacityUnits.provisioned.write | DynamoDB provisioned write capacity units | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.capacityUnits.read | DynamoDB read capacity units % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.dynamo.capacityUnits.write | DynamoDB write capacity units % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.dynamo.errors.system | DynamoDB number of requests with HTTP 500 status code | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.errors.user | DynamoDB number of requests with HTTP 400 status code | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.requests.latency | DynamoDB number of successful request latency for operation | Миллисекунда | autoavgmaxmin | DDUs |
| builtin:cloud.aws.dynamo.requests.returnedItems | DynamoDB number of items returned by operation | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.requests.throttled | DynamoDB number of throttled requests for operation | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.throttledEvents.read | DynamoDB number of read throttled events | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.throttledEvents.write | DynamoDB number of write throttled events | Количество | autovalue | DDUs |
| builtin:cloud.aws.dynamo.tables | Number of tables for AvailabilityZone | Количество | autoavgmaxmin | DDUs |
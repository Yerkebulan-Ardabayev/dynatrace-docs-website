---
title: Мониторинг Amazon Lex
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-lex
scraped: 2026-05-12T11:29:06.468953
---

# Мониторинг Amazon Lex
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Lex. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `BotName`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| MissedUtteranceCount | Количество высказываний, которые не были распознаны за указанный период | Количество | Sum | BotName, BotVersion, InputMode, Operation |  |
| MissedUtteranceCount |  | Количество | Sum | BotName, BotAlias, InputMode, Operation | Применимо |
| MissedUtteranceCount |  | Количество | Sum | BotName, BotAlias, Operation | Применимо |
| MissedUtteranceCount |  | Количество | Sum | BotName, BotVersion, Operation |  |
| RuntimeRequestCount | Количество запросов среды выполнения за указанный период | Количество | Sum | BotName, BotVersion, InputMode, Operation |  |
| RuntimeRequestCount |  | Количество | Sum | BotName, BotAlias, Operation | Применимо |
| RuntimeRequestCount |  | Количество | Sum | BotName, BotAlias, InputMode, Operation | Применимо |
| RuntimeRequestCount |  | Количество | Sum | BotName, BotVersion, Operation |  |
| RuntimeSuccessfulRequestLatency | Задержка для успешных запросов между моментом отправки запроса и моментом возврата ответа | Миллисекунда | Multi | BotName, BotVersion, InputMode, Operation |  |
| RuntimeSuccessfulRequestLatency |  | Миллисекунда | Multi | BotName, BotAlias, Operation | Применимо |
| RuntimeSuccessfulRequestLatency |  | Миллисекунда | Multi | BotName, BotAlias, InputMode, Operation | Применимо |
| RuntimeSuccessfulRequestLatency |  | Миллисекунда | Multi | BotName, BotVersion, Operation |  |

...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-simple-workflow-service-swf
scraped: 2026-05-12T11:28:14.376508
---

# Мониторинг Amazon SWF (Simple Workflow Service)
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Simple Workflow Service (Amazon SWF). Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `Domain`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| ActivityTaskScheduleToCloseTime | Интервал времени в миллисекундах между моментом, когда действие было запланировано, и моментом, когда оно было закрыто | Миллисекунда | Multi | Domain, ActivityTypeName, ActivityTypeVersion | Применимо |
| ActivityTaskScheduleToStartTime | Интервал времени в миллисекундах между моментом, когда задача действия была запланирована, и моментом, когда она была запущена | Миллисекунда | Multi | Domain, ActivityTypeName, ActivityTypeVersion | Применимо |
| ActivityTaskStartToCloseTime | Интервал времени в миллисекундах между моментом, когда задача действия была запущена, и моментом, когда она была закрыта | Миллисекунда | Multi | Domain, ActivityTypeName, ActivityTypeVersion | Применимо |
| ActivityTasksCanceled | Количество отменённых задач действий | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| ActivityTasksCompleted | Количество завершённых задач действий | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| ActivityTasksFailed | Количество задач действий, завершившихся сбоем | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| ConsumedCapacity | Количество запросов в секунду | Количество | Sum | Region, APIName |  |
| ConsumedCapacity |  | Количество | Sum | Region, DecisionName | Применимо |
| DecisionTaskScheduleToStartTime | Интервал времени в миллисекундах между моментом, когда задача принятия решения была запланирована, и моментом, когда она была взята исполнителем и запущена | Миллисекунда | Multi | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| DecisionTaskStartToCloseTime | Интервал времени в миллисекундах между моментом, когда задача принятия решения была запущена, и моментом, когда она была закрыта | Миллисекунда | Multi | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| DecisionTasksCompleted | Количество завершённых задач принятия решений | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion |  |
| PendingTasks | Количество ожидающих задач за интервал в одну минуту для конкретного списка задач | Количество | Sum | Domain |  |
| ProvisionedBucketSize | Количество доступных запросов в секунду | Количество | Minimum | Region, APIName |  |
| ProvisionedBucketSize |  | Количество | Minimum | Region, DecisionName |  |
| ProvisionedRefillRate | Количество запросов в секунду, допускаемых в сегмент | Количество | Minimum | Region, APIName |  |
| ProvisionedRefillRate |  | Количество | Minimum | Region, DecisionName |  |
| ScheduledActivityTasksTimedOutOnClose | Количество задач действий, которые были запланированы, но завершились по тайм-ауту при закрытии | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| ScheduledActivityTasksTimedOutOnStart | Количество задач действий, которые были запланированы, но завершились по тайм-ауту при запуске | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| StartedActivityTasksTimedOutOnClose | Количество задач действий, которые были запущены, но завершились по тайм-ауту при закрытии | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| StartedActivityTasksTimedOutOnHeartbeat | Количество задач действий, которые были запущены, но завершились по тайм-ауту из-за тайм-аута контрольного сигнала | Количество | Sum | Domain, ActivityTypeName, ActivityTypeVersion |  |
| StartedDecisionTasksTimedOutOnClose | Количество задач принятия решений, которые были запущены, но завершились по тайм-ауту при закрытии | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion |  |
| ThrottledEvents | Количество запросов, подвергнутых регулированию | Количество | Sum | Region, APIName |  |
| ThrottledEvents |  | Количество | Sum | Region, DecisionName | Применимо |
| WorkflowStartToCloseTime | Время в миллисекундах между моментом запуска рабочего процесса и моментом его закрытия | Миллисекунда | Multi | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| WorkflowsCanceled | Количество отменённых рабочих процессов | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| WorkflowsCompleted | Количество завершённых рабочих процессов | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| WorkflowsContinuedAsNew | Количество рабочих процессов, продолженных как новые | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| WorkflowsFailed | Количество рабочих процессов, завершившихся сбоем | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| WorkflowsTerminated | Количество прекращённых рабочих процессов | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
| WorkflowsTimedOut | Количество рабочих процессов, завершившихся по тайм-ауту по любой причине | Количество | Sum | Domain, WorkflowTypeName, WorkflowTypeVersion | Применимо |
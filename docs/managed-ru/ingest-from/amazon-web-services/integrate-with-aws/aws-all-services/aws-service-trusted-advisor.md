---
title: Мониторинг AWS Trusted Advisor
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-trusted-advisor
scraped: 2026-05-12T11:31:05.618701
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS Trusted Advisor. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Для AWS Trusted Advisor на странице обзора группы пользовательских устройств нет экземпляров (пользовательских устройств). Метрики сервиса находятся в разделе **Further details** страницы обзора группы пользовательских устройств.

Метрики CloudWatch AWS Trusted Advisor доступны **только** для планов поддержки Business и Enterprise.
...
| --- | --- | --- | --- | --- |
| GreenChecks | Количество | Sum | Region, Category |  |
| RedChecks | Количество | Sum | Region, Category | Применимо |
| RedResources | Количество | Sum | Region, CheckName | Применимо |
| ServiceLimitUsage | Процент | Multi | Region, ServiceLimit, ServiceName | Применимо |
| YellowChecks | Количество | Sum | Region, Category | Применимо |
| YellowResources | Количество | Sum | Region, CheckName | Применимо |
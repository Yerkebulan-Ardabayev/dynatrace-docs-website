...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-translate
scraped: 2026-05-12T11:29:17.674723
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Translate. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| CharacterCount | Количество тарифицируемых символов в запросах | Количество | Sum | Region, LanguagePair, Operation | Применимо |
| ResponseTime | Время, затраченное на ответ на запрос | Миллисекунда | Multi | Region, LanguagePair, Operation | Применимо |
| ServerErrorCount | Количество серверных ошибок. Диапазон кодов HTTP-ответа для серверной ошибки: `500`-`599` | Количество | Sum | Region, Operation | Применимо |
| SuccessfulRequestCount | Количество успешных запросов на перевод. Код ответа для успешного запроса: `200`-`299` | Количество | Sum | Region, Operation | Применимо |
| ThrottledCount | Количество запросов, подвергнутых регулированию | Количество | Sum | Region, Operation | Применимо |
| UserErrorCount | Количество возникших пользовательских ошибок. Диапазон кодов HTTP-ответа для пользовательской ошибки: `400`-`499` | Количество | Sum | Region, Operation | Применимо |
...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-opsworks
scraped: 2026-05-12T11:30:14.804343
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS OpsWorks. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `StackId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| cpu\_idle | Процент времени, в течение которого CPU простаивает | Процент | Multi | StackId | Применимо |
| cpu\_idle |  | Процент | Multi | Region, InstanceId | Применимо |
| cpu\_idle |  | Процент | Multi | Region, LayerId | Применимо |
| cpu\_nice | Процент времени, в течение которого CPU обрабатывает процессы с положительным значением `nice`, имеющие более низкий приоритет планирования | Процент | Multi | StackId | Применимо |
| cpu\_nice |  | Процент | Multi | Region, InstanceId |  |
| cpu\_nice |  | Процент | Multi | Region, LayerId |  |
| cpu\_steal | Процент времени, в течение которого экземпляр ожидает выделения гипервизором физических ресурсов CPU | Процент | Multi | StackId | Применимо |
| cpu\_steal |  | Процент | Multi | Region, InstanceId | Применимо |
| cpu\_steal |  | Процент | Multi | Region, LayerId | Применимо |
| cpu\_system | Процент времени, в течение которого CPU обрабатывает системные операции | Процент | Multi | StackId | Применимо |
| cpu\_system |  | Процент | Multi | Region, InstanceId |  |
| cpu\_system |  | Процент | Multi | Region, LayerId |  |
| cpu\_user | Процент времени, в течение которого CPU обрабатывает пользовательские операции | Процент | Multi | StackId | Применимо |
| cpu\_user |  | Процент | Multi | Region, InstanceId | Применимо |
| cpu\_user |  | Процент | Multi | Region, LayerId | Применимо |
| cpu\_waitio | Процент времени, в течение которого CPU ожидает операций ввода-вывода | Процент | Multi | StackId | Применимо |
| cpu\_waitio |  | Процент | Multi | Region, InstanceId |  |
| cpu\_waitio |  | Процент | Multi | Region, LayerId |  |
| load\_1 | Средняя нагрузка за одноминутное окно | None | Multi | StackId |  |
| load\_1 |  | None | Multi | Region, InstanceId |  |
| load\_1 |  | None | Multi | Region, LayerId |  |
| load\_5 | Средняя нагрузка за пятиминутное окно | None | Multi | StackId | Применимо |
| load\_5 |  | None | Multi | Region, InstanceId | Применимо |
| load\_5 |  | None | Multi | Region, LayerId | Применимо |
| load\_15 | Средняя нагрузка за 15-минутное окно | None | Multi | StackId |  |

...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-eventbridge
scraped: 2026-05-12T11:29:20.524256
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon EventBridge. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Сервис Amazon EventBridge состоит из одной или нескольких шин событий. Существует **шина событий по умолчанию** с метриками в масштабе всего сервиса, и при желании можно создавать дополнительные шины событий, называемые **пользовательскими шинами событий**.
Метрики шины событий по умолчанию можно просматривать в разделе **Further details** на странице обзора **группы пользовательских устройств**. Если создать дополнительные шины событий, метрики пользовательской шины событий появятся в разделе **Further details** на странице обзора **пользовательского устройства**.
...
Основное измерение: `EventBusName`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| DeadLetterInvocations | Количество случаев, когда цель правила не вызывается в ответ на событие | Количество | Sum | EventBusName, RuleName | Применимо |
| DeadLetterInvocations |  | Количество | Sum | Region, RuleName | Применимо |
| DeadLetterInvocations |  | Количество | Sum | Region | Применимо |
| FailedInvocations | Количество вызовов, окончательно завершившихся сбоем | Количество | Sum | EventBusName, RuleName | Применимо |
| FailedInvocations |  | Количество | Sum | Region, RuleName | Применимо |
| FailedInvocations |  | Количество | Sum | Region | Применимо |
| Invocations | Количество случаев вызова цели для правила в ответ на событие | Количество | Sum | EventBusName, RuleName | Применимо |
| Invocations |  | Количество | Sum | Region, RuleName | Применимо |
| Invocations |  | Количество | Sum | Region | Применимо |
| MatchedEvents | Количество событий, совпавших с каким-либо правилом | Количество | Sum | Region | Применимо |
| ThrottledRules | Количество сработавших правил, подвергаемых регулированию | Количество | Sum | EventBusName, RuleName | Применимо |
| ThrottledRules |  | Количество | Sum | Region, RuleName | Применимо |
| ThrottledRules |  | Количество | Sum | Region | Применимо |
| TriggeredRules | Количество сработавших правил, совпавших с каким-либо событием | Количество | Sum | EventBusName, RuleName | Применимо |
| TriggeredRules |  | Количество | Sum | Region, RuleName | Применимо |
| TriggeredRules |  | Количество | Sum | Region | Применимо |

## Ограничения

Amazon EventBridge отправляет метрики `Invocations` в CloudWatch только при ненулевом значении. Дополнительные сведения см. в [документации AWS](https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-monitoring-cloudwatch-metrics.html).
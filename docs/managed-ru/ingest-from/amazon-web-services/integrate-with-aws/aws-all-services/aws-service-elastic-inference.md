...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-elastic-inference
scraped: 2026-05-12T11:29:24.530525
---

# Мониторинг Amazon Elastic Inference
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Elastic Inference. Можно просматривать графики по каждому экземпляру сервиса с набором измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
* **InstanceId** фильтрует данные по экземпляру, к которому подключён ускоритель Elastic Inference.

Основное измерение: `InstanceId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| AcceleratorHealthCheckFailed | Сообщает, прошёл ли ускоритель Elastic Inference проверку работоспособности статуса за последнюю минуту | Количество | Sum | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| AcceleratorHealthCheckFailed |  | Количество | Multi | InstanceId, ElasticInferenceAcceleratorId |  |
| AcceleratorInferenceWithClientErrorCount | Количество запросов на вывод, достигших ускорителя Elastic Inference за последнюю минуту и приведших к ошибке 4xx | Количество | Sum | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| AcceleratorInferenceWithClientErrorCount |  | Количество | Multi | InstanceId, ElasticInferenceAcceleratorId |  |
| AcceleratorInferenceWithServerErrorCount | Количество запросов на вывод, достигших ускорителя Elastic Inference за последнюю минуту и приведших к ошибке 5xx | Количество | Sum | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| AcceleratorInferenceWithServerErrorCount |  | Количество | Multi | InstanceId, ElasticInferenceAcceleratorId |  |
| AcceleratorMemoryUsage | Объём памяти ускорителя Elastic Inference, использованный за последнюю минуту | Байт | Multi | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| AcceleratorSuccessfulInferenceCount | Количество успешных запросов на вывод, достигших ускорителя Elastic Inference за последнюю минуту | Количество | Sum | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| AcceleratorSuccessfulInferenceCount |  | Количество | Multi | InstanceId, ElasticInferenceAcceleratorId |  |
| AcceleratorTotalInferenceCount | Количество запросов на вывод, достигших ускорителя Elastic Inference за последнюю минуту | Количество | Sum | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| AcceleratorTotalInferenceCount |  | Количество | Multi | InstanceId, ElasticInferenceAcceleratorId |  |
| AcceleratorUtilization | Процент ускорителя Elastic Inference, использованный для вычислений за последнюю минуту | Процент | Multi | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| ConnectivityCheckFailed | Сообщает, активно ли подключение к ускорителю Elastic Inference или произошёл сбой за последнюю минуту | Количество | Sum | InstanceId, ElasticInferenceAcceleratorId | Применимо |
| ConnectivityCheckFailed |  | Количество | Multi | InstanceId, ElasticInferenceAcceleratorId |  |
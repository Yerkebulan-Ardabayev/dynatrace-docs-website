...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-waf-classic
scraped: 2026-05-12T11:30:12.860490
---

# Мониторинг AWS WAF Classic
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS WAF Classic. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `WebACL`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| AllowedRequests | Количество разрешённых веб-запросов | Количество | Sum | WebACL, Region, Rule | Применимо |
| AllowedRequests |  | Количество | Sum | WebACL, Region, RuleGroup | Применимо |
| AllowedRequests |  | Количество | Sum | Region, Rule, RuleGroup | Применимо |
| AllowedRequests |  | Количество | Sum | WebACL, Rule | Применимо |
| AllowedRequests |  | Количество | Sum | WebACL, RuleGroup | Применимо |
| BlockedRequests | Количество заблокированных веб-запросов | Количество | Sum | WebACL, Region, Rule | Применимо |
| BlockedRequests |  | Количество | Sum | WebACL, Region, RuleGroup | Применимо |
| BlockedRequests |  | Количество | Sum | Region, Rule, RuleGroup | Применимо |
| BlockedRequests |  | Количество | Sum | WebACL, Rule | Применимо |
| BlockedRequests |  | Количество | Sum | WebACL, RuleGroup | Применимо |
| CountedRequests | Количество подсчитанных веб-запросов | Количество | Sum | WebACL, Region, Rule | Применимо |
| CountedRequests |  | Количество | Sum | WebACL, Region, RuleGroup | Применимо |
| CountedRequests |  | Количество | Sum | Region, Rule, RuleGroup | Применимо |
| CountedRequests |  | Количество | Sum | WebACL, Rule | Применимо |
| CountedRequests |  | Количество | Sum | WebACL, RuleGroup | Применимо |
| PassedRequests | Количество пропущенных запросов для группы правил | Количество | Sum | WebACL, Region, Rule | Применимо |
| PassedRequests |  | Количество | Sum | WebACL, Region, RuleGroup | Применимо |
| PassedRequests |  | Количество | Sum | Region, Rule, RuleGroup | Применимо |
| PassedRequests |  | Количество | Sum | WebACL, Rule | Применимо |
| PassedRequests |  | Количество | Sum | WebACL, RuleGroup | Применимо |

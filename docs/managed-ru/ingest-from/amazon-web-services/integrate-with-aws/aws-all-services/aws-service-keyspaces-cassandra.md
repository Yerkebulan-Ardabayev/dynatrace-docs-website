---
title: Мониторинг Amazon Keyspaces (Cassandra)
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-keyspaces-cassandra
scraped: 2026-05-12T11:29:54.495465
---

# Мониторинг Amazon Keyspaces (Cassandra)
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Keyspaces. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `Keyspace`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| AccountMaxReads | Максимальное количество единиц ёмкости чтения, которые может использовать аккаунт | Количество | Maximum | Region | Применимо |
| AccountMaxTableLevelReads | Максимальное количество единиц ёмкости чтения, которые может использовать таблица аккаунта | Количество | Maximum | Region | Применимо |
| AccountMaxTableLevelWrites | Максимальное количество единиц ёмкости записи, которые может использовать таблица аккаунта | Количество | Maximum | Region | Применимо |
| AccountMaxWrites | Максимальное количество единиц ёмкости записи, которые может использовать аккаунт | Количество | Maximum | Region | Применимо |
| AccountProvisionedReadCapacityUtilization | Процент подготовленных единиц ёмкости чтения, использованных аккаунтом | Процент | Multi | Region | Применимо |
| AccountProvisionedWriteCapacityUtilization | Процент подготовленных единиц ёмкости записи, использованных аккаунтом | Процент | Multi | Region | Применимо |
| ConditionalCheckFailed | Количество неудачных запросов записи облегчённых транзакций (LWT) | Количество | Multi | Keyspace, Operation, TableName | Применимо |
| ConditionalCheckFailed |  | Количество | Sum | Keyspace, Operation, TableName | Применимо |
| ConditionalCheckFailed |  | Количество | Count | Keyspace, Operation, TableName | Применимо |
| ConsumedReadCapacityUnits | Количество единиц ёмкости чтения, израсходованных за указанный период времени | Количество | Multi | Keyspace, TableName | Применимо |
| ConsumedReadCapacityUnits |  | Количество | Sum | Keyspace, TableName | Применимо |
| ConsumedReadCapacityUnits |  | Количество | Count | Keyspace, TableName | Применимо |
| ConsumedWriteCapacityUnits | Количество единиц ёмкости записи, израсходованных за указанный период времени | Количество | Multi | Keyspace, TableName | Применимо |
| ConsumedWriteCapacityUnits |  | Количество | Sum | Keyspace, TableName | Применимо |
| ConsumedWriteCapacityUnits |  | Количество | Count | Keyspace, TableName | Применимо |
| MaxProvisionedTableReadCapacityUtilization | Процент подготовленных единиц ёмкости чтения, использованных таблицей аккаунта с наибольшим объёмом подготовленной ёмкости чтения | Процент | Multi | Region | Применимо |
| MaxProvisionedTableWriteCapacityUtilization | Процент подготовленной ёмкости записи, использованной таблицей аккаунта с наибольшим объёмом подготовленной ёмкости записи | Процент | Multi | Region | Применимо |
| ProvisionedReadCapacityUnits | Количество подготовленных единиц ёмкости чтения для таблицы | Количество | Multi | Keyspace, TableName | Применимо |
| ProvisionedWriteCapacityUnits | Количество подготовленных единиц ёмкости записи для таблицы | Количество | Multi | Keyspace, TableName | Применимо |
| ReturnedItemCountBySelect | Количество строк, возвращённых операциями SELECT за указанный период времени | Количество | Multi | Keyspace, Operation, TableName | Применимо |
| ReturnedItemCountBySelect |  | Количество | Sum | Keyspace, Operation, TableName | Применимо |
| ReturnedItemCountBySelect |  | Количество | Count | Keyspace, Operation, TableName | Применимо |
| SuccessfulRequestCount | Количество успешных запросов | Количество | Multi | Keyspace, Operation, TableName | Применимо |
| SuccessfulRequestCount |  | Количество | Sum | Keyspace, Operation, TableName | Применимо |
| SuccessfulRequestCount |  | Количество | Count | Keyspace, Operation, TableName | Применимо |
| SuccessfulRequestLatency | Успешные запросы к Amazon Keyspaces за указанный период времени | Миллисекунда | Multi | Keyspace, Operation, TableName | Применимо |
| SuccessfulRequestLatency |  | Миллисекунда | Sum | Keyspace, Operation, TableName | Применимо |
| SuccessfulRequestLatency |  | Миллисекунда | Count | Keyspace, Operation, TableName | Применимо |
| SystemErrors | Запросы к Amazon Keyspaces, генерирующие ошибку ServerError, за указанный период времени | Количество | Sum | Keyspace, Operation, TableName | Применимо |
| SystemErrors |  | Количество | Count | Keyspace, Operation, TableName | Применимо |
| UserErrors | Запросы к Amazon Keyspaces, генерирующие ошибку `InvalidRequest`, за указанный период времени | Количество | Sum | Keyspace, Operation, TableName | Применимо |
| UserErrors |  | Количество | Count | Keyspace, Operation, TableName | Применимо |

## Ограничения

* Для этого сервиса нет API. Тегирование доступно на пользовательских устройствах (keyspaces), так как используется отдельный API Amazon.
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS IoT Analytics. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| ActionExecution | Количество выполненных действий | Количество | Sum | Region, ActionType, DatasetName | Применимо |
| ActionExecutionThrottled | Количество действий, подвергнутых регулированию | Количество | Sum | Region, ActionType, DatasetName | Применимо |
| ActivityExecutionError | Количество ошибок, возникших при выполнении действия конвейера | Количество | Sum | Region, PipelineActivityName, PipelineActivityType, PipelineName | Применимо |
| IncomingMessages | Количество сообщений, поступающих в канал | Количество | Sum | Region, ChannelName | Применимо |
| PipelineConcurrentExecutionCount | Количество действий конвейера, выполняемых одновременно | Количество | Sum | Region, PipelineName | Применимо |
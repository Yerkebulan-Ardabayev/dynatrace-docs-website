...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-route-53
scraped: 2026-05-12T11:28:06.710505
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Route 53. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| ChildHealthCheckHealthyCount | Количество исправных проверок работоспособности среди проверок работоспособности, отслеживаемых Route 53 | Количество | Sum | Region, HealthCheckId |  |
| ConnectionTime | Среднее время в миллисекундах, затраченное средствами проверки работоспособности Route 53 на установление TCP-соединения с конечной точкой | Миллисекунда | Multi | Region, HealthCheckId, Region |  |
| ConnectionTime |  | Миллисекунда | Multi | Region, HealthCheckId |  |
| DNSQueries | Общее количество DNS-запросов, на которые Route 53 отвечает для размещённой зоны | Количество | Multi | HostedZoneId | Применимо |
| DNSQueries |  | Количество | Sum | HostedZoneId | Применимо |
| HealthCheckPercentageHealthy | Процент средств проверки работоспособности Route 53, которые считают выбранную конечную точку исправной | Процент | Multi | Region, HealthCheckId |  |
| HealthCheckStatus | Статус конечной точки проверки работоспособности, которую проверяет CloudWatch. `1` означает исправность, а `0` означает неисправность | None | Multi | Region, HealthCheckId |  |
| SSLHandshakeTime | Среднее время в миллисекундах, затраченное средствами проверки работоспособности Route 53 на завершение SSL-рукопожатия | Миллисекунда | Multi | Region, HealthCheckId, Region |  |
| SSLHandshakeTime |  | Миллисекунда | Multi | Region, HealthCheckId |  |
| TimeToFirstByte | Среднее время в миллисекундах, затраченное средствами проверки работоспособности Route 53 на получение первого байта ответа на HTTP- или HTTPS-запрос | Миллисекунда | Multi | Region, HealthCheckId, Region |  |
| TimeToFirstByte |  | Миллисекунда | Multi | Region, HealthCheckId |  |
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon Elastic Load Balancer. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `LoadBalancerName`.

| Ключ метрики | Имя | Единица измерения | Агрегации | Потребление мониторинга |
| --- | --- | --- | --- | --- |
| builtin:cloud.aws.elb.errors.backend.connection | CLB backend connection errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.backend.http2xx | CLB number of backend 2XX errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.backend.http3xx | CLB number of backend 3XX errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.backend.http4xx | CLB number of backend 4XX errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.backend.http5xx | CLB number of backend 5XX errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.elb.http4xx | CLB number of 4XX errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.elb.http5xx | CLB number of 5XX errors | Количество | autovalue | DDUs |
| builtin:cloud.aws.elb.errors.frontend | CLB frontend errors percentage | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.elb.hosts.healthy | CLB number of healthy hosts | Количество | autoavgmaxmin | DDUs |
| builtin:cloud.aws.elb.hosts.unhealthy | CLB number of unhealthy hosts | Количество | autoavgmaxmin | DDUs |
| builtin:cloud.aws.elb.latency | CLB latency | Секунда | autoavgmaxmin | DDUs |
| builtin:cloud.aws.elb.reqCompl | CLB number of completed requests | Количество | autovalue | DDUs |
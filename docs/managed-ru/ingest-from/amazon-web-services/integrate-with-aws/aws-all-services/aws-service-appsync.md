...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-appsync
scraped: 2026-05-12T11:29:46.747360
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS AppSync. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `GraphQLAPIId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| ActiveConnections | Количество одновременных подключений WebSocket от клиентов к AWS AppSync за 1 минуту | Количество | Sum | GraphQLAPIId | Применимо |
| ActiveSubscriptions | Количество одновременных подписок от клиентов за 1 минуту | Количество | Sum | GraphQLAPIId | Применимо |
| ConnectClientError | Количество подключений WebSocket, отклонённых AWS AppSync из-за ошибок на стороне клиента | Количество | Sum | GraphQLAPIId | Применимо |
| ConnectServerError | Количество ошибок, возникших в AWS AppSync при обработке подключений | Количество | Sum | GraphQLAPIId | Применимо |
| ConnectSuccess | Количество успешных подключений WebSocket к AWS AppSync | Количество | Sum | GraphQLAPIId | Применимо |
| ConnectionDuration | Время, в течение которого подключение остаётся открытым | Миллисекунда | Multi | GraphQLAPIId | Применимо |
| DisconnectClientError | Количество ошибок, возникших в AWS AppSync при разрыве подключений WebSocket из-за ошибок на стороне клиента | Количество | Sum | GraphQLAPIId | Применимо |
| DisconnectServerError | Количество ошибок, возникших в AWS AppSync при разрыве подключений WebSocket в процессе обработки подключений | Количество | Sum | GraphQLAPIId | Применимо |
| DisconnectSuccess | Количество успешных разрывов подключений WebSocket в AWS AppSync | Количество | Sum | GraphQLAPIId | Применимо |
| Latency | Время между получением AWS AppSync запроса от клиента и возвратом ответа клиенту | Миллисекунда | Multi | GraphQLAPIId | Применимо |
| PublishDataMessageClientError | Количество сообщений о событиях подписки, которые не удалось опубликовать из-за ошибок на стороне клиента | Количество | Sum | GraphQLAPIId | Применимо |
| PublishDataMessageServerError | Количество ошибок, возникших в AWS AppSync при публикации сообщений о событиях подписки | Количество | Sum | GraphQLAPIId | Применимо |
| PublishDataMessageSize | Размер опубликованных сообщений о событиях подписки | Байт | Multi | GraphQLAPIId | Применимо |
| PublishDataMessageSize |  | Байт | Sum | GraphQLAPIId | Применимо |
| PublishDataMessageSuccess | Количество успешно опубликованных сообщений о событиях подписки | Количество | Sum | GraphQLAPIId | Применимо |
| SubscribeServerError | Количество ошибок, возникших в AWS AppSync при обработке подписок | Количество | Sum | GraphQLAPIId | Применимо |
| SubscribeSuccess | Количество подписок, успешно зарегистрированных в AWS AppSync через WebSocket | Количество | Sum | GraphQLAPIId | Применимо |
| UnsubscribeClientError | Количество отписок, отклонённых AWS AppSync из-за ошибок на стороне клиента | Количество | Sum | GraphQLAPIId | Применимо |
| UnsubscribeServerError | Количество ошибок, возникших в AWS AppSync при обработке отписок | Количество | Sum | GraphQLAPIId | Применимо |
| UnsubscribeSuccess | Количество отписок, успешно обработанных в AWS AppSync | Количество | Sum | GraphQLAPIId | Применимо |
| 4XXError | Количество ошибок на стороне клиента, зафиксированных за указанный период | Количество | Sum | GraphQLAPIId | Применимо |
| 5XXError | Количество ошибок на стороне сервера, зафиксированных за указанный период | Количество | Sum | GraphQLAPIId | Применимо |

## Ограничения

Хотя Dynatrace не поддерживает трафик WebSocket, интеграция AppSync отображает URL-адрес WebSocket в составе свойств создаваемых пользовательских устройств.
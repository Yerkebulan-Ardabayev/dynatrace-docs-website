...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-workmail
scraped: 2026-05-12T11:30:55.966742
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon WorkMail. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `OrganizationId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| IncomingEmailBounced | Количество входящих писем, отклонённых из-за переполненных или несуществующих почтовых ящиков | Количество | Sum | OrganizationId | Применимо |
| MailboxEmailDelivered | Количество писем, доставленных в отдельные почтовые ящики вашей организации Amazon WorkMail | Количество | Sum | OrganizationId | Применимо |
| OrganizationEmailReceived | Количество писем, полученных вашей организацией Amazon WorkMail | Количество | Sum | OrganizationId | Применимо |
| OutgoingEmailBounced | Количество исходящих писем, которые не удалось доставить, подсчитанное для каждого предполагаемого получателя | Количество | Sum | OrganizationId | Применимо |
| OutgoingEmailSent | Количество писем, успешно отправленных из вашей организации Amazon WorkMail | Количество | Sum | OrganizationId | Применимо |
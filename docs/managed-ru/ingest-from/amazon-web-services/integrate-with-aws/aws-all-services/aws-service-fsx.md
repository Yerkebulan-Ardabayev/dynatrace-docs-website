...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-fsx
scraped: 2026-05-12T11:28:20.210960
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая Amazon FSx. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| DataReadBytes | DataReadBytes | Байт | Multi | FileSystemId | Применимо |
| DataReadBytes |  | Байт | Sum | FileSystemId |  |
| DataReadOperations | Количество операций чтения | Количество | Sum | FileSystemId | Применимо |
| DataWriteBytes | Количество байт для операций записи в файловую систему | Байт | Multi | FileSystemId | Применимо |
| DataWriteBytes |  | Байт | Sum | FileSystemId |  |
| DataWriteOperations | Количество операций записи | Количество | Sum | FileSystemId | Применимо |
| FreeStorageCapacity | Объём доступной ёмкости хранилища | Байт | Multi | FileSystemId | Применимо |
| MetadataOperations | Количество операций с метаданными | Количество | Sum | FileSystemId | Применимо |
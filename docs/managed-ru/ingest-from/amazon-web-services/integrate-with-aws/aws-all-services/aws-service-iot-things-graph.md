...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-iot-things-graph
scraped: 2026-05-12T11:31:02.436862
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS IoT Things Graph. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
| --- | --- | --- | --- | --- | --- |
| FlowExecutionTime | Время, необходимое для завершения шага выполнения потока | Миллисекунда | Multi | Region, FlowTemplateId | Применимо |
| FlowExecutionTime |  | Миллисекунда | Multi | Region, SystemTemplateId |  |
| FlowExecutionsAborted | Количество прерванных выполнений потока | Количество | Sum | Region, FlowTemplateId | Применимо |
| FlowExecutionsAborted |  | Количество | Sum | Region, SystemTemplateId |  |
| FlowExecutionsFailed | Количество шагов выполнения потока, завершившихся сбоем | Количество | Sum | Region, FlowTemplateId | Применимо |
| FlowExecutionsFailed |  | Количество | Sum | Region, SystemTemplateId |  |
| FlowExecutionsStarted | Количество запущенных выполнений потока | Количество | Sum | Region, FlowTemplateId | Применимо |
| FlowExecutionsStarted |  | Количество | Sum | Region, SystemTemplateId |  |
| FlowExecutionsSucceeded | Количество успешно выполненных шагов выполнения потока | Количество | Sum | Region, FlowTemplateId | Применимо |
| FlowExecutionsSucceeded |  | Количество | Sum | Region, SystemTemplateId |  |
| FlowStepExecutionTime | Время, необходимое для завершения шага выполнения потока | Миллисекунда | Multi | Region, FlowTemplateId, StepName |  |
| FlowStepExecutionTime |  | Миллисекунда | Multi | Region, SystemTemplateId, StepName |  |
| FlowStepExecutionsFailed | Количество шагов выполнения потока, завершившихся сбоем | Количество | Sum | Region, FlowTemplateId, StepName |  |
| FlowStepExecutionsFailed |  | Количество | Sum | Region, SystemTemplateId, StepName |  |
| FlowStepExecutionsStarted | Количество запущенных шагов выполнения потока | Количество | Sum | Region, FlowTemplateId, StepName |  |
| FlowStepExecutionsStarted |  | Количество | Sum | Region, SystemTemplateId, StepName |  |
| FlowStepExecutionsSucceeded | Количество успешно выполненных шагов выполнения потока | Количество | Sum | Region, FlowTemplateId, StepName |  |
| FlowStepExecutionsSucceeded |  | Количество | Sum | Region, SystemTemplateId, StepName |  |
| FlowStepLambdaExecutionsFailed | Количество шагов функции Lambda при выполнении потока, завершившихся сбоем | Количество | Sum | Region, LambdaArn |  |
| FlowStepLambdaExecutionsStarted | Количество запущенных шагов функции Lambda при выполнении потока | Количество | Sum | Region, LambdaArn |  |
| FlowStepLambdaExecutionsSucceeded | Количество успешно выполненных шагов функции Lambda при выполнении потока | Количество | Sum | Region, LambdaArn |  |
...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services/aws-service-datasync
scraped: 2026-05-12T11:31:07.156059
---
...
Dynatrace принимает метрики для множества предопределённых пространств имён, включая AWS DataSync. Можно просматривать метрики по каждому экземпляру сервиса, разбивать их на несколько измерений и создавать собственные графики, которые можно закреплять на дашбордах.
...
Основное измерение: `TaskId`.

| Имя | Описание | Единица измерения | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| BytesPreparedDestination | Общее количество байт данных, подготовленных в целевом расположении | Байт | Sum | TaskId |  |
| BytesPreparedSource | Общее количество байт данных, подготовленных в исходном расположении | Байт | Sum | TaskId |  |
| BytesTransferred | Общее количество байт, переданных по сети, когда агент читает из исходного расположения в целевое расположение | Байт | Sum | TaskId | Применимо |
| BytesTransferred |  | Байт | Sum | Region, AgentId |  |
| BytesVerifiedDestination | Общее количество байт данных, проверенных в целевом расположении | Байт | Sum | TaskId |  |
| BytesVerifiedSource | Общее количество байт данных, проверенных в исходном расположении | Байт | Sum | TaskId |  |
| BytesWritten | Общий логический размер всех файлов, переданных в целевое расположение | Байт | Sum | TaskId | Применимо |
| BytesWritten |  | Байт | Sum | Region, AgentId |  |
| FilesPreparedDestination | Общее количество файлов, подготовленных в целевом расположении | Количество | Sum | TaskId |  |
| FilesPreparedSource | Общее количество файлов, подготовленных в исходном расположении | Количество | Sum | TaskId |  |
| FilesTransferred | Фактическое количество файлов или метаданных, переданных по сети | Количество | Sum | TaskId | Применимо |
| FilesTransferred |  | Количество | Sum | Region, AgentId |  |
| FilesVerifiedDestination | Общее количество файлов, проверенных в целевом расположении | Количество | Sum | TaskId | Применимо |
| FilesVerifiedSource | Общее количество файлов, проверенных в исходном расположении | Количество | Sum | TaskId |  |
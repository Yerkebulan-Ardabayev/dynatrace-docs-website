...
Dynatrace собирает метрики для множества предварительно выбранных пространств имён, включая Amazon EC2. Можно просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские диаграммы, которые можно закрепить на дашбордах.
...
### Эластичные вычисления (EC2)

| Ключ метрики | Название | Единица | Агрегации | Потребление мониторинга |
| --- | --- | --- | --- | --- |
| builtin:cloud.aws.ec2.cpu.usage | Использование CPU EC2 % | Процент (%) | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ec2.disk.readOps | IOPS чтения хранилища экземпляра EC2 | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ec2.disk.readRate | Скорость чтения хранилища экземпляра EC2 | КБ/с | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ec2.disk.writeOps | IOPS записи хранилища экземпляра EC2 | В секунду | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ec2.disk.writeRate | Скорость записи хранилища экземпляра EC2 | КБ/с | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ec2.net.rx | Скорость получения данных по сети EC2 | Байт/с | autoavgmaxmin | DDUs |
| builtin:cloud.aws.ec2.net.tx | Скорость передачи данных по сети EC2 | Байт/с | autoavgmaxmin | DDUs |

### Зоны доступности эластичных вычислений (EC2)

| Ключ метрики | Название | Единица | Агрегации | Потребление мониторинга |
| --- | --- | --- | --- | --- |
| builtin:cloud.aws.az.running | Количество запущенных экземпляров EC2 (AZ) | Количество | autoavgmaxmin | Хост-единицы |
| builtin:cloud.aws.az.stopped | Количество остановленных экземпляров EC2 (AZ) | Количество | autoavgmaxmin | DDUs |
| builtin:cloud.aws.az.terminated | Количество завершённых экземпляров EC2 (AZ) | Количество | autoavgmaxmin | DDUs |
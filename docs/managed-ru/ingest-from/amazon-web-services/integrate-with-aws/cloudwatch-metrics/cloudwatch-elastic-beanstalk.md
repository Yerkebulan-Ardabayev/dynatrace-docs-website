...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/cloudwatch-metrics/cloudwatch-elastic-beanstalk
scraped: 2026-05-12T11:29:36.554810
---
...
Dynatrace получает метрики для множества предварительно выбранных пространств имён, включая AWS Elastic Beanstalk. Можно просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские графики, которые можно закрепить на панелях мониторинга.
...
Для установки и настройки OneAgent см. [Развёртывание OneAgent на AWS Elastic Beanstalk](/managed/ingest-from/amazon-web-services/integrate-into-aws/aws-beanstalk "Установка OneAgent на AWS Elastic Beanstalk.").
...
| --- | --- | --- | --- | --- | --- |
| ApplicationLatencyP10 | Среднее время, в секундах, необходимое для обработки самых быстрых 10% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP10 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationLatencyP50 | Среднее время, в секундах, необходимое для обработки самых быстрых 50% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP50 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationLatencyP75 | Среднее время, в секундах, необходимое для обработки самых быстрых 75% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP75 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationLatencyP85 | Среднее время, в секундах, необходимое для обработки самых быстрых 85% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP85 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationLatencyP90 | Среднее время, в секундах, необходимое для обработки самых быстрых 90% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP90 |  | Seconds | Multi | EnvironmentName | Доступна |
| ApplicationLatencyP95 | Среднее время, в секундах, необходимое для обработки самых быстрых 95% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP95 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationLatencyP99 | Среднее время, в секундах, необходимое для обработки самых быстрых 99% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP99 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationLatencyP99.9 | Среднее время, в секундах, необходимое для обработки самых быстрых 99.9% запросов (экземпляр и окружение) | Seconds | Multi | EnvironmentName, InstanceId |  |
| ApplicationLatencyP99.9 |  | Seconds | Multi | EnvironmentName |  |
| ApplicationRequestsTotal | Общее количество запросов, обработанных экземпляром или окружением | Count | Sum | EnvironmentName, InstanceId |  |
| ApplicationRequestsTotal |  | Count | Sum | EnvironmentName | Доступна |
| ApplicationRequests2xx | Количество запросов, завершённых с кодом состояния `2XX` (экземпляр и окружение) | Count | Sum | EnvironmentName, InstanceId |  |
| ApplicationRequests2xx |  | Count | Sum | EnvironmentName |  |
| ApplicationRequests3xx | Количество запросов, завершённых с кодом состояния `3XX` (экземпляр и окружение) | Count | Sum | EnvironmentName, InstanceId |  |
| ApplicationRequests3xx |  | Count | Sum | EnvironmentName |  |
| ApplicationRequests4xx | Количество запросов, завершённых с кодом состояния `4XX` (экземпляр и окружение) | Count | Sum | EnvironmentName, InstanceId |  |
| ApplicationRequests4xx |  | Count | Sum | EnvironmentName | Доступна |
| ApplicationRequests5xx | Количество запросов, завершённых с кодом состояния `5XX` (экземпляр и окружение) | Count | Sum | EnvironmentName, InstanceId |  |
| ApplicationRequests5xx |  | Count | Sum | EnvironmentName | Доступна |
| CPUIdle | Процент времени, в течение которого ЦП находился в состоянии простоя за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUIowait | Процент времени, в течение которого ЦП находился в состоянии `iowait` за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUIrq | Процент времени, в течение которого ЦП находился в состоянии `irq` за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUNice | Процент времени, в течение которого ЦП находился в состоянии `nice` за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUPrivileged | Процент времени, в течение которого ЦП находился в привилегированном (`privileged`) состоянии за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUSoftirq | Процент времени, в течение которого ЦП находился в состоянии `softirq` за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUSystem | Процент времени, в течение которого ЦП находился в системном (`system`) состоянии за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| CPUUser | Процент времени, в течение которого ЦП находился в пользовательском (`user`) состоянии за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| EnvironmentHealth | Текущий статус работоспособности окружения; возможные значения: 0 - `OK`, 1 - `Info`, 5 - `Unknown`, 10 - `No data`, 15 - `Warning`, 20 - `Degraded`, 25 - `Severe` | None | Multi | EnvironmentName | Доступна |
| InstanceHealth | Текущий статус работоспособности экземпляра; возможные значения: 0 - `OK`, 1 - `Info`, 5 - `Unknown`, 10 - `No data`, 15 - `Warning`, 20 - `Degraded`, 25 - `Severe` | None | Multi | EnvironmentName, InstanceId | Доступна |
| InstancesDegraded | Количество экземпляров в окружении со статусом работоспособности `degraded` (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesInfo | Количество экземпляров в окружении со статусом работоспособности `info` (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesNoData | Количество экземпляров, данные по которым не поступают (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesOk | Количество экземпляров в окружении со статусом работоспособности `OK` (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesPending | Количество экземпляров в окружении со статусом работоспособности `pending` (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesSevere | Количество экземпляров в окружении со статусом работоспособности `severe` (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesUnknown | Количество экземпляров в окружении со статусом работоспособности `unknown` (только окружение) | Count | Multi | EnvironmentName |  |
| InstancesWarning | Количество экземпляров в окружении со статусом работоспособности `warning` (только окружение) | Count | Multi | EnvironmentName |  |
| LoadAverage1min | Средняя нагрузка на ЦП экземпляра за последнюю минуту (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |
| LoadAverage5min | Средняя нагрузка на ЦП экземпляра за последние пять минут (только экземпляр) | Percent | Multi | EnvironmentName, InstanceId |  |

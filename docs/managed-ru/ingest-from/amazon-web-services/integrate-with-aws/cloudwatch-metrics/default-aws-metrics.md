...
source: https://docs.dynatrace.com/managed/ingest-from/amazon-web-services/integrate-with-aws/cloudwatch-metrics/default-aws-metrics
scraped: 2026-05-12T11:27:44.989338
---
...
В таблице ниже перечислены все метрики AWS, которые Dynatrace собирает по умолчанию при включении [мониторинга AWS](/managed/observe/infrastructure-observability/cloud-platform-monitoring/aws-monitoring "Мониторинг AWS с помощью Dynatrace").

Сведения обо всех остальных метриках, собираемых Dynatrace для настраиваемых сервисов AWS, см. на страницах [облачных сервисов](/managed/ingest-from/amazon-web-services/integrate-with-aws/aws-all-services "Мониторинг всех облачных сервисов AWS в Dynatrace и просмотр доступных метрик.").

| Ключ метрики | Название | Единица | Агрегации |
| --- | --- | --- | --- |

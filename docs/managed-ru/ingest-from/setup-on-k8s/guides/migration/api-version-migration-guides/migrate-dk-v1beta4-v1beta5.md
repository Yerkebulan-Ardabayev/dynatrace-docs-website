---
title: Миграция DynaKube с v1beta4 на v1beta5
...
scraped: 2026-05-12T12:14:40.452706
---
...
В этом руководстве показано, как вручную выполнить миграцию с `apiVersion: dynatrace.com/v1beta4` на `apiVersion: dynatrace.com/v1beta5` для `DynaKube`.

---
title: Мониторинг Azure AI - Custom Vision Prediction
...
Dynatrace получает метрики из Azure Metrics API для Custom Vision Prediction. Вы можете просматривать метрики для каждого экземпляра сервиса, разбивать метрики по различным измерениям и создавать пользовательские графики, которые можно закрепить на ваших дашбордах.

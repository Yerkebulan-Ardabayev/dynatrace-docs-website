...
Dynatrace получает метрики из Azure Metrics API для Azure Private DNS Zone. Вы можете просматривать метрики для каждого экземпляра сервиса, разбивать метрики по различным измерениям и создавать пользовательские графики, которые можно закрепить на ваших дашбордах.
...
| --- | --- | --- | --- |
| QueryVolume | Количество запросов, обработанных для зоны DNS | Количество | Применимо |
| RecordSetCount | Количество наборов записей в зоне DNS | Количество | Применимо |
| RecordSetCapacityUtilization | Процент использования ёмкости наборов записей зоной DNS | Процент | Применимо |
| VirtualNetworkLinkCount | Количество виртуальных сетей, связанных с частной зоной DNS | Количество | Применимо |
| VirtualNetworkLinkCapacityUtilization | Процент ёмкости виртуальной сети, используемой частной зоной DNS | Процент | Применимо |
| VirtualNetworkWithRegistrationCapacityUtilization | Процент использования ёмкости для виртуальной сети с автоматической регистрацией, используемой частной зоной DNS | Процент |  |
| VirtualNetworkWithRegistrationLinkCount | Количество виртуальных сетей, связанных с частной зоной DNS, для которых включена автоматическая регистрация | Количество |  |
...
Информацию о различиях между классическими и другими сервисами см. в разделе [Миграция с классических (ранее «встроенных») сервисов Azure на облачные сервисы](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide/azure-migration-guide "Миграция классических сервисов Azure на их новые версии.").

В таблице ниже перечислены все метрики Azure, которые Dynatrace собирает по умолчанию при включении мониторинга [Microsoft Azure](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide "Настройка и конфигурирование мониторинга Azure в Dynatrace.").

Все остальные метрики, собираемые Dynatrace для каждого настраиваемого сервиса Azure, см. на страницах [облачных сервисов](/managed/ingest-from/microsoft-azure-services/azure-integrations/azure-cloud-services-metrics "Мониторинг сервисов Azure с Dynatrace и просмотр доступных метрик.").

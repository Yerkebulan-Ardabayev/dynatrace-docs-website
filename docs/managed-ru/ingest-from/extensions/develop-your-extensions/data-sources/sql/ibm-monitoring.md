...
# Конфигурация мониторинга IBM Database
...
В одной конфигурации мониторинга в разделе `sqlDb2Remote` можно определить до 20 000 эндпоинтов.
...
Чтобы задать сервер IBM Database, добавьте в раздел `endpoints` следующие сведения:

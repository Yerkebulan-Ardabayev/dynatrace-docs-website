...
Возвращает список всех задач обновления для указанного ActiveGate. Список включает завершённые задачи (успешные или с ошибкой) и задачи в процессе выполнения.
...
| GET | Environment and Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/activeGates/{agId}/updateJobs` |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [UpdateJobList](#openapi-definition-UpdateJobList) | Успех |
...
В этом примере запрос выводит все задачи авто-обновления ActiveGate с ID **2100855201**.

---
title: Settings API - Ingest pipelines configuration (davis.problems) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-davis-problems-pipelines
scraped: 2026-05-12T11:44:06.168889
---

# Settings API - Ingest pipelines configuration (davis.problems) schema table

# Settings API - Ingest pipelines configuration (davis.problems) schema table

* Опубликовано 25 августа 2025 г.

### Конфигурация ingest pipelines (davis.problems) (`builtin:openpipeline.davis.problems.pipelines)`

Содержит конфигурацию pipelines

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.davis.problems.pipelines` | * `group:openpipeline.all.pipelines` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.davis.problems.pipelines` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.davis.problems.pipelines` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.davis.problems.pipelines` |

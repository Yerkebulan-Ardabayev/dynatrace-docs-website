---
title: Settings API - Ingest pipelines configuration (events) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-events-pipelines
scraped: 2026-05-12T11:48:34.126918
---

# Settings API - Ingest pipelines configuration (events) schema table

# Settings API - Ingest pipelines configuration (events) schema table

* Опубликовано 25 августа 2025 г.

### Конфигурация ingest pipelines (события) (`builtin:openpipeline.events.pipelines)`

Содержит конфигурацию pipelines

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.events.pipelines` | * `group:openpipeline.all.pipelines` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.events.pipelines` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.events.pipelines` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.events.pipelines` |

---
title: Settings API - Anomaly detection for custom applications schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-anomaly-detection-rum-custom
scraped: 2026-05-12T11:42:39.647672
---

# Settings API - Anomaly detection for custom applications schema table

# Settings API - Anomaly detection for custom applications schema table

* Опубликовано 05 декабря 2023 г.

### Обнаружение аномалий для custom-приложений (`builtin:anomaly-detection.rum-custom)`
...
| --- | --- | --- |
| `builtin:anomaly-detection.rum-custom` | * `group:anomaly-detection` | `DEVICE_APPLICATION_METHOD` - Mobile app key user action  `CUSTOM_APPLICATION` - Custom Application  `environment` |
...
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:anomaly-detection.rum-custom` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:anomaly-detection.rum-custom` |

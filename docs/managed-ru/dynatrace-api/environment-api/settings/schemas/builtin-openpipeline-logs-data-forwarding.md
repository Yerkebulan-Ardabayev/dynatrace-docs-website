---
title: Settings API - Data forwarding configuration (logs) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-logs-data-forwarding
scraped: 2026-05-12T11:44:26.637897
---

# Settings API - Data forwarding configuration (logs) schema table

# Settings API - Data forwarding configuration (logs) schema table

* Опубликовано 25 сентября 2025 г.

### Конфигурация data forwarding (логи) (`builtin:openpipeline.logs.data-forwarding)`

Содержит конфигурацию data forwarding

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.logs.data-forwarding` | * `group:openpipeline.all.data-forwarding` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.logs.data-forwarding` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.logs.data-forwarding` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.logs.data-forwarding` |

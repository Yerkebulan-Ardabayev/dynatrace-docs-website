...
### Конфигурация маршрутизации ingest (bizevents) (`builtin:openpipeline.bizevents.routing)`

Содержит конфигурацию маршрутизации

| Schema ID | Schema groups | Scope |
| --- | --- | --- |
| `builtin:openpipeline.bizevents.routing` | * `group:openpipeline.all.routing` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.bizevents.routing` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.bizevents.routing` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.bizevents.routing` |

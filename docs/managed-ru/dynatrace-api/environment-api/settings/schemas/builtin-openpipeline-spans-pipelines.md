---
title: Settings API - Ingest pipelines configuration (spans) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-spans-pipelines
scraped: 2026-05-12T11:42:00.066438
---

# Settings API - Ingest pipelines configuration (spans) schema table

# Settings API - Ingest pipelines configuration (spans) schema table

* Опубликовано 25 августа 2025 г.

### Конфигурация ingest pipelines (spans) (`builtin:openpipeline.spans.pipelines)`

Содержит конфигурацию pipelines

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.spans.pipelines` | * `group:openpipeline.all.pipelines` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.spans.pipelines` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.spans.pipelines` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.spans.pipelines` |

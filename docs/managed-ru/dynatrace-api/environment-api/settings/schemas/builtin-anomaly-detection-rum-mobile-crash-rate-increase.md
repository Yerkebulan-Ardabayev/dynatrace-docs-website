...
### Настройки роста crash rate для mobile-приложений (`builtin:anomaly-detection.rum-mobile-crash-rate-increase)`
...
| --- | --- | --- |
| `builtin:anomaly-detection.rum-mobile-crash-rate-increase` | * `group:anomaly-detection` | `MOBILE_APPLICATION` - Mobile App  `environment` |
...
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:anomaly-detection.rum-mobile-crash-rate-increase` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:anomaly-detection.rum-mobile-crash-rate-increase` |

---
title: Settings API - Data forwarding configuration (metrics) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-metrics-data-forwarding
scraped: 2026-05-12T11:43:01.174985
---

# Settings API - Data forwarding configuration (metrics) schema table

# Settings API - Data forwarding configuration (metrics) schema table

* Опубликовано 25 сентября 2025 г.

### Конфигурация data forwarding (метрики) (`builtin:openpipeline.metrics.data-forwarding)`

Содержит конфигурацию data forwarding

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.metrics.data-forwarding` | * `group:openpipeline.all.data-forwarding` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.metrics.data-forwarding` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.metrics.data-forwarding` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.metrics.data-forwarding` |

---
title: Settings API - Ingest pipelines configuration (davis.events) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-davis-events-pipelines
scraped: 2026-05-12T11:41:51.499200
---

# Settings API - Ingest pipelines configuration (davis.events) schema table

# Settings API - Ingest pipelines configuration (davis.events) schema table

* Опубликовано 25 августа 2025 г.

### Конфигурация ingest pipelines (davis.events) (`builtin:openpipeline.davis.events.pipelines)`

Содержит конфигурацию pipelines

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.davis.events.pipelines` | * `group:openpipeline.all.pipelines` | `environment` |
...
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.davis.events.pipelines` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.davis.events.pipelines` |

---
title: Settings API - Data forwarding configuration (davis.events) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-davis-events-data-forwarding
scraped: 2026-05-12T11:38:55.350074
---

# Settings API - Data forwarding configuration (davis.events) schema table

# Settings API - Data forwarding configuration (davis.events) schema table

* Опубликовано 25 сентября 2025 г.

### Конфигурация data forwarding (davis.events) (`builtin:openpipeline.davis.events.data-forwarding)`

Содержит конфигурацию data forwarding

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.davis.events.data-forwarding` | * `group:openpipeline.all.data-forwarding` | `environment` |

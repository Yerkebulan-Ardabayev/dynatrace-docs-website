...
### Конфигурация ingest pipelines (user.events) (`builtin:openpipeline.user.events.pipelines)`

Содержит конфигурацию pipelines

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.user.events.pipelines` | * `group:openpipeline.all.pipelines` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.user.events.pipelines` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.user.events.pipelines` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.user.events.pipelines` |

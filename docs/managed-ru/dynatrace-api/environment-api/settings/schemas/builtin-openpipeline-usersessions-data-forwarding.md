---
title: Settings API - Data forwarding configuration (usersessions) schema table
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/settings/schemas/builtin-openpipeline-usersessions-data-forwarding
scraped: 2026-05-12T11:47:17.795451
---

# Settings API - Data forwarding configuration (usersessions) schema table

# Settings API - Data forwarding configuration (usersessions) schema table

* Опубликовано 25 сентября 2025 г.

### Конфигурация data forwarding (usersessions) (`builtin:openpipeline.usersessions.data-forwarding)`

Содержит конфигурацию data forwarding

| Schema ID | Группы схемы | Scope |
| --- | --- | --- |
| `builtin:openpipeline.usersessions.data-forwarding` | * `group:openpipeline.all.data-forwarding` | `environment` |

Получить schema через Settings API

|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.usersessions.data-forwarding` |
| GET | SaaS | `https://{your-environment-id}.live.dynatrace.com/api/v2/settings/schemas/builtin:openpipeline.usersessions.data-forwarding` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v2/settings/schemas/builtin:openpipeline.usersessions.data-forwarding` |

...
| --- | --- | --- | --- | --- |
| problemId | string | ID запрашиваемой проблемы. | path | Обязательный |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [ProblemDetailsResultWrapper](#openapi-definition-ProblemDetailsResultWrapper) | Успех |
| **4XX** | [ErrorEnvelope](#openapi-definition-ErrorEnvelope) | Ошибка на стороне клиента. |
| **5XX** | [ErrorEnvelope](#openapi-definition-ErrorEnvelope) | Ошибка на стороне сервера. |

### Объекты тела ответа

#### Объект `ProblemDetailsResultWrapper`

| Поле | Тип | Описание |
| --- | --- | --- |
| result | [Problem](#openapi-definition-Problem) | Свойства проблемы. |
...
В этом примере запрос получает детали проблемы с ID **2307087411653364173\_1538400720000V2**.

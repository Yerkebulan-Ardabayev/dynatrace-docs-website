...
Фактический набор полей зависит от типа доказательства. Список фактических объектов смотрите в описании поля **evidenceType** или в [Problems API v2 - JSON-модели](https://dt-url.net/we03sp2?dt=m).
...
Фактический набор полей зависит от типа воздействия. Список фактических объектов смотрите в описании поля **impactType** или в [Problems API v2 - JSON-модели](https://dt-url.net/we03sp2?dt=m).

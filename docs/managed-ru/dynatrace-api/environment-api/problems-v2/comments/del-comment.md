---
title: Problems API v2 - DELETE комментарий
...
# Problems API v2 - DELETE комментарий
...
Удаляет указанный комментарий к проблеме.
...
| DELETE | Environment и Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/problems/{problemId}/comments/{commentId}` |

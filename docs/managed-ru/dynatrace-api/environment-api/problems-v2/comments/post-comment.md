---
title: Problems API v2 - POST комментарий
...
# Problems API v2 - POST комментарий
...
| POST | Environment и Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/problems/{problemId}/comments` |
...
| body | [CommentRequestDtoImpl](#openapi-definition-CommentRequestDtoImpl) | JSON-тело запроса. Содержит добавляемый комментарий. | body | Необязательный |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **201** | - | Успех. Комментарий добавлен. |

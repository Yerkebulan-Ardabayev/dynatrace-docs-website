...
| regionCode | string | Код требуемого региона.  Чтобы получить список доступных кодов регионов, используйте запрос [GET regions of the country](https://dt-url.net/az230x0?dt=m). | path | Required |

---
title: Extensions 2.0 API - GET активную
...
# Extensions 2.0 API - GET активную
...
Возвращает активную версию конфигурации окружения указанного Extensions 2.0 extension.
...
| GET | Environment и Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/extensions/{extensionName}/environmentConfiguration` |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [ExtensionEnvironmentConfigurationVersion](#openapi-definition-ExtensionEnvironmentConfigurationVersion) | Успех |

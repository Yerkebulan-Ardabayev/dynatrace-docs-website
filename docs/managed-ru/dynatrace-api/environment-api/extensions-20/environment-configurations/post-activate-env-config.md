---
title: Extensions 2.0 API - POST конфигурацию окружения
...
# Extensions 2.0 API - POST конфигурацию окружения
...
Включает указанный Extensions 2.0 extension и одновременно активирует указанную версию конфигурации окружения.

Запрос принимает и возвращает payload `application/json`.

|  |  |  |
| --- | --- | --- |
| POST | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/v2/extensions/{extensionName}/environmentConfiguration` |
| POST | Environment и Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/extensions/{extensionName}/environmentConfiguration` |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [ExtensionEnvironmentConfigurationVersion](#openapi-definition-ExtensionEnvironmentConfigurationVersion) | Успех. Конфигурация окружения создана. |

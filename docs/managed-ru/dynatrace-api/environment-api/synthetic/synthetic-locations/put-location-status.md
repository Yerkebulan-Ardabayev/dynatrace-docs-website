---
title: Synthetic locations API - PUT статус публичных локаций
...
# Synthetic locations API - PUT статус публичных локаций
...
| --- | --- | --- | --- | --- |
| body | [SyntheticPublicLocationsStatus](#openapi-definition-SyntheticPublicLocationsStatus) | Обновлённый статус синтетических локаций | body | Необязательный |

...
| Поле | Тип | Описание |
| --- | --- | --- |
| customIconPath | string | Пользовательская иконка сущности. Укажите [barista](https://dt-url.net/u403suy?dt=m) ID иконки или URL вашей собственной иконки. |
| primaryIconType | string | Основная иконка сущности. Указывается [barista](https://dt-url.net/u403suy?dt=m) ID иконки. |
| secondaryIconType | string | Вторичная иконка сущности. Указывается [barista](https://dt-url.net/u403suy?dt=m) ID иконки. |

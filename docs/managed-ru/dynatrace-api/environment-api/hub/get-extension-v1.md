---
title: Hub capabilities API - GET расширения v1
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/hub/get-extension-v1
scraped: 2026-05-12T11:54:49.249332
---

# Hub capabilities API - GET расширения v1
...
Возвращает подробности о расширении версии 1.
...
| GET | Environment and Cluster ActiveGate (default port 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/hub/extensions1/{extension1FQN}` |

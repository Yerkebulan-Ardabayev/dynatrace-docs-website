---
title: Hub capabilities API - GET технологии
...
# Hub capabilities API - GET технологии
...
Возвращает информацию по указанной технологии.
...
| --- | --- | --- | --- | --- |
| slug | string | Slug запрашиваемой технологии | path | Обязательный |

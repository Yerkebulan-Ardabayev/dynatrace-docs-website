---
title: OneAgent remote configuration management API - GET задание конфигурации
...
# OneAgent remote configuration management API - GET задание конфигурации
...
Получает параметры задания конфигурации для OneAgent.

---
title: ActiveGate remote configuration management API - GET завершённые задания
...
# ActiveGate remote configuration management API - GET завершённые задания
...
Перечисляет завершённые задания конфигурации для ActiveGate.

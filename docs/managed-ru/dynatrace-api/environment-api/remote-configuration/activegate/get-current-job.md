---
title: ActiveGate remote configuration management API - GET текущее задание
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/remote-configuration/activegate/get-current-job
scraped: 2026-05-12T11:55:37.340295
---

# ActiveGate remote configuration management API - GET текущее задание
...
Получает параметры выполняющегося в данный момент задания конфигурации для ActiveGate.
...
| GET | Environment and Cluster ActiveGate (default port 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement/current` |

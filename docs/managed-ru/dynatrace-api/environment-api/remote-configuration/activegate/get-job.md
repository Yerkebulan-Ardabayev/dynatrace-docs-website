---
title: ActiveGate remote configuration management API - GET задание конфигурации
...
# ActiveGate remote configuration management API - GET задание конфигурации
...
Получает параметры задания конфигурации для ActiveGate.

Запрос возвращает payload `application/json`.

|  |  |  |
| --- | --- | --- |
| GET | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement/{id}` |
| GET | Environment and Cluster ActiveGate (default port 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement/{id}` |

## Аутентификация

Для выполнения запроса нужен access-токен со scope `activeGates.read`.
...
| --- | --- | --- | --- | --- |
| id | string | ID требуемого задания remote configuration management. | path | Обязательный |

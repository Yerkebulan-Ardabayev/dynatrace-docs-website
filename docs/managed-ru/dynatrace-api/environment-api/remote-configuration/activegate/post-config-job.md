---
title: ActiveGate remote configuration management API - POST задание конфигурации
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/remote-configuration/activegate/post-config-job
scraped: 2026-05-12T11:55:41.470842
---

# ActiveGate remote configuration management API - POST задание конфигурации
...
|  |  |  |
| --- | --- | --- |
| POST | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement` |
| POST | Environment and Cluster ActiveGate (default port 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement` |
...
ActiveGate идентифицируются по их ID. Используйте запрос [GET all ActiveGate](/managed/dynatrace-api/environment-api/activegates/activegate-info/get-all "Список всех ActiveGate, подключённых к окружению сейчас или недавно.") чтобы узнать ID ActiveGate, которые вы хотите сконфигурировать.
...
Ответ не отправляется клиенту, пока не обработаны все ActiveGate, указанные в payload. ActiveGate считается обработанным, когда ему отправлено сообщение о переконфигурировании; фактическое переконфигурирование выполняется ActiveGate независимо.
...
|  |  |  |
| --- | --- | --- |
| POST | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement/validator` |
| POST | Environment and Cluster ActiveGate (default port 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/activeGates/remoteConfigurationManagement/validator` |

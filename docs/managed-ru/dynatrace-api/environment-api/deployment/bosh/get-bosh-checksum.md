...
| version | string | Требуемая версия OneAgent в формате `1.155.275.20181112-084458`.  Список доступных версий можно получить вызовом [**GET available versions of BOSH tarballs**](https://dt-url.net/j703kdn?dt=m). | path | Обязательный |

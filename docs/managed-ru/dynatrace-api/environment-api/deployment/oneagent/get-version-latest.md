...
Возвращает номер последней доступной версии OneAgent.
...
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/v1/deployment/installer/agent/{osType}/{installerType}/latest/metainfo` |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [AgentInstallerMetaInfoDto](#openapi-definition-AgentInstallerMetaInfoDto) | Успех |
| **4XX** | [ErrorEnvelope](#openapi-definition-ErrorEnvelope) | Ошибка на стороне клиента. |
| **5XX** | [ErrorEnvelope](#openapi-definition-ErrorEnvelope) | Ошибка на стороне сервера. |

### Объекты тела ответа

#### Объект `AgentInstallerMetaInfoDto`

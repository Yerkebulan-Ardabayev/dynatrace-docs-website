...
scraped: 2026-05-12T11:58:21.722630
---
...
Скачивает инсталлятор OneAgent, как задано в целевой версии в [OneAgent updates](/managed/ingest-from/dynatrace-oneagent/oneagent-update#configure-oneagent-updates "Узнайте, как обновлять OneAgent."). Номер последней версии можно проверить вызовом [GET the latest version of OneAgent](/managed/dynatrace-api/environment-api/deployment/oneagent/get-version-latest "Просмотр последней версии OneAgent через Dynatrace API.").

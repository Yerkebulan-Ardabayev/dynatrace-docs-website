---
title: Synthetic monitor executions API v2 - GET базовая информация о выполнении
source: https://docs.dynatrace.com/managed/dynatrace-api/environment-api/synthetic-v2/synthetic-monitor-execution/get-execution-basic
scraped: 2026-05-12T11:57:49.724933
---

# Synthetic monitor executions API v2 - GET базовая информация о выполнении
...
Возвращает базовые результаты выполнения синтетического монитора по требованию.
...
| GET | Environment и Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/synthetic/executions/{executionId}` |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [SyntheticOnDemandExecution](#openapi-definition-SyntheticOnDemandExecution) | Успех. Ответ содержит базовую информацию о выполнении по требованию. |

---
title: Synthetic monitors API v2 - DELETE монитор Synthetic
...
# Synthetic monitors API v2 - DELETE монитор Synthetic
...
Удаляет существующий монитор Synthetic. Удаление нельзя отменить.
...
| DELETE | Environment и Cluster ActiveGate (порт по умолчанию 9999) | `https://{your-activegate-domain}:9999/e/{your-environment-id}/api/v2/synthetic/monitors/{monitorId}` |

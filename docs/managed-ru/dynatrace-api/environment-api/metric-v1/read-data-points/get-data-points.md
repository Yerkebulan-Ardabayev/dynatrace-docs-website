...
| considerMaintenanceWindowsForAvailability | boolean | Исключить (`true`) или включить (`false`) точки данных из любого [maintenance window](https://dt-url.net/b2123rg0), определённого в вашей среде. | query | Опциональный |

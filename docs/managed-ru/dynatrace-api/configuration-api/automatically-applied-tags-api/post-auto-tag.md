...
| --- | --- | --- | --- | --- |
| body | [AutoTag](#openapi-definition-AutoTag) | JSON-тело запроса. Содержит параметры нового автоматически применяемого тега. | body | Optional |
...
| Код | Тип | Описание |
| --- | --- | --- |
| **201** | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | Успех. Автоматически применяемый тег создан. Тело ответа содержит ID нового автоматически применяемого тега. |
...
В этом примере запрос создаёт новый автоматически применяемый тег для **Services**, где **service name** содержит `main`. Сервисам и хостам, на которых они работают, был назначен тег **MainApp**.
...
Новый автоматически применяемый тег выглядит в UI так:

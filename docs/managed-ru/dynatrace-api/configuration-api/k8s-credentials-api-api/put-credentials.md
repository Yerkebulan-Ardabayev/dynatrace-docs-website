---
title: Kubernetes credentials API - PUT credentials
source: https://docs.dynatrace.com/managed/dynatrace-api/configuration-api/k8s-credentials-api-api/put-credentials
scraped: 2026-05-12T12:14:56.201248
---
...
Обновляет существующую конфигурацию Kubernetes credentials.

Если конфигурации credentials с указанным ID нет, создаётся новая конфигурация.

Запрос принимает и возвращает payload `application/json`.

|  |  |  |
| --- | --- | --- |
| PUT | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/config/v1/kubernetes/credentials/{id}` |
| PUT | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/config/v1/kubernetes/credentials/{id}` |
...
| --- | --- | --- | --- | --- |
| id | string | ID обновляемой конфигурации Kubernetes credentials. | path | Required |
| body | [KubernetesCredentials](#openapi-definition-KubernetesCredentials) | JSON-тело запроса с обновлёнными параметрами конфигурации Kubernetes credentials. | body | Optional |
...
| **204** | - | Успех. Конфигурация Kubernetes credentials обновлена. Ответ без тела. |
...
|  |  |  |
| --- | --- | --- |
| POST | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/config/v1/kubernetes/credentials/{id}/validator` |
| POST | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/config/v1/kubernetes/credentials/{id}/validator` |

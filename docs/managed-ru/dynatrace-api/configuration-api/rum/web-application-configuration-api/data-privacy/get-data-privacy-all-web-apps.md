...
Возвращает параметры конфиденциальности данных всех веб-приложений, настроенных в вашем окружении Dynatrace.
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | [ApplicationDataPrivacyList](#openapi-definition-ApplicationDataPrivacyList) | Успех |

---
title: Mobile Symbolication API - GET all
source: https://docs.dynatrace.com/managed/dynatrace-api/configuration-api/mobile-symbolication-api/get-all
scraped: 2026-05-12T11:19:34.382170
---
...
Возвращает метаданные всех файлов символов (файлов Android mapping и файлов iOS/tvOS symbol extract) из хранилища файлов символов.

Запрос возвращает payload `application/json`.

|  |  |  |
| --- | --- | --- |
| GET | ManagedDynatrace for Government | `https://{your-domain}/e/{your-environment-id}/api/config/v1/symfiles` |
| GET | Environment ActiveGate | `https://{your-activegate-domain}/e/{your-environment-id}/api/config/v1/symfiles` |

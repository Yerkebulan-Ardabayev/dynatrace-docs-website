---
title: Management zones API - JSON models
...
Некоторые JSON модели API **Management zones** отличаются в зависимости от **type** некоторых объектов. Здесь можно найти JSON модели для каждого варианта.

## Варианты объекта `ConditionKey`

Объект `ConditionKey` является базовым для всех условий. Фактический набор полей зависит от **type** условия.
...
| --- | --- | --- |
| dynamicKey | [CustomHostMetadataKey](#openapi-definition-CustomHostMetadataKey) | Ключ атрибута, для которого нужны динамические ключи.  В остальных случаях не применяется, так как сам атрибут выступает в роли ключа. |

#### Объект `CustomHostMetadataKey`

Ключ атрибута, для которого нужны динамические ключи.

В остальных случаях не применяется, так как сам атрибут выступает в роли ключа.
...
| Элемент | Тип | Описание |
| --- | --- | --- |
| dynamicKey | [CustomProcessMetadataKey](#openapi-definition-CustomProcessMetadataKey) | Ключ атрибута, для которого нужны динамические ключи.  В остальных случаях не применяется, так как сам атрибут выступает в роли ключа. |
...
| Элемент | Тип | Описание |
| --- | --- | --- |
| dynamicKey | string | Ключ атрибута, для которого нужны динамические ключи.  В остальных случаях не применяется, так как сам атрибут выступает в роли ключа. |
...
Объект `ComparisonBasic` является базовым для всех операций сравнения. Фактический набор полей зависит от **type** сравнения.
...
| Элемент | Тип | Описание |
| --- | --- | --- |
| operator | string | Оператор сравнения. Его можно инвертировать, установив **negate** в значение `true`.  Возможные значения зависят от **type** сравнения. Список фактических моделей приведён в описании поля **type**: найди там описание нужной модели. Элемент может принимать следующие значения * `EQUALS` * `EXISTS` |
...
| Элемент | Тип | Описание |
| --- | --- | --- |
| operator | string | Оператор сравнения. Его можно инвертировать, установив **negate** в `true`. Возможные значения зависят от **type** сравнения. Список актуальных моделей приведён в описании поля **type**, там же можно посмотреть описание нужной модели. Элемент может принимать следующие значения: * `EQUALS` * `EXISTS` |
...
| Элемент | Тип | Описание |
| --- | --- | --- |
| operator | string | Оператор сравнения. Его можно инвертировать, установив **negate** в `true`. Возможные значения зависят от **type** сравнения. Список актуальных моделей приведён в описании поля **type**, там же можно посмотреть описание нужной модели. Элемент может принимать следующие значения: * `EQUALS` |
...
| operator | string | Оператор сравнения. Его можно инвертировать, установив **negate** в `true`. Возможные значения зависят от **type** сравнения. Список актуальных моделей приведён в описании поля **type**, там же можно посмотреть описание нужной модели. Элемент может принимать следующие значения: * `CONTAINS` * `EQUALS` * `EXISTS` |
| value | string | Значение для сравнения. |
...
| Элемент | Тип | Описание |
| --- | --- | --- |
| operator | string | Оператор сравнения. Его можно инвертировать, установив **negate** в `true`. Возможные значения зависят от **type** сравнения. Список актуальных моделей приведён в описании поля **type**, там же можно посмотреть описание нужной модели. Элемент может принимать следующие значения: * `EQUALS` * `EXISTS` * `TAG_KEY_EQUALS` |

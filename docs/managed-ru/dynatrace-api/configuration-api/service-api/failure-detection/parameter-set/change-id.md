...
| body | [EntityShortRepresentation](#openapi-definition-EntityShortRepresentation) | JSON-тело запроса. Содержит новый ID набора. Все остальные поля игнорируются. | body | Required |

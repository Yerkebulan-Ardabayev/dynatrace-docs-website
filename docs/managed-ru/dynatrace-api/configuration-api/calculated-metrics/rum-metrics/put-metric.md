...
| --- | --- | --- | --- | --- |
| metricKey | string | Ключ вычисляемой метрики веб-приложения, которую нужно обновить. | path | Required |
| body | [WebApplicationMetricUpdate](#openapi-definition-WebApplicationMetricUpdate) | JSON-тело запроса. Содержит обновлённые параметры вычисляемой метрики веб-приложения. | body | Required |

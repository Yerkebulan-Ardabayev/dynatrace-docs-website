...
Этот API-вызов возвращает текущий статус конфигурации узлов кластера.
...
В этом примере просматриваются все исторические статусы операций реконфигурации узлов. Например, когда отключили трафик Web UI или включили трафик OneAgent.

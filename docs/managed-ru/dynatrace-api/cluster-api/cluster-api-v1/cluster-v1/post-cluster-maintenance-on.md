...
Этот API-запрос включает maintenance кластера.
...
| Код | Тип | Описание |
| --- | --- | --- |
| **200** | - | Успех. Maintenance включён. |
| **400** | [ErrorEnvelope](#openapi-definition-ErrorEnvelope) | Ошибка. Некорректный ввод. |
| **409** | [ErrorEnvelope](#openapi-definition-ErrorEnvelope) | Ошибка. Невозможно включить maintenance, так как предыдущий ещё не завершился. |

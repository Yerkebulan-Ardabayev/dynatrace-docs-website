...
ZIP-файл с файлами данных лицензии в формате JSON. Детали JSON-формата смотрите в [Export license data](/managed/managed-cluster/operation/export-license-data "Узнайте, как экспортировать данные лицензии из Cluster Management Console.").

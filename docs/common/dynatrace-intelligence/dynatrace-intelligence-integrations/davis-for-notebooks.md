...
source: https://docs.dynatrace.com/docs/dynatrace-intelligence/dynatrace-intelligence-integrations/davis-for-notebooks
updated: 2026-02-09
---
...
For each of these options, you can configure a [missing data alert](../../../ru/dynatrace-intelligence/anomaly-detection/anomaly-detection-configuration.md#missing-data "How to set up an alert for missing measurements."). Missing data and threshold conditions are combined by the **OR** logic.
...
3. Add a **Query Grail** section and [query](../../analyze-explore-automate/dashboards-and-notebooks/notebooks.md#query-grail "Analyze, visualize, and share insights from your observability dataâall in one collaborative, customizable workspace.") the data you're interested in, or add a **Metrics** section and select the required metric.
...
Dynatrace Intelligence predictive AI analysis foresees future values of any time series of numeric values based on the accumulated data. To trigger a [forecast analysis](../../../ru/dynatrace-intelligence/reference/ai-models/forecast-analysis.md "Learn how Dynatrace Intelligence predictive AI generates forecasts.")

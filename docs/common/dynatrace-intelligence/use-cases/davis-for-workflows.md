...
source: https://docs.dynatrace.com/docs/dynatrace-intelligence/use-cases/davis-for-workflows
updated: 2026-02-09
---
...
After installation, Dynatrace Intelligence actions appear automatically in the **Chose action** section of [Workflows](../../../ru/analyze-explore-automate/workflows.md "Automate IT processes with Dynatrace Workflowsâreact to events, schedule tasks, and connect services.").

...
source: https://docs.dynatrace.com/docs/dynatrace-intelligence/copilot/quick-analysis-copilot-dql
updated: 2026-02-09
---
...
2. If the request is well-formulated and recognized (see Dynatrace Intelligence generative AI - Tips for writing better prompts for more information), Dynatrace Intelligence generative AI matches the user request with the Dynatrace-owned content, such as documentation and curated query examples, and passes the prompt to LLM.

...
source: https://docs.dynatrace.com/docs/dynatrace-intelligence/anomaly-detection/anomaly-detection-app/configure-a-simple-ad
updated: 2026-02-09
---
...
* [Configure an advanced custom alert](configure-an-advanced-ad.md "Learn how to create and edit advanced custom alerts in the Anomaly Detection app")

...
Make sure to review [Cost Allocation documentation](../../../../ru/license/cost-allocation.md "Learn how to allocate costs to cost centers and products.") when choosing the best approach for your environment.

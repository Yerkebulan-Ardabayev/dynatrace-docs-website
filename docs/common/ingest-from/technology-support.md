...
Supported for OneAgent 1.267+ installed on the Podman node using [crunï»¿](https://github.com/containers/crun) container runtime, versions 0.17 - 1.15 Podman using the `runc` runtime isn't supported. For more details. see OneAgent release notes version 1.267.
...
See [Dynatrace Hubï»¿](https://www.dynatrace.com/hub/?filter=all&type=extension&internal_source=doc&internal_medium=link&internal_campaign=cross) for the complete list of technologies supported by Dynatrace Extensions.

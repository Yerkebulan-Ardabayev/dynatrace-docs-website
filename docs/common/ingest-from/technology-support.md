...
source: https://docs.dynatrace.com/docs/ingest-from/technology-support
updated: 2026-02-09
---
...
You can install OneAgent on the following [Linux](#linux), [Unix](#unix), [Windows](#windows), and [z/OS](../../ru/ingest-from/technology-support/mainframe-technology-support.md "Learn which technologies Dynatrace supports for Mainframe monitoring.") operating systems.

### Linux

Dynatrace only tests and provides support for installation of OneAgent on the [Linux](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") distributions and versions listed below.
...
| --- | --- | --- |
| [AlmaLinux](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 8, 9, 10 | ARM64 (AArch64), PPCLE, s390, x86-64 |
| [Alpine Linux (musl libc) for containers](technology-support/oneagent-platform-and-capability-support-matrix.md "Learn which capabilities are supported by OneAgent on different operating systems and platforms.") | 3.10 - 3.21[1](#fn-supported-os-1-def) | x86-64 |
| [Azure Linux](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 2, 3 | x86-64 |
| [Bottlerocket](../../ru/ingest-from/setup-on-k8s/deployment/application-observability.md "Deploy Dynatrace Operator in application monitoring mode to Kubernetes") | 1[2](#fn-supported-os-2-def) | ARM64 (AArch64), x86-64 |
| [CentOS Stream](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 9 | ARM64 (AArch64), PPCLE, x86-64 |
| [Debian](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 11, 12 | ARM64 (AArch64), x86-64 |
| [Fedora](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 41, 42 | x86-64 |
| [Oracle Linux](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 7, 8, 9, 10 | x86-64 |
| [Red Hat Enterprise Linux](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 7, 8, 9, 10 | ARM64 (AArch64), PPCLE, s390, x86-64 |
| [Red Hat Enterprise Linux CoreOS](setup-on-k8s.md "Ways to deploy and configure Dynatrace on Kubernetes") | 4.14[3](#fn-supported-os-3-def), 4.15[3](#fn-supported-os-3-def), 4.16[3](#fn-supported-os-3-def) | x86-64 |
| [Rocky Linux](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 8, 9, 10 | ARM64 (AArch64), x86-64 |
| [SUSE Linux Enterprise Server](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 12.5, 15.3, 15.4, 15.5, 15.6, 15.7 | PPCLE, s390, x86-64 |
| [SUSE Linux Enterprise Server](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 15.3, 15.4, 15.5, 15.6, 15.7 | ARM64 (AArch64) |
| [Ubuntu](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 16.04 LTS, 18.04 LTS, 20.04 LTS, 22.04 LTS, 24.04 LTS | PPCLE, x86-64 |
| [Ubuntu](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 18.04 LTS, 20.04 LTS, 22.04 LTS, 24.04 LTS | ARM64 (AArch64), s390 |
| [openSUSE](dynatrace-oneagent/installation-and-operation/linux.md "Learn how to install OneAgent on Linux, how to customize installation, and more.") | 15.6 | PPCLE, x86-64 |
...
| --- | --- | --- |
| [IBM AIX](dynatrace-oneagent/installation-and-operation/aix.md "Learn how to install OneAgent on AIX, how to customize installation, and more.") | 7.2 TL5[1](#fn-unix-system-1-def), 7.3 TL1[1](#fn-unix-system-1-def), 7.3 TL2[1](#fn-unix-system-1-def), 7.3 TL3[1](#fn-unix-system-1-def) | POWER10, POWER8, POWER9 |
| [Solaris](dynatrace-oneagent/installation-and-operation/solaris.md "Learn how to install, update and troubleshoot OneAgent on Solaris.") | 11.4 | SPARC, x86-64 |
...
Dynatrace only tests and provides support for installation of OneAgent on the [Windows](dynatrace-oneagent/installation-and-operation/windows.md "Learn how to install OneAgent on Windows, how to customize installation, and more.") versions listed below.
...
| --- | --- | --- |
| [Windows Desktop 10](dynatrace-oneagent/installation-and-operation/windows.md "Learn how to install OneAgent on Windows, how to customize installation, and more.") | 22H2[1](#fn-windows-os-1-def), 1507[2](#fn-windows-os-2-def), 1607[2](#fn-windows-os-2-def), 1809[2](#fn-windows-os-2-def), 21H2[2](#fn-windows-os-2-def) | x86-64 |
| [Windows Desktop 11](dynatrace-oneagent/installation-and-operation/windows.md "Learn how to install OneAgent on Windows, how to customize installation, and more.") | 22H2, 23H2, 24H2, 25H2 | x86-64 |
| [Windows Server](dynatrace-oneagent/installation-and-operation/windows.md "Learn how to install OneAgent on Windows, how to customize installation, and more.") | 2012 R2[3](#fn-windows-os-3-def), 2016[4](#fn-windows-os-4-def), 2019[4](#fn-windows-os-4-def), 2022[4](#fn-windows-os-4-def), 2025[4](#fn-windows-os-4-def) | x86-64 |
| [Windows Server - Nano](dynatrace-oneagent/installation-and-operation/windows.md "Learn how to install OneAgent on Windows, how to customize installation, and more.") | All versions supported[5](#fn-windows-os-5-def) | x86-64 |
...
If the `mmpmonSocket` command on Linux fails, a fallback mode is available, which works when the CAP\_SETUID capability is enabled. For details, see [OneAgent configuration via command-line interface](../../ru/ingest-from/dynatrace-oneagent/oneagent-configuration-via-command-line-interface.md#capsetuid-osagent "Learn how to perform some OneAgent configuration tasks without the need to reinstall OneAgent.").
...
Please see [known limitations of Docker container monitoring](../observe/infrastructure-observability/container-platform-monitoring/container-platform-limitations-and-security.md#limitations "Overview on container groups monitoring").
...
| QEMU |
| Xen |
| [VMware](../observe/infrastructure-observability/vmware-vsphere-monitoring.md "Monitor VMware vSphere with Dynatrace.") |
...
### [AWS](amazon-web-services.md "Set up and configure monitoring for Amazon Web Services.")
...
| [Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration/trace-lambda-functions.md "Monitor AWS Lambda functions.") |
| [Relational Database Service (RDS)](amazon-web-services/integrate-with-aws/cloudwatch-metrics/view-aws-monitoring-results.md#relational-database-service-page "Display AWS monitoring results in Dynatrace on your home dashboard, AWS account page, host page, and more.") |
| [Simple Storage Service (S3)](../../ru/ingest-from/amazon-web-services/aws-platform/set-up-cors-in-amazon-s3.md "Integrate CORS in Amazon Web Services for buckets within Amazon S3.") |

### [Microsoft Azure](../../ru/ingest-from/microsoft-azure-services/azure-integrations.md "Set up Dynatrace deep code monitoring on Azure using OneAgent or OpenTelemetry.")

| Compute service | Extension for deploying OneAgent | Integration of Dynatrace with Azure Monitor |
| --- | --- | --- |
| [Virtual Machines](../../ru/ingest-from/microsoft-azure-services/azure-integrations/azure-vm.md "Learn how to install and configure OneAgent for monitoring Azure Virtual Machines using a VM extension.") | VM-Extension[1](#fn-4-1-def) | yes |
| [Virtual Machine Scale Set](../../ru/ingest-from/microsoft-azure-services/azure-integrations/azure-vmss.md "Learn how to install, configure, and troubleshoot OneAgent for monitoring Azure VM Scale Set using a VM extension.") | VM-Extension[1](#fn-4-1-def) | yes |
| [Service Fabric](../../ru/ingest-from/microsoft-azure-services/azure-integrations/azure-servicefabric.md "Learn how to install, configure, and troubleshoot OneAgent for monitoring Azure Service Fabric using a VM extension.") | VM-Extension[1](#fn-4-1-def) | yes |
| [Azure Kubernetes Service (AKS)](../../ru/ingest-from/microsoft-azure-services/azure-integrations/azure-aks.md "Learn how to deploy, operate, and maintain OneAgent on Azure Kubernetes Service.") | Operator-rollout[2](#fn-4-2-def) | no |
...
| [App Service](../../ru/ingest-from/microsoft-azure-services/azure-integrations/azure-appservice/integrate-oneagent-on-azure-app-service.md "Install, configure, update, uninstall, and troubleshoot OneAgent for monitoring Azure App Service on Windows using an Azure site extension.") (Windows based) | SiteExtension | yes |
| [Azure Functions](../../ru/ingest-from/microsoft-azure-services/azure-integrations/azure-functions/integrate-oneagent-on-azure-functions.md "Learn how to install, configure, update, and uninstall OneAgent for monitoring Azure Functions using an Azure site extension.") | SiteExtension (Early Adopter release) | yes |
...
### [Google Cloud](../../ru/ingest-from/google-cloud-platform/gcp-integrations.md "Set up and configure Dynatrace on Google Cloud.")

| Google Cloud services |
| --- |
| [Google Kubernetes Engine](../../ru/ingest-from/google-cloud-platform/gcp-integrations/google-gke.md "Google GKE") |
| [GKE Autopilot](../../ru/ingest-from/setup-on-k8s/deployment/application-observability.md#automatic "Deploy Dynatrace Operator in application monitoring mode to Kubernetes") (only for automatic `applicationMonitoring`) |
| [Google App Engine](../../ru/ingest-from/google-cloud-platform/gcp-integrations/google-app-engine.md "Install OneAgent on Google App Engine clusters for application-only monitoring.") |
| [Google Compute Engine](../../ru/ingest-from/google-cloud-platform/gcp-integrations/google-compute-engine.md "Install OneAgent on Google Compute Engine.") |
...
Dynatrace supports a variety of Kubernetes flavors according to our [support model for Kubernetes and Openshift](../../ru/ingest-from/technology-support/support-model-and-issues.md "How Dynatrace supports Kubernetes and Red Hat OpenShift versions and known issues").
...
Some distributions and hosted versions require additional configuration. See [Technology support](../../ru/ingest-from/setup-on-k8s/deployment/supported-technologies.md "Overview of different configurations for all major Kubernetes distributions.") for more details.

## Other container and PaaS platforms

### [Cloud Foundry](setup-on-container-platforms/cloud-foundry.md "Set up and configure Dynatrace on Cloud Foundry.")
...
| IBM WebSphere Liberty buildpack | v3.9-20170419-1403+ [See known issue](../../ru/ingest-from/technology-support/known-solutions-and-workarounds.md "Check the solutions for reported problems regarding various technologies.") |

#### [IBM Cloud Foundry](setup-on-container-platforms/cloud-foundry.md "Set up and configure Dynatrace on Cloud Foundry.")

| Features | Versions |
| --- | --- |
| IBM WebSphere Liberty buildpack | v3.9-20170419-1403+ [See known issue](../../ru/ingest-from/technology-support/known-solutions-and-workarounds.md "Check the solutions for reported problems regarding various technologies.") |

#### [Cloud Foundry](../../ru/ingest-from/technology-support/support-model-for-pivotal-platform.md "Read about Dynatrace support for VMware Tanzu Application Service.")
...
| VMware Tanzu Application Service (via BOSH add-on) | [See support model for Tanzu Application Service](../../ru/ingest-from/technology-support/support-model-for-pivotal-platform.md "Read about Dynatrace support for VMware Tanzu Application Service.") |

### [Heroku](setup-on-container-platforms/heroku.md "Install OneAgent to monitor applications running on Heroku.")
...
For details, see [Supported technologies](../../ru/secure/application-security.md#tech "Access the Dynatrace Application Security functionalities.").
...
See [Dynatrace support/desupport for Java versions](../../ru/ingest-from/technology-support/application-software/java.md "Learn about all aspects of Dynatrace support for Java application monitoring.") for details.
...
Powered by Oracle JVM 8 or 11. For Native Images, see [Java Native Images](technology-support.md#java-native-image "Find technical details related to Dynatrace support for specific platforms and development frameworks.")

6

Powered by Oracle JVM 8, 11 or 17. For Native Images, see [Java Native Images](technology-support.md#java-native-image "Find technical details related to Dynatrace support for specific platforms and development frameworks.").

7

Powered by Oracle JVM 11, 17 or 19. For Native Images, see [Java Native Images](technology-support.md#java-native-image "Find technical details related to Dynatrace support for specific platforms and development frameworks.")
...
Only synchronous request-handling supported. Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options").

4

Only HTTP/1.1 request-handling supported. Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options").
...
Publishers supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options").
...
Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options"). Extended tracing support for all AWS service calls

3

Only supported when Netty is used; not supported when using Artery. Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options").

4

gRPC client calls supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options").

5

Only supported when classic-remoting is used; not supported when using Artery. Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options").
...
See also [OneAgent SDK for Java](../../ru/ingest-from/extend-dynatrace/extend-tracing/oneagent-sdk.md "The Dynatrace OneAgent SDK enables you to instrument your application manually to extend end-to-end visibility for frameworks and technologies for which there is no code module yet available.") for custom tracing capabilities.

### [Java Native Image](../../ru/ingest-from/technology-support/application-software/java/graalvm-native-image.md "Install, configure, and manage Dynatrace GraalVM Native Image module.")

| Virtual machine | Versions | Platforms |
| --- | --- | --- |
| [GraalVM Native Image](../../ru/ingest-from/technology-support/application-software/java/graalvm-native-image.md "Install, configure, and manage Dynatrace GraalVM Native Image module.") | GraalVM for JDK 17 version 23[1](#fn-virtual-machine-1-def), GraalVM for JDK 21 version 23[1](#fn-virtual-machine-1-def), GraalVM for JDK 22[1](#fn-virtual-machine-1-def), GraalVM for JDK 23[1](#fn-virtual-machine-1-def), GraalVM for JDK 24[1](#fn-virtual-machine-1-def) | Linux (x86-64, ARM64 (AArch64)), Windows (x86-64) |
...
### [.NET](../../ru/ingest-from/technology-support/application-software/dotnet.md "Learn about all aspects of Dynatrace support for .NET application monitoring.")
...
| --- | --- | --- |
| [.NET and .NET Core](../../ru/ingest-from/technology-support/application-software/dotnet.md "Learn about all aspects of Dynatrace support for .NET application monitoring.") | Core 2.1, Core 2.2, Core 3.0, Core 3.1 | Alpine Linux 64-bit (x86-64), Linux (x86-64), Windows (x86-64) |
| [.NET and .NET Core](../../ru/ingest-from/technology-support/application-software/dotnet.md "Learn about all aspects of Dynatrace support for .NET application monitoring.") | 5, 6, 7, 8, 9, 10 | Alpine Linux 64-bit (x86-64, ARM64 (AArch64)), Linux (x86-64, ARM64 (AArch64)), Windows (x86-64) |
...
See also [OneAgent SDK for .NET](../../ru/ingest-from/extend-dynatrace/extend-tracing/oneagent-sdk.md "The Dynatrace OneAgent SDK enables you to instrument your application manually to extend end-to-end visibility for frameworks and technologies for which there is no code module yet available.") for custom tracing capabilities.

### [.NET Framework](../../ru/ingest-from/technology-support/application-software/dotnet.md "Learn about all aspects of Dynatrace support for .NET application monitoring.")

Dynatrace supports .NET applications written in C#. Limited support for .NET applications written in other languages is available, though not explicitly tested.

| Runtime | Versions | Platforms |
| --- | --- | --- |
| [.NET Framework](../../ru/ingest-from/technology-support/application-software/dotnet.md "Learn about all aspects of Dynatrace support for .NET application monitoring.") | 3.5 SP1, 4[1](#fn-runtime-1-def), 4.5[1](#fn-runtime-1-def), 4.5.1[1](#fn-runtime-1-def), 4.5.2 - 4.8 | Windows (x86-64) |
...
### [Go](../../ru/ingest-from/technology-support/application-software/go.md "Read an overview of Dynatrace support for Go applications.")
...
* See [Supported Go versions](../../ru/ingest-from/technology-support/application-software/go/support/supported-go-versions.md "Find out which Go versions are supported by Dynatrace.") for details.
...
* [Support limited to stable Go releases](technology-support/application-software/go/support/go-known-limitations.md#go-official-stable-releases "Learn the limitations for Go support and their workarounds.").
* On Linux systems, application binary must be dynamically linked unless you're using [Go static monitoring](technology-support/application-software/go/configuration-and-analysis/enable-go-monitoring.md#go-static-monitoring "Learn how you can enable Go monitoring in Dynatrace.").
...
Node.js follows a Long Term Support (LTS) release schedule. The following table lists all fully supported versions. However, some end-of-life LTS versions have *limited* support. For details, see [Dynatrace support/desupport for Node.js versions](../../ru/ingest-from/technology-support/application-software/nodejs.md#support-and-desupport "Read about Dynatrace support for Node.js applications.").

| Node.js versions | Versions | Platforms |
| --- | --- | --- |
| [Node.js](../../ru/ingest-from/technology-support/application-software/nodejs.md "Read about Dynatrace support for Node.js applications.") | 18, 20, 22, 24 | Alpine Linux 64-bit (x86-64), Linux (ARM64 (AArch64), PPCLE, s390, x86-64), Windows (x86-64) |
...
Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options"). The following APIs are not support: NoSQL, advanced queuing, two-phase commit, and continuous query notification.
...
Supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options"). Requires Dynatrace Cluster version 1.262+. Service failure detection is not supported.
...
RabbitMQ publishers supported in [AWS Lambda](../../ru/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration.md "AWS Lambda capabilities and integration options")
...
See also [OneAgent SDK for Node.js](../../ru/ingest-from/extend-dynatrace/extend-tracing/oneagent-sdk.md "The Dynatrace OneAgent SDK enables you to instrument your application manually to extend end-to-end visibility for frameworks and technologies for which there is no code module yet available.") for custom tracing capabilities.
...
* See [OneAgent SDK for Python](../../ru/ingest-from/extend-dynatrace/extend-tracing/oneagent-sdk.md "The Dynatrace OneAgent SDK enables you to instrument your application manually to extend end-to-end visibility for frameworks and technologies for which there is no code module yet available.") for custom tracing capabilities.
* See [Instrument your Python application with OpenTelemetry](../../ru/ingest-from/opentelemetry/walkthroughs/python.md "Learn how to instrument your Python application using OpenTelemetry and Dynatrace.") for OpenTelemetry support.

### [PHP](../../ru/ingest-from/technology-support/application-software/php.md "Read about Dynatrace support for PHP applications.")
...
| --- | --- | --- |
| [PHP](../../ru/ingest-from/technology-support/application-software/php.md "Read about Dynatrace support for PHP applications.") | 7.1 (Zend Engine 3.1), 7.2 (Zend Engine 3.2), 7.3 (Zend Engine 3.3), 7.4 (Zend Engine 3.4), 8.0 (Zend Engine 4.0), 8.1 (Zend Engine 4.1)[1](#fn-php-versions-1-def), 8.2 (Zend Engine 4.2)[2](#fn-php-versions-2-def), 8.3 (Zend Engine 4.3)[3](#fn-php-versions-3-def), 8.4 (Zend Engine 4.4)[4](#fn-php-versions-4-def), 8.5 (Zend Engine 4.5)[5](#fn-php-versions-5-def) | Alpine Linux 64-bit (x86-64), Linux (x86-64, ARM64 (AArch64)), Windows (x86-64) |
...
See [Dynatrace support model for PHP applications](../../ru/ingest-from/technology-support/application-software/php.md "Read about Dynatrace support for PHP applications.") for support and desupport details.
...
See [OneAgent SDK for PHP](../../ru/ingest-from/extend-dynatrace/extend-tracing/oneagent-sdk.md "The Dynatrace OneAgent SDK enables you to instrument your application manually to extend end-to-end visibility for frameworks and technologies for which there is no code module yet available.") for custom tracing capabilities.
...
### C / [C++](../../ru/ingest-from/technology-support/application-software/cpp.md "Learn how to instrument your C++ application with OpenTelemetry as a data source for Dynatrace.")

* See [OneAgent SDK for C/C++](../../ru/ingest-from/extend-dynatrace/extend-tracing/oneagent-sdk.md "The Dynatrace OneAgent SDK enables you to instrument your application manually to extend end-to-end visibility for frameworks and technologies for which there is no code module yet available.") for custom tracing capabilities.
* See [Instrument your C++ application with OpenTelemetry](../../ru/ingest-from/opentelemetry/walkthroughs/cpp.md "Learn how to instrument your C++ application using OpenTelemetry and Dynatrace.") for OpenTelemetry support.

### [Erlang/Elixir](../../ru/ingest-from/technology-support/application-software/erlang-elixir.md "Learn how to instrument your Erlang/Elixir application with OpenTelemetry as a data source for Dynatrace.")

See [Instrument your Erlang application with OpenTelemetry](../../ru/ingest-from/opentelemetry/walkthroughs/erlang.md "Learn how to instrument your Erlang application using OpenTelemetry and Dynatrace.") for OpenTelemetry support.

### [Ruby](../../ru/ingest-from/technology-support/application-software/ruby.md "Learn how to instrument your Ruby application with OpenTelemetry as a data source for Dynatrace.")

See [Instrument your Ruby application with OpenTelemetry](../../ru/ingest-from/opentelemetry/walkthroughs/ruby.md "Learn how to instrument your Ruby application using OpenTelemetry and Dynatrace.") for OpenTelemetry support.

### [Rust](../../ru/ingest-from/technology-support/application-software/rust.md "Learn how to instrument your Rust application with OpenTelemetry as a data source for Dynatrace monitoring.")

See [Instrument your Rust application with OpenTelemetry](../../ru/ingest-from/opentelemetry/walkthroughs/rust.md "Learn how to instrument your Rust application using OpenTelemetry and Dynatrace.") for OpenTelemetry support.
...
Requires runtime instrumentation, see [NGINX runtime instrumentation](../../ru/ingest-from/technology-support/application-software/nginx/manual-runtime-instrumentation.md "Learn how to force instrumenting patched/non-standard NGINX binaries during runtime.")

3

Requires runtime instrumentation, see [NGINX runtime instrumentation](../../ru/ingest-from/technology-support/application-software/nginx/manual-runtime-instrumentation.md "Learn how to force instrumenting patched/non-standard NGINX binaries during runtime."). Reduced instrumentation overhead with agent versions >= 1.313.
...
[How to monitor Varnish Cache](../../ru/observe/infrastructure-observability/databases/extensions/varnish-cache-1.md "Monitor the statistics of your Varnish Cache instances.")
...
If you don't want the RUM JavaScript to be injected into officially unsupported versions, [define appropriate browser exclusion rules](../observe/digital-experience/web-applications/additional-configuration/exclude-browsers-robots-and-spiders-from-monitoring.md#exclude-browsers "Disable Real User Monitoring for certain IP addresses, browsers, bots, and spiders.") in your application settings.
...
Alternative configuration is required when Angular 17+ is used for your application. See [Activate support for Angular 17+](../observe/digital-experience/web-applications/initial-setup/configure-dynatrace-real-user-monitoring-to-capture-xhr-actions.md#enable-angular-17-support "Understand why you need to activate specific JavaScript frameworks for XHR-action support and learn how to configure Real User Monitoring for XHR actions.").
...
On the following web servers and applications, Dynatrace supports [RUM auto-injection](../../ru/observe/digital-experience/web-applications/initial-setup/rum-injection.md "Configure automatic injection of the RUM JavaScript into the pages of your applications"), [RUM JavaScript delivery](../../ru/observe/digital-experience/web-applications/additional-configuration/configure-monitoring-code-source.md "Configure the Real User Monitoring code source for your specific requirements."), [RUM beacon forwarding](../../ru/observe/digital-experience/web-applications/additional-configuration/beacon-endpoint.md "Change the default beacon endpoint URL and send RUM beacons to Dynatrace infrastructure or another instrumented web server."), and [user action to distributed trace correlation](../../ru/observe/digital-experience/web-applications/initial-setup/link-cross-origin-xhrs.md "Enable the correlation between cross-origin XHR actions and distributed traces.").
...
| Microsoft IIS |
| [NGINX](../../ru/ingest-from/technology-support/application-software/nginx.md "Learn the details of Dynatrace support for NGINX.") |
| [Node.js](../../ru/ingest-from/technology-support/application-software/nodejs.md "Read about Dynatrace support for Node.js applications.") |
| Oracle HTTP Server |
...
On the following web servers and applications, Dynatrace supports [user action to distributed trace correlation](../../ru/observe/digital-experience/web-applications/initial-setup/link-cross-origin-xhrs.md "Enable the correlation between cross-origin XHR actions and distributed traces.") for XHR requests.
...
| --- | --- |
| [Android](../../ru/observe/digital-experience/mobile-applications/instrument-android-app.md "Learn how to instrument mobile application monitoring on Android, how to customize instrumentation and more.") | 5.0+ (API 21+) |
| [iOS](../../ru/observe/digital-experience/mobile-applications/instrument-ios-app.md "Instrument mobile application monitoring for iOS apps, customize the auto-instrumentation, and capture additional data via manual instrumentation.") | 12+ |
| [tvOS](../../ru/observe/digital-experience/mobile-applications/instrument-ios-app.md "Instrument mobile application monitoring for iOS apps, customize the auto-instrumentation, and capture additional data via manual instrumentation.") | 12+ |
...
| AFNetworking | 3.3 |
| Alamofire | 5+ |
| [Apache Cordova](../../ru/observe/digital-experience/mobile-applications/cross-platform-frameworks/apache-cordova.md "Set up Dynatrace to monitor hybrid mobile apps with the Cordova plugin.") | 9+ |
| OkHttp | 3+[1](#fn-11-1-def), 4+[1](#fn-11-1-def), 5+[1](#fn-11-1-def) |
| [Xamarin](../../ru/observe/digital-experience/mobile-applications/cross-platform-frameworks/xamarin-nuget.md "Monitor Xamarin apps with Dynatrace OneAgent.")[2](#fn-11-2-def) | Xamarin.iOS, Xamarin.Android, Xamarin.Forms (.NET Standard 2.0+) |
| [.NET MAUI](../../ru/observe/digital-experience/mobile-applications/cross-platform-frameworks/maui.md "Monitor .NET MAUI applications with Dynatrace OneAgent.") | .NET 6.0+ |
| [React Native](../../ru/observe/digital-experience/mobile-applications/cross-platform-frameworks/react-native.md "Auto-instrument your React Native applications with OneAgent.") | 0.59+ |
| [Flutter](../../ru/observe/digital-experience/mobile-applications/cross-platform-frameworks/flutter.md "Learn how to auto-instrument your Flutter applications with OneAgent.") | 1.12+ |
| UIKit | Supported |
| [SwiftUI](../../ru/observe/digital-experience/mobile-applications/instrument-ios-app/instrumentation/instrument-swiftui-controls.md "Use the Dynatrace SwiftUI instrumentor to monitor your SwiftUI apps.") | 2+ |
| [Jetpack Compose](../observe/digital-experience/mobile-applications/instrument-android-app/instrumentation-via-plugin/monitoring-capabilities.md#compose-instrumentation "Configure the Dynatrace Android Gradle plugin to adjust the monitoring capabilities of OneAgent.") | 1.4 - 1.9 |
...
Dynatrace will deprecate the Dynatrace Xamarin NuGet package in May 2024 and desupport it in May 2025. For details, see [Deprecation and end of support for Dynatrace Xamarin NuGet package](../../ru/observe/digital-experience/mobile-applications/cross-platform-frameworks/xamarin-nuget.md#deprecation-announcement "Monitor Xamarin apps with Dynatrace OneAgent.").
...
For more details, check [Dynatrace Android Gradle plugin](../../ru/observe/digital-experience/mobile-applications/instrument-android-app/instrumentation-via-plugin.md "Learn how the Dynatrace Android Gradle plugin can auto-instrument your Android application project.").

### Dynatrace OpenKit

| Product | Versions |
| --- | --- |
| [Java](../../ru/ingest-from/technology-support/application-software/java.md "Learn about all aspects of Dynatrace support for Java application monitoring.") | 7, 8, 11, 12 |
| .NET | Core 3.1, 5, 6 |
...
See [Dynatrace Hubï»¿](https://www.dynatrace.com/hub/?filter=all&type=extension&internal_source=doc&internal_medium=link&internal_campaign=cross) for the complete list of technologies supported by [Dynatrace Extensions](../../ru/ingest-from/extensions.md "Learn how to create and manage Dynatrace Extensions.").

## Metric ingestion data sources

| Technologies | Versions |
| --- | --- |
| [StatsD](../../ru/ingest-from/extend-dynatrace/extend-metrics/ingestion-methods/statsd.md "Ingest metrics into Dynatrace using OneAgent and the ActiveGate StatsD client.") | All versions supported[1](#fn-technologies-1-def) |

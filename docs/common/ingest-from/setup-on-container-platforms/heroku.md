...
source: https://docs.dynatrace.com/docs/ingest-from/setup-on-container-platforms/heroku
updated: 2026-02-09
---
...
The Dynatrace Heroku buildpack enables you to monitor all [supported languages on Linux systems](../technology-support.md#applications-services-and-databases "Find technical details related to Dynatrace support for specific platforms and development frameworks.").

## Prerequisites

* Create a [PaaS Token](../../../ru/manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens.md#paas-token "Learn the concept of an access token and its scopes.").
...
| --- | --- |
| DT\_TENANT | Your Dynatrace environment ID **Note:** For details on how to determine your environment ID, see [environment ID](../../../ru/discover-dynatrace/get-started/monitoring-environment.md "Understand and learn how to work with monitoring environments."). |

...
source: https://docs.dynatrace.com/docs/ingest-from/setup-on-container-platforms/deploy-dynatrace-oneagent-on-mesos-marathon
updated: 2026-02-09
---
...
* For the `API-Token` value, you need a [PaaS token](../../../ru/manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens.md#paas-token "Learn the concept of an access token and its scopes.").

...
Read this explanation](tags-and-metadata/basic-concepts/tags-vs-metadata.md)[#### Best practices and recommendations for tagging
...
Read this explanation](tags-and-metadata/basic-concepts/best-practices-and-recommendations-for-tagging.md)[#### Best practices for scaling tagging and management-zone rules

Optimize auto-tagging and management-zone rules to speed up the automatic assignment process.

* Explanation

Read this explanation](../../ru/manage/tags-and-metadata/basic-concepts/best-practice-tagging-at-scale.md)
...
Read this guide](tags-and-metadata/setup/how-to-define-tags.md)[#### Define tags based on environment variables

Find out how Dynatrace enables you to define tags based on environment variables.

* How-to guide

Read this guide](../../ru/manage/tags-and-metadata/setup/define-tags-based-on-environment-variables.md)
...
Read this explanation](tags-and-metadata/reference/regular-expressions-in-dynatrace.md)
...
Read this guide](../observe/infrastructure-observability/container-platform-monitoring/cloud-foundry-monitoring/organize-cf-deployments-by-tags.md)[#### Organize Kubernetes/OpenShift deployments by tags
...
Read this guide](../../ru/observe/infrastructure-observability/container-platform-monitoring/kubernetes-monitoring/leverage-tags-defined-in-kubernetes-deployments.md)[#### Organize Kubernetes/OpenShift deployments by tags

Organize and filter your monitored applications by importing labels and annotations from your Kubernetes/OpenShift environment.

* How-to guide

Read this guide](../../ru/observe/infrastructure-observability/container-platform-monitoring/kubernetes-monitoring/leverage-tags-defined-in-kubernetes-deployments.md)[#### Define tags and metadata for hosts

Learn how to tag and set additional properties for a monitored host.

* How-to guide

Read this guide](../observe/infrastructure-observability/hosts/configuration/define-tags-and-metadata-for-hosts.md)[#### Define your own process group metadata

Configure your own process-related metadata based on the unique needs of your organization or environment.

* How-to guide

Read this guide](../observe/infrastructure-observability/process-groups/configuration/define-your-own-process-group-metadata.md)

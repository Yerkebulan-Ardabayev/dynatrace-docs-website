---
title: "Clouds app"
source: https://docs.dynatrace.com/docs/observe/infrastructure-observability/cloud-platform-monitoring/clouds-app
updated: 2026-02-09
---
...
* [DPS license](../../../../ru/license.md "About Dynatrace Platform Subscription (DPS), the licensing model for all Dynatrace capabilities.") is required with the following capabilities:
...
* Available for [DPS license](../../../../ru/license.md "About Dynatrace Platform Subscription (DPS), the licensing model for all Dynatrace capabilities.") and [classic licensing](../../../../ru/license/monitoring-consumption-classic.md "Understand how Dynatrace monitoring consumption is calculated for classic licensing.").
...
* How-to guide
* Learn how to create a new AWS connection in the Clouds app.](../../../../ru/observe/infrastructure-observability/cloud-platform-monitoring/clouds-app/create-aws-connection.md)
...
You can find all custom alerts and more information around capabilities and limits in [![Anomaly Detection - new](https://dt-cdn.net/images/davis-anomalydetection-256-105da91594.png "Anomaly Detection - new") **Anomaly Detection**](../../../dynatrace-intelligence/anomaly-detection/anomaly-detection-app.md "Explore anomaly detection configurations using the Anomaly Detection app.").
...
* You can use [Davis Intelligence](../../../dynatrace-intelligence/copilot.md "Learn about Dynatrace Intelligence generative AI.") to get additional insights about the problem and potential remediation steps.
...
You can find more information and join the Cloud Platform Monitoring for Azure Preview through our [Preview program page](../../../whats-new/preview-releases.md#new-cloud-platform-monitoring-for-azure "Learn about our Preview releases and how you can participate in them.").

...
source: https://docs.dynatrace.com/docs/observe/infrastructure-observability/vmware-vsphere-monitoring
updated: 2026-02-09
---
...
1. To learn the schema, use GET a schema with `builtin:virtualization.vmware` as the schemaId.

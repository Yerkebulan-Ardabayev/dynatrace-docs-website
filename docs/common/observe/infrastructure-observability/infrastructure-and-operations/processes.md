---
title: "Processes"
source: https://docs.dynatrace.com/docs/observe/infrastructure-observability/infrastructure-and-operations/processes
updated: 2026-02-09
---
...
* **Health alerts**: Displays health alerts and warning signals powered by Davis AI. For details, see [View health alerts and warning signals](../infrastructure-and-operations.md#health-alerts "Monitor hosts, VMs, processes, and networks to detect issues and improve infrastructure performance.").

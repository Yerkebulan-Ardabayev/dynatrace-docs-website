---
title: Наблюдаемость инфраструктуры
...
Мониторинг состояния и производительности ваших центров обработки данных и зон доступности для обнаружения и устранения критических проблем.
...
Контейнерные платформы, мониторинг которых поддерживает Dynatrace

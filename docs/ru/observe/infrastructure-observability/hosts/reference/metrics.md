...
Вы также можете проверить, доступны ли метрики в режиме мониторинга Discovery. Подробнее см. [Режим Discovery](../../../../platform/oneagent/monitoring-modes/monitoring-modes.md#discovery "Узнайте больше о доступных режимах мониторинга при использовании OneAgent.").

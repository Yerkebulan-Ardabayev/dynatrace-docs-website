...
Это можно сделать с помощью Settings API с использованием [таблицы схем приложения Kubernetes](/docs/dynatrace-api/environment-api/settings/schemas/builtin-app-transition-kubernetes "View builtin:app-transition.kubernetes settings schema table of your monitoring environment via the Dynatrace API."), либо путём настройки параметра, описанного ниже.

...
Потребление лицензии DPS — модели лицензирования для всех возможностей Dynatrace.") основано на принимаемых точках данных метрик. Следующая формула даёт приблизительный годовой объём приёма при включении всех наборов функций и запуске расширения каждую минуту:
...
Для классических лицензий Dynatrace приём метрик потребляет Davis Data Units (DDU) со скоростью 0,001 DDU на точку данных метрики.
Подробнее см. DDU для метрик.

...
Мониторинг баз данных в Dynatrace начинается с установки приложения ![Databases](https://dt-cdn.net/images/dynatrace-database-256-1afe08286e.webp "Databases") **Databases** из **Hub**. Затем можно использовать SQL-расширения для сбора метрик производительности, аналитики запросов и пользовательских SQL-данных, добавляя конфигурации мониторинга для каждого экземпляра.

## Установка приложения Databases

1. Перейдите в **Hub**.
2. Найдите приложение ![Databases](https://dt-cdn.net/images/dynatrace-database-256-1afe08286e.webp "Databases") **Databases**, откройте обзор приложения и нажмите **Open**.
3. Убедитесь, что ваша среда соответствует необходимым [разрешениям](../database-app.md#permissions "Приложение Databases предоставляет обзор всех баз данных, отслеживаемых с помощью Extensions Framework 2.0.").

## Настройка мониторинга баз данных в Dynatrace
...
Мониторинг экземпляров Snowflake с метриками производительности и аналитикой запросов.](get-started/snowflake.md "Как настроить мониторинг баз данных Snowflake в Dynatrace.")[![SAP Hana DB](https://dt-cdn.net/images/sap-hana-768x256-removebg-preview-768-7c1d985abf.png "SAP Hana DB")

### SAP HANA DB

Мониторинг экземпляров SAP HANA DB с метриками производительности и аналитикой запросов.](get-started/sap-hana.md "Как настроить мониторинг баз данных SAP HANA в Dynatrace.")[![IBM DB2](https://dt-cdn.net/images/png-clipart-ibm-db2-logo-ibm-db2-database-computer-software-sql-ibm-text-rectangle-thumbnail-removebg-preview-348-4dff315301.png "IBM DB2")

### IBM DB2

Мониторинг экземпляров IBM DB2 с метриками производительности и аналитикой запросов.](get-started/ibm-db2.md "Как настроить мониторинг баз данных IBM DB2 в Dynatrace.")[![MariaDB](https://dt-cdn.net/hub/mariadb-logo-vert_blue-transparent-icon_1_UyPQzsq_99Xr62T.png "MariaDB")

### MariaDB

Мониторинг экземпляров MariaDB с метриками производительности и аналитикой запросов.](get-started/mariadb.md "Как настроить мониторинг баз данных MariaDB в Dynatrace.")

...
* Сервис (тип сущности: `SERVICE`) автоматически обнаруживается Dynatrace на основе свойств развёртывания и конфигурации вашего приложения. В зависимости от технологий и конфигурации Dynatrace может обнаруживать несколько сервисов на под или сервисы, охватывающие несколько подов.

...
* [Достаточные разрешения](../reference/permissions.md "Overview of user and tailoring permissions.") для использования ![Кубернетес (новый)](https://dt-cdn.net/images/kubernetes-new-1024-45d3de15d1.webp "Kubernetes (new)") **Kubernetes** в вашей среде Dynatrace.
...
Эта предварительная версия основана на **мониторинге платформы Kubernetes**, который включен во все [параметры наблюдения](../../../../../ingest-from/setup-on-k8s/deployment.md "Deploy Dynatrace Operator on Kubernetes").

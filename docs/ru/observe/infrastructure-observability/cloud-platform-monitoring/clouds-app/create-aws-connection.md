---
title: Создание нового подключения AWS
...
Если вы впервые создаёте подключение, сначала ознакомьтесь с инструкциями по первоначальной настройке и её предварительными требованиями.

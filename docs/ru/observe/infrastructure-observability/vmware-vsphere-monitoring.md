...
Установите Environment ActiveGate в вашем центре обработки данных перед подключением Dynatrace к вашей платформе VMware.
...
3. Проверьте сетевые/прокси-настройки.
   ...
   Также при необходимости вы можете обойти прокси для подключения к vCenter или ESXi при настройке интеграции VMware. Измените конфигурацию ActiveGate, чтобы исключить определённый хост из прокси.

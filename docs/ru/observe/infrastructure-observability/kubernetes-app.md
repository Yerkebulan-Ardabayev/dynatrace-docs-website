...
Новый Kubernetes-интерфейс недоступен для Managed ил в средах без Grail — вы можете продолжать использовать **Kubernetes Classic** (доступен из предыдущего Dynatrace через **Kubernetes**).

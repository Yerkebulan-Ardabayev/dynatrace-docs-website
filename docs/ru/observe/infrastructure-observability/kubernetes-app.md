...
Базовые метрики, события и логи работают на основе Grail, что обеспечивает гибкую аналитику с помощью Dynatrace Query Language в ![Kubernetes (new)](https://dt-cdn.net/images/kubernetes-new-1024-45d3de15d1.webp "Kubernetes (new)") **Kubernetes**, ![Dashboards](https://dt-cdn.net/images/dashboards-512-b1f1e9690b.png "Dashboards") **Dashboards** и ![Workflows](https://dt-cdn.net/images/workflows-1024-b5708f3cf9.webp "Workflows") **Workflows**.
...
Для получения дополнительной информации см. FAQ по началу работы.

Новый Kubernetes-интерфейс недоступен для Managed или SaaS в средах без Grail — вы можете продолжать использовать **Kubernetes Classic** (доступен из предыдущего Dynatrace через **Kubernetes**).
...
* Для критических событий создаётся оповещение о здоровье (Health alert), которое запускает расследование Dynatrace Problems.

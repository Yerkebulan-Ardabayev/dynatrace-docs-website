...
5. Задайте **Matching condition** вашего правила как следующий DQL-запрос для matcher:
...
6. Добавьте **Matching condition** к вашему правилу, вставив DQL-запрос для matcher:
...
На этом этапе вы можете начать создание DQL-запросов для анализа загруженных данных, определения метрик и создания графиков и дашбордов.

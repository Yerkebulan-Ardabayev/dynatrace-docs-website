...
5. Задайте **Matching condition** вашего правила как следующий [DQL-запрос для matcher](/docs/platform/openpipeline/reference/dql-matcher-in-openpipeline "Examine specific DQL functions and logical operators for log processing."):
...
6. Добавьте **Matching condition** к вашему правилу, вставив [DQL-запрос для matcher](/docs/platform/openpipeline/reference/dql-matcher-in-openpipeline "Examine specific DQL functions and logical operators for log processing."):
...
На этом этапе вы можете начать создание [DQL](/docs/platform/grail/dynatrace-query-language "How to use Dynatrace Query Language.")-запросов для анализа загруженных данных, определения метрик и создания графиков и дашбордов.

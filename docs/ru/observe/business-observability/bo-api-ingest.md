...
1. В [пользовательском меню](/docs/discover-dynatrace/get-started/dynatrace-ui#user-menu-previous-dynatrace "Навигация в последней версии Dynatrace") (предыдущая версия Dynatrace) выберите **Environment API v2**.
...
Подробнее см. [Обогащение бизнес-событий](/docs/observe/business-observability/bo-events-enrichment "Узнайте, какие свойства Dynatrace автоматически добавляет к отправленным бизнес-событиям.").
...
Чтобы создать новый токен доступа для конечной точки `/bizevents/ingest` API бизнес-событий, следуйте процедуре, описанной в [Dynatrace API — токены и аутентификация](/docs/dynatrace-api/basics/dynatrace-api-authentication#create-token "Узнайте, как пройти аутентификацию для использования Dynatrace API.").
...
**Создайте клиент OAuth**](/docs/observe/business-observability/bo-api-ingest#oauth-client "Настройте аутентификацию и принимайте бизнес-события через API.")[![Шаг 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Шаг 2")

**Создайте политику IAM**](/docs/observe/business-observability/bo-api-ingest#iam-policy "Настройте аутентификацию и принимайте бизнес-события через API.")[![Шаг 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Шаг 3")

**Привяжите политику к группе**](/docs/observe/business-observability/bo-api-ingest#bind-policy "Настройте аутентификацию и принимайте бизнес-события через API.")[![Шаг 4](https://dt-cdn.net/images/step-4-3f89d67d41.svg "Шаг 4")

**Получите токен носителя**](/docs/observe/business-observability/bo-api-ingest#obtain-token "Настройте аутентификацию и принимайте бизнес-события через API.")[![Шаг 5](https://dt-cdn.net/images/step-5-2de312b50f.svg "Шаг 5")

**Аутентифицируйтесь**](/docs/observe/business-observability/bo-api-ingest#authenticate "Настройте аутентификацию и принимайте бизнес-события через API.")
...
3. Выберите **Create policy** и укажите название и описание политики. Эта информация понадобится вам при [привязке политики к группе пользователей](#bind-policy). Подробнее об управлении политиками читайте в [Управление политиками IAM](/docs/manage/identity-access-management/permission-management/manage-user-permissions-policies/iam-policy-mgt "Создавайте, редактируйте, копируйте и удаляйте политики IAM для управления разрешениями пользователей Dynatrace.").
...
Вы можете назначить [созданную политику](#iam-policy) группе, к которой принадлежит ваш пользователь, или добавить пользователя в новую группу. Инструкции по привязке политик к группам см. в [Работа с политиками](/docs/manage/identity-access-management/permission-management/manage-user-permissions-policies#add-or-remove "Работа с политиками").

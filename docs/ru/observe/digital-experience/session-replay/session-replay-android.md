...
Session Replay на Android позволяет записывать взаимодействия ваших клиентов с мобильным приложением и воспроизводить каждое нажатие, свайп, поворот экрана в режиме, подобном видео.
...
* Воспроизводить пользовательские сессии, записанные с помощью Session Replay, можно только в определенных браузерах.
* Дополнительную информацию см. в разделе Технические ограничения Session Replay для веб-приложений.
...
Вы можете включить логи Session Replay так же, как и для OneAgent. Подробнее см. Включение отладочного логирования для Dynatrace Android Gradle plugin или OneAgent SDK.
...
* Session Replay
* Просмотр отчетов о сбоях для мобильных приложений
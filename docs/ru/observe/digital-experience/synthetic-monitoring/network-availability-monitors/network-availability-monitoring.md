...
Вы можете использовать NAM для инфраструктурных сценариев использования или для углубления анализа первопричин для мониторов [HTTP](../http-monitors-classic.md "Узнайте о мониторах HTTP.") и [браузерных](../browser-monitors.md "Узнайте о браузерных мониторах.") мониторов.
...
Вы можете настраивать мониторы NAM и получать доступ к результатам их производительности в [Synthetic](../../synthetic-on-grail/synthetic-app.md "Просмотр синтетических мониторов в вашей среде, поиск мониторов и быстрый обзор выбранного монитора.") в latest Dynatrace.
См. раздел [создание монитора NAM](create-a-nam-monitor.md "Узнайте, как настроить монитор NAM для проверки производительности и доступности вашего сайта."), чтобы узнать, как настроить монитор в [Synthetic](../../synthetic-on-grail/synthetic-app.md "Просмотр синтетических мониторов в вашей среде, поиск мониторов и быстрый обзор выбранного монитора.") или через [API](create-a-nam-monitor.md#nam-api "Узнайте, как настроить монитор NAM для проверки производительности и доступности вашего сайта.").
...
Мониторы доступности сети поддерживаются только на [частных синтетических локациях](../private-synthetic-locations/create-a-private-synthetic-location.md "Узнайте, как создать частную локацию для синтетического мониторинга.").
...
Мониторы доступности сети не поддерживают использование [прокси-серверов](../private-synthetic-locations/setting-up-proxy-for-private-synthetic.md#proxy-connection-scenarios "Узнайте, как настроить свойства ActiveGate для настройки прокси для частного синтетического мониторинга."). Убедитесь, что ваша сетевая конфигурация позволяет прямой доступ к отслеживаемым эндпоинтам без маршрутизации через прокси.

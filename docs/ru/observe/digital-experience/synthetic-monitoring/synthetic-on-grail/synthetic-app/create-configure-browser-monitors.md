...
3. Опционально. Укажите **Context setup**. Вы можете указать:
   ...
   * Запросы с определёнными шаблонами, которые будут заблокированы во время выполнения монитора.
   ...
   Хотя вы можете указать cookies, заголовки и запросы с определёнными шаблонами позже в [Advanced setup](#advanced-setup), в некоторых случаях целесообразно сделать это здесь, чтобы обеспечить плавную [запись кликпути](/docs/observe/digital-experience/synthetic-monitoring/synthetic-on-grail/synthetic-app/create-configure-browser-monitors/clickpath-synthetic-app-browser-monitor "Узнайте, как записать браузерную кликпуть для браузерного монитора").
...
Dynatrace предлагает глобальную сеть [публичных точек Synthetic Monitoring](/docs/observe/digital-experience/synthetic-monitoring/general-information/public-synthetic-locations "Узнайте обо всех доступных в настоящее время публичных точках Synthetic Monitoring.") из коробки. Вы также можете [создать частные синтетические точки](/docs/observe/digital-experience/synthetic-monitoring/synthetic-on-grail/synthetic-app/private-locations "Узнайте, как управлять частными точками в приложении Synthetic.") в рамках вашей собственной сетевой инфраструктуры. Как публичные, так и частные точки отображаются на этой странице настроек.
...
* **Generate a problem and send an alert on performance threshold violations.**
  ...
  Также вы можете установить пороговое значение производительности для [отдельных шагов](/docs/observe/digital-experience/synthetic-monitoring/synthetic-on-grail/synthetic-app/create-configure-browser-monitors/steps-waiting-time-validation-thresholds#performance-thresholds "Узнайте, как настроить время ожидания между шагами, проверку контента и пороговые значения производительности.").
...
Вы можете настроить аутентификацию по сертификату для браузерных мониторов, работающих на любой [публичной точке](/docs/observe/digital-experience/synthetic-monitoring/general-information/public-synthetic-locations "Узнайте обо всех доступных в настоящее время публичных точках Synthetic Monitoring.") и [частных точках](/docs/observe/digital-experience/synthetic-monitoring/synthetic-on-grail/synthetic-app/private-locations "Узнайте, как управлять частными точками в приложении Synthetic.") с ActiveGate на базе Linux (как контейнеризированных, так и неконтейнеризированных).

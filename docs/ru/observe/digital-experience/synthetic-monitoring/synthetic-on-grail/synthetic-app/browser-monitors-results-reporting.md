...
В верхнем правом углу страницы вы можете получить доступ к [**Анализу выполнений**](#analyze-executions), **Выполнению по запросу** и дополнительным настройкам монитора браузера:

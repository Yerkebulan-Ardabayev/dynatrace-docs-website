...
3. Выберите **Processing mode** — он применяется ко всем выбранным локациям для данного выполнения.
   ...
   * **Execution details only** — выполнения не учитываются в статистике доступности и производительности и при обнаружении проблем. Вы по-прежнему можете просмотреть результаты в разделе [**Analyze executions**](browser-monitors-results-reporting.md#analyze-executions "Узнайте о странице деталей браузера для браузерных мониторов.").
   ...
   Обратите внимание, что для всех режимов обработки выполнения видны в списке выполнений по требованию в веб-интерфейсе и доступны через [API выполнений по требованию](../../general-information/on-demand-executions.md#api "Запуск синтетических мониторов по требованию из публичных или приватных локаций").
...
* При запуске нескольких выполнений по требованию через [API](../../general-information/on-demand-executions.md#api "Запуск синтетических мониторов по требованию из публичных или приватных локаций") существует лимит в 100 выполнений на пакет.

...
* Независимо от выбранного подхода к настройке RUM для вашего приложения, добавьте ключи идентификации приложения (идентификатор приложения и URL-адрес маяка) в файл `Info.plist` вашего проекта; ключи [`DTXApplicationID` и `DTXBeaconURL`](../customization/ios-configuration-keys.md#general "С помощью ключей конфигурации можно точно настроить автоинструментирование ваших приложений iOS.") всегда обязательны. Без ключей идентификации приложения ваше мобильное приложение не сможет отправлять данные мониторинга в Dynatrace.
  ...
  Для проверки ключей идентификации приложения используйте мастер инструментирования мобильных приложений.
* Вы также можете использовать `Info.plist` для включения или отключения дополнительных функций мониторинга, добавив ключи конфигурации в этот файл.

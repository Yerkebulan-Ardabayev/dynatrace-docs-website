...
Ключи конфигурации — это, по сути, свойства, которые можно задать по своему усмотрению для автоинструментирования. Добавьте ключи в файл `Info.plist` вашего приложения в соответствии с требованиями для точной настройки автоинструментирования.

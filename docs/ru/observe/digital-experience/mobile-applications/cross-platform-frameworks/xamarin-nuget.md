...
Мы рекомендуем вам [обновить ваши Xamarin проекты до .NET](https://learn.microsoft.com/en-gb/dotnet/maui/migration) и использовать Dynatrace .NET MAUI NuGet пакет вместо устаревшего Xamarin NuGet пакета.

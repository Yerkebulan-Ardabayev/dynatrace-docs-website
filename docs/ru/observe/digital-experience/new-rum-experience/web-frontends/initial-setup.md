...
* У вас есть доступ к веб-серверу, и вы можете установить OneAgent.
...
**Настройка автоматически инструментированного фронтенда****Настройка безагентного RUM**
...
* Использование целостности подресурсов (SRI) в New RUM Experience в New RUM Experience для обеспечения целостности кода Real User Monitoring.")
...
* Выборочное развёртывание RUM для ваших фронтендов в New RUM Experience

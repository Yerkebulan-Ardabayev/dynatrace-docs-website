...
При использовании безагентного мониторинга RUM-beacon-запросы отправляются на Cluster ActiveGate, который является частью инфраструктуры Dynatrace. Эти beacon-запросы являются cross-origin.

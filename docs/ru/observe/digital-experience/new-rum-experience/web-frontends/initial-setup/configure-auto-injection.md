...
Фрагмент RUM JavaScript, внедряемый в HTML вашего приложения, может иметь различные форматы, каждый из которых предназначен для определённых требований, как описано в Выбор формата фрагмента в New RUM Experience.
...
Чтобы узнать больше о различных форматах фрагментов, обратитесь к Выбор формата фрагмента в New RUM Experience.
...
Кроме того, вы можете получить фрагмент через API, что позволяет интегрировать его вставку в процесс сборки. Это гарантирует, что ваш фронтенд постоянно работает с последней конфигурацией.

## Связанные темы

* Настройка автоматически внедряемого фронтенда в New RUM Experience
* Выбор формата фрагмента в New RUM Experience

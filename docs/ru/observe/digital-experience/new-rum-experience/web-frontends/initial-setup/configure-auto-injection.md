---
title: Настройка автоматического внедрения в новом опыте RUM
...
Чтобы узнать больше о различных форматах фрагментов, обратитесь к [Выбор формата фрагмента в New RUM Experience](snippet-formats.md "Узнайте, как выбрать формат фрагмента RUM JavaScript, наиболее подходящий для вашего конкретного случая в New RUM Experience.").
...
Кроме того, вы можете получить фрагмент через [API](../../../../../dynatrace-api/environment-api/rum/rum-manual-insertion-tags.md "Узнайте, как загрузить теги ручной вставки RUM через API"), что позволяет интегрировать его вставку в процесс сборки. Это гарантирует, что ваш фронтенд постоянно работает с последней конфигурацией.
...
* [Выбор формата фрагмента в New RUM Experience](snippet-formats.md "Узнайте, как выбрать формат фрагмента RUM JavaScript, наиболее подходящий для вашего конкретного случая в New RUM Experience.")

...
Оптимальный подход к использованию SRI для безагентного фронтенда — это интеграция вставки тега OneAgent JavaScript с SRI в ваш процесс сборки через API. Это гарантирует, что ваш фронтенд всегда работает с актуальной конфигурацией.
...
* Выбор формата сниппета в новом интерфейсе RUM
* Настройка автоматического внедрения в новом интерфейсе RUM
* Настройка безагентного RUM в новом интерфейсе RUM

...
Если вы используете безагентный мониторинг, данные отправляются на Cluster ActiveGate, который является частью инфраструктуры Dynatrace.
...
### Автоматически инжектируемый фронтенд: отправка beacon-сигналов в инфраструктуру Dynatrace

Если вы хотите, чтобы RUM beacon-сигналы автоматически инжектируемого фронтенда обрабатывались инфраструктурой Dynatrace вместо OneAgent, выполните следующие шаги.

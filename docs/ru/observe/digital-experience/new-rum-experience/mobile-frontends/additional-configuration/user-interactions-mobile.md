...
В настоящее время события касания являются поддерживаемым типом пользовательских взаимодействий для мобильных фронтендов и захватываются при касании пользователем мобильного компонента.

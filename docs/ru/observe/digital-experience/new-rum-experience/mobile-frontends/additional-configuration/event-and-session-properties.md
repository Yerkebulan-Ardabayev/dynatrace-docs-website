...
Свойства событий и сессий позволяют прикреплять пользовательские пары «ключ–значение» к событиям пользователей и пользовательским сессиям с использованием пространств имён `event_properties` и `session_properties`.
...
Свойства событий и сессий можно отправлять через новые RUM API для мобильных фронтендов, включая конфигурацию запуска, отчётность о событиях, обработку ошибок, отслеживание представлений и расширенные функции Dynatrace на базе Grail."):
...
* Новые RUM API для мобильных фронтендов для мобильных фронтендов, включая конфигурацию запуска, отчётность о событиях, обработку ошибок, отслеживание представлений и расширенные функции Dynatrace на базе Grail.")

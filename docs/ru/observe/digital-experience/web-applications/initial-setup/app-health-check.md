...
Раздел **Диагностика внедрения RUM JavaScript** не отображается, если ваше приложение не является автоматически внедряемым приложением — в частности, если вы вручную вставили RUM JavaScript на страницы своего приложения.

...
scraped: 2026-02-26T21:28:11.272069
---
...
Because the RUM monitoring code is inlined, its cache duration matches that of your page, which is determined by the cache settings on your web server. The Session Replay monitoring code can be cached for up to a year by both browsers and the Dynatrace CDN. This extended cache duration is made possible by embedding the RUM JavaScript version in the file URL.

...
В дополнение к SDv1 можно также использовать [Service Detection v2](service-detection-v2.md "Узнайте, как обнаруживать, именовать и разделять сервисы из спанов OpenTelemetry и OneAgent.") (SDv2), который обеспечивает унифицированные правила обнаружения сервисов для источников данных OpenTelemetry и OneAgent. SDv2 доступен в общей доступности для OpenTelemetry и в публичной предварительной версии для OneAgent на Kubernetes.
...
Подробнее см. в разделе [Правила обнаружения сервисов](service-detection-v1/customize-service-detection.md "Использование правил обнаружения для настройки и улучшения автоматического обнаружения сервисов.").
...
Дополнительную информацию см. в разделе [Правила именования сервисов](service-detection-v1/customize-service-naming.md "Использование правил именования для настройки и улучшения автоматического именования сервисов.")
...
Подробнее см. в разделе [Настройка именования запросов](service-detection-v1/set-up-request-naming.md "Настройка именования запросов и определение операций, предоставляемых сервисами.").
...
Дополнительную информацию см. в разделе [Настройка обнаружения сбоев сервиса](service-detection-v1/configure-service-failure-detection.md "Узнайте, какие типы ошибок сервиса Dynatrace обнаруживает автоматически, и научитесь настраивать параметры обнаружения сбоев под свои требования.").
...
* [Обнаружение групп процессов](../../../infrastructure-observability/process-groups/configuration/pg-detection.md "Способы настройки обнаружения групп процессов")

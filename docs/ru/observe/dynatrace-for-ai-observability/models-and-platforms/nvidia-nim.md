...
Следуйте руководству Настройка Dynatrace в Kubernetes для мониторинга вашего кластера.
...
Следуйте руководству по установке OpenTelemetry Collector для развертывания коллектора.

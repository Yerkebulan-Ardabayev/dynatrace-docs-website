...
* [Логирования информации и захвата метрик и маппинга трассировок непосредственно из записей логов.](openai-observability.md#lplogs "Узнайте о Dynatrace для наблюдаемости OpenAI, как Dynatrace наблюдает за сервисами OpenAI и многое другое.")
* [Отправки пользовательских метрик через канал приёма метрик OneAgent.](openai-observability.md#lpcustom-metrics "Узнайте о Dynatrace для наблюдаемости OpenAI, как Dynatrace наблюдает за сервисами OpenAI и многое другое.")

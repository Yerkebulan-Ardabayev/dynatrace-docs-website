...
* [Захвата частей полезной нагрузки запроса с помощью бизнес-событий.](../../../business-observability/bo-event-processing/bo-processing-classic-pipeline.md "Обработка данных бизнес-событий в Dynatrace через классический конвейер.")

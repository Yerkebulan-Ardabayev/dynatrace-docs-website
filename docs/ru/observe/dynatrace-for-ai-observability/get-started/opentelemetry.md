...
* Dynatrace SaaS с лицензией Dynatrace Platform Subscription (DPS) — модели лицензирования для всех возможностей Dynatrace."), в которой включены Traces powered by Grail."), Metrics powered by Grail и Log Analytics.

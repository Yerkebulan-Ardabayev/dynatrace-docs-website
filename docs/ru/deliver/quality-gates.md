...
5. Проверьте результаты
   ...
   ```
6. Если ваш пайплайн завершился успешно, вы можете запустить ещё один рабочий процесс, отправляющий уведомление члену вашей команды, который может одобрить продвижение. Для этого вы можете использовать один из [коннекторов Workflows](/docs/analyze-explore-automate/workflows/actions "Use Dynatrace ready-made actions for your workflows and integrate Dynatrace with third-party systems."), например Slack, Microsoft Teams или Jira.

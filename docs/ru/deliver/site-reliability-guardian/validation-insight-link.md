...
* Для [гардианов жизненного цикла](../site-reliability-guardian.md#lifecycle-guardian "Автоматическая валидация целей производительности, доступности и ёмкости критических сервисов для принятия правильного решения о выпуске.") аналитику валидации для типа события `validation.objective` можно найти в свойстве `dt.srg.objective`.
  ...
  ```
* Для [бизнес-гардианов](../site-reliability-guardian.md#business-guardian "Автоматическая валидация целей производительности, доступности и ёмкости критических сервисов для принятия правильного решения о выпуске.") ссылки на цели для типа события `guardian.validation.objective` можно найти в свойстве `guardian.objective`.
...
Ознакомьтесь с контекстом выполнения гардиана. Используйте события из вашего инструмента непрерывной интеграции (CI) для отправки в Dynatrace, который, в свою очередь, может запустить валидацию вашего гардиана в рабочем процессе.
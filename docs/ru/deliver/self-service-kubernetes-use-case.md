...
Чтобы завершить настройку рабочего процесса прогнозирования, необходимо зафиксировать его в системе. Это позволит сохранить все изменения и настройки, сделанные на предыдущих шагах. 

После фиксации рабочего процесса он будет доступен для использования в других частях системы Dynatrace, таких как Smartscape и PurePath. Это позволит получить более полное представление о поведении и производительности системы, а также использовать возможности Davis AI и Grail для анализа и прогнозирования.

Чтобы зафиксировать рабочий процесс, выполните следующие действия:

* Откройте редактор рабочего процесса и нажмите кнопку "Зафиксировать"
* Введите комментарий, описывающий изменения, сделанные в рабочем процессе
* Нажмите кнопку "Зафиксировать", чтобы сохранить изменения

После фиксации рабочего процесса он будет доступен для использования в других частях системы Dynatrace. Это позволит использовать возможности DQL для анализа и прогнозирования, а также интегрировать рабочий процесс с другими инструментами и системами, такими как Cluster Management Console (CMC), Mission Control и Management Zone.

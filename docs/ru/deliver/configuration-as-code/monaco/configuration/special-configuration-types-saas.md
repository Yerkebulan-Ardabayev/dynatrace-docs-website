...
[Settings API](../../../../dynatrace-api/environment-api/settings.md "Узнайте, что предлагает Dynatrace Settings API.") имеет дополнительные свойства, не связанные с конкретными схемами.

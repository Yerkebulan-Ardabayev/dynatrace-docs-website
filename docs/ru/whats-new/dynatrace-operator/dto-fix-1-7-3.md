...
* Устаревший Dynatrace OneAgent Operator удалён из каталога operatorhub.io. Пожалуйста, используйте наш Dynatrace Operator.
...
* Поддержка OpenShift 4.10 и 4.11 завершилась в марте 2025 г. В результате Dynatrace Operator 1.7.0 больше не будет поддерживать эти версии.

## Обновление с Dynatrace Operator версии 1.6

В Dynatrace Operator версии 1.7 версии API DynaKube `v1beta1` и `v1beta2` больше не обслуживаются. Применение ресурсов DynaKube с использованием этих версий завершится ошибкой. Обновите ваши манифесты DynaKube до `v1beta5` перед обновлением Dynatrace Operator. Подробнее см. Руководство по миграции версий API DynaKube.

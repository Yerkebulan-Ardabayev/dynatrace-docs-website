...
* Учётная запись пользователя Dynatrace с одним или обоими из следующих [разрешений управления аккаунтом](/docs/manage/identity-access-management/permission-management/account-management-permissions "Dynatrace permissions required to access Account Management"):
...
Дополнительную информацию о POC см. в разделе [Proof of Concept for existing DPS subscriptions](/docs/license/proof-of-concept "Use Account Management tools to view consumption during your DPS Proof of Concept period.").

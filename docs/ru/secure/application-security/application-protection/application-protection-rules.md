...
* [Настроить детализированные правила мониторинга для блокировки, отслеживания или игнорирования будущих атак](#handling-rules), основанные на атрибутах ресурсов, и определить несколько условий для одного правила. При создании правила можно проверить, применяются ли условия, и сколько групп процессов затронуто.

...
* [Как Dynatrace фактически блокирует атаки?](/docs/secure/faq#block-attacks "Часто задаваемые вопросы о Dynatrace Application Security.")
* [Как определяется IP-адрес злоумышленника?](/docs/secure/faq#attacker "Часто задаваемые вопросы о Dynatrace Application Security.")

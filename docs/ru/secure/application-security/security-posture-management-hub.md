...
* Чтобы начать работу с Kubernetes Security Posture Management, см. Kubernetes Security Posture Management.

* Чтобы начать работу с Cloud Security Posture Management и/или VMware Security Posture Management, см. Загрузка результатов соответствия Runecast Analyzer.
...
Соблюдение требований с помощью Security Posture Management
...
* Чтобы просмотреть нахождения по кластеру, вы можете фильтровать и сортировать результаты.
* Контекстная информация для устранения нахождений по кластеру — см. Получение аналитики.

### Можно ли включать или отключать стандарты соответствия?

* Для Dynatrace Kubernetes Security Posture Management (KSPM) можно управлять стандартами соответствия в **Настройках** Dynatrace, см. [Настройка области оценки](../xspm.md#configure-assessment "Detect, manage, and take action on security and compliance findings.").
...
Обзор использования нахождений соответствия см. в разделе Соблюдение требований с помощью Security Posture Management.

### Как обеспечить соответствие критическим нахождениям, созданным Dynatrace?

Рекомендации по повышению уровня соответствия см. в разделе Соблюдение требований с помощью Security Posture Management.
...
* Чтобы лучше понять конфигурацию ресурсов и изучить источник правила, см. Получение аналитики.
...
Рекомендации по устранению нахождений см. в разделе Соблюдение требований с помощью Security Posture Management.
...
Поэтому вы можете использовать ![xSPM](https://dt-cdn.net/images/security-posture-management-highresolution-1024-83a748ecdd.png "xSPM") **Security Posture Management** с Kubernetes Platform Monitoring, где OneAgent не развёрнут.

### Как настроить Security Posture Management для облачных сред?

Настройте Dynatrace интеграцию с Runecast Analyzer.

...
* Установите и настройте интеграцию Amazon GuardDuty (или любую другую [поддерживаемую интеграцию загрузки данных](../threat-observability/security-events-ingest.md#ingest "Ingest external security data into Grail.")).
* Установите и настройте обогащение AbuseIPDB (или любую другую [поддерживаемую интеграцию обогащения](../threat-observability/security-events-ingest.md#enrich "Ingest external security data into Grail.")).

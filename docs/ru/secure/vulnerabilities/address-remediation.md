...
Чтобы узнать больше о Security Advisor, см. [Концепции: Security Advisor](/docs/secure/vulnerabilities/concepts#dsa "Концепции, специфичные для приложения Dynatrace Vulnerabilities.").

## Отслеживание хода устранения

Вы можете добавлять ссылки на задачи, созданные в вашей системе отслеживания, для [затронутых сущностей](/docs/secure/vulnerabilities/concepts#affected "Концепции, специфичные для приложения Dynatrace Vulnerabilities.").
...
* [FAQ: Почему исправленная уязвимость всё ещё отображается как открытая?](/docs/secure/faq#open "Часто задаваемые вопросы о Dynatrace Application Security.")
* [Концепции: Уязвимый компонент](/docs/secure/vulnerabilities/concepts#vulnerable-component "Концепции, специфичные для приложения Dynatrace Vulnerabilities.")
* [Оценка уязвимостей: Уязвимости сторонних компонентов](/docs/secure/application-security/vulnerability-analytics/vulnerability-evaluation#tpv "Изучите механизм генерации уязвимостей сторонних компонентов и уязвимостей на уровне кода в Dynatrace.")
...
* [Концепции: Точки входа](/docs/secure/vulnerabilities/concepts#entry-points "Концепции, специфичные для приложения Dynatrace Vulnerabilities.")
...
Заглушение всех затронутых сущностей уязвимости устанавливает статус уязвимости в `Muted`. Подробнее см. [Статус уязвимости](/docs/secure/vulnerabilities/concepts#status "Концепции, специфичные для приложения Dynatrace Vulnerabilities.").
...
Для обзора общего покрытия мониторинга и тенденций подверженности см. [Оценка покрытия](/docs/secure/vulnerabilities/assess-coverage "Оцените покрытие процессов RVA и хостов вашей среды с помощью дашборда покрытия уязвимостей.").
...
* Генеративный ИИ Dynatrace Intelligence включён на уровне среды. Подробнее см. [Включение генеративного ИИ Dynatrace Intelligence в вашей среде](/docs/dynatrace-intelligence/copilot/copilot-getting-started#enable-davis-copilot "Узнайте, как настроить агентный и генеративный ИИ Dynatrace Intelligence.").
* У вас есть необходимые разрешения для доступа. Подробнее см. [Разрешения пользователей](/docs/dynatrace-intelligence/copilot/copilot-getting-started#davis-copilot-user-permissions "Узнайте, как настроить агентный и генеративный ИИ Dynatrace Intelligence.").
...
1. В [![Vulnerabilities](https://dt-cdn.net/images/vulnerabilities-highresolution-1025-9279da9743.png "Vulnerabilities") **Vulnerabilities**](/docs/secure/vulnerabilities "Приоритизируйте и эффективно управляйте уязвимостями в ваших отслеживаемых средах.") выберите уязвимость.

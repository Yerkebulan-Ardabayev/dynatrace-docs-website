...
* [Оценка уязвимостей: Уязвимости сторонних компонентов](../application-security/vulnerability-analytics/vulnerability-evaluation.md#tpv "Изучите механизм генерации уязвимостей сторонних компонентов и уязвимостей на уровне кода в Dynatrace.")
...
Для обзора общего покрытия мониторинга и тенденций подверженности см. [Оценка покрытия](assess-coverage.md "Оцените покрытие процессов RVA и хостов вашей среды с помощью дашборда покрытия уязвимостей.").

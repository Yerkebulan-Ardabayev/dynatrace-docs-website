---
title: Интеграция аналитики уязвимостей в Dynatrace и внешние приложения
...
* **Примеры**:
  ...
  + При просмотре раздела **Exploit attempts** уязвимости на уровне кода в ![Vulnerabilities](https://dt-cdn.net/images/vulnerabilities-highresolution-1025-9279da9743.png "Vulnerabilities") **Vulnerabilities** вы можете либо выбрать отдельную попытку эксплуатации, либо использовать кнопку **View all related exploit attempts** для доступа к подробной информации в [![Threats & Exploits](https://dt-cdn.net/images/attacks-512-b922840b12.png "Threats & Exploits") **Threats & Exploits**](../threats-and-exploits.md "Понимание, сортировка и расследование обнаруженных угроз и оповещений."). Это позволяет исследовать технические детали, сопоставлять доказательства из среды выполнения и определять, является ли уязвимость объектом активной атаки, что помогает расставлять приоритеты устранения на основе реального риска.
  + При просмотре уязвимости, связанной с узлом Kubernetes, в ![Vulnerabilities](https://dt-cdn.net/images/vulnerabilities-highresolution-1025-9279da9743.png "Vulnerabilities") **Vulnerabilities** вы можете выбрать затронутый узел из обзора узлов Kubernetes, чтобы перейти непосредственно в [![Kubernetes (new)](https://dt-cdn.net/images/kubernetes-new-1024-45d3de15d1.webp "Kubernetes (new)") **Kubernetes**](../../observe/infrastructure-observability/kubernetes-app.md "Мониторинг и оптимизация Kubernetes с помощью Dynatrace. Получайте данные в реальном времени о состоянии кластеров и рабочих нагрузок."), где вы можете оценить его состояние, зависимости и влияние на рабочие нагрузки.
...
Используйте [коннекторы Workflows](../../analyze-explore-automate/workflows/actions.md "Используйте готовые действия Dynatrace для ваших рабочих процессов и интегрируйте Dynatrace со сторонними системами.") для обмена данными об уязвимостях с внешними платформами и автоматизации задач по устранению.

* **Примеры**:

  + Автоматическое создание задач в Jira при обнаружении новых уязвимостей или превышении пороговых значений с помощью [коннектора Jira](../../analyze-explore-automate/workflows/actions/jira.md "Автоматизируйте создание, переход, комментирование и назначение задач Jira на основе событий и расписаний ваших рабочих процессов.").
  + Отправка оповещений в реальном времени в определённые каналы или людям с помощью [коннектора Slack](../../analyze-explore-automate/workflows/actions/slack.md "Отправка сообщений в рабочие пространства Slack") или [коннектора Microsoft Teams](../../analyze-explore-automate/workflows/actions/microsoft-teams.md "Отправка сообщений в Microsoft Teams").
  + Запуск рабочих процессов устранения с помощью [коннектора Red Hat Ansible](../../analyze-explore-automate/workflows/actions/red-hat/redhat-ansible.md "Автоматизируйте выполнение заданий Ansible на основе данных мониторинга и событий.") или [коннектора Jenkins](../../analyze-explore-automate/workflows/actions/jenkins.md "Автоматизируйте конвейеры в Jenkins.").
...
Используйте приложение [![Workflows](https://dt-cdn.net/images/workflows-1024-b5708f3cf9.webp "Workflows") **Workflows**](../../analyze-explore-automate/workflows.md "Автоматизируйте ИТ-процессы с помощью Dynatrace Workflows — реагируйте на события, планируйте задачи и подключайте сервисы.") для автоматизации действий на основе серьёзности, типа уязвимости или затронутых сущностей.

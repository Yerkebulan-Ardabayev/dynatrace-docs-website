...
Эта страница обновлена в соответствии с новой таблицей событий безопасности Grail. Полный список обновлений и действий, необходимых для миграции, см. в руководстве по миграции на таблицу безопасности Grail.
...
* Обнаружение пробелов в охвате результатов безопасности.")
...
* Токены:
  ...
  + Сгенерируйте токен доступа с областью `openpipeline.events_security` и сохраните его для дальнейшего использования. Подробности см. в Dynatrace API — Токены и аутентификация.
...
3. Проверьте конфигурацию, выполнив следующие запросы в [![Notebooks](https://dt-cdn.net/images/notebooks-768-046137830a.webp "Notebooks") **Notebooks**](../../../analyze-explore-automate/dashboards-and-notebooks/notebooks.md "Анализ, визуализация и обмен данными наблюдаемости."):
   ...
   * Для журналов аудита:
     ...
     ```
4. После установки и успешной работы расширения вы можете получить к нему доступ и управлять им в Dynatrace через ![Extensions](https://dt-cdn.net/images/dynatrace-extensions-256-9cb05e0f55.png "Extensions") **Extensions**. Подробности см. в О расширениях.
...
Интеграция Dynatrace с Tenable — это расширение, работающее на Dynatrace ActiveGate. После включения и настройки расширения Dynatrace Tenable:
...
2. В разделе **Extension content** выберите нужный готовый дашборд.
...
Откройте [![Notebooks](https://dt-cdn.net/images/notebooks-768-046137830a.webp "Notebooks") **Notebooks**](../../../analyze-explore-automate/dashboards-and-notebooks/notebooks.md "Анализ, визуализация и обмен данными наблюдаемости.") или [![Investigations](https://dt-cdn.net/images/security-investigator-256-93f6c187d9.png "Investigations") **Investigations**](../../investigations.md "Комбинация функций Grail для расследований на основе доказательств.") для запроса принятых данных, используя формат данных из [семантического словаря](https://dt-url.net/3q03pb0).
...
Информацию о тарификации см. в События на базе Grail.
...
Вы можете выполнить DQL-запрос и применить **dedup** к событиям, используя поля `object.id`, `scan.id` и `finding.id`.

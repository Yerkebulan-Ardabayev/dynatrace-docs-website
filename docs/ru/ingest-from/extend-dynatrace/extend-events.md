...
Полная документация по API доступна в разделе Events API v2.
...
| --- | --- |
| Dynatrace | `https://{your-environment-id}.live.dynatrace.com/api/v2/events` |
...
Обязательно укажите ваш идентификатор среды в правильном месте URL.
...
Для получения дополнительной информации о токенах доступа см. Dynatrace API — Токены и аутентификация.
...
Полный список примеров ActiveGate для различных типов запросов см. в Events API v2.

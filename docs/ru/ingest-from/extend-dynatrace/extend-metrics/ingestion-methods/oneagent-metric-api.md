...
При использовании локальной конечной точки API идентификатор хоста и контекст имени хоста автоматически добавляются к каждой метрике в качестве измерений. Узнайте, как обогатить ваши метрики другими специфическими для Dynatrace измерениями и применять детали причинно-следственного анализа Dynatrace-AI к загруженным данным.

## Формат метрик

Предоставляемые точки данных должны соответствовать протоколу загрузки метрик.

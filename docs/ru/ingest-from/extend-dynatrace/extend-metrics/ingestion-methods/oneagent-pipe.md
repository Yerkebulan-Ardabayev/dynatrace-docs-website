...
Оба параметра `[Options]` и `[Metrics]` являются необязательными. Синтаксис метрик, передаваемых в аргументе `[Metrics]`, должен соответствовать протоколу загрузки метрик.

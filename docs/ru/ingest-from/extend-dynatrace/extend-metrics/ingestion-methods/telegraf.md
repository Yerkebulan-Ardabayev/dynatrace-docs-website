...
Если вы не можете установить OneAgent на хосте, мониторинг которого осуществляется Telegraf, вы можете настроить Dynatrace Output Plugin для отправки метрик напрямую в вашу среду Dynatrace через Metrics API v2.
...
Когда OneAgent и Telegraf установлены на одном хосте, идентификатор хоста и имя хоста автоматически добавляются к каждой метрике в качестве измерений. Узнайте, как обогатить ваши метрики дополнительными измерениями, специфичными для Dynatrace, и применить детали причинно-следственного анализа Dynatrace AI к вашим принятым данным.

## Формат метрик

Предоставляемые точки данных должны соответствовать протоколу приёма метрик.

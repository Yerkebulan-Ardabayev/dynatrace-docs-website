...
* `entitySelectorTemplate`: Селектор сущностей, используемый для ссылки на карточки из другого типа отслеживаемых сущностей. Подробнее см. в разделе Environment API v2 — Селектор сущностей.

...
Если ваше расширение предоставляет дополнительные данные для сущности по умолчанию с собственной унифицированной страницей анализа, вы можете расширить страницу с помощью инъекций карточек. Примеры встроенных унифицированных страниц анализа: [страница обзора хоста](/docs/observe/infrastructure-observability/hosts/monitoring/host-monitoring "Мониторинг хостов с помощью Dynatrace.") или любая унифицированная страница анализа Kubernetes. Инъекции карточек доступны начиная с версии Dynatrace 1.233.

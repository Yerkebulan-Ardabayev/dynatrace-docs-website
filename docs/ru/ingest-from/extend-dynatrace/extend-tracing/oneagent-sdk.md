...
* Создавать пользовательские сессии и действия пользователей: эта функциональность предоставляется [Dynatrace OpenKit](../openkit.md "Узнайте, как инструментировать приложение с помощью OpenKit, как использовать методы Dynatrace OpenKit API и многое другое.")
...
* [Инструментация через OneAgent SDK для Android](../../../observe/digital-experience/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk/oneagent-sdk-for-android.md "Узнайте, как расширить мониторинг пользовательского опыта мобильных приложений на Android с помощью OneAgent SDK.")
* [OneAgent SDK для iOS](../../../observe/digital-experience/mobile-applications/instrument-ios-app/customization/oneagent-sdk-for-ios.md "Расширьте мониторинг пользовательского опыта мобильных приложений с помощью OneAgent SDK для iOS.")
* [OneAgent](../../../platform/oneagent.md "Узнайте о возможностях мониторинга OneAgent.")
* [Dynatrace OneAgent](../../dynatrace-oneagent.md "Изучите важные концепции, связанные с OneAgent, и узнайте, как установить и эксплуатировать OneAgent на различных платформах.")

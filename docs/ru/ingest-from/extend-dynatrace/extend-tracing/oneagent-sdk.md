...
Dynatrace предоставляет широкие возможности мониторинга для практически всех популярных языков и технологий, включая Java, .NET, Node.js, PHP и Golang. Подробную информацию обо всех поддерживаемых технологиях см. на странице поддерживаемых технологий.
...
* Создавать пользовательские сессии и действия пользователей: эта функциональность предоставляется Dynatrace OpenKit
...
* Инструментация через OneAgent SDK для Android

...
Дополнительные сведения и параметры конфигурации см. в разделе Установка модуля zRemote.

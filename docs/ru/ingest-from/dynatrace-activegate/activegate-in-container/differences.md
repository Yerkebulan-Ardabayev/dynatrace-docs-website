...
Для полного обзора см. [Назначения и функциональность ActiveGate](../capabilities.md "Learn the capabilities and uses of ActiveGate.").

## Автоматическое обновление

[Автоматическое обновление ActiveGate](../operation/update-activegate.md "Learn how to find out which version of ActiveGate you have installed and how you can download and install the latest version.") поддерживается только для хостовых ActiveGate, развёрнутых с помощью установщика.
...
[Удалённое управление конфигурацией](../../bulk-configuration.md "Perform OneAgent and ActiveGate configuration on hosts from the Deployment status page or at scale using the Dynatrace API.") не поддерживает контейнеризованные ActiveGate.

---
title: Мониторинг Google Cloud DNS
...
После развёртывания интеграции метрики отслеживаемых сервисов можно просматривать в браузере метрик, Data Explorer и тайлах дашборда.

...
После развёртывания интеграции вы можете видеть метрики отслеживаемых сервисов в [обозревателе метрик](/docs/analyze-explore-automate/dashboards-classic/metrics-browser "Просматривайте метрики с помощью обозревателя метрик Dynatrace."), [Data Explorer](/docs/analyze-explore-automate/explorer "Запрашивайте метрики и преобразуйте результаты для получения нужных данных.") и плитках дашборда.

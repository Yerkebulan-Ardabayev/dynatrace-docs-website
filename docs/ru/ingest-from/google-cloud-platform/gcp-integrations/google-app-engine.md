...
* Создайте [PaaS Token](../../../manage/identity-access-management/access-tokens-and-oauth-clients/access-tokens.md#paas-token "Learn the concept of an access token and its scopes.").
...
* [Настройка Dynatrace на Google Cloud](../../google-cloud-platform.md "Monitor Google Cloud with Dynatrace.")

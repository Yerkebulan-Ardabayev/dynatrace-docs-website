...
Для этого Dynatrace предоставляет специфичные для языков пакеты, такие как [`@dynatrace/opentelemetry-gcf` для Node.js](opentelemetry-on-gcf-nodejs.md "Мониторинг Google Cloud Functions с OpenTelemetry для Node.js и Dynatrace."), [`dynatrace-opentelemetry-gcf` для Python](opentelemetry-on-gcf-python.md "Мониторинг Google Cloud Functions с OpenTelemetry для Python и Dynatrace.") и [`Dynatrace.OpenTelemetry.Instrumentation.GoogleCloudFunctions` для .NET](opentelemetry-on-gcf-dotnet.md "Мониторинг Google Cloud Functions с OpenTelemetry для .NET и Dynatrace."), которые могут использоваться в сочетании со стандартными SDK и API OpenTelemetry.
...
* **Node.js:** [Интеграция с Google Cloud Functions для Node.js](opentelemetry-on-gcf-nodejs.md "Мониторинг Google Cloud Functions с OpenTelemetry для Node.js и Dynatrace.")
* **Python:** [Интеграция с Google Cloud Functions для Python](opentelemetry-on-gcf-python.md "Мониторинг Google Cloud Functions с OpenTelemetry для Python и Dynatrace.")
* **Go:** [Интеграция с Google Cloud Functions для GoLang](opentelemetry-on-gcf-go.md "Мониторинг Google Cloud Functions с OpenTelemetry для Go и Dynatrace.")
* **.NET:** [Интеграция с Google Cloud Functions для .NET](opentelemetry-on-gcf-dotnet.md "Мониторинг Google Cloud Functions с OpenTelemetry для .NET и Dynatrace.")

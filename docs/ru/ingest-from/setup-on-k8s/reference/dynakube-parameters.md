...
Эта страница поможет вам понять и настроить [Kubernetes Custom Resourceï»¿](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/), что позволит оптимизировать конфигурацию Dynatrace Operator в соответствии с вашими конкретными требованиями.
...
| `namespaceSelector` | The namespaces where OTLP exporter configuration will be injected. For more information, see [Configure monitoring for namespaces and pods](../guides.md#annotate "Detailed description of installation and configuration options for specific use-cases") | Not applicable | LabelSelector |

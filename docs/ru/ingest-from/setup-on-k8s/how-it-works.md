...
В этом разделе подробно описывается, как развёртываются компоненты Dynatrace и как они взаимодействуют с кластерами и объектами Kubernetes.
...
[#### Классический полностековый мониторинг

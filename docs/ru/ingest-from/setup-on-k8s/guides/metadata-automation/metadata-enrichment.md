...
Подробнее см. в разделе [Обогащение принятых данных Dynatrace-специфичными измерениями](/docs/ingest-from/extend-dynatrace/extend-data#operator-enrichment-directory "Узнайте, как автоматически обогащать данные телеметрии Dynatrace-специфичными полями.").

## Дополнительные материалы

* [Документация Dynatrace: файлы обогащения метаданными](/docs/ingest-from/extend-dynatrace/extend-data#operator-enrichment-directory "Узнайте, как автоматически обогащать данные телеметрии Dynatrace-специфичными полями.")

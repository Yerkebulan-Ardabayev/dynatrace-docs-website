...
* Используйте [ArgoCD](https://dt-url.net/hi037z9) для развёртывания конфигурации из репозитория Git в среду Kubernetes.
* Внедрите [Renovate](https://dt-url.net/vn237h6) для автоматического обновления репозитория Git актуальными конфигурациями Dynatrace Operator.
...
[Argo](https://dt-url.net/wt4379d) предлагает набор инструментов с открытым исходным кодом для развёртывания и управления приложениями Kubernetes. ArgoCD — инструмент непрерывной доставки — используется для поддержания синхронизации конфигурации Dynatrace Operator с кластером Kubernetes.
...
Renovate автоматизирует обновление зависимостей в репозиториях Git. Интеграция Renovate в ваш рабочий процесс гарантирует, что версия Dynatrace Operator, указанная в вашем `ApplicationSet`, всегда актуальна. Используйте [руководство по Renovate](https://dt-url.net/67637gq) для получения инструкций по обновлению конфигураций ArgoCD.

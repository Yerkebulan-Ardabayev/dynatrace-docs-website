...
* Введение в сетевые зоны и базовая информация
* Подключение OneAgent и ActiveGate
...
1. Выполните следующую команду для создания сетевой зоны в резервном режиме *None* с помощью Dynatrace API.

...
В Dynatrace реализована модель разрешений для Grail. Она распространяется на все телеметрические данные: метрики, события, спаны и журналы.
...
Для развёртываний на основе Kubernetes убедитесь, что в Dynatrace Operator включено обогащение метаданными.
...
Чтобы включить эту функцию, убедитесь, что в Dynatrace Operator включено обогащение метаданными.

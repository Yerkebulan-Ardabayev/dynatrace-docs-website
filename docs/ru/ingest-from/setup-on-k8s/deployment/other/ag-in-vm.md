---
title: Развертывание ActiveGate на виртуальной машине
...
1. Выберите Маршрутизация трафика OneAgent в качестве [назначения ActiveGate](../../../dynatrace-activegate.md#purposes "Основные концепции, связанные с ActiveGate.").
...
Инструкции по добавлению сертификата в файл хранилища доверенных сертификатов см. в разделе Доверенные корневые сертификаты для ActiveGate.

### Настройка установки

Вы можете добавить дополнительные параметры к команде установки для настройки. Например, чтобы установить ActiveGate в другой каталог, используйте параметр `INSTALL=<path>`:
...
Информацию о параметрах по умолчанию, включая каталоги по умолчанию, см. в разделе Параметры по умолчанию ActiveGate для Linux.
...
Для обновления ActiveGate см. Обновление ActiveGate.

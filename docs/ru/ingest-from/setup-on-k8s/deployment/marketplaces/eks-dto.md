---
title: Установка дополнения Dynatrace Operator для AWS Elastic Kubernetes Service (AWS EKS)
...
2. Примените пользовательский ресурс DynaKube.
   ...
   Загрузите [образец пользовательского ресурса DynaKube для режима cloud-native full-stack с GitHub](https://dt-url.net/9n636jg). Кроме того, можно ознакомиться с доступными параметрами или практическими руководствами и адаптировать пользовательский ресурс DynaKube согласно своим требованиям.

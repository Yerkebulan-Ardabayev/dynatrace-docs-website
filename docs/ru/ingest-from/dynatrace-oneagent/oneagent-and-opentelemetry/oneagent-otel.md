...
* Отправлять трассировки OpenTelemetry на [конечные точки Dynatrace OTLP API](../../opentelemetry/otlp-api.md "Learn about the OTLP API endpoints that your application uses to export OpenTelemetry data to Dynatrace.").
...
Для настройки и конфигурации сенсора спанов OneAgent см. [Enable the OpenTelemetry Span Sensor for OneAgent](configuration.md "Learn how to enable and configure the OneAgent Span Sensor for OpenTelemetry data.").

...
Чтобы узнать, как отправлять данные OpenTelemetry в Dynatrace OneAgent, см. [Использование OneAgent с данными OpenTelemetry](oneagent-otel.md "Узнайте, как отправлять данные OpenTelemetry в Dynatrace OneAgent.").
...
5. Выполните следующие действия для маскирования хранимого значения атрибута.
   ...
   3. Введите ключ хранимого значения и выберите вариант из выпадающего списка **Masking**. Подробнее о вариантах маскирования см. в разделе [Трассировки OpenTelemetry](../../../manage/data-privacy-and-security/data-privacy/personal-data-captured-by-dynatrace.md#otel-traces "Узнайте, какие типы пользовательских данных могут быть захвачены при мониторинге Dynatrace и какие методы доступны для маскирования персональных данных.").
...
* Невозможно создать [атрибуты запросов](../../../observe/application-observability/services/request-attributes.md "Узнайте, что такое атрибуты запросов и как использовать их на всех уровнях представлений анализа сервисов.") (обычно используемые для поиска и фильтрации трассировок) на основе атрибутов ресурсов OpenTelemetry.

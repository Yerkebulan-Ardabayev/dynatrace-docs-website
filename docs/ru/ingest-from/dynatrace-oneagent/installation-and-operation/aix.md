...
Dynatrace поддерживает полную установку OneAgent на IBM AIX. Аналитическую информацию о поддерживаемых возможностях OneAgent для AIX см. в матрице поддержки платформ и возможностей OneAgent. Сведения о поддерживаемых версиях AIX приведены в разделе OneAgent supported technologies and versions.

### Установка

[#### Файлы OneAgent и требования к дисковому пространству на AIX

Узнайте о требованиях к дисковому пространству для установки OneAgent на AIX.
...
Узнайте, как загрузить и установить Dynatrace OneAgent на AIX.
...
Узнайте, как включить автоматическое внедрение OneAgent для глубокого мониторинга кода на AIX.
...
Узнайте, как остановить и перезапустить OneAgent на AIX.
...
Узнайте, как выполнять некоторые задачи настройки OneAgent без необходимости повторной установки.

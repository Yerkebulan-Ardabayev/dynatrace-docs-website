...
Для начала войдите в свою среду Dynatrace через веб-сайт [Dynatrace.com](https://www.dynatrace.com), используя учётные данные, предоставленные при регистрации. Затем перейдите к описанным ниже шагам установки.

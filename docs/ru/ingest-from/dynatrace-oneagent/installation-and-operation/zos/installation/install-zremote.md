...
Вы можете [настроить модуль zRemote](install-zremote/customize-zremote.md "Настройте модуль zRemote под свои нужды.") для включения дополнительных функций, таких как **Группы хостов** и **Получение SQL-запросов Db2**.
...
* К одному zRemote можно подключить несколько [подсистем zDC](install-zdc.md "Настройка подсистемы сбора данных z/OS (zDC)."), если количество отслеживаемых транзакций соответствует аппаратным требованиям.
...
* zRemote поддерживает только [установку ActiveGate на хосте](../../../../dynatrace-activegate/capabilities.md "Узнайте о возможностях и способах использования ActiveGate."), настроенную для одной среды.
* Мониторинг хоста, на котором работает zRemote, с помощью OneAgent поддерживается только в [режиме полного мониторинга](../../../../../platform/oneagent/monitoring-modes/monitoring-modes.md "Узнайте больше о доступных режимах мониторинга при использовании OneAgent.").
...
Следующие каталоги сохраняются при обновлении или удалении. Вы можете вносить изменения в эти каталоги. Подробнее см. [Настройка модуля zRemote](install-zremote/customize-zremote.md "Настройте модуль zRemote под свои нужды.").

## Установка

Модуль zRemote загружается и устанавливается автоматически в процессе установки ActiveGate на [Linux](../../../../dynatrace-activegate/installation/linux/linux-install-an-environment-activegate.md "Пошаговая инструкция по установке Environment ActiveGate на Linux.") или [Windows](../../../../dynatrace-activegate/installation/windows/windows-install-an-environment-activegate.md "Пошаговая инструкция по установке Environment ActiveGate на Windows.").
...
Подробнее о настройках установки по умолчанию см. настройки установки ActiveGate по умолчанию для [Linux](../../../../dynatrace-activegate/installation/linux/linux-default-settings.md "Узнайте о настройках по умолчанию, с которыми устанавливается ActiveGate на Linux.") или [Windows](../../../../dynatrace-activegate/installation/windows/windows-default-settings.md "Узнайте о настройках по умолчанию, с которыми устанавливается ActiveGate на Windows.").

Подробнее о настройке установки см. настройку установки ActiveGate на [Linux](../../../../dynatrace-activegate/installation/linux/linux-customize-installation-for-activegate.md "Узнайте о параметрах командной строки, которые можно использовать с ActiveGate на Linux.") или [Windows](../../../../dynatrace-activegate/installation/windows/windows-customize-installation-for-activegate.md "Узнайте о параметрах, которые можно использовать с ActiveGate на Windows.").

## Журналирование

Журналы zRemote создаются на машине, где установлен модуль zRemote, в каталогах по умолчанию для [Linux](../../../../dynatrace-activegate/installation/linux/linux-default-settings.md "Узнайте о настройках по умолчанию, с которыми устанавливается ActiveGate на Linux.") и [Windows](../../../../dynatrace-activegate/installation/windows/windows-default-settings.md "Узнайте о настройках по умолчанию, с которыми устанавливается ActiveGate на Windows."). Вы можете просмотреть журналы zRemote непосредственно на машине, где установлен zRemote, или запросив их из Dynatrace через процедуру [диагностики OneAgent](../../../oneagent-troubleshooting/oneagent-diagnostics.md "Узнайте, как запустить диагностику OneAgent.").
...
3. [Установите модуль zRemote](../../../../dynatrace-activegate/installation/windows/windows-install-an-environment-activegate.md "Пошаговая инструкция по установке Environment ActiveGate на Windows."), выполнив установщик.

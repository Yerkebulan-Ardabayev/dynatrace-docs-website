...
Java-модуль z/OS передаёт захваченные [спаны OpenTelemetry](https://opentelemetry.io/docs/concepts/signals/traces/#spans-in-opentelemetry) через подсистему zDC и модуль zRemote в вашу среду Dynatrace.
...
Как правило, вы создали файл `dtconfig.json` во время установки Java-модуля z/OS и установили атрибуты `Tenant`, `ClusterID` и `zdcName` для вашей среды.
...
Вы можете определить атрибут запроса для любого захваченного атрибута спана. Для этого
...
Чтобы узнать больше об атрибутах спанов и о том, как их захватывать, см. Span settings.

![Use Span attribute as a request attribute](https://dt-cdn.net/images/screenshot-2022-09-30-at-09-24-35-1883-e2f2b63693.png)

Вы можете найти **Attribute key** ваших спанов на странице Distributed traces на вкладке **Code level** в разделе **Span attributes**.

...
OneAgent загружает системные логи AIX для диагностики проблем, которые могут быть вызваны условиями в вашем окружении. Подробности см. в разделе [Системные логи, загружаемые OneAgent](/docs/ingest-from/dynatrace-oneagent/installation-and-operation/aix/installation/oneagent-security-aix#system-logs-downloaded-by-oneagent "Узнайте о безопасности Dynatrace OneAgent и изменениях в вашей системе на базе AIX.").
...
Информацию о механизме автообновления OneAgent см. в разделе [Обновление Dynatrace OneAgent на AIX](/docs/ingest-from/dynatrace-oneagent/installation-and-operation/aix/operation/update-oneagent-on-aix "Узнайте, как обновить Dynatrace OneAgent на AIX.").
...
Для поддерживаемых платформ см. [Поддержка технологий](/docs/ingest-from/technology-support#aix "Узнайте технические подробности поддержки Dynatrace для конкретных платформ и фреймворков разработки.").

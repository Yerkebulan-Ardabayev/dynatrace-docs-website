...
* Постоянное круглосуточное профилирование CPU производственного уровня
* Метрики, специфичные для Go:
...
* Сквозная трассировка служб gRPC
* Мониторинг пользовательских служб для пользовательских служб, не использующих стандартные протоколы.")
...
* [Поддержка OpenTelemetry](https://github.com/open-telemetry/opentelemetry-go/) для захвата трассировок.
  Дополнительные сведения см. в разделе Инструментирование приложения Go с помощью OpenTelemetry

...
В результате интеграции мониторинга Azure некоторые сервисы мониторируются «из коробки».

[Служба управления API Azure](azure-cloud-services-metrics/monitor-azure-api-management-service.md) Шлюзы приложений Azure (классические) Служба приложений Azure (классическая) Cosmos DB Azure (классическая) Концентраторы событий Azure (классические) IoT Hub Azure (классический) Балансировщики нагрузки Azure (классические) Кэш Redis Azure (классический) Служебная шина Azure (классическая) SQL Server Azure (классический) Виртуальные машины Azure (классические) Учётная запись хранения Azure
...
Для получения списка всех поддерживаемых Azure сервисов на вашем кластере для текущей версии используйте API поддерживаемых сервисов Azure.

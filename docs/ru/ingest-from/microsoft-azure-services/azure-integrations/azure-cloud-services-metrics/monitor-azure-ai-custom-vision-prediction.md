...
Dynatrace принимает метрики из Azure Metrics API для Custom Vision Prediction. Вы можете просматривать метрики для каждого экземпляра сервиса, разбивать метрики по нескольким измерениям и создавать пользовательские диаграммы, которые можно прикрепить к вашим дашбордам.

## Предварительные требования

* Dynatrace версии 1.203+
* Версия Environment ActiveGate 1.195+
...
| --- | --- | --- | --- | --- |
| BlockedCalls | Количество вызовов, превысивших ограничение скорости или квоту | ApiName, OperationName, Region | Count | Применимо |

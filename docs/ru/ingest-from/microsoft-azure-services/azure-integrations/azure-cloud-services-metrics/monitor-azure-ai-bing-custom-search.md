---
title: Мониторинг Azure AI - Bing Custom Search
...
Dynatrace принимает метрики из Azure Metrics API для Bing Custom Search. Вы можете просматривать метрики для каждого экземпляра службы, разделять метрики по нескольким измерениям и создавать пользовательские графики, которые можно закрепить на дашбордах.

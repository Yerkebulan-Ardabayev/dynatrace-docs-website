...
* Расширенный мониторинг ввода-вывода требует [интеграции Azure Monitor](../azure-monitoring-guide.md "Настройка и конфигурация мониторинга Azure в Dynatrace.").
...
* Определите ваш [идентификатор среды](../../../../discover-dynatrace/get-started/monitoring-environment.md "Узнайте, как работать со средами мониторинга и управлять ими.").
...
Подробнее о потреблении мониторинга для Azure Functions см. [Бессерверный мониторинг](../../../../license/monitoring-consumption-classic/davis-data-units/serverless-monitoring.md "Узнайте, как рассчитывается потребление бессерверного мониторинга.").

## Связанные темы

* [Настройка Dynatrace на Microsoft Azure](../../../microsoft-azure-services.md "Настройка и конфигурация мониторинга для Microsoft Azure.")
...
* [Настройка мониторинга OpenTelemetry для Azure Functions на плане Consumption](func-dynamic-plans/opentelemetry-on-azure-functions.md "Мониторинг Azure Functions на плане Consumption с помощью OpenTelemetry и Dynatrace.")
...
* Логи от [инструмента перенаправления логов Azure](../set-up-log-forwarder-azure.md "Используйте перенаправление логов Azure для приёма логов Azure.") по-прежнему связаны с историческими данными и сущностями.
...
| --- | --- |
| [Служба управления API Azure](../azure-cloud-services-metrics/monitor-azure-api-management-service.md "Мониторинг службы управления API Azure и просмотр доступных метрик.") | [Службы управления API Azure (классические)](../azure-cloud-services-metrics/monitor-azure-api-management-services-builtin.md "Мониторинг служб управления API Azure и просмотр доступных метрик.") Устаревший |
| [Шлюз приложений Azure](../azure-cloud-services-metrics/monitor-azure-application-gateway.md "Мониторинг шлюза приложений Azure и просмотр доступных метрик.") | [Шлюз приложений Azure (классический)](../azure-cloud-services-metrics/monitor-azure-app-gateways-builtin.md "Мониторинг шлюзов приложений Azure и просмотр доступных метрик.") |
| [Базовый балансировщик нагрузки Azure](../azure-cloud-services-metrics/monitor-azure-basic-load-balancer.md "Мониторинг базового балансировщика нагрузки Azure и просмотр доступных метрик.") | [Балансировщик нагрузки Azure (классический)](../azure-cloud-services-metrics/monitor-azure-load-balancers-builtin.md "Мониторинг балансировщиков нагрузки Azure и просмотр доступных метрик.") |
| [Шлюзовой балансировщик нагрузки Azure](../azure-cloud-services-metrics/monitor-azure-gateway-load-balancer.md "Мониторинг шлюзового балансировщика нагрузки Azure и просмотр доступных метрик.") | [Балансировщик нагрузки Azure (классический)](../azure-cloud-services-metrics/monitor-azure-load-balancers-builtin.md "Мониторинг балансировщиков нагрузки Azure и просмотр доступных метрик.") |
| [Стандартный балансировщик нагрузки Azure](../azure-cloud-services-metrics/monitor-azure-standard-load-balancer.md "Мониторинг стандартного балансировщика нагрузки Azure и просмотр доступных метрик.") | [Балансировщик нагрузки Azure (классический)](../azure-cloud-services-metrics/monitor-azure-load-balancers-builtin.md "Мониторинг балансировщиков нагрузки Azure и просмотр доступных метрик.") |
| [Кэш Azure для Redis](../azure-cloud-services-metrics/monitor-azure-cache-for-redis.md "Мониторинг кэша Azure для Redis и просмотр доступных метрик.") | [Azure Redis (классический)](../azure-cloud-services-metrics/monitor-azure-redis-cache-builtin.md "Мониторинг кэша Azure Redis и просмотр доступных метрик.") |
| [Учётная запись Azure Cosmos DB (GlobalDocumentDB)](../azure-cloud-services-metrics/monitor-azure-cosmos-db-account-globaldocumentdb.md "Мониторинг учётной записи Azure Cosmos DB (GlobalDocumentDB) и просмотр доступных метрик.") | [Azure Cosmos DB (классическая)](../azure-cloud-services-metrics/monitor-azure-cosmos-db-builtin.md "Мониторинг Azure Cosmos DB и просмотр доступных метрик.") |
| [Учётная запись Azure Cosmos DB (MongoDB)](../azure-cloud-services-metrics/monitor-azure-cosmos-db-account-mongodb.md "Мониторинг учётной записи Azure Cosmos DB (MongoDB) и просмотр доступных метрик.") | [Azure Cosmos DB (классическая)](../azure-cloud-services-metrics/monitor-azure-cosmos-db-builtin.md "Мониторинг Azure Cosmos DB и просмотр доступных метрик.") |
| [Azure IoT Hub](../azure-cloud-services-metrics/monitor-azure-iot-hub.md "Мониторинг Azure IoT Hub и просмотр доступных метрик.") | [Azure IoT Hubs (классические)](../azure-cloud-services-metrics/monitor-azure-iot-hub-builtin.md "Мониторинг Azure IoT Hub и просмотр доступных метрик.") |
| [SQL Server Azure](../azure-cloud-services-metrics/monitor-azure-sql-server.md "Мониторинг SQL Server Azure и просмотр доступных метрик.") | [SQL Azure (классический)](../azure-cloud-services-metrics/monitor-azure-sql-servers-builtin.md "Мониторинг SQL Server Azure и просмотр доступных метрик.") |
| [База данных SQL Azure (DTU)](../azure-cloud-services-metrics/monitor-azure-sql-database-dtu.md "Мониторинг базы данных SQL Azure (DTU) и просмотр доступных метрик.") | [SQL Azure (классический)](../azure-cloud-services-metrics/monitor-azure-sql-servers-builtin.md "Мониторинг SQL Server Azure и просмотр доступных метрик.") |
| [База данных SQL Azure (vCore)](../azure-cloud-services-metrics/monitor-azure-sql-database-vcore.md "Мониторинг базы данных SQL Azure (vCore) и просмотр доступных метрик.") | [SQL Azure (классический)](../azure-cloud-services-metrics/monitor-azure-sql-servers-builtin.md "Мониторинг SQL Server Azure и просмотр доступных метрик.") |
| [Эластичный пул SQL Azure (DTU)](../azure-cloud-services-metrics/monitor-azure-sql-elastic-pool-dtu.md "Мониторинг эластичного пула SQL Azure (DTU) и просмотр доступных метрик.") | [SQL Azure (классический)](../azure-cloud-services-metrics/monitor-azure-sql-servers-builtin.md "Мониторинг SQL Server Azure и просмотр доступных метрик.") |
| [Эластичный пул SQL Azure (vCore)](../azure-cloud-services-metrics/monitor-azure-sql-elastic-pool-vcore.md "Мониторинг эластичного пула SQL Azure (vCore) и просмотр доступных метрик.") | [SQL Azure (классический)](../azure-cloud-services-metrics/monitor-azure-sql-servers-builtin.md "Мониторинг SQL Server Azure и просмотр доступных метрик.") |
| [Учётная запись хранения Azure](../azure-cloud-services-metrics/monitor-azure-storage-account.md "Мониторинг учётной записи хранения Azure и просмотр доступных метрик.") | [Учётные записи хранения Azure (классические)](../azure-cloud-services-metrics/monitor-azure-storage-account-builtin.md "Мониторинг учётных записей хранения Azure и просмотр доступных метрик.") |
| [Служба BLOB-объектов хранилища Azure](../azure-cloud-services-metrics/monitor-azure-storage-account.md "Мониторинг учётной записи хранения Azure и просмотр доступных метрик.") | [Учётные записи хранения Azure (классические)](../azure-cloud-services-metrics/monitor-azure-storage-account-builtin.md "Мониторинг учётных записей хранения Azure и просмотр доступных метрик.") |
| [Файловая служба хранилища Azure](../azure-cloud-services-metrics/monitor-azure-storage-account.md "Мониторинг учётной записи хранения Azure и просмотр доступных метрик.") | [Учётные записи хранения Azure (классические)](../azure-cloud-services-metrics/monitor-azure-storage-account-builtin.md "Мониторинг учётных записей хранения Azure и просмотр доступных метрик.") |
| [Служба очередей хранилища Azure](../azure-cloud-services-metrics/monitor-azure-storage-account.md "Мониторинг учётной записи хранения Azure и просмотр доступных метрик.") | [Учётные записи хранения Azure (классические)](../azure-cloud-services-metrics/monitor-azure-storage-account-builtin.md "Мониторинг учётных записей хранения Azure и просмотр доступных метрик.") |
| [Служба таблиц хранилища Azure](../azure-cloud-services-metrics/monitor-azure-storage-account.md "Мониторинг учётной записи хранения Azure и просмотр доступных метрик.") | [Учётные записи хранения Azure (классические)](../azure-cloud-services-metrics/monitor-azure-storage-account-builtin.md "Мониторинг учётных записей хранения Azure и просмотр доступных метрик.") |

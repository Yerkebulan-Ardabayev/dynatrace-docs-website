---
title: Настройка метрических событий для оповещения
...
После настройки интеграции Azure Monitor вы можете начать настройку и конфигурацию событий метрик для оповещений.

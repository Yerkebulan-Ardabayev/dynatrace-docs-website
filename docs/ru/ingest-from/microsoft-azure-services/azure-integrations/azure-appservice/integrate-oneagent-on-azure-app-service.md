...
* [Интеграция OneAgent для Linux и контейнеров](integrate-oneagent-on-web-app-for-containers.md "Узнайте, как установить, настроить, обновить и удалить OneAgent в контейнеризованных приложениях на Linux.")
...
* Сбор метрик на уровне платформы и [дополнительная информация о вашем плане App Service](monitor-app-service.md "Мониторинг Azure App Service (план App Service, слот развёртывания веб-приложения) и просмотр доступных метрик.") через [интеграцию Azure Monitor](../../../microsoft-azure-services.md "Настройте и сконфигурируйте мониторинг Microsoft Azure.")
* Сбор логов через [перенаправление логов](../set-up-log-forwarder-azure.md "Используйте перенаправление логов Azure для приёма логов Azure.")
...
* Мониторинг ввода/вывода требует включения [интеграции Azure Monitor](../azure-monitoring-guide.md "Настройте и сконфигурируйте мониторинг Azure в Dynatrace."), которая также предоставляет [дополнительную информацию о вашем плане App Service](monitor-app-service.md "Мониторинг Azure App Service (план App Service, слот развёртывания веб-приложения) и просмотр доступных метрик.")
* Сбор логов требует включения [перенаправления логов](../set-up-log-forwarder-azure.md "Используйте перенаправление логов Azure для приёма логов Azure.")
...
Для Azure App Service на Linux или в контейнерах см. [Интеграция OneAgent на Azure App Service для Linux и контейнеров](integrate-oneagent-on-web-app-for-containers.md "Узнайте, как установить, настроить, обновить и удалить OneAgent в контейнеризованных приложениях на Linux.").
...
Расширение сайта Dynatrace OneAgent не включает установщик OneAgent. Вместо этого расширение использует REST API Dynatrace для загрузки установщика из кластера в целевой версии, установленной в разделе [Обновления OneAgent](../../../dynatrace-oneagent/oneagent-update.md#configure-oneagent-updates "Узнайте, как обновить OneAgent.").
...
| networkZone | Опциональный | Ваша сетевая зона. Укажите желаемое значение для вашего экземпляра App Service. Подробнее см. [сетевые зоны](../../../../manage/network-zones.md "Узнайте, как работают сетевые зоны в Dynatrace."). |
...
Для Azure App Service потребление ресурсов мониторинга рассчитывается на основе единиц хостов. Подробности см. в разделе [Мониторинг приложений и инфраструктуры (единицы хостов)](../../../../license/monitoring-consumption-classic/application-and-infrastructure-monitoring.md "Узнайте, как рассчитывается потребление ресурсов мониторинга Dynatrace на основе единиц хостов.").
...
* [Настройка Dynatrace на Microsoft Azure](../../../microsoft-azure-services.md "Настройте и сконфигурируйте мониторинг Microsoft Azure.")

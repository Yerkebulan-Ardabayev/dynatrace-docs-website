...
Если вы указали версию OneAgent по умолчанию для установки на новых хостах и в приложениях с помощью настроек обновления OneAgent, ваши веб-приложения будут автоматически мониториться указанной версией OneAgent по умолчанию.

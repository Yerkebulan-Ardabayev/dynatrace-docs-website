...
* Поддерживаются также [классические виртуальные машины](/docs/ingest-from/microsoft-azure-services/azure-integrations/azure-vm/monitor-azure-virtual-machines-classic "Мониторинг классических виртуальных машин Azure и просмотр доступных метрик.")
...
* Определите ваш [идентификатор среды](/docs/discover-dynatrace/get-started/monitoring-environment "Изучите работу со средами мониторинга.").
...
| hostGroup | Необязательный | Определите [группу хостов](/docs/observe/infrastructure-observability/hosts/configuration/organize-your-environment-using-host-groups "Узнайте, как Dynatrace позволяет организовать хосты, процессы и сервисы с помощью групп хостов."), к которой принадлежит виртуальная машина. |

...
3. Добавьте следующую функцию в файл запуска приложения.
   ...
   Операции чтения файлов, связанные с разбором файлов `dt_metadata` в примере кода, выполняют попытку чтения [файлов данных OneAgent](../../extend-dynatrace/extend-data.md "Узнайте, как автоматически обогащать данные телеметрии полями, специфичными для Dynatrace.") для обогащения OTLP-запроса и обеспечения доступности всей необходимой информации о топологии в Dynatrace.
...
* [Обогащение принимаемых данных полями, специфичными для Dynatrace](../../extend-dynatrace/extend-data.md "Узнайте, как автоматически обогащать данные телеметрии полями, специфичными для Dynatrace.")

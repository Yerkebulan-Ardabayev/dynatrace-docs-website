...
2. Создайте файл с именем `otel.js` в каталоге вашего приложения и сохраните следующее содержимое.
   ...
   Операции чтения файлов, разбирающие файлы `dt_metadata` в примере кода, пытаются прочитать файлы данных OneAgent для обогащения OTLP-запроса и обеспечения доступности всей необходимой топологической информации в Dynatrace.

...
| --- | --- | --- |
| Windows | Все версии, поддерживаемые OneAgent | x86-64, |
| Amazon Linux | Все версии, поддерживаемые OneAgent | x86-64, ARM64 (AArch64[1](#fn-1-1-def)) |
...
Узнайте больше о настройке установки OneAgent для Linux и Windows.

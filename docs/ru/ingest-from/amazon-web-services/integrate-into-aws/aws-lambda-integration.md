...
Читать руководство#### Monitor AWS Lambda (built-in)
...
Дополнительные сведения см. в разделе Поддержка технологий.

## Потребление мониторинга

Для AWS Lambda потребление мониторинга рассчитывается на основе единиц данных Davis. Подробности см. в разделе Мониторинг бессерверных функций.

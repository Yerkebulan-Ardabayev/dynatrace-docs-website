...
Убедитесь, что вы используете [поддерживаемую среду выполнения AWS Lambda](../../aws-lambda-integration.md#support-lifecycle "Возможности и варианты интеграции AWS Lambda") и что вы выполнили шаги **начальной настройки**, описанные в [Мониторинг AWS Lambda с помощью OpenTelemetry](aws-lambda-otel-integration/aws-lambda-otel-setup.md "Предварительные требования для мониторинга AWS Lambda с помощью OpenTelemetry"), прежде чем использовать пакеты ниже.

...
* Настройте сбор логов AWS Lambda или потоковую передачу логов через Amazon Data Firehose.
...
Ознакомьтесь с разделом Сбор логов AWS Lambda, чтобы узнать больше об ограничениях, поскольку обогащение логов Lambda **не** выполняется автоматически.

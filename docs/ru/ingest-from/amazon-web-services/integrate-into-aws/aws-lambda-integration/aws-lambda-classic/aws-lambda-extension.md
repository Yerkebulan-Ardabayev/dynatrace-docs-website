...
Эта страница относится к классической интеграции AWS Lambda. Для последней версии см. Трассировка Lambda-функций.
...
* Обнаруживать RUM (веб и мобильные)
...
Для получения токена для сбора логов настройте другое получение.
...
* Расширение Dynatrace AWS Lambda не поддерживает захват атрибутов запросов на уровне методов.

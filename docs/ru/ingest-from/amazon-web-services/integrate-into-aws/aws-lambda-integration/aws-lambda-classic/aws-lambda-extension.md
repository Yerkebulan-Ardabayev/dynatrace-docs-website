...
Эта страница относится к классической интеграции AWS Lambda. Для последней версии см. [Трассировка Lambda-функций](../trace-lambda-functions.md "Мониторинг функций AWS Lambda.").
...
* Поддерживаемая [среда выполнения](../../aws-lambda-integration.md#support-lifecycle "Возможности AWS Lambda и варианты интеграции") AWS Lambda. Расширение Dynatrace поддерживает функции AWS Lambda, написанные на **Node.js**, **Python** или **Java**.
...
**Включение AWS Lambda**](aws-lambda-extension.md#activate-aws-lambda "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Шаг 2")

**Выбор метода конфигурации**](aws-lambda-extension.md#lambda-cfg-method "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 3 (необязательно)](https://dt-cdn.net/images/dotted-step-3-e2082c1921.svg "Шаг 3 (необязательно)")

**Указание конечной точки API Dynatrace**](aws-lambda-extension.md#lambda-cfg-endpoint "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 4 (необязательно)](https://dt-cdn.net/images/dotted-step-4-2b9147df5b.svg "Шаг 4 (необязательно)")

**Включение мониторинга реальных пользователей**](aws-lambda-extension.md#lambda-cfg-rum "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 5](https://dt-cdn.net/images/step-5-2de312b50f.svg "Шаг 5")

**Определение имени слоя AWS**](aws-lambda-extension.md#lambda-cfg-layer "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 6 (необязательно)](https://dt-cdn.net/images/dotted-step-6-fbd29ea893.svg "Шаг 6 (необязательно)")

**Развертывание**](aws-lambda-extension.md#deployment "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 7](https://dt-cdn.net/images/step-7-35139ef2d6.svg "Шаг 7")

**Параметры конфигурации**](aws-lambda-extension.md#config-options "Мониторинг Lambda-функций на Python, Node.js и Java.")[![Шаг 8](https://dt-cdn.net/images/step-8-72c2162189.svg "Шаг 8")

**Интеграция Dynatrace с AWS**](aws-lambda-extension.md#aws-integration "Мониторинг Lambda-функций на Python, Node.js и Java.")
...
* Обнаруживать [RUM](../../../../../observe/digital-experience/rum-concepts/rum-overview.md "Узнайте о мониторинге реальных пользователей, ключевых метриках производительности, мониторинге мобильных приложений и многом другом.") (веб и мобильные)
...
Для [получения токена для сбора логов](../collector.md#aws-secrets-manager "Сбор логов из функций AWS Lambda") настройте другое получение.
...
* Расширение Dynatrace AWS Lambda не поддерживает захват [атрибутов запросов на уровне методов](../../../../../observe/application-observability/services/request-attributes/capture-request-attributes-based-on-method-arguments.md "Узнайте, как создавать атрибуты запросов на основе аргументов методов Java, .NET или PHP и как использовать их на обзорной странице сервиса. Также узнайте, как агрегировать захваченные значения атрибутов запросов, а также как обращаться к объектам, если захватываемое значение является сложным объектом.").

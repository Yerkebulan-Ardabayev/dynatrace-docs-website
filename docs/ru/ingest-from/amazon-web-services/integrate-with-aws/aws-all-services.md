...
В результате интеграции мониторинга AWS некоторые сервисы отслеживаются автоматически. Такие сервисы отмечены как классические.

Amazon Dynamo Database (классический) Amazon EC2 (классический) Amazon EC2 Auto Scaling (классический) AWS Lambda (классический) AWS Application and Network Load Balancer (классический) Elastic Load Balancer (классический) Amazon S3 (классический) Amazon RDS (классический) Amazon EBS (классический)
...
Для получения списка всех поддерживаемых сервисов AWS в вашем кластере текущей версии используйте API поддерживаемых сервисов AWS.

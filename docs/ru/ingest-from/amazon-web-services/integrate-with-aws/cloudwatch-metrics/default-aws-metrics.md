...
В таблице ниже перечислены все метрики AWS, которые Dynatrace собирает по умолчанию при включении мониторинга AWS.

Все остальные метрики, собираемые Dynatrace для настраиваемых сервисов AWS, см. на страницах облачных сервисов.

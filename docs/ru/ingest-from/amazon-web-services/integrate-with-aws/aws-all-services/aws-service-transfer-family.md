---
title: Мониторинг AWS Transfer Family
...
scraped: 2026-03-05T21:32:53.664056
---

Dynatrace собирает метрики для множества предварительно выбранных пространств имён, включая AWS Transfer Family. Вы можете просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские графики, которые можно закрепить на дашбордах.
...
`ServerId` является основным измерением.

| Название | Описание | Единица | Статистика | Измерения | Рекомендуемая |
| --- | --- | --- | --- | --- | --- |
| BytesIn | Общее количество байт, переданных на сервер | Байты | Sum | ServerId | Доступна |
| BytesOut | Общее количество байт, переданных с сервера | Байты | Sum | ServerId | Доступна |

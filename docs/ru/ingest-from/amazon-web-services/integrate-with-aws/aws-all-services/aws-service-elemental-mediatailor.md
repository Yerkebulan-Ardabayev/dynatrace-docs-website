...
Для [обновления политики AWS IAM](https://dt-url.net/8q038eb) используйте JSON ниже, содержащий политику мониторинга (разрешения) для всех поддерживаемых сервисов.

...
`StackId` — основное измерение.

| Название | Описание | Единица | Статистика | Измерения | Рекомендовано |
| --- | --- | --- | --- | --- | --- |
| cpu\_idle | Процент времени, в течение которого CPU простаивает | Percent | Multi | StackId | Применимо |
| cpu\_idle |  | Percent | Multi | Region, InstanceId | Применимо |
| cpu\_idle |  | Percent | Multi | Region, LayerId | Применимо |
| cpu\_nice | Процент времени, в течение которого CPU обрабатывает процессы с положительным значением `nice`, имеющие более низкий приоритет планирования | Percent | Multi | StackId | Применимо |
| cpu\_nice |  | Percent | Multi | Region, InstanceId |  |
| cpu\_nice |  | Percent | Multi | Region, LayerId |  |
| cpu\_steal | Процент времени, в течение которого экземпляр ожидает выделения физических ресурсов CPU гипервизором | Percent | Multi | StackId | Применимо |
| cpu\_steal |  | Percent | Multi | Region, InstanceId | Применимо |
| cpu\_steal |  | Percent | Multi | Region, LayerId | Применимо |
| cpu\_system | Процент времени, в течение которого CPU обрабатывает системные операции | Percent | Multi | StackId | Применимо |
| cpu\_system |  | Percent | Multi | Region, InstanceId |  |
| cpu\_system |  | Percent | Multi | Region, LayerId |  |
| cpu\_user | Процент времени, в течение которого CPU обрабатывает пользовательские операции | Percent | Multi | StackId | Применимо |
| cpu\_user |  | Percent | Multi | Region, InstanceId | Применимо |
| cpu\_user |  | Percent | Multi | Region, LayerId | Применимо |
| cpu\_waitio | Процент времени, в течение которого CPU ожидает завершения операций ввода/вывода | Percent | Multi | StackId | Применимо |
| cpu\_waitio |  | Percent | Multi | Region, InstanceId |  |
| cpu\_waitio |  | Percent | Multi | Region, LayerId |  |
| load\_1 | Средняя нагрузка за одну минуту | None | Multi | StackId |  |
| load\_1 |  | None | Multi | Region, InstanceId |  |
| load\_1 |  | None | Multi | Region, LayerId |  |
| load\_5 | Средняя нагрузка за пять минут | None | Multi | StackId | Применимо |
| load\_5 |  | None | Multi | Region, InstanceId | Применимо |
| load\_5 |  | None | Multi | Region, LayerId | Применимо |
| load\_15 | Средняя нагрузка за 15 минут | None | Multi | StackId |  |
| load\_15 |  | None | Multi | Region, InstanceId |  |
| load\_15 |  | None | Multi | Region, LayerId |  |
| memory\_buffers | Объём буферизованной памяти | None | Multi | StackId | Применимо |
| memory\_buffers |  | None | Multi | Region, InstanceId |  |
| memory\_buffers |  | None | Multi | Region, LayerId |  |
| memory\_cached | Объём кэшированной памяти | None | Multi | StackId | Применимо |
| memory\_cached |  | None | Multi | Region, InstanceId |  |
| memory\_cached |  | None | Multi | Region, LayerId |  |
| memory\_free | Объём свободной памяти | None | Multi | StackId | Применимо |
| memory\_free |  | None | Multi | Region, InstanceId | Применимо |
| memory\_free |  | None | Multi | Region, LayerId | Применимо |
| memory\_swap | Объём пространства подкачки | None | Multi | StackId | Применимо |
| memory\_swap |  | None | Multi | Region, InstanceId |  |
| memory\_swap |  | None | Multi | Region, LayerId |  |
| memory\_total | Общий объём памяти | None | Multi | StackId | Применимо |
| memory\_total |  | None | Multi | Region, InstanceId | Применимо |
| memory\_total |  | None | Multi | Region, LayerId | Применимо |
| memory\_used | Объём используемой памяти | None | Multi | StackId | Применимо |
| memory\_used |  | None | Multi | Region, InstanceId | Применимо |
| memory\_used |  | None | Multi | Region, LayerId | Применимо |
| procs | Количество активных процессов | None | Multi | StackId | Применимо |
| procs |  | None | Multi | Region, InstanceId | Применимо |
| procs |  | None | Multi | Region, LayerId | Применимо |

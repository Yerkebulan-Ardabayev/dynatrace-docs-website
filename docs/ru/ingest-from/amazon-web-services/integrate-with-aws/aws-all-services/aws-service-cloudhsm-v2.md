...
scraped: 2026-03-02T21:18:35.470573
---

* 4-min read

Dynatrace собирает метрики для множества предварительно выбранных пространств имен, включая AWS CloudHSM (V2). Вы можете просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские графики, которые можно закрепить на панелях мониторинга.
...
`ClusterId` является основным измерением.
...
| HsmKeysSessionOccupied | Количество сеансовых ключей, используемых экземпляром HSM | Count | Multi | ClusterId, HsmId | Применимо |
| HsmKeysSessionOccupied |  | Count | Multi | ClusterId | Применимо |
| HsmKeysSessionOccupied |  | Count | Multi | Region | Применимо |
| HsmKeysTokenOccupied | Количество токен-ключей, используемых экземпляром HSM и кластером | Count | Multi | ClusterId, HsmId | Применимо |
| HsmKeysTokenOccupied |  | Count | Multi | ClusterId | Применимо |
| HsmKeysTokenOccupied |  | Count | Multi | Region | Применимо |
| HsmSslCtxsOccupied | Количество сквозных зашифрованных каналов, установленных для экземпляра HSM | Count | Multi | ClusterId, HsmId | Применимо |
| HsmSslCtxsOccupied |  | Count | Multi | ClusterId | Применимо |
| HsmSslCtxsOccupied |  | Count | Multi | Region |  |
| HsmSessionCount | Количество открытых подключений к экземпляру HSM | Count | Multi | ClusterId, HsmId | Применимо |
| HsmSessionCount |  | Count | Multi | ClusterId | Применимо |
| HsmSessionCount |  | Count | Multi | Region |  |
| HsmUsersAvailable | Количество дополнительных пользователей, которых можно создать | Count | Multi | ClusterId, HsmId | Применимо |
| HsmUsersAvailable |  | Count | Multi | ClusterId | Применимо |
| HsmUsersAvailable |  | Count | Multi | Region |  |
| HsmUsersMax | Максимальное количество пользователей, которых можно создать на экземпляре HSM | Count | Maximum | ClusterId, HsmId | Применимо |
| HsmUsersMax |  | Count | Maximum | ClusterId | Применимо |
| HsmUsersMax |  | Count | Maximum | Region |  |
| InterfaceEth2DroppedInput | Количество отброшенных пакетов на входе | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2DroppedInput |  | Count | Average | ClusterId |  |
| InterfaceEth2DroppedInput |  | Count | Average | Region |  |
| InterfaceEth2ErrorsInput | Количество пакетов с ошибками на входе | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2ErrorsInput |  | Count | Average | ClusterId |  |
| InterfaceEth2ErrorsInput |  | Count | Average | Region |  |
| InterfaceEth2OctetsInput | Кумулятивная сумма трафика к HSM на текущую дату | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2OctetsInput |  | Count | Average | ClusterId |  |
| InterfaceEth2OctetsInput |  | Count | Average | Region |  |
| InterfaceEth2PacketsInput | Общее количество пакетов на входе | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2PacketsInput |  | Count | Average | ClusterId |  |
| InterfaceEth2PacketsInput |  | Count | Average | Region |  |
| InterfaceEth2DroppedOutput | Количество отброшенных пакетов на выходе | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2DroppedOutput |  | Count | Average | ClusterId |  |
| InterfaceEth2DroppedOutput |  | Count | Average | Region |  |
| InterfaceEth2ErrorsOutput | Количество пакетов с ошибками на выходе | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2ErrorsOutput |  | Count | Average | ClusterId |  |
| InterfaceEth2ErrorsOutput |  | Count | Average | Region |  |
| InterfaceEth2OctetsOutput | Кумулятивная сумма трафика от HSM на текущую дату | Count | Average | ClusterId, HsmId |  |
| InterfaceEth2OctetsOutput |  | Count | Average | ClusterId |  |
| InterfaceEth2OctetsOutput |  | Count | Average | Region |  |
| InterfaceEth2PacketsOutput | Общее количество пакетов на выходе | Count | Average | ClusterId, HsmId |  |

...
Метрики также можно просматривать на панелях управления в веб-интерфейсе Dynatrace. Для этого сервиса предустановленная панель недоступна, но вы можете [создать собственную панель управления](../../../../analyze-explore-automate/dashboards-classic/dashboards/create-dashboards.md "Узнайте, как создавать и редактировать панели управления Dynatrace.").

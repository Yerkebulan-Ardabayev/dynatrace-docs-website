...
Для получения информации о различиях между классическими сервисами и другими сервисами см. раздел [Миграция с классических AWS-сервисов (ранее «встроенных») на облачные сервисы](/docs/ingest-from/amazon-web-services/integrate-with-aws/cloudwatch-metrics/aws-migration-guide "Миграция классических AWS-сервисов на новые версии.").
...
Сведения о включении мониторинга сервиса см. в разделе [Включение мониторинга сервиса](/docs/ingest-from/amazon-web-services/integrate-with-aws/aws-metrics-ingest/aws-enable-service-monitoring "Включение мониторинга AWS в Dynatrace.").
...
Метрики также можно просматривать на панелях управления в веб-интерфейсе Dynatrace. Для этого сервиса предустановленная панель недоступна, но вы можете [создать собственную панель управления](/docs/analyze-explore-automate/dashboards-classic/dashboards/create-dashboards "Узнайте, как создавать и редактировать панели управления Dynatrace.").

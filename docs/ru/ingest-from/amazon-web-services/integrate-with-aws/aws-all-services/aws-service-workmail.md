---
title: Мониторинг Amazon WorkMail
...
scraped: 2026-03-05T21:30:44.799315
---

# Мониторинг Amazon WorkMail
...
Dynatrace собирает метрики для множества предварительно выбранных пространств имён, включая Amazon WorkMail. Вы можете просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские графики, которые можно закрепить на дашбордах.
...
* Для развёртываний Dynatrace SaaS вам потребуется Environment ActiveGate или Multi-environment ActiveGate.
  ...
  Для доступа на основе ролей в развёртывании [SaaS](/docs/ingest-from/amazon-web-services/integrate-with-aws/cloudwatch-metrics#role-based-access "Интеграция метрик из Amazon CloudWatch.") вам необходим [Environment ActiveGate](/docs/ingest-from/dynatrace-activegate/installation "Узнайте, как настроить ActiveGate"), установленный на хосте Amazon EC2.
...
`OrganizationId` является основным измерением.

| Название | Описание | Единица | Статистика | Измерения | Рекомендуется |
| --- | --- | --- | --- | --- | --- |
| IncomingEmailBounced | Количество входящих писем, отклонённых из-за переполненных или несуществующих почтовых ящиков | Количество | Сумма | OrganizationId | Да |
| MailboxEmailDelivered | Количество писем, доставленных в отдельные почтовые ящики вашей организации Amazon WorkMail | Количество | Сумма | OrganizationId | Да |
| OrganizationEmailReceived | Количество писем, полученных вашей организацией Amazon WorkMail | Количество | Сумма | OrganizationId | Да |
| OutgoingEmailBounced | Количество исходящих писем, которые не удалось доставить, подсчитанное для каждого предполагаемого получателя | Количество | Сумма | OrganizationId | Да |
| OutgoingEmailSent | Количество писем, успешно отправленных из вашей организации Amazon WorkMail | Количество | Сумма | OrganizationId | Да |

...
* Для развёртываний Dynatrace вам потребуется Environment ActiveGate или Multi-environment ActiveGate.
  ...
  Для доступа на основе ролей в развёртывании [Dynatrace](../cloudwatch-metrics.md#role-based-access "Интеграция метрик из Amazon CloudWatch.") вам необходим Environment ActiveGate, установленный на хосте Amazon EC2.

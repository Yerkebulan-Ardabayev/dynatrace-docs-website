...
* Для развертывания Dynatrace, вам необходимо Environment ActiveGate или Multi-среду ActiveGate.

  Для доступа на основе ролей в [Dynatrace](../cloudwatch-metrics.md#role-based-access "Интегрируйте метрики из Amazon CloudWatch.") развертывании, вам необходимо Environment ActiveGate, установленный на хосте Amazon EC2.
...
Если вы не хотите добавлять разрешения для всех служб и хотите выбрать разрешения только для определенных служб, обратитесь к таблице ниже. Таблица содержит набор разрешений, необходимых для всех облачных служб AWS и, для каждой поддерживаемой службы, список необязательных разрешений, специфичных для этой службы.
...
Чтобы узнать, как включить мониторинг служб, см. Включение мониторинга служб.

...
Вы также можете просматривать метрики в веб-интерфейсе Dynatrace на дашбордах. Для этого сервиса предустановленный дашборд недоступен, но вы можете [создать собственный дашборд](/docs/analyze-explore-automate/dashboards-classic/dashboards/create-dashboards "Узнайте, как создавать и редактировать дашборды Dynatrace.").

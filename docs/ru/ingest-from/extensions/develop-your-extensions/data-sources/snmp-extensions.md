...
Мы также предоставляем источник данных SNMP traps, который сообщает единственную метрику: количество ловушек (traps), отправленных определённым источником за заданный интервал. Подробнее см. в разделе Источник данных SNMP traps.

Предполагается следующее:

* Вы обладаете достаточными знаниями в области SNMP для создания расширения SNMP.
* Вы знакомы с основными концепциями Extensions и общей структурой файла YAML расширения.

Ознакомьтесь с предварительными требованиями и охватом поддерживаемых технологий. Ограничения, применимые к вашему расширению, см. в разделе Extensions.
...
Чтобы узнать, как определить аутентификацию в конфигурации мониторинга, см. Аутентификация SNMP.

...
Обратите внимание, что каждый хост ActiveGate, выполняющий ваше расширение, нуждается в корневом сертификате для проверки подлинности расширения. Дополнительную информацию см. в разделе Подписание расширения.

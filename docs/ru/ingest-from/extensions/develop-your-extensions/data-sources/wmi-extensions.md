...
* Вы знакомы с [основными концепциями расширений](/docs/ingest-from/extensions/concepts "Узнайте больше о концепции расширений Dynatrace.") и общей структурой [YAML-файла расширения](/docs/ingest-from/extensions/develop-your-extensions/extension-yaml "Узнайте, как создать YAML-файл расширения с помощью фреймворка Extensions.").

## Предварительные требования и поддержка

Ознакомьтесь с предварительными требованиями и областью поддерживаемых технологий. Информацию об ограничениях, применимых к вашему расширению, см. в разделе [Ограничения расширений](/docs/ingest-from/extensions/concepts "Узнайте больше о концепции расширений Dynatrace.").

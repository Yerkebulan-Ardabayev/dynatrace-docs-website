...
* Вы знакомы с основными концепциями расширений и общей структурой YAML-файла расширения.

## Предварительные требования и поддержка

Ознакомьтесь с предварительными требованиями и областью поддерживаемых технологий. Информацию об ограничениях, применимых к вашему расширению, см. в разделе Ограничения расширений.

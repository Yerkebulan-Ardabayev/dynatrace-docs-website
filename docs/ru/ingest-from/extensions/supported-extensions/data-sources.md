---
title: Понимание источников данных расширений
...
См. [SQL extensions](data-sources/sql.md "Extend observability in Dynatrace with declarative metrics ingested from SQL-based extensions.").
...
См. [Manage WMI extensions](data-sources/wmi.md "Learn how to extend observability in Dynatrace with declarative WMI metrics ingestion.").
...
См. [Manage SNMP extensions](data-sources/snmp.md "Learn how to extend observability in Dynatrace with declarative SNMP metrics and event ingestion.").

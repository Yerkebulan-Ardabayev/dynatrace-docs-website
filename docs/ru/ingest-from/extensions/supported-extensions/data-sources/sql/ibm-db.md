...
Мастер активации расширения содержит динамически обновляемые JSON-данные с конфигурацией мониторинга. Сведения об использовании этих данных для активации расширения через Dynatrace API см. в разделе Manage Extensions.

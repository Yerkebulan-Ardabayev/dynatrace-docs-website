...
Определите конечные точки](microsoft-sql.md#define-endpoints "Расширьте наблюдаемость в Dynatrace с помощью декларативных метрик, получаемых от Microsoft SQL Server.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

Выберите ActiveGates](microsoft-sql.md#activegate-group "Расширьте наблюдаемость в Dynatrace с помощью декларативных метрик, получаемых от Microsoft SQL Server.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

Активируйте расширение](microsoft-sql.md#activate-extension "Расширьте наблюдаемость в Dynatrace с помощью декларативных метрик, получаемых от Microsoft SQL Server.")
...
1. Выберите **Add Sql Server endpoint**, чтобы определить серверы, с которых требуется получать данные. Можно задать до 100 конечных точек. Укажите следующие данные подключения:
   ...
   * Схема аутентификации. Можно выбрать одну из следующих [схем аутентификации](../../../develop-your-extensions/data-sources/sql/microsoft-sql-monitoring.md#authentication "Расширения Microsoft SQL в фреймворке Extensions."):

     + Базовая аутентификация
     + Аутентификация Kerberos
     + Аутентификация NTLM
   * Вы можете [включить SSL](../../../develop-your-extensions/data-sources/sql/microsoft-sql-monitoring.md#ssl "Расширения Microsoft SQL в фреймворке Extensions."), чтобы установить защищённое соединение для вашей конфигурации.
   * Вы можете [использовать хранилище учётных данных](../../../develop-your-extensions/data-sources/sql/microsoft-sql-monitoring.md#credential-vault "Расширения Microsoft SQL в фреймворке Extensions.") для более безопасного хранения и управления учётными данными пользователей.
...
Мастер активации расширений содержит динамически обновляемую JSON-нагрузку с вашей конфигурацией мониторинга. Чтобы узнать, как использовать её для активации расширения через Dynatrace API, см. раздел [Управление расширениями](../../../manage-extensions.md "Узнайте, как управлять расширениями.").

...
1. Выберите **Add Sql Server endpoint**, чтобы определить серверы, с которых требуется получать данные. Можно задать до 100 конечных точек. Укажите следующие данные подключения:
   ...
   * Схема аутентификации. Можно выбрать одну из следующих схем аутентификации:

     + Базовая аутентификация
     + Аутентификация Kerberos
     + Аутентификация NTLM
   * Вы можете включить SSL, чтобы установить защищённое соединение для вашей конфигурации.
   * Вы можете использовать хранилище учётных данных для более безопасного хранения и управления учётными данными пользователей.
...
Мастер активации расширений содержит динамически обновляемую JSON-нагрузку с вашей конфигурацией мониторинга. Чтобы узнать, как использовать её для активации расширения через Dynatrace API, см. раздел Управление расширениями.

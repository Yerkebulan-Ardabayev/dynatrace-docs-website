...
Мастер активации расширения содержит динамически обновляемый JSON-документ с вашей конфигурацией мониторинга. См. Управление расширениями, чтобы узнать, как использовать его для активации расширения через API Dynatrace.

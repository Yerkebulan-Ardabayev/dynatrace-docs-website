...
3. Ознакомьтесь с [аппаратными требованиями](../../develop-your-extensions/data-sources/snmp-extensions.md#hw "Learn how to create an SNMP extension using the Extensions framework.") для ActiveGate, выполняющего мониторинг SNMP.
...
**Группа ActiveGate**](snmp.md#step-1 "Learn how to extend observability in Dynatrace with declarative SNMP metrics and event ingestion.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Определение устройств**](snmp.md#step-2 "Learn how to extend observability in Dynatrace with declarative SNMP metrics and event ingestion.")[![Step 3 optional](https://dt-cdn.net/images/dotted-step-3-e2082c1921.svg "Step 3 optional")

**Дополнительные свойства**](snmp.md#step-3 "Learn how to extend observability in Dynatrace with declarative SNMP metrics and event ingestion.")[![Step 4](https://dt-cdn.net/images/step-4-3f89d67d41.svg "Step 4")
...
Мастер активации расширения содержит динамически обновляемую JSON-нагрузку с вашей конфигурацией мониторинга. См. [Управление расширениями](../../manage-extensions.md "Learn how to manage extensions."), чтобы узнать, как использовать её для активации расширения через API Dynatrace.

...
Сначала проверьте [Dynatrace Hub](https://www.dynatrace.com/hub/?query=snmp), чтобы узнать, покрывается ли ваше устройство существующим расширением. Если нет, вы можете создать собственное SNMP-расширение Dynatrace для вашего SNMP-устройства.

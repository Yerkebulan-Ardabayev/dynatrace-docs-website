...
* См. [Конфигурация мониторинга Oracle Database](develop-your-extensions/data-sources/sql/oracle-monitoring.md "Создание и активация конфигурации мониторинга для расширения на основе SQL-источника данных для Oracle Database."), чтобы узнать, как создать конфигурацию мониторинга для Oracle Database.
* См. [Конфигурация мониторинга Microsoft SQL Server](develop-your-extensions/data-sources/sql/microsoft-sql-monitoring.md "Расширения Microsoft SQL в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для Microsoft SQL Server.
* См. [Конфигурация мониторинга IBM Database](develop-your-extensions/data-sources/sql/ibm-monitoring.md "Расширения IBM DB2 в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для IBM Database.
* См. [Конфигурация мониторинга MySQL](develop-your-extensions/data-sources/sql/mysql-monitoring.md "Расширения MySQL в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для MySQL.
* См. [Конфигурация мониторинга PostgreSQL](develop-your-extensions/data-sources/sql/postgresql-monitoring.md "Расширения PostgreSQL в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для PostgreSQL.
* См. [Конфигурация мониторинга SAP Hana Database](develop-your-extensions/data-sources/sql/sap-hana-monitoring.md "Расширения SAP Hana в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для SAP Hana Database.
* См. [Конфигурация мониторинга Snowflake Database](develop-your-extensions/data-sources/sql/snowflake-monitoring.md "Расширения Snowflake Database в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для Snowflake Database.
* См. [Конфигурация мониторинга JDBC](develop-your-extensions/data-sources/sql/jdbc-monitoring.md "Расширения JDBC в фреймворке расширений."), чтобы узнать, как создать конфигурацию мониторинга для JDBC.
...
Подробнее см. [Подпись расширения](develop-your-extensions/sign-extensions.md "Узнайте, как подписать расширение для безопасного распространения в вашей среде с помощью фреймворка расширений Dynatrace.") и проект [dt-cli](https://github.com/dynatrace-oss/dt-cli) на GitHub.
...
Перед развёртыванием расширений ознакомьтесь с текущими [ограничениями](extension-limits.md "Узнайте об ограничениях расширений."), чтобы убедиться, что вы можете эффективно достичь своих целей мониторинга.
...
Расширьте наблюдаемость данными ваших сетевых устройств с помощью декларативных метрик на основе SNMP OID.](develop-your-extensions/data-sources/snmp-extensions.md "Узнайте, как создать расширение SNMP с помощью фреймворка расширений.")[![WMI](https://dt-cdn.net/images/techn-icon-microsoft-e15d516aaf.svg "WMI")

### WMI

Расширьте наблюдаемость данными устройств, предоставляющих интерфейс Windows Management Instrumentation.](develop-your-extensions/data-sources/wmi-extensions.md "Узнайте, как создать расширение WMI с помощью фреймворка расширений.")[![Prometheus](https://dt-cdn.net/images/prometheus-b1fab729ac.svg "Prometheus")

### Prometheus

Расширьте данные приложений и сервисов метриками, полученными из эндпоинта Prometheus вне Kubernetes.](develop-your-extensions/data-sources/prometheus-extensions.md "Узнайте, как создать расширение Prometheus с помощью фреймворка расширений.")[![SQL data source](https://dt-cdn.net/images/sql-logo-036ab75f37.svg "SQL data source")

### SQL

Расширьте наблюдаемость данными, полученными из слоя базы данных с помощью SQL-запросов.](develop-your-extensions/data-sources/sql.md "Узнайте, как создать расширение на основе SQL-источника данных с помощью фреймворка расширений.")[![JMX](https://dt-cdn.net/images/techn-icon-java-3016283f6a.svg "JMX")
...
Расширьте наблюдаемость данными любой технологии, предоставляющей данные через интерфейс, с помощью пользовательских расширений на основе Python SDK от Dynatrace.](develop-your-extensions/data-sources/python.md "Библиотека Python и набор инструментов для создания расширений Python для Dynatrace Extensions.")

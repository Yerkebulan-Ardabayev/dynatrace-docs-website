...
Эти заметки о выпуске Dynatrace — демонстрация новых функций, изменений и исправлений ошибок — помогают вам оставаться в курсе и быть впереди событий.
...
Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace, и о том, как начать работу.](/docs/whats-new/technology "Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace.")[### Новости о прекращении поддержки

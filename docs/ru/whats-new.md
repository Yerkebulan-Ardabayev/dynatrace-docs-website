...
Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace, и о том, как начать работать с ними.](/docs/whats-new/technology "Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace.")[### Новости о прекращении поддержки

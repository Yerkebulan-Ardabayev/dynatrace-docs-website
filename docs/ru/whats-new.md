...
|  | [Стандартная поддержка](https://www.dynatrace.com/services-support/) | [Предприятие и поддержка](https://www.dynatrace.com/services-support/) |
| --- | --- | --- |
...
Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace, и как начать работу с ними.](/docs/whats-new/technology "Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace.")[### Новости о прекращении поддержки

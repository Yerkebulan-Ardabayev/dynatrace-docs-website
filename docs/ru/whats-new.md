...
Эти заметки о выпуске для Dynatrace, в которых представлены новые функции, изменения и исправления ошибок, помогают вам оставаться в курсе и быть впереди событий.
...
|  | [Стандартная поддержка](https://www.dynatrace.com/services-support/) | [Предприятическая поддержка и успех](https://www.dynatrace.com/services-support/) |
| --- | --- | --- |
...
[### Новая технологическая поддержка

Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace, и как начать работу.](/docs/whats-new/technology "Узнайте о новых технологиях, которые можно отслеживать с помощью Dynatrace.")[### Новости об окончании поддержки

...
Dynatrace следует агиле-разработке с спринтами каждые две недели.
...
* **Развертывание** SaaS — это двухнедельный период, в течение которого мы развертываем новый выпуск в кластерах Dynatrace.
...
Откройте для себя новые технологии, которые можно отслеживать с помощью Dynatrace, и как начать работать с ними.](/docs/whats-new/technology "Откройте для себя новые технологии, которые можно отслеживать с помощью Dynatrace.")[### Новости о прекращении поддержки

Объявления о прекращении поддержки технологий, поддерживаемых Dynatrace.](/docs/whats-new/technology/end-of-support-news "Объявления о прекращении поддержки технологий, поддерживаемых Dynatrace.")[### Новые темы документации

...
Предиктивное управление ёмкостью начинается в **Notebooks**, где необходимо настроить показатели ёмкости. На изображении ниже показан пример индикатора процента свободного дискового пространства для операционной команды.
...
В ![Workflows](https://dt-cdn.net/images/workflows-1024-b5708f3cf9.webp "Workflows") **Workflows** настройте необходимое расписание для запуска прогноза. Чтобы узнать, как это сделать, см. Триггер расписания рабочего процесса. На изображении ниже показан рабочий процесс, который запускается в 8:00 для прогнозирования всех дисков, которые с высокой вероятностью исчерпают свободное пространство в течение следующей недели.
...
3. Настройте сообщение. Чтобы узнать, как это сделать, см. Коннектор Slack.

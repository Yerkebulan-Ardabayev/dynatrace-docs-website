...
* [Примеры обнаружения аномалий на Grail](/docs/dynatrace-intelligence/use-cases/anomaly-detection-examples "Используйте возможности Grail и DQL для преобразования любых данных в временные ряды для анализаторов обнаружения аномалий.")

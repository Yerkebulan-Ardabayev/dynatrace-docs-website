...
При использовании анализа прогнозирования в одном из ваших ноутбуков вы можете написать любой DQL-запрос, который возвращает данные временного ряда в [формате записи временного ряда](#time-series-record-format).

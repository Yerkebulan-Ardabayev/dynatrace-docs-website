...
Прочитайте это объяснение](/docs/dynatrace-intelligence/anomaly-detection/anomaly-detection-configuration)[#### Автоматический многомерный базлин

Узнайте, как Dynatrace AI автоматически рассчитывает базовые метрики на основе многомерной схемы базлининга.
...
Прочитайте это руководство](/docs/dynatrace-intelligence/anomaly-detection/set-up-anomaly-detectors-via-api)
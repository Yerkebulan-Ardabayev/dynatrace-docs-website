---
title: Приложение Dynatrace Intelligence (Preview)
...
3. Выберите триггер рабочего процесса, который запустит выполнение рабочего процесса.
4. Выберите **Add task**.
...
Чтобы узнать о конкретных сценариях использования и о том, как применять действие генеративного ИИ Dynatrace Intelligence в рабочих процессах, см. Обобщение открытых проблем с помощью Dynatrace Intelligence (Preview) для обобщения открытых проблем и предложения шагов по их устранению.").
...
* Dynatrace Assist
* Обобщение открытых проблем с помощью Workflows для обобщения открытых проблем и предложения шагов по их устранению.")

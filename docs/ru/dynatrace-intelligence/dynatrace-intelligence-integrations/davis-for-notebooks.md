...
Dynatrace Intelligence для Notebooks запускает ряд анализаторов直接 в Notebooks, обеспечивая моментальные результаты и позволяя вам тонко настраивать ваши пользовательские конфигурации оповещений.
...
Прогнозный анализ Dynatrace Intelligence предвидит будущие значения любой временной серии числовых значений на основе накопленных данных. Чтобы запустить [анализ прогноза](/docs/dynatrace-intelligence/reference/ai-models/forecast-analysis "Узнайте, как Dynatrace Intelligence генерирует прогнозы с помощью прогнозного ИИ.")

...
Problems API v1 был объявлен устаревшим в версии Dynatrace 1.243. Его заменой является Problems API v2. Мы рекомендуем выполнить миграцию на новый API при первой возможности.
...
* Селектор сущностей помогает фильтровать проблемы в запросах на чтение.
...
Подробнее о новых параметрах запросов/тела см. документацию отдельных запросов в Problems API v2.

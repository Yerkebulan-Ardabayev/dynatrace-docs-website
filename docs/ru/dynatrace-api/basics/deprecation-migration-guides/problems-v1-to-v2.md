...
[Problems API v1](/docs/dynatrace-api/environment-api/problems "Узнайте, что предлагает Dynatrace Problems v1 API.") был объявлен устаревшим в [версии Dynatrace 1.243](/docs/whats-new/dynatrace-api/sprint-243 "Список изменений для версии Dynatrace API 1.243"). Его заменой является [Problems API v2](/docs/dynatrace-api/environment-api/problems-v2 "Узнайте, что предлагает Dynatrace Problems v2 API."). Мы рекомендуем выполнить миграцию на новый API при первой возможности.
...
* [Селектор сущностей](/docs/dynatrace-api/environment-api/entity-v2/entity-selector "Настройте селектор сущностей для конечных точек Environment API.") помогает фильтровать проблемы в запросах на чтение.
...
Подробнее о новых параметрах запросов/тела см. документацию отдельных запросов в [Problems API v2](/docs/dynatrace-api/environment-api/problems-v2 "Узнайте, что предлагает Dynatrace Problems v2 API.").

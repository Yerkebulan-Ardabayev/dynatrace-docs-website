...
API окон обслуживания был объявлен устаревшим в Dynatrace версии 1.240. Его заменой является Settings API со схемой **Maintenance windows** (`builtin:alerting.maintenance-window`). Мы рекомендуем выполнить миграцию на новый API при первой возможности.
...
Чтобы получить список всех окон обслуживания, используйте запрос GET objects. В параметрах запроса установите **schemaIds** в `builtin:alerting.maintenance-window` и **scope** в `environment`.
...
Чтобы создать окно обслуживания, используйте запрос POST an object. В теле запроса установите **schemaId** в `builtin:alerting.maintenance-window` и **scope** в `environment`. Предоставьте конфигурацию окна обслуживания в объекте **value**.
...
Чтобы отредактировать окно обслуживания, используйте запрос PUT an object.

...
|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-environment-id}.live.dynatrace.com/api/v2/rum/inlineCode/{applicationId}` |
...
Сведения о том, как получить и использовать токен, см. в разделе Токены и аутентификация.

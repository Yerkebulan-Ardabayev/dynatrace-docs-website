...
Получает список всех групп процессов в вашей среде Dynatrace вместе с их параметрами и связями.
...
|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-environment-id}.live.dynatrace.com/api/v1/entity/infrastructure/process-groups` |

...
Использование этого API ограничено тегами с только значением. Для назначения тегов формата ключ:значение используйте [Custom tags API](../../custom-tags/post-tags.md "Назначайте пользовательские теги отслеживаемым сущностям через Dynatrace API.").
...
Чтобы узнать, как его получить и использовать, см. раздел [Токены и аутентификация](../../../../discover-dynatrace/references/dynatrace-api/basics/dynatrace-api-authentication.md).
...
* [Services](../../../../observe/application-observability/services.md "Узнайте, как отслеживать и анализировать ваши сервисы, определять и использовать атрибуты запросов и многое другое.")

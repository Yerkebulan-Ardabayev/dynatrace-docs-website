...
Этот API устарел. Используйте вместо него API мониторируемых сущностей. Дополнительную информацию о переходе на новый API можно найти в руководстве по миграции.
...
|  |  |  |
| --- | --- | --- |
| GET | Managed | `https://{your-environment-id}.live.dynatrace.com/api/v1/entity/services/{meIdentifier}` |

...
Возвращает список групп процессов отслеживания исправлений для сторонней уязвимости (или, в случае уязвимостей Kubernetes, узлов Kubernetes для отслеживания исправлений).

...
Этот API предназначен для использования с последней реализацией AWS Lambda. Подробнее см. в разделе [AWS Lambda](/docs/ingest-from/amazon-web-services/integrate-into-aws/aws-lambda-integration "Возможности AWS Lambda и варианты интеграции").
...
Информацию о том, как получить и использовать токен, см. в разделе [Токены и аутентификация](/docs/discover-dynatrace/references/dynatrace-api/basics/dynatrace-api-authentication).

...
scraped: 2026-02-24T21:34:50.273764
---
...
**Разрешенные домены биконов** API позволяет вам управлять списком источников RUM-биконов, которые должны быть приняты OneAgent и ActiveGate.

Чтобы управлять списком источников RUM-биконов в веб-интерфейсе Dynatrace, перейдите в **Настройки** > **Мониторинг веба и мобильных приложений** > **Источники биконов для CORS**.

...
Получите обзор сопоставлений IP-адресов.](/docs/dynatrace-api/configuration-api/rum/geographic-regions-ip-address/get-configuration "Read the configuration of IP address mapping via the Dynatrace API.")[### Обновление конфигурации

Обновите конфигурацию сопоставлений IP-адресов.](/docs/dynatrace-api/configuration-api/rum/geographic-regions-ip-address/put-configuration "Update the configuration of IP address mapping via the Dynatrace API.")

## Связанные темы

* [Сопоставление внутренних IP-адресов с местоположениями для веб-приложений](/docs/observe/digital-experience/web-applications/additional-configuration/map-internal-ip-addresses-to-locations-web "Configure Dynatrace to use local addresses to understand where the users of your web applications are.")

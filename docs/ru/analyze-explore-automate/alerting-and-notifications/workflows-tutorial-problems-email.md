...
2. Добавлять триггер события для [проблем Davis](../workflows/trigger/event-trigger.md#davis-problem-trigger "Руководство по созданию триггеров событий автоматизации рабочих процессов в Dynatrace Workflows.").
3. Добавлять email-уведомление.
...
2. Добавьте триггер события для [проблем Davis](../workflows/trigger/event-trigger.md#davis-problem-trigger "Руководство по созданию триггеров событий автоматизации рабочих процессов в Dynatrace Workflows.").

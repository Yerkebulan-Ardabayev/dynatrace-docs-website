...
Следующие сценарии использования демонстрируют некоторые из способов применения Notebooks и Dashboards для визуализации и анализа данных, загруженных в Grail.

### Анализ и отчётность с помощью фрагментов кода безопасности

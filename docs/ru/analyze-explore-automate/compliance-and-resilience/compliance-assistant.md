...
* Открыть шаблон отчёта
  ...
  Обратите внимание, что это готовый документ.
...
* Используйте сегменты для удобной фильтрации инцидентов наблюдаемости и безопасности, влияющих на критический сервис по DORA.

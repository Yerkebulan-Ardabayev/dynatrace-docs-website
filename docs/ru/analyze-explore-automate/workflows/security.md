...
* У вас есть необходимые разрешения, предоставленные в [Account Management](../../manage/account-management.md "Управление лицензией Dynatrace, аккаунтами, внедрением платформы и состоянием среды.").
...
* Передать владение другому пользователю. Подробности см. в разделе [Смена владельца рабочего процесса](manage-workflows/workflows-change-owner.md "Смена владельца рабочего процесса.").
...
Сервисные пользователи и их разрешения управляются администраторами через [управление идентификацией и доступом](../../manage/identity-access-management/user-and-group-management/access-service-users.md "Сервисные пользователи"). Мы настоятельно рекомендуем предоставлять сервисному пользователю только те разрешения, которые необходимы для предполагаемого сценария использования.
...
Подробнее см. [Сервисные пользователи](../../manage/identity-access-management/user-and-group-management/access-service-users.md "Сервисные пользователи")

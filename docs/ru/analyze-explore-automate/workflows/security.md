...
* У вас есть необходимые разрешения, предоставленные в [Account Management](/docs/manage/account-management "Управление лицензией Dynatrace, аккаунтами, внедрением платформы и состоянием среды.").
...
* Передать владение другому пользователю. Подробности см. в разделе [Смена владельца рабочего процесса](/docs/analyze-explore-automate/workflows/manage-workflows/workflows-change-owner "Смена владельца рабочего процесса.").
...
Сервисные пользователи и их разрешения управляются администраторами через [управление идентификацией и доступом](/docs/manage/identity-access-management/user-and-group-management/access-service-users "Сервисные пользователи"). Мы настоятельно рекомендуем предоставлять сервисному пользователю только те разрешения, которые необходимы для предполагаемого сценария использования.
...
Подробнее см. [Сервисные пользователи](/docs/manage/identity-access-management/user-and-group-management/access-service-users "Сервисные пользователи")

...
Действие **Выполнить запрос DQL** для Workflows позволяет использовать запросы DQL в рабочем процессе. В **запросе DQL** введите свой запрос DQL. В **Сегменте** вы можете необязательно выбрать фильтровый сегмент.

...
Настройка и конфигурирование GitHub Connector.](github/github-workflows-setup.md "Узнайте, как настроить GitHub Connector.")[![GitHub](https://dt-cdn.net/images/github-for-workflows-new-lxjn9po-256-94579b3812.png "GitHub")

### Действия GitHub Connector

Узнайте о доступных действиях, используемых интеграцией GitHub Connector для автоматизации работы с задачами и pull request'ами на основе данных мониторинга и событий.](github/github-workflows-actions.md "Интеграция Workflows с сервисами GitHub для использования действий GitHub Connector.")

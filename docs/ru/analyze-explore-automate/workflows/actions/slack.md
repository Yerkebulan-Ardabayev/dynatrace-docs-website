...
Подробнее см. Выражения Dynatrace.
...
Дополнительные возможности выражений см. в Справочнике по выражениям.
...
7. Укажите тело сообщения.
   Отформатируйте сообщение с помощью [Slack Markdown](https://api.slack.com/reference/surfaces/formatting#basics). Также можно использовать выражения рабочих процессов в качестве входных данных.
...
* Отправка уведомлений Slack о проблемах

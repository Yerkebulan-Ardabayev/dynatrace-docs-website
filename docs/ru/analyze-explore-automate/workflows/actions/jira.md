...
Ниже представлены решения проблем, с которыми сталкиваются некоторые пользователи при работе с действиями Jira Connector.

* [Ошибка недействительного подключения в Jira Connector​](https://dt-url.net/86238jw)
* [Ошибка недостаточных разрешений в Jira Connector​](https://dt-url.net/ix2388q)
* [Почему создание задачи Jira завершается ошибкой в Jira Connector?​](https://dt-url.net/ru038v6)

...
* Если вы уже используете приложение ![Панели](https://dt-cdn.net/images/dashboards-512-b1f1e9690b.png "Панели") **Панели** в последнем Dynatrace, см. Панели для связанной документации.
* Если вы все еще используете классические панели, мы рекомендуем вам обновить свои панели и воспользоваться всеми возможностями последних панелей, доступными в приложении ![Панели](https://dt-cdn.net/images/dashboards-512-b1f1e9690b.png "Панели") **Панели** в последнем Dynatrace.
...
Используйте плитки визуализаций, чтобы создать визуальные представления запросов Data Explorer, которые можно прикрепить к вашим панелям.
...
* Все плитки имеют меню плитки в правом верхнем углу:
  ...
  + **Настройка плитки в Data Explorer** открывает плитку в Data Explorer, где вы можете настроить запрос и визуализацию.
...
3. Выберите **Настроить плитку**, чтобы открыть свою плитку в Data Explorer.
...
* Цель ссылки в круглых скобках: `(` и `)`. Существует два способа определить цель:
  ...
  + Якорь на страницу Dynatrace (включая другие панели управления).  
    ...
    ```
    Моя ссылка на статус развертывания
    ```
...
* Если вы не видите данных на мировой карте, вам, возможно, нужно сопоставить внутренние IP-адреса с местоположениями для вашего веб-, мобильных- и пользовательских приложений.
...
Отображает ключевые показатели производительности, связанные с выбранным веб-приложением: рейтинг Apdex, действия пользователей в минуту, и количество ошибок JavaScript в минуту.
...
Отображает ключевые показатели производительности, связанные с выбранным приложением и ключевым действием пользователя: продолжительность действия пользователя, действия пользователей в минуту, и количество ошибок в минуту.
...
3. На странице **Запрос сеанса пользователя** создайте запрос и выберите **Выполнить запрос**
...
Для получения дополнительной информации см. Настройка и мониторинг целей обслуживания с Dynatrace.
...
* Из меню плитки выберите **Просмотр деталей**, чтобы открыть вашу Проблемы ленту.

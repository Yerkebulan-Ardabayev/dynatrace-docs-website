...
Начиная с OneAgent версии 1.243 и Dynatrace Cluster версии 1.252, мы настоятельно рекомендуем перейти на Log Storage.

С выпуском Dynatrace версии 1.285 (март 2024 года) Dynatrace автоматически преобразует ваши конфигурации источников логов и хранения логов до актуальной версии.
...
Обновлённая конфигурация (см. Log ingest rules), определяемая на страницах **Custom log source configuration** и **Log sources and storage**, предоставит вам:

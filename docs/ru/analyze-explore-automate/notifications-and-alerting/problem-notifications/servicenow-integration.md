...
Для расширенных возможностей и автоматизации рабочих процессов (например, включения целевых уведомлений и автоматического устранения проблем) см. [Коннекторы Workflows](/docs/analyze-explore-automate/workflows/actions "Используйте готовые действия Dynatrace для ваших рабочих процессов и интегрируйте Dynatrace со сторонними системами.").

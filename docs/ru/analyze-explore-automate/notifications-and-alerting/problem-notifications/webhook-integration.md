...
4. Настройте уведомление:
   ...
   * Назначьте [профиль оповещения](/docs/analyze-explore-automate/notifications-and-alerting/alerting-profiles "Узнайте, как создавать профили оповещения и управлять ими.").

...
Для расширенных возможностей и автоматизации рабочих процессов (например, целевые уведомления и устранение проблем) см. Connectors для Workflows.
...
7. Назначьте Профиль оповещений.

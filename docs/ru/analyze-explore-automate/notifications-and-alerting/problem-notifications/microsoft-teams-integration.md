...
Для расширенных возможностей и автоматизации рабочих процессов (например, целевых уведомлений и устранения проблем) см. раздел [Workflows Connectors](/docs/analyze-explore-automate/workflows/actions "Используйте готовые действия Dynatrace для ваших рабочих процессов и интегрируйте Dynatrace со сторонними системами.").

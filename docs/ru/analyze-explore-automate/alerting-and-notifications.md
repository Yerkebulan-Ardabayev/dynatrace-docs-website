...
Dynatrace Intelligence автоматически обнаруживает аномалии в вашей среде, генерирует события Davis для отдельных инцидентов и группирует их в проблемы. Эти проблемы предоставляют чёткий, контекстный обзор, позволяющий ускорить анализ коренных причин и их устранение.
...
Вы можете настроить чувствительность обнаружения аномалий в соответствии с вашей средой и уменьшить количество ложных срабатываний или пропущенных аномалий. Подробнее см. Настройка чувствительности обнаружения аномалий.
...
Полный список см. в разделе Коннекторы Workflows.
...
* Настройка оповещений на основе событий, извлечённых из журналов
* Настройка пользовательских оповещений на основе метрик, извлечённых из журналов
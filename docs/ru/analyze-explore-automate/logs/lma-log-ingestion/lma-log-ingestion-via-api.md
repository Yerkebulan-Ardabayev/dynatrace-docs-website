...
* Для Dynatrace конечная точка приема журналов доступна в вашей среде.
...
При использовании обработки журналов с пользовательским конвейером обработки (OpenPipeline), прием поддерживает все типы данных JSON для значений атрибутов. Это требует верси 1.295+ при использовании конечной точк API или версии ActiveGate 1.295+ при использовании конечной точки ActiveGate API. Во всех остальных случаях все принятые значения преобразуются в строковый тип.

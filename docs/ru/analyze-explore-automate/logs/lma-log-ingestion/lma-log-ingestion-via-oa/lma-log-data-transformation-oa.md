...
Для получения подробной информации и полного списка атрибутов уровня хоста см. раздел Атрибуты ресурсов.
Специфическое для Kubernetes обогащение метаданными описано в разделе Обогащение метаданными всей телеметрии, исходящей из рабочих нагрузок Kubernetes.

...
* `log.source`
* `process.technology`
* [`span_id`](/docs/analyze-explore-automate/logs/lma-log-enrichment "Связывайте входящие данные журналов с трассировками для более точного анализа в Dynatrace.")
* `status`
* [`trace_id`](/docs/analyze-explore-automate/logs/lma-log-enrichment "Связывайте входящие данные журналов с трассировками для более точного анализа в Dynatrace.")
...
Для получения подробной информации и полного списка атрибутов уровня хоста см. раздел [Атрибуты ресурсов](/docs/platform/oneagent/resource-attributes "Любой сигнал, использующий данный ресурс, например хост или группу процессов, обогащается определёнными атрибутами из ресурса.").
Специфическое для Kubernetes обогащение метаданными описано в разделе [Обогащение метаданными всей телеметрии, исходящей из рабочих нагрузок Kubernetes](/docs/ingest-from/setup-on-k8s/guides/metadata-automation/k8s-metadata-telemetry-enrichment "Руководства по обогащению телеметрии на Kubernetes").
...
* [API приёма журналов](/docs/analyze-explore-automate/logs/lma-log-ingestion/lma-log-ingestion-via-api "Потоковая передача данных журналов в Dynatrace через API для их преобразования в значимые сообщения журналов.")
* [Приём журналов через OneAgent](/docs/analyze-explore-automate/logs/lma-log-ingestion/lma-log-ingestion-via-oa "Приём данных журналов в Dynatrace через OneAgent для их преобразования в значимые сообщения журналов.")

...
Управление журналами и аналитика Dynatrace использует DaemonSet OneAgent, включающий модуль журналов. Это рекомендуемый способ потоковой передачи журналов с узлов и подов в Dynatrace.
...
* Поддерживает потоковую передачу журналов для интеграций только с приложениями.

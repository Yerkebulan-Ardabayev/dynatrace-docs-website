...
* В Dynatrace версии 1.331 и выше предварительная обработка JSON-логов включена по умолчанию. Её нельзя отключить или настроить, и она доступна только для новых сред.
* В Dynatrace версии 1.330 и ниже предварительная обработка JSON-логов недоступна.

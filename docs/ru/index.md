...
Откройте для себя все [Приложения Dynatrace](discover-dynatrace/dynatrace-apps.md).

## Полезные ресурсы

- [Университет Dynatrace](https://university.dynatrace.com) — образование и ресурсы, онлайн и лично
- [Dynatrace Developer](https://developer.dynatrace.com) — создавайте приложения с минимальными усилиями
- [Сообщество Dynatrace](https://community.dynatrace.com) — ответы и общение с экспертами
- [Поддержка Dynatrace](https://support.dynatrace.com/) — помощь от экспертов по продуктам

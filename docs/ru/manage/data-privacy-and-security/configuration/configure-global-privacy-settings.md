...
Dynatrace позволяет гибко управлять тем, какие данные вы хотите собирать. В зависимости от ваших сценариев использования вы можете настроить Dynatrace для предоставления необходимого объёма [данных из отслеживаемых сред](/docs/manage/data-privacy-and-security/data-privacy/personal-data-captured-by-dynatrace "Узнайте, какие типы данных конечных пользователей могут быть собраны при мониторинге Dynatrace и какие методы доступны для маскировки персональных данных."). Однако имейте в виду, что защита персональных данных ваших клиентов при использовании Dynatrace является вашей ответственностью.
...
Обратите внимание, что Dynatrace маскирует данные в соответствии с нашими [тремя уровнями защиты данных](/docs/manage/data-privacy-and-security/data-privacy/levels-of-data-protection "Узнайте, как Dynatrace защищает информацию конечных пользователей, применяя различные уровни защиты в зависимости от ситуации."): **при сборе**, **при хранении** и **при отображении**. В следующих разделах настройки конфиденциальности данных сгруппированы по этим уровням защиты.
...
Настройки маскировки на стороне OneAgent не влияют на [JavaScript RUM Dynatrace](/docs/observe/digital-experience/rum-concepts/applications#web "Узнайте о мониторинге приложений в Real User Monitoring и различных типах приложений, поддерживаемых Dynatrace."). Для веб-приложений используйте [опцию **Mask personal data in URIs**](/docs/observe/digital-experience/web-applications/additional-configuration/configure-real-user-monitoring-according-to-gdpr#mask-uris "Узнайте о настройках конфиденциальности, предоставляемых Dynatrace для обеспечения соответствия ваших веб-приложений нормам защиты данных вашего региона.") для управления маскировкой конфиденциальных данных в URL.
...
В Log Management and Analytics вы можете использовать [полностью настраиваемые правила маскировки](/docs/analyze-explore-automate/logs/lma-log-ingestion/lma-log-ingestion-via-oa/lma-sensitive-data-masking "Маскировка конфиденциальной информации в данных логов с помощью Log Management and Analytics.") для логов, собираемых OneAgent.
...
Чтобы избежать сбора персональной информации в действиях пользователей мобильных приложений, ознакомьтесь с информацией о [маскировке действий мобильных пользователей](/docs/observe/digital-experience/mobile-applications/additional-configuration/configure-rum-privacy-mobile#user-action-masking "Используйте настройки конфиденциальности Dynatrace для обеспечения соответствия ваших мобильных приложений нормам защиты данных вашего региона.").
...
Dynatrace автоматически считает определённые собираемые точки данных конфиденциальными и отображает их только пользователям, имеющим [разрешение](/docs/manage/identity-access-management/permission-management/role-based-permissions "Разрешения на основе ролей") **View sensitive request data**. Все остальные пользователи видят, что точка данных существует, но персональные данные маскируются звёздочками `*****`.
...
[Атрибуты запросов](/docs/observe/application-observability/services/request-attributes "Узнайте, что такое атрибуты запросов и как использовать их на всех уровнях представлений анализа сервисов.") — это пары ключ-значение метаданных, фильтруемые во всех представлениях сервисов и распределённых трассировок Dynatrace.

Dynatrace позволяет вам решить, должен ли атрибут запроса быть [помечен как конфиденциальный](/docs/observe/application-observability/services/request-attributes#confidential "Узнайте, что такое атрибуты запросов и как использовать их на всех уровнях представлений анализа сервисов."). Для управления атрибутами запросов необходимо иметь [разрешение](/docs/manage/identity-access-management/permission-management/role-based-permissions "Разрешения на основе ролей") **Manage capturing of sensitive request data**.
...
* **Capture anonymous user sessions for "Do Not Track"-enabled browsers**: При обнаружении заголовка `DNT` Dynatrace собирает данные RUM, но исключает всю персональную информацию, которая может привести к идентификации пользователя. IP-адрес маскируется, и информация о [теге пользователя](/docs/observe/digital-experience/rum-concepts/user-and-error-events#user-tagging "Узнайте о пользовательских событиях и событиях ошибок, а также типах событий, собираемых Dynatrace.") не отправляется.
...
При включении JavaScript RUM устанавливает постоянный куки в браузерах конечных пользователей, указывающий, что браузер ранее использовался для доступа к вашему приложению. При отключении RUM Classic больше не может связывать сессии с одним и тем же пользователем при перезапуске браузера. Узнайте, [как мы храним этот куки](/docs/manage/data-privacy-and-security/data-privacy/cookies#cookie-storage "Узнайте об использовании собственных куки в Dynatrace.").
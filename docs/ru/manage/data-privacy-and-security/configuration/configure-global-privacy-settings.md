...
Настройки маскировки на стороне OneAgent не влияют на [JavaScript RUM Dynatrace](../../../observe/digital-experience/rum-concepts/applications.md#web "Узнайте о мониторинге приложений в Real User Monitoring и различных типах приложений, поддерживаемых Dynatrace."). Для веб-приложений используйте [опцию **Mask personal data in URIs**](../../../observe/digital-experience/web-applications/additional-configuration/configure-real-user-monitoring-according-to-gdpr.md#mask-uris "Узнайте о настройках конфиденциальности, предоставляемых Dynatrace для обеспечения соответствия ваших веб-приложений нормам защиты данных вашего региона.") для управления маскировкой конфиденциальных данных в URL.
...
Чтобы избежать сбора персональной информации в действиях пользователей мобильных приложений, ознакомьтесь с информацией о [маскировке действий мобильных пользователей](../../../observe/digital-experience/mobile-applications/additional-configuration/configure-rum-privacy-mobile.md#user-action-masking "Используйте настройки конфиденциальности Dynatrace для обеспечения соответствия ваших мобильных приложений нормам защиты данных вашего региона.").
...
Dynatrace автоматически считает определённые собираемые точки данных конфиденциальными и отображает их только пользователям, имеющим [разрешение](../../identity-access-management/permission-management/role-based-permissions.md "Разрешения на основе ролей") **View sensitive request data**. Все остальные пользователи видят, что точка данных существует, но персональные данные маскируются звёздочками `*****`.
...
[Атрибуты запросов](../../../observe/application-observability/services/request-attributes.md "Узнайте, что такое атрибуты запросов и как использовать их на всех уровнях представлений анализа сервисов.") — это пары ключ-значение метаданных, фильтруемые во всех представлениях сервисов и распределённых трассировок Dynatrace.

Dynatrace позволяет вам решить, должен ли атрибут запроса быть [помечен как конфиденциальный](../../../observe/application-observability/services/request-attributes.md#confidential "Узнайте, что такое атрибуты запросов и как использовать их на всех уровнях представлений анализа сервисов."). Для управления атрибутами запросов необходимо иметь [разрешение](../../identity-access-management/permission-management/role-based-permissions.md "Разрешения на основе ролей") **Manage capturing of sensitive request data**.
...
При включении JavaScript RUM устанавливает постоянный куки в браузерах конечных пользователей, указывающий, что браузер ранее использовался для доступа к вашему приложению. При отключении RUM Classic больше не может связывать сессии с одним и тем же пользователем при перезапуске браузера. Узнайте, [как мы храним этот куки](../data-privacy/cookies.md#cookie-storage "Узнайте об использовании собственных куки в Dynatrace.").
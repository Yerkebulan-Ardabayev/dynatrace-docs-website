...
6. Необязательно: применяйте политики сканирования для уточнения области сканирования — например, для исключения известных ложноположительных результатов. Подробнее см. в разделе Create a policy in Sensitive Data Center.
...
* Настроить или скорректировать правила маскирования, чтобы предотвратить приём аналогичных данных.
* Изменить права доступа к хранимым данным.
* Обновить периоды хранения данных.
* Использовать функцию очистки для удаления конфиденциальных данных при необходимости.

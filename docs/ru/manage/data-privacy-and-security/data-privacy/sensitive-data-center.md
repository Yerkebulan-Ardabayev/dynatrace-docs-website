...
1. В Dynatrace перейдите в Управление учётной записью.
...
* Экспортировать персональные данные: Просмотр и экспорт персональных данных, относящихся к конкретному конечному пользователю.
* Удалить персональные данные: Просмотр и удаление персональных данных, относящихся к конкретному конечному пользователю.
* Очистить данные: Удаление ошибочно загруженных данных за определённый период времени.
* Запланировать сканирования: Создание сканирований для ошибочно загруженных конфиденциальных данных, таких как номера кредитных карт и IBAN, с использованием Sensitive Data Scanner. Эта функциональность доступна только в рамках предварительного доступа.
...
* Используйте политики, чтобы обеспечить соблюдение политик вашей организации в отношении конфиденциальных данных.
...
* Создание политики для обогащения или фильтрации результатов запросов с помощью Sensitive Data Center.02Экспорт персональных данных в Sensitive Data Center

* Экспорт персональных данных с помощью запросов на экспорт Sensitive Data Center.03Просмотр логов аудита в Sensitive Data Center

* Просмотр логов аудита Sensitive Data Center.04Удаление персональных данных в Sensitive Data Center

* Удаление персональных данных с помощью запросов на удаление Sensitive Data Center.05Очистка данных в Sensitive Data Center

* Очистка данных с помощью запросов на очистку Sensitive Data Center.[06Создание запланированного сканирования в Sensitive Data Center

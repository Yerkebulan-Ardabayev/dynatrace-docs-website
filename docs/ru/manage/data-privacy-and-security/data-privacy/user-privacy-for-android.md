...
OneAgent может собирать дополнительные данные через вашу [ручную инструментацию](../../../observe/digital-experience/mobile-applications/instrument-android-app/instrumentation-via-oneagent-sdk.md "Learn what OneAgent SDK for Android is."). Если вы инструментируете приложение для сбора дополнительных данных, убедитесь, что это отражено в разделе **Data safety** в Google Play Console.

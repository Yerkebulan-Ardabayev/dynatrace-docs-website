...
Используйте описанные здесь процедуры в веб-интерфейсе Dynatrace для управления политиками IAM Dynatrace.
...
* Вы можете применить встроенную политику, назначив её группе для всей учётной записи или для любой среды.
...
Полный и актуальный список сервисов Dynatrace, поддерживающих управление разрешениями через политики IAM, см. в разделе Справочник по политикам IAM.
...
Чтобы применить политику к группе, необходимо привязать политику к этой группе. Подробности об управлении разрешениями групп с помощью IAM см. в разделе Работа с политиками.

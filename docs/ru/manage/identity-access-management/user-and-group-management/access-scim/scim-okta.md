...
На этой странице описывается сторона IdP (**Okta**) в конфигурации **SCIM** SSO, а не сторона Dynatrace. Используйте её как часть полной процедуры настройки SCIM для Dynatrace при использовании Okta.

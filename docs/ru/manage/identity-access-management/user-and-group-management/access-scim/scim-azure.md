...
На этой странице описывается настройка на стороне IdP (**Azure**) для конфигурации SSO с использованием **SCIM**, а не на стороне Dynatrace. Используйте данное руководство как часть полной процедуры настройки SCIM для Dynatrace, если вы используете Azure.

---
title: Настройка Azure SCIM для Dynatrace
...
На этой странице описывается настройка на стороне IdP (**Azure**) для конфигурации SSO с использованием **SCIM**, а не на стороне Dynatrace. Используйте данное руководство как часть полной процедуры настройки SCIM для Dynatrace SaaS, если вы используете Azure.

...
Фреймворк Settings 2.0 предоставляет унифицированный инструмент для управления различными конфигурациями в Dynatrace. Независимо от того, используете ли вы веб-интерфейс Dynatrace или [Settings API](/docs/dynatrace-api/environment-api/settings "Узнайте, что предлагает Dynatrace Settings API."), вы задаёте одни и те же конфигурации с одинаковым эффектом.
...
Чтобы узнать, как настроить политики доступа для настроек, см. [Справочник политик IAM](/docs/manage/identity-access-management/permission-management/manage-user-permissions-policies/advanced/iam-policystatements#settings "Полный справочник политик IAM и соответствующих условий для всех сервисов Dynatrace."). Ниже приведены некоторые примеры политик.
...
* [Settings 2.0 — Доступные схемы](/docs/dynatrace-api/environment-api/settings/schemas "Просмотр всей таблицы схем настроек вашей среды мониторинга через Dynatrace API.")

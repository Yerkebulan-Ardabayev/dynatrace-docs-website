...
Используйте переменную окружения [`DT_CUSTOM_PROP`](/docs/observe/infrastructure-observability/process-groups/configuration/define-your-own-process-group-metadata#variables "Настройте собственные метаданные процессов на основе уникальных потребностей вашей организации или окружения.") для определения метаданных. Это позволяет использовать [правила автоматической маркировки](/docs/manage/tags-and-metadata/setup/how-to-define-tags#automatic "Узнайте, как определять и применять теги вручную и автоматически.") на основе существующих или пользовательских метаданных для определения наборов фильтров для графиков, оповещений и многого другого. Эти теги и правила можно изменять и адаптировать в любое время, и они применяются практически мгновенно без каких-либо изменений в контролируемом окружении или приложениях.

...
scraped: 2026-03-06T21:32:52.576228
---
...
Dynatrace собирает метрики для множества предварительно выбранных пространств имён, включая Amazon EC2 API. Вы можете просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские диаграммы, которые можно закрепить на ваших дашбордах.
...
По умолчанию метрики Amazon EC2 API **недоступны** в Amazon CloudWatch. Чтобы включить эту функцию в вашем аккаунте AWS, обратитесь в службу поддержки AWS.
...
| --- | --- | --- | --- | --- | --- |
| ClientErrors | Количество неудачных API-запросов, вызванных ошибками клиента | Count | Sum | Region, Action | Доступен |
| ClientErrors |  | Count | Sum | Region | Доступен |
| RequestLimitExceeded | Количество случаев превышения максимально допустимой частоты запросов к API Amazon EC2 для вашего аккаунта | Count | Sum | Region, Action | Доступен |
| RequestLimitExceeded |  | Count | Sum | Region | Доступен |
| ServerErrors | Количество неудачных API-запросов, вызванных внутренними ошибками сервера | Count | Sum | Region, Action | Доступен |
| ServerErrors |  | Count | Sum | Region | Доступен |
| SuccessfulCalls | Количество успешных API-запросов | Count | Sum | Region, Action | Доступен |
| SuccessfulCalls |  | Count | Sum | Region | Доступен |
---
title: Мониторинг Amazon CloudSearch
...
Dynatrace собирает метрики для множества предварительно выбранных пространств имен, включая Amazon CloudSearch. Вы можете просматривать графики для каждого экземпляра сервиса с набором измерений и создавать пользовательские графики, которые можно закрепить на дашбордах.
...
`DomainName` является основным измерением.

| Название | Описание | Единица измерения | Статистика | Измерения | Рекомендуемая |
| --- | --- | --- | --- | --- | --- |
| IndexUtilization | Процент использованной емкости индекса поискового экземпляра | Процент | Multi | DomainName, ClientId | Доступна |
| Partitions | Количество разделов, по которым распределен индекс | Количество | Multi | DomainName, ClientId | Доступна |
| SearchableDocuments | Количество документов, доступных для поиска в индексе домена | Количество | Максимум | DomainName, ClientId | Доступна |
| SuccessfulRequests | Количество поисковых запросов, успешно обработанных поисковым экземпляром | Количество | Сумма | DomainName, ClientId | Доступна |
| SuccessfulRequests |  | Количество | Максимум | DomainName, ClientId | Доступна |

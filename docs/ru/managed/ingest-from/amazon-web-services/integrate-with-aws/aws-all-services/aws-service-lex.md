...
scraped: 2026-03-03T21:22:56.113224
---
...
Dynatrace собирает метрики для множества предварительно выбранных пространств имён, включая Amazon Lex. Вы можете просматривать метрики для каждого экземпляра сервиса, разделять метрики по нескольким измерениям и создавать пользовательские графики, которые можно закрепить на панелях мониторинга.

Данный сервис отслеживает AWS Lex V1 (AWS Lex V2 **не** поддерживается).
...
`BotName` является основным измерением.
...
Сущности Dynatrace данного сервиса AWS не обогащаются свойством ARN.
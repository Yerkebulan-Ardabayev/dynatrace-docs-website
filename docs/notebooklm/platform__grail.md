...
Язык запросов Dynatrace (DQL) — это мощный инструмент для изучения ваших данных и обнаружения закономерностей, выявления аномалий и выбросов, создания статистического моделирования и многого другого на основе данных, хранящихся в [Система хранения данных Dynatrace Grail](/docs/platform/grail/dynatrace-grail "Grail is the Dynatrace data lakehouse that's designed explicitly for observability and security data and acts as single unified storage for logs, metrics, traces, events, and more.").

DQL обеспечивает максимальную гибкость, поскольку он создан для обработки произвольных данных о событиях и не требует предварительного описания схемы входных данных, в отличие от реляционных баз данных, таких как таблицы SQL.

Прочтите [как использовать запросы DQL](/docs/platform/grail/dynatrace-query-language/dql-guide "Find out how DQL works and what are DQL key concepts."), чтобы начать или изучить язык.

[### Как использовать DQL

Узнайте, как работает DQL и каковы ключевые понятия DQL.](/docs/platform/grail/dynatrace-query-language/dql-guide «Узнайте, как работает DQL и каковы ключевые понятия DQL.»)[### Справочник по языку

Узнайте подробнее о синтаксисе DQL.](/docs/platform/grail/dynatrace-query-language/dql-reference «Справочник по синтаксису языка запросов Dynatrace.»)[### Изучите DQL

Получите практический опыт с помощью интерактивных руководств по использованию DQL.](/docs/platform/grail/dynatrace-query-language/dql-guide#learn-dql-app "Узнайте, как работает DQL и каковы ключевые понятия DQL.")[### Миграция на DQL

Сравните DQL с другими распространенными языками запросов.](/docs/platform/grail/dynatrace-query-language/dql-comparison "Посмотрите, как DQL сравнивается с другими языками запросов.")[### Примеры DQL для журналов

Узнайте, что можно делать с журналами с помощью DQL.](/docs/analyze-explore-automate/logs/logs-on-grail-examples «Изучите базовые примеры управления журналами и аналитики использования данных журналов в Dynatrace на базе Grail.»)[### Примеры DQL для данных безопасности

Используйте DQL для запроса данных безопасности в Grail.](/docs/secure/threat-observability/dql-examples «Примеры DQL для данных безопасности на основе Grail.»)[### Примеры DQL для бизнес-событий

Узнайте, что можно делать с бизнес-событиями с помощью DQL.](/docs/observe/business-observability/bo-analysis «Анализ и представление данных о бизнес-событиях.»)[### Примеры DQL для проблем и событий Дейвиса

Создавайте мощные информационные панели состояния, анализируя проблемы и события, сообщаемые Dynatrace Intelligence, с помощью DQL.](/docs/dynatrace-intelligence/use-cases/davis-dql-examples "Создавайте мощные информационные панели состояния, анализируя проблемы и события, сообщаемые Dynatrace Intelligence с использованием DQL.")[### Примеры DQL для метрик

Используйте DQL для запроса данных о наблюдаемости метрик.](/docs/analyze-explore-automate/metrics/dql-examples «Примеры временных рядов DQL»)

## Похожие темы

* [Используйте запросы DQL](/docs/platform/grail/dynatrace-query-language/dql-guide "Find out how DQL works and what are DQL key concepts.")
* [DQL по сравнению с SQL и многим другим](/docs/platform/grail/dynatrace-query-language/dql-comparison "See how DQL compares to other query languages.")
...
* [DQL-команды](/docs/platform/grail/dynatrace-query-language/commands "A list of DQL commands.")
* [DQL-функции](/docs/platform/grail/dynatrace-query-language/functions "A list of DQL functions.")
* [DQL-операторы](/docs/platform/grail/dynatrace-query-language/operators "A list of DQL Operators.")

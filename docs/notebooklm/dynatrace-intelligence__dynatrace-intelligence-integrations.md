...
Прогнозная аналитика Dynatrace Intelligence предвидит будущие значения любого временного ряда числовых значений на основе накопленных данных. Чтобы запустить [анализ прогнозирования](/docs/dynatrace-intelligence/reference/ai-models/forecast-analysis "Узнайте, как Dynatrace Intelligence генерирует прогнозы.")

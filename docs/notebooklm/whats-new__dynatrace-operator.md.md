# Dynatrace Documentation: whats-new/dynatrace-operator.md
...
Get to know the changes in [Dynatrace Operatorï»¿](https://github.com/Dynatrace/dynatrace-operator) releases.

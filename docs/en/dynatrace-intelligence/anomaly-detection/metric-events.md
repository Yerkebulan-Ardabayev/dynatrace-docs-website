...
Management zones set up via [dimensional data rules](../../manage/identity-access-management/permission-management/management-zones/management-zone-rules.md#logs-metrics "Define rules to limit the entities accessible within a management zone.") are not supported for metric events.

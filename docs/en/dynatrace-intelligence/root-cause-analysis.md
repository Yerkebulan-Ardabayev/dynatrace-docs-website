...
Read this explanation](root-cause-analysis/concepts.md)[#### Event analysis and correlation
...
Read this explanation](../../common/dynatrace-intelligence/root-cause-analysis/detection-of-frequent-issues.md)
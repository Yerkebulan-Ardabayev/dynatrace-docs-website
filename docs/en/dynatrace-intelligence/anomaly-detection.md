...
Read this explanation](anomaly-detection/auto-adaptive-threshold.md)[#### Static thresholds for anomaly detection

When to use a static threshold for your anomaly detection.

* Explanation

Read this explanation](anomaly-detection/static-thresholds.md)[#### Anomaly detection configuration

How to set up an alert for missing measurements.

* Explanation

Read this explanation](anomaly-detection/anomaly-detection-configuration.md)[#### Automated multi-dimensional baselining

Learn how Dynatrace AI automatically calculates baselines based on a multi-dimensional baselining scheme.

* Explanation

Read this explanation](anomaly-detection/automated-multidimensional-baselining.md)[#### Anomaly Detection status types
...
Read this explanation](anomaly-detection/adjust-sensitivity-anomaly-detection.md)[![Anomaly Detection - new](https://dt-cdn.net/images/davis-anomalydetection-256-105da91594.png "Anomaly Detection - new")
...
See the overview](anomaly-detection/metric-events.md)[#### Automate alerts with API

Learn how to set up an Anomaly Detection custom alert via API.

* Tutorial

Read this tutorial](anomaly-detection/set-up-anomaly-detectors-via-api.md)
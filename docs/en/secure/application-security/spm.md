...
For detailed explanations of each compliance standard and how Dynatrace supports them, see [Security Posture Management compliance standards](spm/compliance-standards.md "Technical details about the supported compliance standards.").

| **Compliance standards** | **Kubernetes[1](#fn-1-1-def)** | **AWS** | **Azure** | **GCP** | **vSphere[2](#fn-1-2-def)** | **NSX-T[3](#fn-1-3-def)** |
| --- | --- | --- | --- | --- | --- | --- |
| [BSI C5](spm/compliance-standards.md#bsic5 "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [BSI IT-Grundschutz](spm/compliance-standards.md#bsi-it "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [CIS](spm/compliance-standards.md#cis "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [Cyber Essentials](spm/compliance-standards.md#cyber "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [DISA STIG](spm/compliance-standards.md#stig "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [DORA](spm/compliance-standards.md#dora "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [Essential Eight](spm/compliance-standards.md#essential "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [GDPR](spm/compliance-standards.md#gdpr "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [HIPAA](spm/compliance-standards.md#hipaa "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [ISO 27001](spm/compliance-standards.md#iso "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [KVKK](spm/compliance-standards.md#kvkk "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [NIST](spm/compliance-standards.md#nist "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [PCI DSS](spm/compliance-standards.md#pci "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [TISAX](spm/compliance-standards.md#tisax "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
| [VMware SCG](spm/compliance-standards.md#vmware "Technical details about the supported compliance standards.") |  |  |  |  |  |  |
...
For instructions, see [Improve coverage](../xspm/assess-coverage.md#improve "Review the Security Posture Management coverage of your systems at a glance.").

### Why am I getting failed results on my system?

Resources on your system are assessed as `Failed` (not compliant) according to rules specified in the [supported standards](spm.md#support "Assess, manage, and take action on misconfigurations and violations against security hardening guidelines and regulatory compliance standards.").
...
For a list of supported systems and their versions and distributions, see [Security Posture Management](spm.md#support "Assess, manage, and take action on misconfigurations and violations against security hardening guidelines and regulatory compliance standards.").

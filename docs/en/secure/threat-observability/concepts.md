...
* [Logs](../../analyze-explore-automate/logs.md "Log Management and Analytics provides a unified approach to controlling and studying your log data in Dynatrace.")
* [Metrics](../../analyze-explore-automate/metrics/built-in-metrics-on-grail.md "Get to know the equivalents of the classic built-in metrics supported on Grail.")
* [Entities](../../platform/grail/querying-monitored-entities.md "Find out how to query monitored entities in Grail.")
* [Dynatrace Intelligence problems and events](../../dynatrace-intelligence/root-cause-analysis/event-analysis-and-correlation.md "Gain an understanding of the Events section on each host, process, and service overview page.")
* [System events](../../platform/upgrade.md#system-data "Use the power of Grail, AppEngine, and AutomationEngine to take advantage of improvements in storing and analyzing observability and security data.")
* [Business events](../../observe/business-observability/bo-basic-concepts.md#business-event "Basic concepts of Dynatrace Business Observability.")

For details, see

* [Data in Grail](../../platform/upgrade.md#data-in-grail "Use the power of Grail, AppEngine, and AutomationEngine to take advantage of improvements in storing and analyzing observability and security data.")
...
For a list of supported integrations, see [Security events ingest](security-events-ingest.md "Ingest external security data into Grail.").

## Security-related data

Security-related data can be either generated by Dynatrace native capabilities and collected by [OneAgent](../../platform/oneagent.md "Learn the monitoring capabilities of OneAgent.") or [ActiveGate](../../ingest-from/dynatrace-activegate.md "Understand the basic concepts related to ActiveGate."), or ingested from third-party tools via [log ingestion](../../analyze-explore-automate/logs.md "Log Management and Analytics provides a unified approach to controlling and studying your log data in Dynatrace.") or [OpenPipeline](../../platform/openpipeline.md "Scale Dynatrace platform data handling with Dynatrace OpenPipeline.").
...
This event type can be ingested both from [third-party security tools](security-events-ingest.md "Ingest external security data into Grail.") and from [third-party libraries used by Dynatrace-monitored processes](../vulnerabilities/concepts.md#tpv-events "Concepts that are specific to the Dynatrace Vulnerabilities app.").
...
Use ![Vulnerabilities](https://dt-cdn.net/images/vulnerabilities-highresolution-1025-9279da9743.png "Vulnerabilities") **Vulnerabilities** to [analyze, prioritize, and efficiently manage findings](../vulnerabilities/explore-findings.md "View, filter, and analyze vulnerability findings from Dynatrace and external security tools.") in your monitored environments.
...
Use [![Threats & Exploits](https://dt-cdn.net/images/attacks-512-b922840b12.png "Threats & Exploits") **Threats & Exploits**](../threats-and-exploits.md "Understand, triage, and investigate detection findings and alerts.") to evaluate, triage, and investigate detection findings.
...
With [OpenPipeline](../../platform/openpipeline.md "Scale Dynatrace platform data handling with Dynatrace OpenPipeline."), you can ingest external security events from multiple third-party products into [Grail](../../platform/grail.md "Insights on what and how you can query Dynatrace data.") and operationalize your data on the Dynatrace platform.

**Out-of-the-box integrations**

Dynatrace provides seamless OpenPipeline integration options for specific technologies. Ingested data is automatically stored in [Grail](../../platform/grail.md "Insights on what and how you can query Dynatrace data.") and mapped to the [Dynatrace Semantic Dictionary unified formatï»¿](https://dt-url.net/3q03pb0).
We provide ready-made dashboards and workflows to help you visualize data and automatize notifications. For a practical example, see [Visualize and analyze security findings use case](../use-cases/visualize-and-analyze-security-findings.md "Visualize, prioritize, and analyze ingested security findings.").

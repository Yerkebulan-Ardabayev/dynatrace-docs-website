...
* Gain fine-grained visibility into user frontend activity through [user events](new-rum-experience/concepts/data-model.md#user-events "Get familiar with the data model at the heart of the New RUM Experience.").
...
[Learn more](new-rum-experience/transition-from-rum-classic.md)

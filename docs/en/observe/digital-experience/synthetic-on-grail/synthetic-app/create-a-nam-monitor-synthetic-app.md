...
There are three types of NAM monitors: ICMP, TCP, and DNS. To learn more about them, see [NAM types](../../synthetic-monitoring/network-availability-monitors/network-availability-monitoring.md#NAM-types "ICMP, TCP, and DNS synthetic monitors").
You can create NAM monitors in [![Synthetic](https://dt-cdn.net/images/synthetic-new-256-1ddb35ac79.png "Synthetic") Synthetic](#monitor-configuration) in latest Dynatrace or through [API](../../synthetic-monitoring/network-availability-monitors/create-a-nam-monitor.md#nam-api "Learn how to set up a NAM monitor to check the performance and availability of your site.").

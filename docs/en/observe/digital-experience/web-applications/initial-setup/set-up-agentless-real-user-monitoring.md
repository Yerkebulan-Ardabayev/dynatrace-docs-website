...
**Create an application and insert RUM JavaScript**](set-up-agentless-real-user-monitoring.md#saas-create-app-add-code "Set up agentless monitoring for your web applications.")[![Step 2 optional](https://dt-cdn.net/images/dotted-step-2-8ae6982454.svg "Step 2 optional")

**Choose another RUM JavaScript snippet format**](set-up-agentless-real-user-monitoring.md#saas-choose-insertion-format "Set up agentless monitoring for your web applications.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Keep RUM JavaScript up-to-date**](set-up-agentless-real-user-monitoring.md#saas-keep-code-updated "Set up agentless monitoring for your web applications.")
...
4. Select **Copy code snippet** to copy the generated JavaScript code to the clipboard. The code generated after you've created the application is in the [JavaScript tag](snippet-formats.md#js-tag "Select a format for the RUM JavaScript snippet that best fits your specific use case") format.
...
* Unless you use the **JavaScript tag** [snippet format](snippet-formats.md#js-tag "Select a format for the RUM JavaScript snippet that best fits your specific use case") for agentless monitoring, the RUM JavaScript embedded into your application's pages is not automatically updated when you change your application monitoring settings. You'll have to update the code manually.
...
For some technologies, [automatic RUM JavaScript injection](rum-injection.md#automatic-injection "Configure automatic injection of the RUM JavaScript into the pages of your applications") is not supported even when you can install OneAgent. For example, while OneAgent can monitor the server side of a Heroku application, it can't inject the RUM JavaScript into the application's pages. If that's the case, manually add the RUM JavaScript to your application's pages.
...
Agentless monitoring requires you to insert the RUM JavaScript by yourself, so make sure that it requires as little manual effort as possible. If you don't want to have to change your code every time your application monitoring settings change or when a new version of the RUM JavaScript is released, opt for the **JavaScript tag** [snippet format](snippet-formats.md#js-tag "Select a format for the RUM JavaScript snippet that best fits your specific use case").
...
For example, the [Content Security Policy (CSP) standardï»¿](https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP), which was introduced to minimize the chance of becoming a victim of cross-site scripting, disallows inline JavaScript code. This means that you might need to use the **JavaScript tag** [snippet format of the RUM JavaScript](snippet-formats.md#js-tag "Select a format for the RUM JavaScript snippet that best fits your specific use case").

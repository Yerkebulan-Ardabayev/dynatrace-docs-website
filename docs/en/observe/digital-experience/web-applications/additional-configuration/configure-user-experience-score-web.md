...
3. Optional Turn on **Consider rage clicks / rage taps in score calculation** to include [rage events](../../rum-concepts/user-and-error-events.md#rage-event "Learn about user and error events and the types of user and error events captured by Dynatrace.") when determining the user experience score.

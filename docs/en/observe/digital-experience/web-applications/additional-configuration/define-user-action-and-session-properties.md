...
| `Date` | Only available for the `JavaScript API` [expression type](#expression-types)âmetadata should be captured via the RUM JavaScript API. |

...
When you reach the maximum key user action limit, consider using calculated metrics (available for your [web](../../web-applications/additional-configuration/rum-calculated-metrics-web.md "Create calculated metrics as well as custom charts based on calculated metrics for your web applications."), [mobile](../../mobile-applications/additional-configuration/rum-calculated-metrics-mobile.md "Create calculated metrics as well as custom charts based on calculated metrics for your mobile applications."), and [custom applications](rum-calculated-metrics-custom.md "Create calculated metrics as well as custom charts based on calculated metrics for your custom applications.")), which offer similar capabilities.

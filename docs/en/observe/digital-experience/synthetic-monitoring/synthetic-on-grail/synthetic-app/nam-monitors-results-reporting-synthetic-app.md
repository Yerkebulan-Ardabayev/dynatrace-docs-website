...
* **Success rate**âa chart of the success rate over time, where the success rate is the percentage of all executed requests that were sucessful.
  ...
  + See the [conditions](../../network-availability-monitors/create-a-nam-monitor.md#script-configuration-constraints "Learn how to set up a NAM monitor to check the performance and availability of your site.") a request needs to meet to be considered successful.

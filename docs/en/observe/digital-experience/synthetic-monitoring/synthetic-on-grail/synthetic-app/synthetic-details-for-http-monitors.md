...
If you're a non-DPS user, see [HTTP monitors reporting results (classic)](../../analysis-and-alerting/synthetic-details-for-http-monitors-classic.md#analyze-last-execution "Learn about the Synthetic details page for HTTP monitors (classic).").

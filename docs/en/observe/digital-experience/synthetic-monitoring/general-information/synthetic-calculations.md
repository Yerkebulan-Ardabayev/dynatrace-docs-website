...
Maintenance windows can be excluded from availability calculation for synthetic monitors, displayed, for example, in **Synthetic Classic**, synthetic monitor details pages, and reports. A global setting enables you to always exclude maintenance windows from availability calculationsâgo to **Settings** > **Web and mobile monitoring** > **Synthetic availability** to access it.

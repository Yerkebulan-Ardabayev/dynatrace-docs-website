...
1. **Dynatrace Cluster to ActiveGate**
   ...
   The cluster provides the configuration, monitors definitions, and schedules executions. The data is encrypted through the ActiveGate token.

...
We recommend that you [upgrade your Xamarin projects to .NETï»¿](https://learn.microsoft.com/en-gb/dotnet/maui/migration) and use the [Dynatrace .NET MAUI NuGet package](maui.md "Monitor .NET MAUI applications with Dynatrace OneAgent.") instead of the deprecated Xamarin NuGet package.
...
**Install the Dynatrace Xamarin NuGet package**](xamarin-nuget.md#install-package "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Create an application and get the config file**](xamarin-nuget.md#installation-dynatrace "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Add the config file to your project**](xamarin-nuget.md#configure-app "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 4](https://dt-cdn.net/images/step-4-3f89d67d41.svg "Step 4")

**Add the OneAgent start method**](xamarin-nuget.md#start-method "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 5](https://dt-cdn.net/images/step-5-2de312b50f.svg "Step 5")

Xamarin.Forms only

**Set up Xamarin.Forms DependencyService**](xamarin-nuget.md#usage-forms "Monitor Xamarin apps with Dynatrace OneAgent.")[![Step 6 optional](https://dt-cdn.net/images/dotted-step-6-fbd29ea893.svg "Step 6 optional")

**Enable automatic web request instrumentation**](xamarin-nuget.md#http-client "Monitor Xamarin apps with Dynatrace OneAgent.")

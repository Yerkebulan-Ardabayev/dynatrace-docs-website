...
We recommend that you [upgrade your Xamarin projects to .NETï»¿](https://learn.microsoft.com/en-gb/dotnet/maui/migration) and use the Dynatrace .NET MAUI NuGet package instead of the deprecated Xamarin NuGet package.

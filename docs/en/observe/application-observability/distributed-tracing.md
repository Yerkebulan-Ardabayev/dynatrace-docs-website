...
* Tutorial
* Exception analysis helps you detect, investigate, and resolve exceptions more effectively in Dynatrace.](distributed-tracing/exception-analysis.md)[02Ingest traces

* How-to guide
* Instrument your applications with OneAgent or OpenTelemetry to start ingesting trace data into Dynatrace.](distributed-tracing/ingest-traces.md)[03Set up Grail permissions for Distributed Tracing

* How-to guide
* Manage permissions for Distributed Tracing powered by Grail.](distributed-tracing/permissions.md)[04Configure data storage and retention for Distributed Tracing

* How-to guide
* Manage data storage and retention for Distributed Tracing powered by Grail.](distributed-tracing/storage.md)[05Span and trace context propagation

* Reference
* Understand span and trace context propagation in Dynatrace and how to set them up.](distributed-tracing/tracking-transactions.md)[06Use traces, DQL, and logs to spot patterns

* Tutorial
* Utilize traces, logs, and DQL to visualize raw data and identify abnormal patterns.](distributed-tracing/use-traces-and-dql-to-spot-patterns.md)[07Distributed Tracing app

* Explanation
* Discover the functionalities of the new Distributed Tracing app.](distributed-tracing/distributed-tracing-app.md)[08Advanced Tracing Analytics powered by Grail

* Tutorial
* Explore advanced tracing analysis capabilities on Grail.](distributed-tracing/advanced-tracing-analytics.md)
...
* Follow [Dynatrace Intelligence root cause analysis drill-downs](../../dynatrace-intelligence/root-cause-analysis/concepts.md "Get acquainted with root cause analysis concepts.") to identify cause-effect relationships between events.
...
The span context allows a child span to relate to the trace and its parent span. Therefore, the context needs to be propagated within a service (across different threads) but also across services and process boundaries. This typically happens via HTTP headers (like the [W3C trace contextï»¿](https://www.w3.org/TR/trace-context/)) or via unique IDs in messaging systems. To learn more about context propagation, see [Span and trace context propagation](distributed-tracing/tracking-transactions.md "Understand span and trace context propagation in Dynatrace and how to set them up.").
...
* [Detect and name services](services/service-detection/service-detection-v1.md "Find out how Dynatrace Service Detection v1 detects and names different types of services.").
* Gather data on the trace context and relationships with other entities for [Smartscape topology](../../analyze-explore-automate/smartscape-classic.md "Learn how Smartscape Classic visualizes all the entities and dependencies in your environment.").
...
* Understand how the duration of a span is affected by [service timings](services-classic/service-analysis-timing.md "Find out what each time in service analysis means.") (for example, CPU time, network time, or just waiting for other threads) and analyze which code was executed in the context of the span.

#### Best practices

If you collect trace data via

* OpenTelemetry, define [captured attribute settings](../../ingest-from/extend-dynatrace/extend-tracing/span-settings.md "Learn how to configure span settings for OpenTelemetry and OpenTracing.").
* OneAgent, define [requests attribute settings](services/request-attributes.md "Understand what request attributes are and learn how to use them across all levels of all service-analysis views.").
...
* [Segment requests to improve response time degradation](distributed-traces/use-cases/segment-request.md "Enhance your distributed system performance by segmenting requests with slow response time via Service flow and analyzing their distributed traces.").
...
* [Automatic setup with OneAgent](../../ingest-from/dynatrace-oneagent.md "Understand the important concepts related to OneAgent and find out how to install and operate OneAgent on different platforms.")
* [Instrumentation with OpenTelemetry](../../ingest-from/opentelemetry/getting-started.md "How to get your OpenTelemetry data into Dynatrace.")
...
* Performance optimization: Understand [system performance](distributed-tracing/detect-performance-issues.md "Analyze your trace data and detected which requests are slow and why with the Distributed Tracing app.") and identify bottlenecks to improve reliability and user experience.
...
* Make sure the [OneAgent feature](../../ingest-from/dynatrace-oneagent/oneagent-features.md "Manage OneAgent features globally and per process group.") **Forward Tag 4 trace context extension** is on; this ensures OneAgent-captured traces are compatible with the W3C trace context standard.
...
* [Span and trace context propagation](distributed-tracing/tracking-transactions.md "Understand span and trace context propagation in Dynatrace and how to set them up.")
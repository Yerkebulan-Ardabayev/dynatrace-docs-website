...
Data availability depends on endpoint metrics, which consume DDUs. To get started on endpoint monitoring, see [Manage endpoint monitoring](../services/service-detection/service-detection-v1/service-types/unified-service.md#endpoint-monitoring "Define services on observability signals ingested via Trace ingest APIs.").

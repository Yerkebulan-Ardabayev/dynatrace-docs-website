...
* Review the dimension for [unsupported placeholders](../../../analyze-explore-automate/metrics/built-in-metrics-on-grail.md#unsupported-placeholders "Get to know the equivalents of the classic built-in metrics supported on Grail.") on Grail.
...
For a complete list of available dimensions see [Built-in Metrics on Grail - Calculated service metrics](../../../analyze-explore-automate/metrics/built-in-metrics-on-grail.md#calc-service "Get to know the equivalents of the classic built-in metrics supported on Grail.").

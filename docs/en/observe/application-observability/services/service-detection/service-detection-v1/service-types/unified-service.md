...
The Grail metrics `dt.service.request.response_time`, `dt.service.request.failure_count`, and `dt.service.request.count` are billable. To learn more, see Metrics powered by Grail (DPS).

For current detection rules and customization options, see the Service Detection v2.

...
* ActiveGate version 1.327+ is a prerequisite for [Kubernetes Enhanced Object Visibility](kubernetes-app/preview/enhanced-object-vis-preview.md "Accelerate root cause analysis with deeper Kubernetes object visibility.").
...
The new Kubernetes experience is not available for Managed or SaaS on non-Grail environmentsâyou can continue to use [**Kubernetes Classic**](kubernetes-monitoring.md "Monitor Kubernetes/OpenShift with Dynatrace.") (accessible from the previous Dynatrace via **Kubernetes**).

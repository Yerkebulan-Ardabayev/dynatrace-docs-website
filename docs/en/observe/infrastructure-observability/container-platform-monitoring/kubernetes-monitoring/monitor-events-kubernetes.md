...
* To trigger alerts whenever Kubernetes events occur (for example, always alert in case of an `Evicted` event), define Metric events based on the **Kubernetes: Event count** metric.

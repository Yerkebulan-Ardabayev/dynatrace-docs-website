...
Read this explanation](../../../platform/oneagent/monitoring-modes/monitoring-modes.md)[#### Enable OneAgent monitoring modes

Learn how to enable monitoring modes when using OneAgent.

* How-to guide

Read this guide](../../../platform/oneagent/monitoring-modes/enable-monitoring-modes.md)
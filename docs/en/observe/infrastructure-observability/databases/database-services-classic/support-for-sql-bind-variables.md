...
This feature is available in Dynatrace environments that are licensed via Dynatrace Platform Subscription (DPS), the licensing model for all Dynatrace capabilities."). If you have a Dynatrace classic license, change your subscription plan to a Dynatrace Platform Subscription (DPS) license to use bind variables.
...
You might also choose to mask or drop parts of the captured data via OpenPipeline.

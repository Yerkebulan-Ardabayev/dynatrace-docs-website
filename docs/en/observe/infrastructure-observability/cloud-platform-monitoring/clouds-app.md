...
* How-to guide
* Learn how to create a new AWS connection in the Clouds app.](clouds-app/create-aws-connection.md)[02Create a new Azure connection

* How-to guide
* Learn how to create a new Azure connection in the Clouds app.](clouds-app/create-azure-connection.md)

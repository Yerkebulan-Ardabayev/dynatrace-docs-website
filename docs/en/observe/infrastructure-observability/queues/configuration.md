...
* Via [Settings API](../../../dynatrace-api/environment-api/settings.md "Find out what the Dynatrace Settings API offers."), use the `builtin:process-group.detection-flags` schema ID.

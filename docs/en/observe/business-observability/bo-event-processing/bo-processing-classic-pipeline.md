...
5. Add a **Processor definition**.
   ...
   It is created using processing commands, functions and pattern matching (Dynatrace Pattern Language) that allows you to add, modify or remove incoming records.

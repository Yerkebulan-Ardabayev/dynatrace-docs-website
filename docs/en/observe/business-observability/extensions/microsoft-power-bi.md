...
The cost of executing DQL queries within Microsoft Power BI is equivalent to the Dynatrace UI.
...
You need to have Permissions in Grail to execute queries and to view

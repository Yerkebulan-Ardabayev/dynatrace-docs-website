...
In case you haven't created a variable yet, first see [Add a variable to a dashboard](dashboard-component-variable.md#add-a-variable "Add variables to your Dynatrace dashboards.").

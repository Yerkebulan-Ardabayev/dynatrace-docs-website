...
When you add a query from the  **Add** menu of the Dashboards or Notebooks app, you can choose how to visualize the results. Dynatrace offers several visualization types for your dashboard tiles and notebook sections.
...
For details, see Raw visualization.
...
For details, see Meter bar chart.

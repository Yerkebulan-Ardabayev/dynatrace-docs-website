...
For more information on general Workflows user permissions, see [User permissions for workflows](../../security.md#user-permission "Guide on security aspects of workflow automation in Dynatrace Workflows").

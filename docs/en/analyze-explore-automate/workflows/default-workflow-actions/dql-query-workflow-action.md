...
The **Execute DQL Query** action for Workflows enables you to use DQL queries in a workflow. In **DQL query**, enter your DQL query. In **Segment**, you can optionally select a filter segment.

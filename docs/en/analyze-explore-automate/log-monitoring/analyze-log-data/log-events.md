...
3. Enter the **Matcher**.  
   Enter the Log Monitoring query to filter the log data for your log event. For details, see [Log viewer](log-viewer.md#query-syntax "Learn how to use Dynatrace log viewer to analyze log data.").

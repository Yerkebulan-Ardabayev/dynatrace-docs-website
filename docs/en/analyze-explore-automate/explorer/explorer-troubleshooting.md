...
* The *maximum* number of displayed series per metric is `100`. Note that this limit applies even if you remove the [**limit** transformation](../../dynatrace-api/environment-api/metric-v2/metric-selector.md#limit "Configure the metric selector for the Metric v2 API.") from the metric selector on the **Code** tab.

...
3. Configure a [Slack message](../workflows/actions/slack.md "Send messages to Slack Workspaces").
...
* You have [set up Slack integration](../workflows/actions/slack.md#setup-slack-integration "Send messages to Slack Workspaces").
...
* [Slack Connector](../workflows/actions/slack.md "Send messages to Slack Workspaces")
...
2. Add an event trigger for  [Davis problems](../workflows/trigger/event-trigger.md#davis-problem-trigger "Guide to creating workflow automation event triggers in Dynatrace Workflows.").
3. Configure a Slack message.
...
* You should have permission to configure and run a  simple workflow.
  For example, the permission granted with the default policy is for a standard user.

...
This is equivalent to using the [`matchesPhrase`](../../../platform/grail/dynatrace-query-language/functions/string-functions.md#matchesPhrase "A list of DQL string functions.") DQL string function.

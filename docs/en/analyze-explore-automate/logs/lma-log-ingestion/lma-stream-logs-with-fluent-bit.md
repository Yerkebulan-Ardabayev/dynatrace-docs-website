...
3. To send logs into the Dynatrace generic logs ingest endpoint, configure the [http output pluginï»¿](https://dt-url.net/0z034x4) through the configuration file.

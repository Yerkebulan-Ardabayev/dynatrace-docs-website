...
See the OneAgent for logs ingestion use case to learn how to set up log monitoring using OneAgent to automatically discover and ingest logs from your hosts.
...
Learn more by accessing the Log ingestion via OneAgent.
...
Read more about configuring log ingest from Kubernetes by accessing the Stream Kubernetes logs with Dynatrace Log Module page.

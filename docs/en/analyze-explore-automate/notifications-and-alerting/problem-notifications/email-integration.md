...
4. Configure the notification:
   ...
   * Select an [alerting profile](../alerting-profiles.md "Learn how to create and manage alerting profiles.") to filter the problem feed.

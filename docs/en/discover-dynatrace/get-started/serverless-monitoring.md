...
**Turn on cloud service monitoring**](serverless-monitoring.md#services "Serverless observability with Dynatrace")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Enable Dynatrace extensions on cloud services**](serverless-monitoring.md#extensions "Serverless observability with Dynatrace")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Advanced visibility**](serverless-monitoring.md#advanced "Serverless observability with Dynatrace")
...
* [Amazon CloudWatch integration](../../ingest-from/amazon-web-services/integrate-with-aws/cloudwatch-metrics.md "Integrate metrics from Amazon CloudWatch.")
* [Azure Monitor integration](../../ingest-from/microsoft-azure-services/azure-integrations/azure-monitoring-guide.md "Set up and configure Azure monitoring in Dynatrace.")
* [Google Cloud operations suite integration](../../ingest-from/google-cloud-platform/gcp-integrations/gcp-supported-service-metrics-new.md "Monitor Google Cloud services with Dynatrace and view available metrics.")
...
* [Amazon Web Services](../../ingest-from/amazon-web-services.md "Set up and configure monitoring for Amazon Web Services.")
* [Azure Services](../../ingest-from/microsoft-azure-services/azure-integrations.md "Set up Dynatrace deep code monitoring on Azure using OneAgent or OpenTelemetry.")
* [Google Cloud Services](../../ingest-from/google-cloud-platform/gcp-integrations.md "Set up and configure Dynatrace on Google Cloud.")

...
See the [`.spec.oneAgent.cloudNativeFullStack`](../reference/dynakube-parameters.md "List the available parameters for setting up Dynatrace Operator on Kubernetes.") section of DynaKube for additional information.
...
* Enables data enrichment for Kubernetes environments via [enrichment files](../../extend-dynatrace/extend-data.md#dynatrace-kubernetes-operator "Learn how to automatically enrich your telemetry data with Dynatrace-specific fields.").
...
* [Go static monitoring](../../technology-support/application-software/go/support/go-known-limitations.md#static-monitoring "Learn the limitations for Go support and their workarounds.") is partially supported.
...
* [Dynatrace Operator CSI Driver](components/dynatrace-operator.md#csidriver "Components of Dynatrace Operator") deployed as a DaemonSet, provides writable volume storage for OneAgent binaries to minimize network and storage usage.

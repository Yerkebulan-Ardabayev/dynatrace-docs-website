...
**Define endpoints**](snowflake-sql.md#define-endpoints "Extend observability in Dynatrace with declarative metrics ingested from Snowflake Database.")[![Step 2](https://dt-cdn.net/images/step-2-1a1384627e.svg "Step 2")

**Select ActiveGates**](snowflake-sql.md#activegate-group "Extend observability in Dynatrace with declarative metrics ingested from Snowflake Database.")[![Step 3](https://dt-cdn.net/images/step-3-350cf6c19a.svg "Step 3")

**Activate extension**](snowflake-sql.md#activate-extension "Extend observability in Dynatrace with declarative metrics ingested from Snowflake Database.")
...
* Authentication credentials
  ...
  + You can [use credential vault](../../../develop-your-extensions/data-sources/sql/snowflake-monitoring.md#authentication "Snowflake Database extensions in the Extensions framework.") to provide a more secure approach of storing and managing user credentials.
* Select **Next step**.

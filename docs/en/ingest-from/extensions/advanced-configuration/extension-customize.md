...
See [Extension YAML file](../develop-your-extensions/extension-yaml.md#schemas "Learn how to create an extension YAML file using the Extensions framework.") to learn how to get the schema JSON files.

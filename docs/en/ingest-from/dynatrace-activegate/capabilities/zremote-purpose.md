...
To monitor a z/OS LPAR, including technologies such as CICS, IMS, and Java, you need an ActiveGate with the zRemote module enabled. You can install this ActiveGate on any [Linux](../installation/linux/linux-activegate-hardware-and-system-requirements.md#supported-operating-systems "Learn what hardware and operating system requirements need to be taken into account before installing ActiveGate on Linux for routing and monitoring purposes.") or [Windows](../installation/windows/windows-activegate-hardware-and-system-requirements.md#supported-operating-systems "Learn what hardware and operating system requirements need to be taken into account before installing ActiveGate on Windows for routing and monitoring.") operating system that is supported by ActiveGate.

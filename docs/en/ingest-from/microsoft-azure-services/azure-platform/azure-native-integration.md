...
* The Dynatrace environment is created in the same Azure region in which you create the Dynatrace resource. In this new environment:
  ...
  + After you [install OneAgent](#oa), you can start monitoring metrics from your Azure resources. You can also collect metrics from the [default services](azure-native-integration.md#default "Set and configure your Dynatrace SaaS environment using Azure Marketplace.")
...
* **Smartscape topology** - For details, see Visualize your environment through Smartscape Classic.
...
* You can activate logs either [during the Azure integration deployment](#setup) or [after deployment](#how-to-logs).
...
* You can create tags either [during the Azure integration deployment](#setup) or [after deployment](#how-to-tags).
...
5. Optional Provide a host group for OneAgent.

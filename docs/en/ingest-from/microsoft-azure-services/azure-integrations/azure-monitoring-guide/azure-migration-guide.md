...
| --- | --- |
| Azure API Management Service | Azure API Management services (classic) Deprecated |
| Azure Application Gateway | Azure Application Gateway (classic) |
| Azure Basic Load Balancer | Azure Load Balancer (classic) |
| Azure Gateway Load Balancer | Azure Load Balancer (classic) |
| Azure Standard Load Balancer | Azure Load Balancer (classic) |
| Azure Cache for Redis | Azure Redis (classic) |
| Azure Cosmos DB Account (GlobalDocumentDB) and view available metrics.") | Azure Cosmos DB (classic) |
| Azure Cosmos DB Account (MongoDB) and view available metrics.") | Azure Cosmos DB (classic) |
| Azure IoT Hub | Azure IoT Hubs (classic) |
| Azure SQL Server | Azure SQL (classic) |
| Azure SQL Database (DTU) and view available metrics.") | Azure SQL (classic) |
| Azure SQL Database (vCore) and view available metrics.") | Azure SQL (classic) |
| Azure SQL elastic pool (DTU) and view available metrics.") | Azure SQL (classic) |
| Azure SQL elastic pool (vCore) and view available metrics.") | Azure SQL (classic) |
| Azure Storage Account | Azure Storage accounts (classic) |
| Azure Storage Blob Services | Azure Storage accounts (classic) |
| Azure Storage File Services | Azure Storage accounts (classic) |
| Azure Storage Queue Services | Azure Storage accounts (classic) |
| Azure Storage Table Services | Azure Storage accounts (classic) |

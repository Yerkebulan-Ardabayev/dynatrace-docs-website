...
* For Google Cloud service metrics that are available with earlier versions of the Google Cloud integration, see Google Cloud supported service metrics (legacy).

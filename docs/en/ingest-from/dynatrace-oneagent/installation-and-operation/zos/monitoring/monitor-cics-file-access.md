...
With Dynatrace, you can monitor the VSAM and BDAM file access calls from your CICS applications using the CICS module. Each accessed file in a CICS region is represented as a database service on the Databases page, including metrics like response time, failure rate, and throughput.

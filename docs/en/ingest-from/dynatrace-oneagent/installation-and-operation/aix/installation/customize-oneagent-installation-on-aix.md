...
OneAgent downloads AIX system logs for the purpose of diagnosing issues that may be caused by conditions in your environment. For details, see [System logs downloaded by OneAgent](oneagent-security-aix.md#system-logs-downloaded-by-oneagent "Learn about Dynatrace OneAgent security and modifications to your AIX-based system.").
...
For information about the OneAgent auto-update mechanism, see [Update Dynatrace OneAgent on AIX](../operation/update-oneagent-on-aix.md "Learn how you can update Dynatrace OneAgent on AIX.").
...
For supported platforms, see [Technology support](../../../../technology-support.md#aix "Find technical details related to Dynatrace support for specific platforms and development frameworks.").
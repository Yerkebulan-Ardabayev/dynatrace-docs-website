...
Use the **`USER`** parameter to define the user running the process responsible for Dynatrace extensions functionality. For example:
...
For information about the OneAgent auto-update mechanism, see Update Dynatrace OneAgent on Windows.

...
OneAgent uses the TCP port 14499 as default port for this endpoint. You can change the port with [`oneagentctl`](../../extend-dynatrace/extend-metrics/ingestion-methods/oneagent-metric-api.md#communication-port "Use the Dynatrace API to retrieve the metrics of monitored entities.").

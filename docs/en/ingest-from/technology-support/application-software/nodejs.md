...
| Node.js version | Vendor released | Vendor End of life | First supported Dynatrace OneAgent version | Last supported Dynatrace OneAgent version | Dynatrace support until | [Dynatrace support level](../../technology-support.md#support-levels) |
| --- | --- | --- | --- | --- | --- | --- |
...
* There is currently only limited support for [ECMAScript modulesï»¿](https://nodejs.org/api/esm.html) (aka "ES6 modules"):
  ...
  + If the main script file itself is an ECMAScript module OneAgent version 1.219+ with [Agent preloading](../../../../common/whats-new/preview-releases.md#oneagent-1-219-nodejs-agent-preloading "Learn about our Preview releases and how you can participate in them.") enabled is needed for the OneAgent to be injected into the Node.js process.

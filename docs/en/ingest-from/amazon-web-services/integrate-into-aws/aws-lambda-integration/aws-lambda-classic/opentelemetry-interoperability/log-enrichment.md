...
* Set up [AWS Lambda log collection](../../collector.md "Collect logs from AWS Lambda functions") or [Stream logs via Amazon Data Firehose](../../../../integrate-with-aws/aws-logs-ingest/lma-stream-logs-with-firehose.md "Amazon Data Firehose integration allows ingest of cloud logs directly, without additional infrastructure needed, and at higher throughput.").
* [Enable OpenTelemetry interoperability](../opentelemetry-interoperability.md#enable-otel-interoperability "Enable and use OpenTelemetry interoperability in AWS Lambda.") for the Lambda function.
...
Check [AWS Lambda log collection](../../collector.md#limitations "Collect logs from AWS Lambda functions") to learn more about limitations since Lambda log enrichment is **not** automatic.

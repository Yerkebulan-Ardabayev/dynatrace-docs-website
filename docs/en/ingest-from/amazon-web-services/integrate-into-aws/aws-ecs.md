...
Privileged mode and volume parameters are prerequisites for this deployment method. As a result, this can only be done using JSON revisions. Consider using [build-time injection](aws-fargate.md#buildtime "Install OneAgent on AWS Fargate.") instead.

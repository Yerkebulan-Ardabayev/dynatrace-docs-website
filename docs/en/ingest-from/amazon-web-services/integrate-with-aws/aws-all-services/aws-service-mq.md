...
For role-based access in a [SaaS](../cloudwatch-metrics.md#role-based-access "Integrate metrics from Amazon CloudWatch.") deployment, you need an Environment ActiveGate installed on an Amazon EC2 host.

...
For more information, see [Host-level resource attributes](../../platform/oneagent/resource-attributes.md#host-level-resource-attributes "Any signal that uses a given resource, such as host or process group, is enriched with certain attributes coming from the resource.").

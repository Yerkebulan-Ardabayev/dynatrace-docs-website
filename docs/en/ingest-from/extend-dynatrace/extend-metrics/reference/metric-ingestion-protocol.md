...
See [POST ingest data points](../../../../dynatrace-api/environment-api/metric-v2/post-ingest-metrics.md#example "Ingest custom metrics to Dynatrace via Metrics v2 API.") for an example API call.

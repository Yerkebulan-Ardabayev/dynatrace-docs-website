...
* Custom events and/or event-ingestion channels.
  ...
  + Any custom event sent to Dynatrace via the [Events API v2](../../dynatrace-api/environment-api/events-v2.md "Find out what you can do with the Dynatrace Events API v2.") or the [OneAgent API](../../ingest-from/extend-dynatrace/extend-events.md#oneagent "Learn how to extend event observability in Dynatrace.").
  ...
  + Any custom event created in a [processing step](../../platform/openpipeline/concepts/processing.md "Learn the core concepts of Dynatrace OpenPipeline processing.") in OpenPipeline.

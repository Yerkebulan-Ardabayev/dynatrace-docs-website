...
For an overview of the capability, including its main features, see [Log Analytics (DPS)](../log-analytics.md "Learn how Dynatrace Log Analytics consumption is calculated using the Dynatrace Platform Subscription model.").
...
* [Log Analytics (DPS)](../log-analytics.md "Learn how Dynatrace Log Analytics consumption is calculated using the Dynatrace Platform Subscription model.")

...
[Application Security](../../secure/application-security.md "Access the Dynatrace Application Security functionalities.") helps secure cloud-native and on-premise applications at runtime with intelligent automation.
...
[Security Posture Management (SPM)](../../secure/application-security/spm.md "Assess, manage, and take action on misconfigurations and violations against security hardening guidelines and regulatory compliance standards.") provides ongoing monitoring and automated assessment for KubernetesÂ® environments.

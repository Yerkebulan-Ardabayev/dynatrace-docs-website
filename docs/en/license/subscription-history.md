...
* A Dynatrace user account with one or both of these Account Management permissions:
...
For more information about POCs, see Proof of Concept for existing DPS subscriptions.

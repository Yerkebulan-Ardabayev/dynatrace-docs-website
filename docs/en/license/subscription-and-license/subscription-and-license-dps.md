...
For information about all other Dynatrace Platform Subscription licenses, see License Dynatrace, the licensing model for all Dynatrace capabilities.").
...
For full details, see Application and Infrastructure Monitoring (Host Units).
...
* Account Management, see Subscription overview (Dynatrace Platform Subscription pre-2023).
* The Account Management API, see Dynatrace Platform Subscription API.

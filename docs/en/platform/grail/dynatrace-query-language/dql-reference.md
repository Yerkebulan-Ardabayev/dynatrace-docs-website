...
The required parameter is `aggregation`. For this command to be syntactically valid, at least one call to an [aggregation function](functions.md#aggregation-functions "A list of DQL functions.") has to be specified.
...
* **Line 9**
  ...
  With the [`fieldsAdd`](commands.md#fields-add "A list of DQL commands.") command, you add a new field showing the total payload converted into megabytes, basing on a mathematical expression.
* **Line 10**

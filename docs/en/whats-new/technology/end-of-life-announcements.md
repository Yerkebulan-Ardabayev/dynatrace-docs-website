...
* To continue using extensions after the OneAgent version 1.299 EoL date, migrate to the new Extensions framework and update OneAgent to a supported version. See [Migration guides for custom extensions 1.0](#migration)
...
To remain supported, update your OneAgent to the latest version.
...
* Set up your preferred notification integrations via:
  ...
  + Dynatrace SaaS: Workflows
  + Dynatrace Managed: Problem notifications

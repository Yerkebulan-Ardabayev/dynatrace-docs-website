...
* [Notebooks ![Notebooks](https://dt-cdn.net/images/notebooks-768-046137830a.webp "Notebooks")](../../../analyze-explore-automate/dashboards-and-notebooks/notebooks.md "Analyze, visualize, and share insights from your observability dataâall in one collaborative, customizable workspace.")
...
* [Workflows ![Workflows](https://dt-cdn.net/images/workflows-1024-b5708f3cf9.webp "Workflows")](../../../analyze-explore-automate/workflows.md "Automate IT processes with Dynatrace Workflowsâreact to events, schedule tasks, and connect services.")
...
**Apply a segment to filter data on your dashboard**](segments-getting-started-analyze-monitoring-data.md#apply-segment "Learn how to analyze monitoring data more efficiently by using segments in Dashboards.")[![Step 2 optional](https://dt-cdn.net/images/dotted-step-2-8ae6982454.svg "Step 2 optional")

**Select multiple values for more flexible filtering**](segments-getting-started-analyze-monitoring-data.md#multi-select "Learn how to analyze monitoring data more efficiently by using segments in Dashboards.")[![Step 3 optional](https://dt-cdn.net/images/dotted-step-3-e2082c1921.svg "Step 3 optional")

**Pin recent selections for quick access**](segments-getting-started-analyze-monitoring-data.md#pinning "Learn how to analyze monitoring data more efficiently by using segments in Dashboards.")

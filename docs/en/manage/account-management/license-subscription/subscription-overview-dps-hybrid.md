...
This page is specifically for customers with a DPS for Hybrid setup, see DPS for Hybrid.

If you do not share your DPS license with other accounts, see Subscription (DPS) for a description of your **Overview** view.
...
Select **View details** to see the **Cost and usage details** page, see Cost and usage.

...
Depending on the type of [guardian](../site-reliability-guardian.md#guardian "Automatically validate the performance, availability, and capacity objectives of your critical services to make the right release decision.") â [Lifecycle guardian](../site-reliability-guardian.md#lifecycle-guardian "Automatically validate the performance, availability, and capacity objectives of your critical services to make the right release decision.") or [Business guardian](../site-reliability-guardian.md#business-guardian "Automatically validate the performance, availability, and capacity objectives of your critical services to make the right release decision.") â you use, the underlying event structure is different.
...
To query [Lifecycle guardian](../site-reliability-guardian.md#lifecycle-guardian "Automatically validate the performance, availability, and capacity objectives of your critical services to make the right release decision.") events with DQL, use the following query:

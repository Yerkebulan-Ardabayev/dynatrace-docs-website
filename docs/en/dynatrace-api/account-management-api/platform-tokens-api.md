...
Get an overview of all platform tokens in your Dynatrace account.](/docs/dynatrace-api/account-management-api/platform-tokens-api/get-all-platform-tokens "Get an overview of platform tokens in your Dynatrace account via the Dynatrace API.")[### Create a platform token

Add a new platform token to your Dynatrace account.](/docs/dynatrace-api/account-management-api/platform-tokens-api/post-platform-token "Create a platform token in your Dynatrace account via the platform tokens API.")[### Delete a platform token
